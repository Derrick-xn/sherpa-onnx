...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset offsetM3033boximpl = currentBounds != null ? Offset.m3033boximpl(currentBounds.m3079getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(offsetM3033boximpl);
            long packedValue = offsetM3033boximpl.getPackedValue();
            float fM3044getXimpl = Offset.m3044getXimpl(packedValue);
            float fM3045getYimpl = Offset.m3045getYimpl(packedValue);
            ...
            if (path != null) {
                ...
                try {
                    drawContext.getTransform().mo3815clipPathmtrdDE(path, iM3313getIntersectrtfAjoo);
                    drawScope.getDrawContext().getTransform().translate(fM3044getXimpl, fM3045getYimpl);
                    try {
    ...
    public final long m130getNonNullLookaheadSizeNHjbRc() {
        ...
        return IntSizeKt.m6030toSizeozmzZPI(layoutCoordinatesInvoke.mo4682getSizeYbymL2g());
    }
    ...
    public final long m129calculateLookaheadOffsetF1C5BW0() {
        LayoutCoordinates layoutCoordinatesInvoke = this.lookaheadCoords.invoke();
        if (layoutCoordinatesInvoke == null) {
            throw new IllegalArgumentException("Error: lookahead coordinates is null.".toString());
        }
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo4683localPositionOfR5De75A(layoutCoordinatesInvoke, Offset.INSTANCE.m3060getZeroF1C5BW0());
    }
