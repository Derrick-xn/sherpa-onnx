            ...
            if (z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibilityImpl$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                        return m90invoke3p2s80s(measureScope, measurable, constraints.m5793unboximpl());
                    }
                    ...
                    public final MeasureResult m90invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                        ...
                        if (measureScope.isLookingAhead() && !function1.invoke(transition.getTargetState()).booleanValue()) {
                            jIntSize = IntSize.INSTANCE.m6023getZeroYbymL2g();
                        } else {
                            jIntSize = IntSizeKt.IntSize(placeableMo4680measureBRTryo0.getWidth(), placeableMo4680measureBRTryo0.getHeight());
                        }
                        return MeasureScope.CC.layout$default(measureScope, IntSize.m6018getWidthimpl(jIntSize), IntSize.m6017getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibilityImpl$1$1.1
                            {
                                super(1);
                            }
        ...
        if ((4793491 & i8) != 4793490 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (function1.invoke(transition.getTargetState()).booleanValue() || function1.invoke(transition.getCurrentState()).booleanValue() || transition.isSeeking() || transition.getHasInitialValueAnimations()) {
                ...
                if (!getExitFinished(transitionCreateChildTransitionInternal) || !AnimatedEnterExitImpl$lambda$4(stateProduceState)) {
                    ...
                    if (onLookaheadMeasured2 != null) {
                        ...
                        if (z || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue3 = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$2$1
                                ...
                                @Override // kotlin.jvm.functions.Function3
                                public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                                    return m89invoke3p2s80s(measureScope, measurable, constraints.m5793unboximpl());
                                }
                                ...
                                public final MeasureResult m89invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                                    ...
                                    if (measureScope.isLookingAhead()) {
                                        onLookaheadMeasured6.m121invokeozmzZPI(IntSizeKt.IntSize(placeableMo4680measureBRTryo0.getWidth(), placeableMo4680measureBRTryo0.getHeight()));
                                    }
                                    return MeasureScope.CC.layout$default(measureScope, placeableMo4680measureBRTryo0.getWidth(), placeableMo4680measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$2$1$1$1
                                        {
                                            super(1);
                                        }
                    ...
                    Updater.m2784setimpl(composerM2777constructorimpl, animatedEnterExitMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                    ...
                    function3.invoke(animatedVisibilityScopeImpl, composer2, Integer.valueOf((i14 >> 18) & 112));
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    composer2.endNode();
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
