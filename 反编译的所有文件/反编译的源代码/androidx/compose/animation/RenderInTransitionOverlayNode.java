...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements DrawModifierNode, ModifierLocalModifierNode {
    ...
    private final class LayerWithRenderer implements LayerRenderer {
        ...
        public void drawInOverlay(DrawScope drawScope) {
            if (RenderInTransitionOverlayNode.this.getRenderInOverlay().invoke().booleanValue()) {
                ...
                long jMo4683localPositionOfR5De75A = renderInTransitionOverlayNode.getSharedScope().getRoot$animation_release().mo4683localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode2), Offset.INSTANCE.m3060getZeroF1C5BW0());
                float fM3044getXimpl = Offset.m3044getXimpl(jMo4683localPositionOfR5De75A);
                float fM3045getYimpl = Offset.m3045getYimpl(jMo4683localPositionOfR5De75A);
                ...
                if (pathInvoke != null) {
                    ...
                    try {
                        drawContext.getTransform().mo3815clipPathmtrdDE(pathInvoke, iM3313getIntersectrtfAjoo);
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.CC.m3894recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode.draw.1
            {
                super(1);
            }
