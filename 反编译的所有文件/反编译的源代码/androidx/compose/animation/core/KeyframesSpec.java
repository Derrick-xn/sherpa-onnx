...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public final KeyframeEntity<T> m181usingngzHuyU(KeyframeEntity<T> keyframeEntity, int i) {
            keyframeEntity.m180setArcModeRur9ykg$animation_core_release(i);
            return keyframeEntity;
        }
    }
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> converter) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i3 < i2) {
                        if ((255 & j) < 128) {
                            ...
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                            mutableIntObjectMap.set(i5, new VectorizedKeyframeSpecElementInfo(converter.getConvertToVector().invoke(keyframeEntity.getValue$animation_core_release()), keyframeEntity.getEasing(), keyframeEntity.getArcMode(), null));
                        } else {
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                        }
        ...
        mutableIntList.sort();
        return new VectorizedKeyframesSpec<>(mutableIntList, mutableIntObjectMap, this.config.getDurationMillis(), this.config.getDelayMillis(), EasingKt.getLinearEasing(), ArcMode.INSTANCE.m175getArcLinear9TMq4(), null);
    }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i2 & 2) != 0 ? EasingKt.getLinearEasing() : easing, (i2 & 4) != 0 ? ArcMode.INSTANCE.m175getArcLinear9TMq4() : i, null);
        }
        ...
        public final void m180setArcModeRur9ykg$animation_core_release(int i) {
            this.arcMode = i;
        }
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(keyframeEntity.getValue$animation_core_release(), getValue$animation_core_release()) && Intrinsics.areEqual(keyframeEntity.getEasing(), getEasing()) && ArcMode.m169equalsimpl0(keyframeEntity.arcMode, this.arcMode);
        }

        public int hashCode() {
            T value$animation_core_release = getValue$animation_core_release();
            return ((((value$animation_core_release != null ? value$animation_core_release.hashCode() : 0) * 31) + ArcMode.m170hashCodeimpl(this.arcMode)) * 31) + getEasing().hashCode();
        }
    }
}