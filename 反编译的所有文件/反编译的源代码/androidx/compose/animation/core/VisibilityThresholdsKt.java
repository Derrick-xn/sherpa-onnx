...
public final class VisibilityThresholdsKt {
    ...
    static {
        ...
        Float fValueOf3 = Float.valueOf(DpVisibilityThreshold);
        visibilityThresholdMap = MapsKt.mapOf(TuplesKt.to(vectorConverter, fValueOf2), TuplesKt.to(VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), fValueOf2), TuplesKt.to(VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), fValueOf2), TuplesKt.to(VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE), Float.valueOf(0.01f)), TuplesKt.to(VectorConvertersKt.getVectorConverter(Rect.INSTANCE), fValueOf), TuplesKt.to(VectorConvertersKt.getVectorConverter(Size.INSTANCE), fValueOf), TuplesKt.to(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), fValueOf), TuplesKt.to(vectorConverter2, fValueOf3), TuplesKt.to(VectorConvertersKt.getVectorConverter(DpOffset.INSTANCE), fValueOf3));
    }
    ...
    public static final long getVisibilityThreshold(DpOffset.Companion companion) {
        return DpKt.m5865DpOffsetYgX7TsA(getVisibilityThreshold(Dp.INSTANCE), getVisibilityThreshold(Dp.INSTANCE));
    }
    ...
    public static final float getVisibilityThreshold(Dp.Companion companion) {
        return Dp.m5844constructorimpl(DpVisibilityThreshold);
    }
}