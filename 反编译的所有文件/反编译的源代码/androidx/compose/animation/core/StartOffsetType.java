...
public final class StartOffsetType {
    ...
    private static final int Delay = m207constructorimpl(-1);
    private static final int FastForward = m207constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StartOffsetType m206boximpl(int i) {
        return new StartOffsetType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m207constructorimpl(int i) {
        return i;
    }
    ...
    public static int m210hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m211toStringimpl(int i) {
        return "StartOffsetType(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m208equalsimpl(this.value, obj);
    }
