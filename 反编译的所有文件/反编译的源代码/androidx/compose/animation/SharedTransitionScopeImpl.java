...
public final class SharedTransitionScopeImpl implements SharedTransitionScope, LookaheadScope {
    ...
    public long mo132localLookaheadPositionOfauaQtc(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        return this.$$delegate_0.mo132localLookaheadPositionOfauaQtc(layoutCoordinates, layoutCoordinates2, j, z);
    }

    @Override // androidx.compose.animation.SharedTransitionScope
    public /* synthetic */ EnterTransition scaleInSharedContentToBounds(ContentScale contentScale, Alignment alignment) {
    ...
    @Override // androidx.compose.animation.SharedTransitionScope
    public /* synthetic */ ExitTransition scaleOutSharedContentToBounds(ContentScale contentScale, Alignment alignment) {
    ...
    */
    ...
    private static final class ShapeBasedClip implements SharedTransitionScope.OverlayClip {
        ...
        public Path getClipPath(SharedTransitionScope.SharedContentState state, Rect bounds, LayoutDirection layoutDirection, Density density) {
            this.path.reset();
            OutlineKt.addOutline(this.path, this.clipShape.mo308createOutlinePq9zytI(bounds.m3077getSizeNHjbRc(), layoutDirection, density));
            this.path.mo3181translatek4lQ0M(bounds.m3079getTopLeftF1C5BW0());
            return this.path;
        }
    }
}