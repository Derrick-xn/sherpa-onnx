...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public final long m115sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i == 2) {
            ChangeSize changeSize = this.enter.getData().getChangeSize();
            return (changeSize == null || (size = changeSize.getSize()) == null) ? fullSize : size.invoke(IntSize.m6010boximpl(fullSize)).getPackedValue();
        }
        if (i != 3) {
            throw new NoWhenBranchMatchedException();
        }
        ChangeSize changeSize2 = this.exit.getData().getChangeSize();
        return (changeSize2 == null || (size2 = changeSize2.getSize()) == null) ? fullSize : size2.invoke(IntSize.m6010boximpl(fullSize)).getPackedValue();
    }
    ...
    public final long m117targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            ...
            if (changeSize != null) {
                long packedValue = changeSize.getSize().invoke(IntSize.m6010boximpl(fullSize)).getPackedValue();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long jMo2890alignKFBX0sM = alignment.mo2890alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m5979minusqkQi6aY(jMo2890alignKFBX0sM, alignment2.mo2890alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m5986getZeronOccac();
        }
        return IntOffset.INSTANCE.m5986getZeronOccac();
    ...
    public MeasureResult mo114measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long jIntSize = IntSizeKt.IntSize(placeableMo4680measureBRTryo0.getWidth(), placeableMo4680measureBRTryo0.getHeight());
            this.lookaheadSize = jIntSize;
            m113setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.CC.layout$default(measureScope, IntSize.m6018getWidthimpl(jIntSize), IntSize.m6017getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable placeableMo4680measureBRTryo02 = measurable.mo4680measureBRTryo0(j);
            long jIntSize2 = IntSizeKt.IntSize(placeableMo4680measureBRTryo02.getWidth(), placeableMo4680measureBRTryo02.getHeight());
            final long j2 = AnimationModifierKt.m91isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize2;
            ...
            State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m6010boximpl(m118invokeYEO4UFw(enterExitState));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m118invokeYEO4UFw(EnterExitState enterExitState) {
                    return this.this$0.m115sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (stateAnimate3 != null) {
                jIntSize2 = stateAnimate3.getValue().getPackedValue();
            }
            long jM5801constrain4WqzIAM = ConstraintsKt.m5801constrain4WqzIAM(j, jIntSize2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            final long jM5986getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                }
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m5967boximpl(m119invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m119invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m117targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m5986getZeronOccac() : stateAnimate2.getValue().getPackedValue();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long jM5986getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m5967boximpl(m120invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m120invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m116slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m5986getZeronOccac() : stateAnimate.getValue().getPackedValue();
            Alignment alignment2 = this.currentAlignment;
            final long jM5980plusqkQi6aY = IntOffset.m5980plusqkQi6aY(alignment2 != null ? alignment2.mo2890alignKFBX0sM(j2, jM5801constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m5986getZeronOccac(), jM5986getZeronOccac2);
            return MeasureScope.CC.layout$default(measureScope, IntSize.m6018getWidthimpl(jM5801constrain4WqzIAM), IntSize.m6017getHeightimpl(jM5801constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(placeableMo4680measureBRTryo02, IntOffset.m5976getXimpl(jM5986getZeronOccac) + IntOffset.m5976getXimpl(jM5980plusqkQi6aY), IntOffset.m5977getYimpl(jM5986getZeronOccac) + IntOffset.m5977getYimpl(jM5980plusqkQi6aY), 0.0f, function1Init);
                }
            }, 4, null);
        }
        final Placeable placeableMo4680measureBRTryo03 = measurable.mo4680measureBRTryo0(j);
        return MeasureScope.CC.layout$default(measureScope, placeableMo4680measureBRTryo03.getWidth(), placeableMo4680measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo4680measureBRTryo03, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public final long m116slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long jM5986getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5986getZeronOccac() : slideOffset2.invoke(IntSize.m6010boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long jM5986getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5986getZeronOccac() : slideOffset.invoke(IntSize.m6010boximpl(fullSize)).getPackedValue();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m5986getZeronOccac();
        }
