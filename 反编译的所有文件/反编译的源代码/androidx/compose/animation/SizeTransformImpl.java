...
final class SizeTransformImpl implements SizeTransform {
    ...
    public FiniteAnimationSpec<IntSize> mo146createAnimationSpecTemP2vQ(long initialSize, long targetSize) {
        return this.sizeAnimationSpec.invoke(IntSize.m6010boximpl(initialSize), IntSize.m6010boximpl(targetSize));
    }
}