...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds(sharedElementInternalState != null ? RectKt.m3084Recttz77jQw(sharedElementInternalState.m129calculateLookaheadOffsetF1C5BW0(), sharedElementInternalState.m130getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void m128onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            this.targetBoundsProvider = state;
            Rect rect = get_targetBounds();
            Offset offsetM3033boximpl = rect != null ? Offset.m3033boximpl(rect.m3079getTopLeftF1C5BW0()) : null;
            if (offsetM3033boximpl != null && Offset.m3041equalsimpl0(offsetM3033boximpl.getPackedValue(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size sizeM3101boximpl = rect2 != null ? Size.m3101boximpl(rect2.m3077getSizeNHjbRc()) : null;
                if (sizeM3101boximpl != null && Size.m3109equalsimpl0(sizeM3101boximpl.getPackedValue(), lookaheadSize)) {
                    return;
                }
            }
            Rect rectM3084Recttz77jQw = RectKt.m3084Recttz77jQw(topLeft, lookaheadSize);
            set_targetBounds(rectM3084Recttz77jQw);
            SnapshotStateList<SharedElementInternalState> snapshotStateList = this.states;
            int size = snapshotStateList.size();
            for (int i = 0; i < size; i++) {
                ...
                boundsAnimation.animate(currentBounds, rectM3084Recttz77jQw);
            }
        }
    }
