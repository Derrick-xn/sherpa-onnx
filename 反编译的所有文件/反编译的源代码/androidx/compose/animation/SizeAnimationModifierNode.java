...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m138setLookaheadConstraintsBRTryo0(long j) {
        this.lookaheadConstraints = j;
        this.lookaheadConstraintsAvailable = true;
    }

    /* renamed from: targetConstraints-ZezNO4M, reason: not valid java name */
    private final long m139targetConstraintsZezNO4M(long j) {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m141copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m143copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m143copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m6016equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m6019hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m6021toStringimpl(this.startSize)) + ')';
        }
        ...
        public final void m145setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo114measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        long jM5801constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m138setLookaheadConstraintsBRTryo0(j);
            placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(j);
        } else {
            placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(m139targetConstraintsZezNO4M(j));
        }
        ...
        if (measureScope.isLookingAhead()) {
            ...
            jM5801constrain4WqzIAM = jIntSize;
        } else {
            jM5801constrain4WqzIAM = ConstraintsKt.m5801constrain4WqzIAM(j, m140animateTomzRDjE0(AnimationModifierKt.m91isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize));
        }
        final int iM6018getWidthimpl = IntSize.m6018getWidthimpl(jM5801constrain4WqzIAM);
        final int iM6017getHeightimpl = IntSize.m6017getHeightimpl(jM5801constrain4WqzIAM);
        return MeasureScope.CC.layout$default(measureScope, iM6018getWidthimpl, iM6017getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m4750placeRelative70tqf50$default(placementScope, placeable, this.this$0.getAlignment().mo2890alignKFBX0sM(jIntSize, IntSizeKt.IntSize(iM6018getWidthimpl, iM6017getHeightimpl), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m140animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            boolean z = (IntSize.m6016equalsimpl0(targetSize, animData.getAnim().getValue().getPackedValue()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m6016equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue()) || z) {
                animData.m145setStartSizeozmzZPI(animData.getAnim().getValue().getPackedValue());
            ...
            animData = new AnimData(new Animatable(IntSize.m6010boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m6010boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
