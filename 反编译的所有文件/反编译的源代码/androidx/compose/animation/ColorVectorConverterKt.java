        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m93invoke8_81llA(color.m3334unboximpl());
                }

                /* renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m93invoke8_81llA(long j) {
                    long jM3321convertvNxB06k = Color.m3321convertvNxB06k(j, ColorSpaces.INSTANCE.getOklab());
                    return new AnimationVector4D(Color.m3326getAlphaimpl(jM3321convertvNxB06k), Color.m3330getRedimpl(jM3321convertvNxB06k), Color.m3329getGreenimpl(jM3321convertvNxB06k), Color.m3327getBlueimpl(jM3321convertvNxB06k));
                }
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m3314boximpl(m94invokevNxB06k(animationVector4D));
                }
                ...
                public final long m94invokevNxB06k(AnimationVector4D animationVector4D) {
                    ...
                    return Color.m3321convertvNxB06k(ColorKt.Color(v2, v3, f2, f3 <= 1.0f ? f3 : 1.0f, ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };
