...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6010boximpl(IntSize.INSTANCE.m6023getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo62slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m83isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6018getWidthimpl(this.m82getCurrentSizeYbymL2g()) - IntOffset.m5976getXimpl(this.m81calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m82getCurrentSizeYbymL2g()))));
            }
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m5976getXimpl(this.m81calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m82getCurrentSizeYbymL2g()))) - i));
            }
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6017getHeightimpl(this.m82getCurrentSizeYbymL2g()) - IntOffset.m5977getYimpl(this.m81calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m82getCurrentSizeYbymL2g()))));
            }
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m5977getYimpl(this.m81calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m82getCurrentSizeYbymL2g()))) - i));
            }
    ...
    private final boolean m83isLeftgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m69equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m75getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m69equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m77getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m69equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m74getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m84isRightgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m69equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m76getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m69equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m77getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m69equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m74getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }
    ...
    public final long m81calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo2890alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo63slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m83isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5976getXimpl(this.this$0.m81calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6023getZeroYbymL2g()))) - i));
            }
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6023getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5976getXimpl(this.this$0.m81calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m6018getWidthimpl(packedValue)));
            }
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5977getYimpl(this.this$0.m81calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6023getZeroYbymL2g()))) - i));
            }
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6023getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5977getYimpl(this.this$0.m81calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m6017getHeightimpl(packedValue)));
            }
    ...
    public final void m86setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m6010boximpl(j));
    }
        ...
        public MeasureResult mo87measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo146createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long packedValue2 = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6023getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long packedValue3 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m6023getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo146createAnimationSpecTemP2vQ = value.mo146createAnimationSpecTemP2vQ(packedValue2, packedValue3)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo146createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m6010boximpl(m88invokeYEO4UFw(obj));
                }
                ...
                public final long m88invokeYEO4UFw(S s) {
                    ...
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6023getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(stateAnimate);
            if (measureScope.isLookingAhead()) {
                packedValue = IntSizeKt.IntSize(placeableMo4680measureBRTryo0.getWidth(), placeableMo4680measureBRTryo0.getHeight());
            } else {
                packedValue = stateAnimate.getValue().getPackedValue();
            }
            int iM6018getWidthimpl = IntSize.m6018getWidthimpl(packedValue);
            int iM6017getHeightimpl = IntSize.m6017getHeightimpl(packedValue);
            final AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl3 = AnimatedContentTransitionScopeImpl.this;
            return MeasureScope.CC.layout$default(measureScope, iM6018getWidthimpl, iM6017getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m4749place70tqf50$default(placementScope, placeableMo4680measureBRTryo0, animatedContentTransitionScopeImpl3.getContentAlignment().mo2890alignKFBX0sM(IntSizeKt.IntSize(placeableMo4680measureBRTryo0.getWidth(), placeableMo4680measureBRTryo0.getHeight()), packedValue, LayoutDirection.Ltr), 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
