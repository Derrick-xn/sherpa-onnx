...
public final class PlaceKt {
    ...
    public static final ImageVector getPlace(Icons.TwoTone twoTone) {
        ...
        pathBuilder.close();
        ImageVector.Builder.m4028addPathoIyEayM$default(builder, pathBuilder.getNodes(), defaultFillType, "", solidColor, 0.3f, null, 1.0f, 1.0f, iM3686getButtKaPHkGw, iM3696getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
