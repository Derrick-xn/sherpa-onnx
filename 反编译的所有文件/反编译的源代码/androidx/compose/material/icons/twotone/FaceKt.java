...
public final class FaceKt {
    ...
    public static final ImageVector getFace(Icons.TwoTone twoTone) {
        ...
        pathBuilder3.arcToRelative(1.25f, 1.25f, 0.0f, true, true, -2.5f, 0.0f);
        ImageVector.Builder.m4028addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3686getButtKaPHkGw3, iM3696getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
