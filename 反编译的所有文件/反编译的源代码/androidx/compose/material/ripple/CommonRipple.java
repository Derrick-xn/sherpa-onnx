...
public final class CommonRipple extends Ripple {
    ...
    public RippleIndicationInstance mo1450rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> color, State<RippleAlpha> rippleAlpha, Composer composer, int i) {
