...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5844constructorimpl(10);
    ...
    public static final float m1455getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m3113getWidthimpl(j), Size.m3110getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m1454getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float fM3042getDistanceimpl = Offset.m3042getDistanceimpl(OffsetKt.Offset(Size.m3113getWidthimpl(j), Size.m3110getHeightimpl(j))) / 2.0f;
        return z ? fM3042getDistanceimpl + getRippleEndRadius.mo397toPx0680j_4(BoundedRippleExtraRadius) : fM3042getDistanceimpl;
    }
}