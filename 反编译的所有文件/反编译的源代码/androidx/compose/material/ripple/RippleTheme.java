...
public interface RippleTheme {
    ...
    long mo1452defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1462defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m3376luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m3361getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc, reason: not valid java name */
        public final RippleAlpha m1461defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (lightTheme) {
                return ((double) ColorKt.m3376luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha;
            }
