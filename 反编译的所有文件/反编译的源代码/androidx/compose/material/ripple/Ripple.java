...
public abstract class Ripple implements Indication {
    ...
    public abstract RippleIndicationInstance mo1450rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i);
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        long jMo1452defaultColorWaAFU9c;
        ...
        if (this.color.getValue().m3334unboximpl() != Color.INSTANCE.m3360getUnspecified0d7_KjU()) {
            jMo1452defaultColorWaAFU9c = this.color.getValue().m3334unboximpl();
        } else {
            jMo1452defaultColorWaAFU9c = rippleTheme.mo1452defaultColorWaAFU9c(composer, 0);
        }
        composer.endReplaceableGroup();
        RippleIndicationInstance rippleIndicationInstanceMo1450rememberUpdatedRippleInstance942rkJo = mo1450rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(jMo1452defaultColorWaAFU9c), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i & 14) | ((i << 12) & 458752));
        EffectsKt.LaunchedEffect(rippleIndicationInstanceMo1450rememberUpdatedRippleInstance942rkJo, interactionSource, new AnonymousClass1(interactionSource, rippleIndicationInstanceMo1450rememberUpdatedRippleInstance942rkJo, null), composer, ((i << 3) & 112) | 520);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleIndicationInstanceMo1450rememberUpdatedRippleInstance942rkJo;
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.bounded == ripple.bounded && Dp.m5849equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual(this.color, ripple.color);
    }

    public int hashCode() {
        return (((UByte$$ExternalSyntheticBackport0.m(this.bounded) * 31) + Dp.m5850hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
