...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1465setColorDxMtmZc(long color, float alpha) {
        long jM1464calculateRippleColor5vOe2sY = m1464calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 != null && Color.m3325equalsimpl0(color2.m3334unboximpl(), jM1464calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m3314boximpl(jM1464calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m3378toArgb8_81llA(jM1464calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m1464calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m3323copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
