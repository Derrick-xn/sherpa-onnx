...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1452defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM1462defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1462defaultRippleColor5vOe2sY(Color.INSTANCE.m3350getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1462defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM1461defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1461defaultRippleAlphaDxMtmZc(Color.INSTANCE.m3350getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleAlphaM1461defaultRippleAlphaDxMtmZc;
    }
}