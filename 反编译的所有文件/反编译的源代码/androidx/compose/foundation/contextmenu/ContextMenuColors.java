...
public final class ContextMenuColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.backgroundColor, contextMenuColors.backgroundColor) && Color.m3325equalsimpl0(this.textColor, contextMenuColors.textColor) && Color.m3325equalsimpl0(this.iconColor, contextMenuColors.iconColor) && Color.m3325equalsimpl0(this.disabledTextColor, contextMenuColors.disabledTextColor) && Color.m3325equalsimpl0(this.disabledIconColor, contextMenuColors.disabledIconColor);
    }

    public int hashCode() {
        return (((((((Color.m3331hashCodeimpl(this.backgroundColor) * 31) + Color.m3331hashCodeimpl(this.textColor)) * 31) + Color.m3331hashCodeimpl(this.iconColor)) * 31) + Color.m3331hashCodeimpl(this.disabledTextColor)) * 31) + Color.m3331hashCodeimpl(this.disabledIconColor);
    }

    public String toString() {
        return "ContextMenuColors(backgroundColor=" + ((Object) Color.m3332toStringimpl(this.backgroundColor)) + ", textColor=" + ((Object) Color.m3332toStringimpl(this.textColor)) + ", iconColor=" + ((Object) Color.m3332toStringimpl(this.iconColor)) + ", disabledTextColor=" + ((Object) Color.m3332toStringimpl(this.disabledTextColor)) + ", disabledIconColor=" + ((Object) Color.m3332toStringimpl(this.disabledIconColor)) + ')';
    }
}