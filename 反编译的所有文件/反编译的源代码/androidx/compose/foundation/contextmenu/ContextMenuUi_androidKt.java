...
public final class ContextMenuUi_androidKt {
    ...
    private static final ContextMenuColors DefaultContextMenuColors = new ContextMenuColors(Color.INSTANCE.m3361getWhite0d7_KjU(), Color.INSTANCE.m3350getBlack0d7_KjU(), Color.INSTANCE.m3350getBlack0d7_KjU(), Color.m3323copywmQWz5c$default(Color.INSTANCE.m3350getBlack0d7_KjU(), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3323copywmQWz5c$default(Color.INSTANCE.m3350getBlack0d7_KjU(), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public static final void ContextMenuPopup(final PopupPositionProvider popupPositionProvider, final Function0<Unit> function0, Modifier modifier, final Function1<? super ContextMenuScope, Unit> function1, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 1171) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            ContextMenuPopup(popupPositionProvider, function0, modifier, computeContextMenuColors(0, 0, composerStartRestartGroup, 0, 3), function1, composerStartRestartGroup, (i3 & 14) | (i3 & 112) | (i3 & 896) | ((i3 << 3) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    */
    ...
    public static final ContextMenuColors computeContextMenuColors(int i, int i2, Composer composer, int i3, int i4) throws Resources.NotFoundException {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            long jM386resolveColorg2O1Hgs = m386resolveColorg2O1Hgs(context, i5, R.attr.colorBackground, contextMenuColors.getBackgroundColor());
            ColorStateList colorStateListResolveColorStateList = resolveColorStateList(context, i6, R.attr.textColorPrimary);
            long jM385enabledColor4WTKRHQ = m385enabledColor4WTKRHQ(colorStateListResolveColorStateList, contextMenuColors.getTextColor());
            long jM384disabledColor4WTKRHQ = m384disabledColor4WTKRHQ(colorStateListResolveColorStateList, contextMenuColors.getDisabledTextColor());
            objRememberedValue = new ContextMenuColors(jM386resolveColorg2O1Hgs, jM385enabledColor4WTKRHQ, jM385enabledColor4WTKRHQ, jM384disabledColor4WTKRHQ, jM384disabledColor4WTKRHQ, null);
    ...
    private static final long m386resolveColorg2O1Hgs(Context context, int i, int i2, long j) throws Resources.NotFoundException {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i, new int[]{i2});
        int iM3378toArgb8_81llA = ColorKt.m3378toArgb8_81llA(j);
        int color = typedArrayObtainStyledAttributes.getColor(0, iM3378toArgb8_81llA);
        typedArrayObtainStyledAttributes.recycle();
        return color == iM3378toArgb8_81llA ? j : ColorKt.Color(color);
    }
    ...
    private static final long m385enabledColor4WTKRHQ(ColorStateList colorStateList, long j) {
        int iM3378toArgb8_81llA = ColorKt.m3378toArgb8_81llA(j);
        Integer numValueOf = colorStateList != null ? Integer.valueOf(colorStateList.getColorForState(new int[]{R.attr.state_enabled}, iM3378toArgb8_81llA)) : null;
        return (numValueOf == null || numValueOf.intValue() == iM3378toArgb8_81llA) ? j : ColorKt.Color(numValueOf.intValue());
    }

    /* renamed from: disabledColor-4WTKRHQ, reason: not valid java name */
    private static final long m384disabledColor4WTKRHQ(ColorStateList colorStateList, long j) {
        int iM3378toArgb8_81llA = ColorKt.m3378toArgb8_81llA(j);
        Integer numValueOf = colorStateList != null ? Integer.valueOf(colorStateList.getColorForState(new int[]{-16842910}, iM3378toArgb8_81llA)) : null;
        return (numValueOf == null || numValueOf.intValue() == iM3378toArgb8_81llA) ? j : ColorKt.Color(numValueOf.intValue());
    }
}