...
public final class ContextMenuState {
    ...
    public static abstract class Status {
        ...
        public static final class Open extends Status {
            ...
            public String toString() {
                return "Open(offset=" + ((Object) Offset.m3052toStringimpl(this.offset)) + ')';
            }

            public int hashCode() {
                return Offset.m3046hashCodeimpl(this.offset);
            }
            ...
            public boolean equals(Object other) {
                ...
                if (other instanceof Open) {
                    return Offset.m3041equalsimpl0(this.offset, ((Open) other).offset);
                }
                return false;
            }
        }
