...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo369calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m5976getXimpl(this.localPosition), IntSize.m6018getWidthimpl(popupContentSize), IntSize.m6018getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m5977getYimpl(this.localPosition), IntSize.m6017getHeightimpl(popupContentSize), IntSize.m6017getHeightimpl(windowSize), false, 8, null));
    }
}