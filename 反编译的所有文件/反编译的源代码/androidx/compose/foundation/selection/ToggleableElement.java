...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public void update(ToggleableNode node) {
        node.m982updateQzZPfjk(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int iM = UByte$$ExternalSyntheticBackport0.m(this.value) * 31;
        ...
        Role role = this.role;
        return ((iHashCode2 + (role != null ? Role.m5105hashCodeimpl(role.getValue()) : 0)) * 31) + this.onValueChange.hashCode();
    }
}