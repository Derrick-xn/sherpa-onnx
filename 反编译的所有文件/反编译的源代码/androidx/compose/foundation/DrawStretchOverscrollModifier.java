...
final class DrawStretchOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    private final RenderNode getRenderNode() {
        ...
        RenderNode renderNodeM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m("AndroidEdgeEffectOverscrollEffect");
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float f = contentDrawScope.mo397toPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        ...
        if (edgeEffectWrapper.isLeftAnimating()) {
            ...
            if (edgeEffectWrapper.isLeftStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateLeftEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect), 1 - Offset.m3045getYimpl(this.overscrollEffect.m243displacementF1C5BW0$foundation_release()));
            }
        } else {
        ...
        if (edgeEffectWrapper.isTopAnimating()) {
            ...
            if (edgeEffectWrapper.isTopStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateTopEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect), Offset.m3044getXimpl(this.overscrollEffect.m243displacementF1C5BW0$foundation_release()));
            }
        }
        ...
        if (edgeEffectWrapper.isRightAnimating()) {
            ...
            if (edgeEffectWrapper.isRightStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateRightEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect), Offset.m3045getYimpl(this.overscrollEffect.m243displacementF1C5BW0$foundation_release()));
            }
        }
        ...
        if (edgeEffectWrapper.isBottomAnimating()) {
            ...
            if (edgeEffectWrapper.isBottomStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateBottomEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect), 1 - Offset.m3044getXimpl(this.overscrollEffect.m243displacementF1C5BW0$foundation_release()));
            }
            zDrawLeftStretch = z;
        }
        if (zDrawLeftStretch) {
        ...
        long j = contentDrawScope.mo3806getSizeNHjbRc();
