...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m331boximpl(i2), null, 2, null);
    ...
    public final int m345getAnimationModeZbEOnfQ() {
    ...
    public final void m346setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m331boximpl(i));
    }
    ...
    public final void m347updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m346setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m5849equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo114measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        setContainerWidth(ConstraintsKt.m5804constrainWidthK40F9xA(j, placeableMo4680measureBRTryo0.getWidth()));
        setContentWidth(placeableMo4680measureBRTryo0.getWidth());
        return MeasureScope.CC.layout$default(measureScope, getContainerWidth(), placeableMo4680measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo4680measureBRTryo0, MathKt.roundToInt((-((Number) this.offset.getValue()).floatValue()) * this.getDirection()), 0, 0.0f, (Function1) null, 12, (Object) null);
            }
        }, 4, null);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float fM3110getHeightimpl = Size.m3110getHeightimpl(contentDrawScope2.mo3806getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo3816clipRectN_I0leg(fFloatValue, 0.0f, containerWidth, fM3110getHeightimpl, iM3313getIntersectrtfAjoo);
            if (z2) {
            ...
            if (i == 0) {
                ...
                if (FlowKt.collectLatest(SnapshotStateKt.snapshotFlow(new Function0<Float>() { // from class: androidx.compose.foundation.MarqueeModifierNode.runAnimation.2.1
                    ...
                    public final Float invoke() {
                        ...
                        if (!MarqueeAnimationMode.m334equalsimpl0(marqueeModifierNode.m345getAnimationModeZbEOnfQ(), MarqueeAnimationMode.INSTANCE.m339getWhileFocusedZbEOnfQ()) || marqueeModifierNode.getHasFocus()) {
