...
public final class MagnifierNode extends Modifier.Node implements GlobalPositionAwareModifierNode, DrawModifierNode, SemanticsModifierNode, ObserverModifierNode {
    ...
    public /* synthetic */ MagnifierNode(Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function1, (i & 2) != 0 ? null : function12, (i & 4) != 0 ? null : function13, (i & 8) != 0 ? Float.NaN : f, (i & 16) != 0 ? false : z, (i & 32) != 0 ? DpSize.INSTANCE.m5951getUnspecifiedMYxV2XQ() : j, (i & 64) != 0 ? Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM() : f2, (i & 128) != 0 ? Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM() : f3, (i & 256) != 0 ? true : z2, (i & 512) != 0 ? PlatformMagnifierFactory.INSTANCE.getForCurrentPlatform() : platformMagnifierFactory, null);
    }
    ...
    public final void m323setSizeEaSLcWc(long j) {
        this.size = j;
    }
    ...
    public final void m321setCornerRadius0680j_4(float f) {
        this.cornerRadius = f;
    }
    ...
    public final void m322setElevation0680j_4(float f) {
        this.elevation = f;
    }
    ...
    private MagnifierNode(Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        this.sourceCenterInRoot = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
    }
    ...
    private final long m317getAnchorPositionInRootF1C5BW0() {
    ...
    public final void m324update5F03MCQ(Function1<? super Density, Offset> sourceCenter, Function1<? super Density, Offset> magnifierCenter, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Function1<? super DpSize, Unit> onSizeChanged, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        if (this.magnifier != null && ((!Magnifier_androidKt.equalsIncludingNaN(zoom, f) && !platformMagnifierFactory.getCanUpdateZoom()) || !DpSize.m5939equalsimpl0(size, j) || !Dp.m5849equalsimpl0(cornerRadius, f2) || !Dp.m5849equalsimpl0(elevation, f3) || useTextDefault != z || clippingEnabled != z2 || !Intrinsics.areEqual(platformMagnifierFactory, platformMagnifierFactory2) || !Intrinsics.areEqual(viewRequireView, view) || !Intrinsics.areEqual(densityRequireDensity, density))) {
            recreateMagnifier();
        }
        updateMagnifier();
    }
    ...
    public void onAttach() {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C01851(null), 3, null);
    }
    ...
    static final class C01851 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return MagnifierNode.this.new C01851(continuation);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
                ...
                androidx.compose.foundation.MagnifierNode$onAttach$1$1 r5 = new kotlin.jvm.functions.Function1<java.lang.Long, kotlin.Unit>() { // from class: androidx.compose.foundation.MagnifierNode.onAttach.1.1
                    static {
                        /*
                            ...
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C01851.C00111.<clinit>():void");
                    }

                    {
                        /*
                            ...
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C01851.C00111.<init>():void");
                    }
                    ...
                    public final void invoke(long r1) {
                        /*
                            ...
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C01851.C00111.invoke(long):void");
                    }
                    ...
                    public /* bridge */ /* synthetic */ kotlin.Unit invoke(java.lang.Long r3) {
                        /*
                            ...
                            return r3
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C01851.C00111.invoke(java.lang.Object):java.lang.Object");
                    }
                }
            ...
            L4d:
                ...
                goto L21
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C01851.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    private final void recreateMagnifier() {
        ...
        this.magnifier = this.platformMagnifierFactory.mo351createnHHXs2Y(view, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, density, this.zoom);
    ...
    */
    public final void updateMagnifier() {
        ...
        Ld:
            ...
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m3063isSpecifiedk4lQ0M(r1)
            if (r3 == 0) goto L7d
            long r3 = r8.m317getAnchorPositionInRootF1C5BW0()
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m3063isSpecifiedk4lQ0M(r3)
            if (r3 == 0) goto L7d
            long r3 = r8.m317getAnchorPositionInRootF1C5BW0()
            long r1 = androidx.compose.ui.geometry.Offset.m3049plusMKHz9U(r3, r1)
            ...
            boolean r1 = androidx.compose.ui.geometry.OffsetKt.m3063isSpecifiedk4lQ0M(r1)
            if (r1 == 0) goto L50
            goto L51
        L50:
            r0 = 0
        L51:
            if (r0 == 0) goto L60
            long r0 = r0.getPackedValue()
            long r2 = r8.m317getAnchorPositionInRootF1C5BW0()
            long r0 = androidx.compose.ui.geometry.Offset.m3049plusMKHz9U(r2, r0)
            goto L66
        L60:
            androidx.compose.ui.geometry.Offset$Companion r0 = androidx.compose.ui.geometry.Offset.INSTANCE
            long r0 = r0.m3059getUnspecifiedF1C5BW0()
        L66:
            r5 = r0
        ...
        L6e:
            ...
            float r7 = r8.zoom
            r2.mo350updateWko1d7g(r3, r5, r7)
        L79:
    ...
    private final void updateSizeIfNecessary() {
        Density density;
        PlatformMagnifier platformMagnifier = this.magnifier;
        if (platformMagnifier == null || (density = this.density) == null || IntSize.m6015equalsimpl(platformMagnifier.mo349getSizeYbymL2g(), this.previousSize)) {
            return;
        }
        Function1<? super DpSize, Unit> function1 = this.onSizeChanged;
        if (function1 != null) {
            function1.invoke(DpSize.m5930boximpl(density.mo395toDpSizekrfVVM(IntSizeKt.m6030toSizeozmzZPI(platformMagnifier.mo349getSizeYbymL2g()))));
        }
        this.previousSize = IntSize.m6010boximpl(platformMagnifier.mo349getSizeYbymL2g());
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (channel != null) {
            ChannelResult.m7839boximpl(channel.mo7829trySendJP2dKIU(Unit.INSTANCE));
        }
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(Magnifier_androidKt.getMagnifierPositionInRoot(), new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierNode.applySemantics.1
            ...
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Offset invoke() {
                return Offset.m3033boximpl(m326invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0, reason: not valid java name */
            public final long m326invokeF1C5BW0() {
