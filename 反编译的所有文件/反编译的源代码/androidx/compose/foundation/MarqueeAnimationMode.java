...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m332constructorimpl(0);
    private static final int WhileFocused = m332constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m331boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m332constructorimpl(int i) {
        return i;
    }
    ...
    public static String m336toStringimpl(int i) {
        if (m334equalsimpl0(i, Immediately)) {
            return "Immediately";
        }
        if (m334equalsimpl0(i, WhileFocused)) {
            return "WhileFocused";
        }
