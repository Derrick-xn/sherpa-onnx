...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(Context context, OverscrollConfiguration overscrollConfiguration) {
        ...
        EdgeEffectWrapper edgeEffectWrapper = new EdgeEffectWrapper(context, ColorKt.m3378toArgb8_81llA(overscrollConfiguration.getGlowColor()));
        this.edgeEffectWrapper = edgeEffectWrapper;
        this.redrawSignal = SnapshotStateKt.mutableStateOf(Unit.INSTANCE, SnapshotStateKt.neverEqualPolicy());
        this.invalidationEnabled = true;
        this.containerSize = Size.INSTANCE.m3122getZeroNHjbRc();
    ...
    */
    public long mo242applyToScrollRhakbz0(long r11, int r13, kotlin.jvm.functions.Function1<? super androidx.compose.ui.geometry.Offset, androidx.compose.ui.geometry.Offset> r14) {
        /*
            Method dump skipped, instructions count: 304
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect.mo242applyToScrollRhakbz0(long, int, kotlin.jvm.functions.Function1):long");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public java.lang.Object mo241applyToFlingBMRW4eQ(long r11, kotlin.jvm.functions.Function2<? super androidx.compose.ui.unit.Velocity, ? super kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super kotlin.Unit> r14) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 443
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect.mo241applyToFlingBMRW4eQ(long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final boolean stopOverscrollAnimation() {
        ...
        if (this.edgeEffectWrapper.isLeftStretched()) {
            m237pullLeftk4lQ0M(Offset.INSTANCE.m3060getZeroF1C5BW0());
            z = true;
        } else {
            z = false;
        }
        if (this.edgeEffectWrapper.isRightStretched()) {
            m238pullRightk4lQ0M(Offset.INSTANCE.m3060getZeroF1C5BW0());
            z = true;
        }
        if (this.edgeEffectWrapper.isTopStretched()) {
            m239pullTopk4lQ0M(Offset.INSTANCE.m3060getZeroF1C5BW0());
            z = true;
        }
        if (!this.edgeEffectWrapper.isBottomStretched()) {
            return z;
        }
        m236pullBottomk4lQ0M(Offset.INSTANCE.m3060getZeroF1C5BW0());
        return true;
    }

    /* renamed from: updateSize-uvyYCjk$foundation_release, reason: not valid java name */
    public final void m244updateSizeuvyYCjk$foundation_release(long size) {
        boolean zM3109equalsimpl0 = Size.m3109equalsimpl0(this.containerSize, Size.INSTANCE.m3122getZeroNHjbRc());
        boolean z = !Size.m3109equalsimpl0(size, this.containerSize);
        this.containerSize = size;
        if (z) {
            this.edgeEffectWrapper.m315setSizeozmzZPI(IntSizeKt.IntSize(MathKt.roundToInt(Size.m3113getWidthimpl(size)), MathKt.roundToInt(Size.m3110getHeightimpl(size))));
        }
        if (zM3109equalsimpl0 || !z) {
            return;
        }
    ...
    public final long m243displacementF1C5BW0$foundation_release() {
        Offset offset = this.pointerPosition;
        long packedValue = offset != null ? offset.getPackedValue() : SizeKt.m3123getCenteruvyYCjk(this.containerSize);
        return OffsetKt.Offset(Offset.m3044getXimpl(packedValue) / Size.m3113getWidthimpl(this.containerSize), Offset.m3045getYimpl(packedValue) / Size.m3110getHeightimpl(this.containerSize));
    }
    ...
    private final void animateToRelease() {
        ...
        if (edgeEffect4 != null) {
            ...
            if (!edgeEffect4.isFinished() && !zIsFinished) {
                return;
            }
        } else if (!zIsFinished) {
            return;
    ...
    private final boolean m240releaseOppositeOverscrollk4lQ0M(long delta) {
        boolean z;
        boolean z2 = true;
        if (!this.edgeEffectWrapper.isLeftAnimating() || Offset.m3044getXimpl(delta) >= 0.0f) {
            z = false;
        } else {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateLeftEffect(), Offset.m3044getXimpl(delta));
            z = !this.edgeEffectWrapper.isLeftAnimating();
        }
        if (this.edgeEffectWrapper.isRightAnimating() && Offset.m3044getXimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateRightEffect(), Offset.m3044getXimpl(delta));
            z = z || !this.edgeEffectWrapper.isRightAnimating();
        }
        if (this.edgeEffectWrapper.isTopAnimating() && Offset.m3045getYimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateTopEffect(), Offset.m3045getYimpl(delta));
            z = z || !this.edgeEffectWrapper.isTopAnimating();
        }
        if (!this.edgeEffectWrapper.isBottomAnimating() || Offset.m3045getYimpl(delta) <= 0.0f) {
            return z;
        }
        EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateBottomEffect(), Offset.m3045getYimpl(delta));
    ...
    private final float m239pullTopk4lQ0M(long scroll) {
        float fM3044getXimpl = Offset.m3044getXimpl(m243displacementF1C5BW0$foundation_release());
        float fM3045getYimpl = Offset.m3045getYimpl(scroll) / Size.m3110getHeightimpl(this.containerSize);
        EdgeEffect orCreateTopEffect = this.edgeEffectWrapper.getOrCreateTopEffect();
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect) == 0.0f ? EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateTopEffect, fM3045getYimpl, fM3044getXimpl) * Size.m3110getHeightimpl(this.containerSize) : Offset.m3045getYimpl(scroll);
    }
    ...
    private final float m236pullBottomk4lQ0M(long scroll) {
        ...
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect) == 0.0f ? (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateBottomEffect, -fM3045getYimpl, 1 - fM3044getXimpl)) * Size.m3110getHeightimpl(this.containerSize) : Offset.m3045getYimpl(scroll);
    }

    /* renamed from: pullLeft-k-4lQ0M, reason: not valid java name */
    private final float m237pullLeftk4lQ0M(long scroll) {
        float fM3045getYimpl = Offset.m3045getYimpl(m243displacementF1C5BW0$foundation_release());
        float fM3044getXimpl = Offset.m3044getXimpl(scroll) / Size.m3113getWidthimpl(this.containerSize);
        EdgeEffect orCreateLeftEffect = this.edgeEffectWrapper.getOrCreateLeftEffect();
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect) == 0.0f ? EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateLeftEffect, fM3044getXimpl, 1 - fM3045getYimpl) * Size.m3113getWidthimpl(this.containerSize) : Offset.m3044getXimpl(scroll);
    }
    ...
    private final float m238pullRightk4lQ0M(long scroll) {
        ...
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect) == 0.0f ? (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateRightEffect, -fM3044getXimpl, fM3045getYimpl)) * Size.m3113getWidthimpl(this.containerSize) : Offset.m3044getXimpl(scroll);
    }
}