...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode {
    ...
    public final void m262setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private BackgroundNode(long j, Brush brush, float f, Shape shape) {
        ...
        this.alpha = f;
        this.shape = shape;
        this.lastSize = Size.INSTANCE.m3121getUnspecifiedNHjbRc();
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m3325equalsimpl0(this.color, Color.INSTANCE.m3360getUnspecified0d7_KjU())) {
            DrawScope.CC.m3891drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.CC.m3890drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        ...
        if (!Color.m3325equalsimpl0(this.color, Color.INSTANCE.m3360getUnspecified0d7_KjU())) {
            OutlineKt.m3590drawOutlinewDX37Ww(contentDrawScope, outline, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m3895getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m3589drawOutlinehn5TExg$default(contentDrawScope, outline, brush, this.alpha, null, null, 0, 56, null);
        }
    }
    ...
    private final Outline getOutline(final ContentDrawScope contentDrawScope) {
        ...
        if (Size.m3109equalsimpl0(contentDrawScope.mo3806getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            ?? r1 = this.lastOutline;
            ...
            ObserverModifierNodeKt.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.foundation.BackgroundNode.getOutline.1
                ...
                public final void invoke2() {
                    objectRef.element = this.getShape().mo308createOutlinePq9zytI(contentDrawScope.mo3806getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
                }
            });
        }
        this.lastOutline = (Outline) objectRef.element;
        this.lastSize = contentDrawScope.mo3806getSizeNHjbRc();
