...
public final class BasicTooltip_androidKt {
    ...
    */
                        ...
                        if (zChanged || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue2 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.BasicTooltip_androidKt$TooltipPopup$2$1$1
                                ...
                                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                    SemanticsPropertiesKt.m5126setLiveRegionhR3wRGc(semanticsPropertyReceiver, LiveRegionMode.INSTANCE.m5099getAssertive0phEisY());
    ...
    static final class C01801 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ BasicTooltipState $state;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01801(BasicTooltipState basicTooltipState, Continuation<? super C01801> continuation) {
            super(2, continuation);
            this.$state = basicTooltipState;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01801 c01801 = new C01801(this.$state, continuation);
            c01801.L$0 = obj;
            return c01801;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C01801) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class C00051 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r17) throws java.lang.Throwable {
                    /*
                        ...
                        To view this dump change 'Code comments level' option to 'DEBUG'
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.BasicTooltip_androidKt.C01801.C00051.C00061.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (ForEachGestureKt.awaitEachGesture(this.$$this$pointerInput, new C00061(coroutineScope, this.$state, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (CoroutineScopeKt.coroutineScope(new C00051((PointerInputScope) this.L$0, this.$state, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    private static final Modifier handleGestures(Modifier modifier, boolean z, BasicTooltipState basicTooltipState) {
        return z ? SuspendingPointerInputFilterKt.pointerInput(SuspendingPointerInputFilterKt.pointerInput(modifier, basicTooltipState, new C01801(basicTooltipState, null)), basicTooltipState, new C01812(basicTooltipState, null)) : modifier;
    }
    ...
    static final class C01812 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ BasicTooltipState $state;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01812(BasicTooltipState basicTooltipState, Continuation<? super C01812> continuation) {
            super(2, continuation);
            this.$state = basicTooltipState;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01812 c01812 = new C01812(this.$state, continuation);
            c01812.L$0 = obj;
            return c01812;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C01812) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r12) {
                    ...
                    L39:
                        ...
                        int r5 = r5.m4627getMouseT8wyACA()
                        boolean r4 = androidx.compose.ui.input.pointer.PointerType.m4622equalsimpl0(r4, r5)
                        if (r4 == 0) goto L29
                        int r12 = r12.getType()
                        ...
                        int r4 = r4.m4502getEnter7fucELk()
                        boolean r4 = androidx.compose.ui.input.pointer.PointerEventType.m4498equalsimpl0(r12, r4)
                        if (r4 == 0) goto L7a
                    ...
                    L7a:
                        androidx.compose.ui.input.pointer.PointerEventType$Companion r4 = androidx.compose.ui.input.pointer.PointerEventType.INSTANCE
                        int r4 = r4.m4503getExit7fucELk()
                        boolean r12 = androidx.compose.ui.input.pointer.PointerEventType.m4498equalsimpl0(r12, r4)
                        if (r12 == 0) goto L29
                        androidx.compose.foundation.BasicTooltipState r12 = r11.$state
                        r12.dismiss()
                        goto L29
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.BasicTooltip_androidKt.C01812.AnonymousClass1.C00081.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    CoroutineScope coroutineScope = (CoroutineScope) this.L$0;
                    this.label = 1;
                    if (this.$$this$pointerInput.awaitPointerEventScope(new C00081(coroutineScope, this.$state, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
            ...
            public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                ...
                SemanticsPropertiesKt.onLongClick(semanticsPropertyReceiver, str2, new Function0<Boolean>() { // from class: androidx.compose.foundation.BasicTooltip_androidKt.anchorSemantics.1.1
                    ...
                    public final Boolean invoke() {
                        BuildersKt__Builders_commonKt.launch$default(coroutineScope2, null, null, new C00041(basicTooltipState2, null), 3, null);
                        return true;
                    }
                });
            }
