...
public abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode, FocusEventModifierNode, SemanticsModifierNode, TraversableNode {
    ...
    private AbstractClickableNode(MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, String str, Role role, Function0<Unit> function0) {
        ...
        this.centerOffset = Offset.INSTANCE.m3060getZeroF1C5BW0();
    ...
    */
    protected final void m235updateCommonQzZPfjk(androidx.compose.foundation.interaction.MutableInteractionSource r3, androidx.compose.foundation.IndicationNodeFactory r4, boolean r5, java.lang.String r6, androidx.compose.ui.semantics.Role r7, kotlin.jvm.functions.Function0<kotlin.Unit> r8) {
        /*
            r2 = this;
        ...
        L99:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AbstractClickableNode.m235updateCommonQzZPfjk(androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.foundation.IndicationNodeFactory, boolean, java.lang.String, androidx.compose.ui.semantics.Role, kotlin.jvm.functions.Function0):void");
    }
    ...
    public final void mo233onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        long jM6024getCenterozmzZPI = IntSizeKt.m6024getCenterozmzZPI(bounds);
        this.centerOffset = OffsetKt.Offset(IntOffset.m5976getXimpl(jM6024getCenterozmzZPI), IntOffset.m5977getYimpl(jM6024getCenterozmzZPI));
        initializeIndicationAndInteractionSourceIfNeeded();
        if (this.enabled && pass == PointerEventPass.Main) {
            int type = pointerEvent.getType();
            if (PointerEventType.m4498equalsimpl0(type, PointerEventType.INSTANCE.m4502getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m4498equalsimpl0(type, PointerEventType.INSTANCE.m4503getExit7fucELk())) {
    ...
    public final boolean mo232onKeyEventZmokQxo(KeyEvent event) {
        ...
        if (this.enabled && Clickable_androidKt.m307isPressZmokQxo(event)) {
            if (!this.currentKeyPressInteractions.containsKey(Key.m4091boximpl(KeyEvent_androidKt.m4402getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.centerOffset, defaultConstructorMarker);
                this.currentKeyPressInteractions.put(Key.m4091boximpl(KeyEvent_androidKt.m4402getKeyZmokQxo(event)), press);
                if (this.interactionSource == null) {
                    return true;
                }
        ...
        } else if (this.enabled && Clickable_androidKt.m305isClickZmokQxo(event)) {
            PressInteraction.Press pressRemove = this.currentKeyPressInteractions.remove(Key.m4091boximpl(KeyEvent_androidKt.m4402getKeyZmokQxo(event)));
    ...
    public final void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (role != null) {
            ...
            SemanticsPropertiesKt.m5127setRolekuIjeqM(semanticsPropertyReceiver, role.getValue());
        }
    ...
    protected final Object m231handlePressInteractiond4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
