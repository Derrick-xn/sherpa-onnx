...
public final class TextFieldScrollKt {
    ...
    public static final Modifier textFieldScroll(Modifier modifier, TextFieldScrollerPosition textFieldScrollerPosition, TextFieldValue textFieldValue, VisualTransformation visualTransformation, Function0<TextLayoutResultProxy> function0) {
        ...
        int iM1119getOffsetToFollow5zctL8 = textFieldScrollerPosition.m1119getOffsetToFollow5zctL8(textFieldValue.getSelection());
        textFieldScrollerPosition.m1121setPreviousSelection5zctL8(textFieldValue.getSelection());
        ...
        if (i == 1) {
            verticalScrollLayoutModifier = new VerticalScrollLayoutModifier(textFieldScrollerPosition, iM1119getOffsetToFollow5zctL8, transformedTextFilterWithValidation, function0);
        } else {
            if (i != 2) {
                throw new NoWhenBranchMatchedException();
            }
            verticalScrollLayoutModifier = new HorizontalScrollLayoutModifier(textFieldScrollerPosition, iM1119getOffsetToFollow5zctL8, transformedTextFilterWithValidation, function0);
        }
    ...
    public static final Rect getCursorRectInScroller(Density density, int i, TransformedText transformedText, TextLayoutResult textLayoutResult, boolean z, int i2) {
        ...
        Rect rect = zero;
        int iMo391roundToPx0680j_4 = density.mo391roundToPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (z) {
            left = (i2 - rect.getLeft()) - iMo391roundToPx0680j_4;
        } else {
            left = rect.getLeft();
        }
        float f = left;
        if (z) {
            ...
            left2 = rect.getLeft() + iMo391roundToPx0680j_4;
        }
    ...
    public static final Modifier textFieldScrollable(Modifier modifier, final TextFieldScrollerPosition textFieldScrollerPosition, final MutableInteractionSource mutableInteractionSource, final boolean z) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.TextFieldScrollKt$textFieldScrollable$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                ComposerKt.sourceInformationMarkerEnd(composer);
                Modifier modifierScrollable = ScrollableKt.scrollable(Modifier.INSTANCE, textFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1, textFieldScrollerPosition.getOrientation(), (16 & 4) != 0 ? true : z && textFieldScrollerPosition.getMaximum() != 0.0f, (16 & 8) != 0 ? false : z2, (16 & 16) != 0 ? null : null, (16 & 32) != 0 ? null : mutableInteractionSource);
                if (ComposerKt.isTraceInProgress()) {
