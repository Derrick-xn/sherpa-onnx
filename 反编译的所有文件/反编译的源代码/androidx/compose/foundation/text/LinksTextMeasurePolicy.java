...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo61measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        return MeasureScope.CC.layout$default(measureScope, Constraints.m5787getMaxWidthimpl(j), Constraints.m5786getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (listMeasureWithTextRangeMeasureConstraints != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        Placeable.PlacementScope.m4749place70tqf50$default(placementScope, placeable, function0 != null ? ((IntOffset) function0.invoke()).getPackedValue() : IntOffset.INSTANCE.m5986getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
