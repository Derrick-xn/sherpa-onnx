...
public final class LegacyTextFieldState {
    ...
    private final MutableState minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m5842boximpl(Dp.m5844constructorimpl(0)), null, 2, null);
    ...
    private final Function1<TextFieldValue, Unit> onValueChange = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onValueChange$1
        ...
        public final void invoke2(TextFieldValue textFieldValue) {
            ...
            this.this$0.m1058setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5303getZerod9O1mEE());
            this.this$0.m1055setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5303getZerod9O1mEE());
    ...
    private final Function1<ImeAction, Unit> onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onImeActionPerformed$1
        ...
        public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
            m1060invokeKlQnJC8(imeAction.getValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-KlQnJC8, reason: not valid java name */
        public final void m1060invokeKlQnJC8(int i) {
            this.this$0.keyboardActionRunner.m1036runActionKlQnJC8(i);
        }
    };
    private final Paint highlightPaint = AndroidPaint_androidKt.Paint();
    private long selectionBackgroundColor = Color.INSTANCE.m3360getUnspecified0d7_KjU();

    /* renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m5286boximpl(TextRange.INSTANCE.m5303getZerod9O1mEE()), null, 2, null);

    /* renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m5286boximpl(TextRange.INSTANCE.m5303getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1052getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m5858unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1056setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField.setValue(Dp.m5842boximpl(f));
    }
    ...
    public final void m1057setSelectionBackgroundColor8_81llA(long j) {
        this.selectionBackgroundColor = j;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getSelectionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1054getSelectionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1058setSelectionPreviewHighlightRange5zctL8(long j) {
        this.selectionPreviewHighlightRange.setValue(TextRange.m5286boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDeletionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1051getDeletionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1055setDeletionPreviewHighlightRange5zctL8(long j) {
        this.deletionPreviewHighlightRange.setValue(TextRange.m5286boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m5292getCollapsedimpl(m1054getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m5292getCollapsedimpl(m1051getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* renamed from: update-fnh65Uc, reason: not valid java name */
    public final void m1059updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate textDelegateM1093updateTextDelegaterm0N8CA = TextDelegateKt.m1093updateTextDelegaterm0N8CA(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, (448 & 32) != 0 ? true : softWrap, (448 & 64) != 0 ? TextOverflow.INSTANCE.m5772getClipgIe3tQ8() : 0, (448 & 128) != 0 ? Integer.MAX_VALUE : 0, (448 & 256) != 0 ? 1 : 0, CollectionsKt.emptyList());
        if (this.textDelegate != textDelegateM1093updateTextDelegaterm0N8CA) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = textDelegateM1093updateTextDelegaterm0N8CA;
    }
}