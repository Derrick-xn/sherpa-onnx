...
public final class TextFieldCursorKt {
    private static final AnimationSpec<Float> cursorAnimationSpec = AnimationSpecKt.m162infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursorAnimationSpec$1
    ...
    private static final float DefaultCursorThickness = Dp.m5844constructorimpl(2);
    ...
    public static final Modifier cursor(Modifier modifier, final LegacyTextFieldState legacyTextFieldState, final TextFieldValue textFieldValue, final OffsetMapping offsetMapping, final Brush brush, boolean z) {
        return z ? ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                ComposerKt.sourceInformationMarkerEnd(composer);
                if (((WindowInfo) objConsume).isWindowFocused() && legacyTextFieldState.getHasFocus() && TextRange.m5292getCollapsedimpl(textFieldValue.getSelection()) && z2) {
                    ...
                    TextRange textRangeM5286boximpl = TextRange.m5286boximpl(textFieldValue.getSelection());
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer);
                    EffectsKt.LaunchedEffect(annotatedString, textRangeM5286boximpl, (Function2) objRememberedValue2, composer, 0);
                    ...
                    if (zChangedInstance2 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue3 = (Function1) new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1$2$1
                            ...
                            public final void invoke2(ContentDrawScope contentDrawScope) {
                                ...
                                int iOriginalToTransformed = offsetMapping2.originalToTransformed(TextRange.m5298getStartimpl(textFieldValue2.getSelection()));
                                ...
                                float f = contentDrawScope.mo397toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                                float f2 = f / 2;
                                float fCoerceAtLeast = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(rect.getLeft() + f2, Size.m3113getWidthimpl(contentDrawScope.mo3806getSizeNHjbRc()) - f2), f2);
                                DrawScope.CC.m3882drawLine1RTmtNc$default(contentDrawScope, brush3, OffsetKt.Offset(fCoerceAtLeast, rect.getTop()), OffsetKt.Offset(fCoerceAtLeast, rect.getBottom()), f, 0, null, cursorAlpha, null, 0, 432, null);
                            }
                        };
