...
public final class TextFieldState {
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(str, TextRangeKt.m5304coerceIn8ffj60Q(j, 0, str.length()), (DefaultConstructorMarker) null);
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m5301toStringimpl(m1147getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean zM5291equalsimpl0 = true ^ TextRange.m5291equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1179getSelectiond9O1mEE());
        if (z) {
            this.textUndoManager.clearHistory();
        }
        m1148syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, z, zM5291equalsimpl0);
    }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super EditingBuffer, Unit> block) {
        getMainBuffer().getChangeTracker().clearChanges();
        block.invoke(getMainBuffer());
        updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(getMainBuffer().toString(), getMainBuffer().m1179getSelectiond9O1mEE(), getMainBuffer().m1178getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m5291equalsimpl0(value$foundation_release.getSelection(), this.mainBuffer.m1179getSelectiond9O1mEE())) {
            if (Intrinsics.areEqual(value$foundation_release.getComposition(), this.mainBuffer.m1178getCompositionMzsxiRA()) && Intrinsics.areEqual(value$foundation_release.getHighlight(), this.mainBuffer.getHighlight())) {
                return;
            }
            updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1179getSelectiond9O1mEE(), this.mainBuffer.m1178getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null), restartImeIfContentChanges);
            return;
        }
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1179getSelectiond9O1mEE(), this.mainBuffer.m1178getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null);
        ...
        boolean z2 = !TextRange.m5291equalsimpl0(textFieldBuffer2.getSelectionInChars(), textFieldCharSequence.getSelection());
        if (z || z2) {
            textFieldBuffer = textFieldBuffer2;
            m1148syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(textFieldBuffer, null, z, z2);
        } else {
            textFieldBuffer = textFieldBuffer2;
            updateValueAndNotifyListeners(value$foundation_release, TextFieldBuffer.m1137toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer2, 0L, textFieldCharSequence.getComposition(), 1, null), restartImeIfContentChanges);
        }
    ...
    public final void m1148syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        String string = this.mainBuffer.toString();
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(string, this.mainBuffer.m1179getSelectiond9O1mEE(), this.mainBuffer.m1178getCompositionMzsxiRA(), null, 8, null);
        boolean z = !Intrinsics.areEqual(newComposition, this.mainBuffer.m1178getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m5298getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m5293getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition == null || TextRange.m5292getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.commitComposition();
        } else {
            this.mainBuffer.setComposition(TextRange.m5296getMinimpl(newComposition.getPackedValue()), TextRange.m5295getMaximpl(newComposition.getPackedValue()));
        }
        ...
        updateValueAndNotifyListeners(textFieldCharSequence, new TextFieldCharSequence(string, this.mainBuffer.m1179getSelectiond9O1mEE(), this.mainBuffer.m1178getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m5298getStartimpl(textFieldState.m1147getSelectiond9O1mEE())), Integer.valueOf(TextRange.m5293getEndimpl(textFieldState.m1147getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
