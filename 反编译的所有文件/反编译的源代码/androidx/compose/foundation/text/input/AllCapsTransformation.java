...
final /* data */ class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.INSTANCE.m5529getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 126, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer textFieldBuffer) {
        ...
        for (int i = 0; i < changes.getChangeCount(); i++) {
            long jMo1143getRangejx7JFs = changes.mo1143getRangejx7JFs(i);
            changes.mo1142getOriginalRangejx7JFs(i);
            if (!TextRange.m5292getCollapsedimpl(jMo1143getRangejx7JFs)) {
                textFieldBuffer.replace(TextRange.m5296getMinimpl(jMo1143getRangejx7JFs), TextRange.m5295getMaximpl(jMo1143getRangejx7JFs), StringKt.toUpperCase(TextRangeKt.m5305substringFDrldGo(textFieldBuffer.asCharSequence(), jMo1143getRangejx7JFs), this.locale));
            }
        }
    }
