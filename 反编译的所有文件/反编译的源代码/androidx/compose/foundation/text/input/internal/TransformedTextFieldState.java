...
public final class TransformedTextFieldState {
    ...
    private static final long m1261mapFromTransformedxdX6G0(long j, OffsetMappingCalculator offsetMappingCalculator) {
        return Companion.m1274mapFromTransformedxdX6G0(j, offsetMappingCalculator);
    }

    @JvmStatic
    /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
    private static final long m1262mapToTransformedXGyztTk(long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity) {
        return Companion.m1275mapToTransformedXGyztTk(j, offsetMappingCalculator, selectionWedgeAffinity);
    }
    ...
    public final void placeCursorBeforeCharAt(int transformedOffset) {
        m1270selectCharsIn5zctL8(TextRangeKt.TextRange(transformedOffset));
    }

    /* renamed from: selectCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1270selectCharsIn5zctL8(long transformedRange) {
        m1271selectUntransformedCharsIn5zctL8(m1266mapFromTransformedGEjPoXI(transformedRange));
    }

    /* renamed from: selectUntransformedCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1271selectUntransformedCharsIn5zctL8(long untransformedRange) {
        ...
        textFieldState.getMainBuffer().setSelection(TextRange.m5298getStartimpl(untransformedRange), TextRange.m5293getEndimpl(untransformedRange));
    ...
    public final void m1264highlightCharsIn7RAjNK8(int type, long transformedRange) {
        long jM1266mapFromTransformedGEjPoXI = m1266mapFromTransformedGEjPoXI(transformedRange);
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        TextFieldEditUndoBehavior textFieldEditUndoBehavior = TextFieldEditUndoBehavior.MergeIfPossible;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        textFieldState.getMainBuffer().m1180setHighlightK7f2yys(type, TextRange.m5298getStartimpl(jM1266mapFromTransformedGEjPoXI), TextRange.m5293getEndimpl(jM1266mapFromTransformedGEjPoXI));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void deleteSelectedText() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.delete(TextRange.m5296getMinimpl(mainBuffer.m1179getSelectiond9O1mEE()), TextRange.m5295getMaximpl(mainBuffer.m1179getSelectiond9O1mEE()));
        mainBuffer.setSelection(TextRange.m5296getMinimpl(mainBuffer.m1179getSelectiond9O1mEE()), TextRange.m5296getMinimpl(mainBuffer.m1179getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }

    /* renamed from: replaceText-M8tDOmk$default, reason: not valid java name */
    public static /* synthetic */ void m1263replaceTextM8tDOmk$default(TransformedTextFieldState transformedTextFieldState, CharSequence charSequence, long j, TextFieldEditUndoBehavior textFieldEditUndoBehavior, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            textFieldEditUndoBehavior = TextFieldEditUndoBehavior.MergeIfPossible;
        }
        transformedTextFieldState.m1269replaceTextM8tDOmk(charSequence, j, textFieldEditUndoBehavior, (i & 8) != 0 ? true : z);
    }

    /* renamed from: replaceText-M8tDOmk, reason: not valid java name */
    public final void m1269replaceTextM8tDOmk(CharSequence newText, long range, TextFieldEditUndoBehavior undoBehavior, boolean restartImeIfContentChanges) {
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        long jM1266mapFromTransformedGEjPoXI = m1266mapFromTransformedGEjPoXI(range);
        mainBuffer.replace(TextRange.m5296getMinimpl(jM1266mapFromTransformedGEjPoXI), TextRange.m5295getMaximpl(jM1266mapFromTransformedGEjPoXI), newText);
        int iM5296getMinimpl = TextRange.m5296getMinimpl(jM1266mapFromTransformedGEjPoXI) + newText.length();
        mainBuffer.setSelection(iM5296getMinimpl, iM5296getMinimpl);
    ...
    public final void replaceSelectedText(CharSequence newText, boolean clearComposition, TextFieldEditUndoBehavior undoBehavior) {
        ...
        long jM1179getSelectiond9O1mEE = mainBuffer.m1179getSelectiond9O1mEE();
        mainBuffer.replace(TextRange.m5296getMinimpl(jM1179getSelectiond9O1mEE), TextRange.m5295getMaximpl(jM1179getSelectiond9O1mEE), newText);
        int iM5296getMinimpl = TextRange.m5296getMinimpl(jM1179getSelectiond9O1mEE) + newText.length();
        mainBuffer.setSelection(iM5296getMinimpl, iM5296getMinimpl);
    ...
    public final void collapseSelectionToMax() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m5295getMaximpl(mainBuffer.m1179getSelectiond9O1mEE()), TextRange.m5295getMaximpl(mainBuffer.m1179getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void collapseSelectionToEnd() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m5293getEndimpl(mainBuffer.m1179getSelectiond9O1mEE()), TextRange.m5293getEndimpl(mainBuffer.m1179getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final long m1267mapToTransformedjx7JFs(int offset) {
        long jTextRange;
        TransformedText value;
        ...
        if (offsetMapping2 != null) {
            jTextRange = offsetMapping2.m1217mapFromSourcejx7JFs(offset);
        } else {
            jTextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping != null ? Companion.m1275mapToTransformedXGyztTk(jTextRange, offsetMapping, getSelectionWedgeAffinity()) : jTextRange;
    }

    /* renamed from: mapToTransformed-GEjPoXI, reason: not valid java name */
    public final long m1268mapToTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMapping = null;
        ...
        if (offsetMapping2 != null) {
            range = Companion.m1276mapToTransformedXGyztTk$default(Companion, range, offsetMapping2, null, 4, null);
        }
        return offsetMapping != null ? Companion.m1275mapToTransformedXGyztTk(range, offsetMapping, getSelectionWedgeAffinity()) : range;
    }

    /* renamed from: mapFromTransformed--jx7JFs, reason: not valid java name */
    public final long m1265mapFromTransformedjx7JFs(int offset) {
        long jTextRange;
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        ...
        if (offsetMapping != null) {
            jTextRange = offsetMapping.m1216mapFromDestjx7JFs(offset);
        } else {
            jTextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping2 != null ? Companion.m1274mapFromTransformedxdX6G0(jTextRange, offsetMapping2) : jTextRange;
    }

    /* renamed from: mapFromTransformed-GEjPoXI, reason: not valid java name */
    public final long m1266mapFromTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMapping = null;
        ...
        if (offsetMapping != null) {
            range = Companion.m1274mapFromTransformedxdX6G0(range, offsetMapping);
        }
        return offsetMapping2 != null ? Companion.m1274mapFromTransformedxdX6G0(range, offsetMapping2) : range;
    }
    ...
    */
    public final java.lang.Object collectImeNotifications(final androidx.compose.foundation.text.input.TextFieldState.NotifyImeListener r5, kotlin.coroutines.Continuation<?> r6) throws java.lang.Throwable {
        /*
            r4 = this;
    ...
    static final class Companion {
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, OutputTransformation outputTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            TextRange textRangeM5286boximpl = null;
            if (textFieldBuffer.getChanges().getChangeCount() == 0) {
                return null;
            }
            long jM1275mapToTransformedXGyztTk = m1275mapToTransformedXGyztTk(untransformedValue.getSelection(), offsetMappingCalculator, wedgeAffinity);
            TextRange textRangeM1144getCompositionMzsxiRA = untransformedValue.getComposition();
            if (textRangeM1144getCompositionMzsxiRA != null) {
                textRangeM5286boximpl = TextRange.m5286boximpl(TransformedTextFieldState.Companion.m1275mapToTransformedXGyztTk(textRangeM1144getCompositionMzsxiRA.getPackedValue(), offsetMappingCalculator, wedgeAffinity));
            }
            return new TransformedText(textFieldBuffer.m1141toTextFieldCharSequenceudt6zUU$foundation_release(jM1275mapToTransformedXGyztTk, textRangeM5286boximpl), offsetMappingCalculator);
        }
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, CodepointTransformation codepointTransformation, SelectionWedgeAffinity wedgeAffinity) {
            TextRange textRangeM5286boximpl;
            OffsetMappingCalculator offsetMappingCalculator = new OffsetMappingCalculator();
            ...
            return new TransformedText(new TextFieldCharSequence(visualText, jM1275mapToTransformedXGyztTk, textRangeM5286boximpl, null, 8, null), offsetMappingCalculator);
        }

        /* renamed from: mapToTransformed-XGyztTk$default, reason: not valid java name */
        static /* synthetic */ long m1276mapToTransformedXGyztTk$default(Companion companion, long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity, int i, Object obj) {
            if ((i & 4) != 0) {
        ...
        @JvmStatic
        /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
        public final long m1275mapToTransformedXGyztTk(long range, OffsetMappingCalculator mapping, SelectionWedgeAffinity wedgeAffinity) {
            long jTextRange;
            long jM1217mapFromSourcejx7JFs = mapping.m1217mapFromSourcejx7JFs(TextRange.m5298getStartimpl(range));
            long jM1217mapFromSourcejx7JFs2 = TextRange.m5292getCollapsedimpl(range) ? jM1217mapFromSourcejx7JFs : mapping.m1217mapFromSourcejx7JFs(TextRange.m5293getEndimpl(range));
            int iMin = Math.min(TextRange.m5296getMinimpl(jM1217mapFromSourcejx7JFs), TextRange.m5296getMinimpl(jM1217mapFromSourcejx7JFs2));
            int iMax = Math.max(TextRange.m5295getMaximpl(jM1217mapFromSourcejx7JFs), TextRange.m5295getMaximpl(jM1217mapFromSourcejx7JFs2));
            if (TextRange.m5297getReversedimpl(range)) {
                jTextRange = TextRangeKt.TextRange(iMax, iMin);
            } else {
                jTextRange = TextRangeKt.TextRange(iMin, iMax);
            }
            if (!TextRange.m5292getCollapsedimpl(range) || TextRange.m5292getCollapsedimpl(jTextRange)) {
                return jTextRange;
            }
            ...
            if (i == 1) {
                return TextRangeKt.TextRange(TextRange.m5298getStartimpl(jTextRange));
            }
            if (i == 2) {
                return TextRangeKt.TextRange(TextRange.m5293getEndimpl(jTextRange));
            }
        ...
        @JvmStatic
        /* renamed from: mapFromTransformed-xdX6-G0, reason: not valid java name */
        public final long m1274mapFromTransformedxdX6G0(long range, OffsetMappingCalculator mapping) {
            long jM1216mapFromDestjx7JFs = mapping.m1216mapFromDestjx7JFs(TextRange.m5298getStartimpl(range));
            long jM1216mapFromDestjx7JFs2 = TextRange.m5292getCollapsedimpl(range) ? jM1216mapFromDestjx7JFs : mapping.m1216mapFromDestjx7JFs(TextRange.m5293getEndimpl(range));
            int iMin = Math.min(TextRange.m5296getMinimpl(jM1216mapFromDestjx7JFs), TextRange.m5296getMinimpl(jM1216mapFromDestjx7JFs2));
            int iMax = Math.max(TextRange.m5295getMaximpl(jM1216mapFromDestjx7JFs), TextRange.m5295getMaximpl(jM1216mapFromDestjx7JFs2));
            if (TextRange.m5297getReversedimpl(range)) {
