...
public final class AndroidTextInputSession_androidKt {
    ...
    */
    public static final java.lang.Object platformSpecificTextInputSession(androidx.compose.ui.platform.PlatformTextInputSession r12, androidx.compose.foundation.text.input.internal.TransformedTextFieldState r13, androidx.compose.foundation.text.input.internal.TextLayoutState r14, androidx.compose.ui.text.input.ImeOptions r15, androidx.compose.foundation.content.internal.ReceiveContentConfiguration r16, kotlin.jvm.functions.Function1<? super androidx.compose.ui.text.input.ImeAction, kotlin.Unit> r17, kotlinx.coroutines.flow.MutableSharedFlow<kotlin.Unit> r18, androidx.compose.ui.platform.ViewConfiguration r19, kotlin.coroutines.Continuation<?> r20) throws java.lang.Throwable {
        /*
            r0 = r20
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public static final void invokeSuspend$lambda$0(ComposeInputMethodManager composeInputMethodManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, boolean z) {
                ...
                if (z && textFieldCharSequence.getComposition() != null && !textFieldCharSequence.contentEquals(textFieldCharSequence2)) {
                    ...
                    if (TextRange.m5291equalsimpl0(selection, selection2) && Intrinsics.areEqual(composition, composition2)) {
                        return;
                    }
                    composeInputMethodManager.updateSelection(TextRange.m5296getMinimpl(selection2), TextRange.m5295getMaximpl(selection2), composition2 != null ? TextRange.m5296getMinimpl(composition2.getPackedValue()) : -1, composition2 != null ? TextRange.m5295getMaximpl(composition2.getPackedValue()) : -1);
                }
            }
        }
        ...
        public static final InputConnection invokeSuspend$lambda$2(final TransformedTextFieldState transformedTextFieldState, ImeOptions imeOptions, final ReceiveContentConfiguration receiveContentConfiguration, final ComposeInputMethodManager composeInputMethodManager, final Function1 function1, final CursorAnchorInfoController cursorAnchorInfoController, final TextLayoutState textLayoutState, final ViewConfiguration viewConfiguration, EditorInfo editorInfo) {
            ...
            TextInputSession textInputSession = new TextInputSession() { // from class: androidx.compose.foundation.text.input.internal.AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$3$textInputSession$1
                ...
                public void mo1173onImeActionKlQnJC8(int imeAction) {
                    ...
                    if (function12 != null) {
                        function12.invoke(ImeAction.m5481boximpl(imeAction));
                    }
                }
            ...
            EditorInfo_androidKt.m1182updatepLxbY9I(editorInfo, transformedTextFieldState.getVisualText(), transformedTextFieldState.getVisualText().getSelection(), imeOptions, receiveContentConfiguration != null ? AndroidTextInputSession_androidKt.ALL_MIME_TYPES : null);
