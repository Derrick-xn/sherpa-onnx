...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode {
    ...
    private final DragAndDropModifierNode dragAndDropNode = (DragAndDropModifierNode) delegate(TextFieldDragAndDropNode_androidKt.textFieldDragAndDropNode(new Function0<Set<? extends MediaType>>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$dragAndDropNode$1
        ...
        public final Boolean invoke(ClipEntry clipEntry, ClipMetadata clipMetadata) {
            ...
            if (receiveContentConfiguration != null) {
                TransferableContent transferableContentOnReceive = receiveContentConfiguration.getReceiveContentListener().onReceive(new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m361getDragAndDropkB6V9T0(), null, 8, null));
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
            m1239invokek4lQ0M(offset.getPackedValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m1239invokek4lQ0M(long j) {
            long jM1260fromWindowToDecorationUv8p0NA = TextLayoutStateKt.m1260fromWindowToDecorationUv8p0NA(this.this$0.getTextLayoutState(), j);
            this.this$0.getTextFieldState().m1270selectCharsIn5zctL8(TextRangeKt.TextRange(TextLayoutState.m1250getOffsetForPosition3MmeM6k$default(this.this$0.getTextLayoutState(), jM1260fromWindowToDecorationUv8p0NA, false, 2, null)));
            this.this$0.getTextFieldSelectionState().m1307updateHandleDraggingUv8p0NA(Handle.Cursor, jM1260fromWindowToDecorationUv8p0NA);
        }
    ...
    public /* synthetic */ void mo387onRemeasuredozmzZPI(long j) {
        LayoutAwareModifierNode.CC.m4831$default$onRemeasuredozmzZPI(this, j);
    }
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation inputTransformation, boolean z, boolean z2, final KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean z3, MutableInteractionSource mutableInteractionSource) {
        ...
        this.stylusHandwritingNode = (StylusHandwritingNode) delegate(new StylusHandwritingNode(new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$stylusHandwritingNode$1
            ...
            public final Boolean invoke() {
                ...
                if (!KeyboardType.m5537equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m5556getPasswordPjHm6EE()) && !KeyboardType.m5537equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m5555getNumberPasswordPjHm6EE()) && (stylusHandwritingTrigger = this.this$0.getStylusHandwritingTrigger()) != null) {
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m5128setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, selection);
        if (!this.enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.4
            ...
            public final Boolean invoke(int i, int i2, boolean z) {
                ...
                if (i == TextRange.m5298getStartimpl(selection2) && i2 == TextRange.m5293getEndimpl(selection2)) {
                    return true;
                }
                ...
                if (z) {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1271selectUntransformedCharsIn5zctL8(jTextRange);
                } else {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1270selectCharsIn5zctL8(jTextRange);
                }
                return true;
            }
        }, 1, null);
        final int iM1049getImeActionOrDefaulteUduSuo$foundation_release = this.keyboardOptions.m1049getImeActionOrDefaulteUduSuo$foundation_release();
        SemanticsPropertiesKt.m5123onImeAction9UiTYpY$default(semanticsPropertyReceiver, iM1049getImeActionOrDefaulteUduSuo$foundation_release, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            @Override // kotlin.jvm.functions.Function0
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.m1238onImeActionPerformedKlQnJC8(iM1049getImeActionOrDefaulteUduSuo$foundation_release);
                return true;
            }
        }, 2, null);
        ...
        if (!TextRange.m5292getCollapsedimpl(selection)) {
    ...
    public final void onFocusChange() {
        ...
        if (isFocused() && this.observeChangesJob == null) {
            this.observeChangesJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03061(null), 3, null);
        } else {
            if (isFocused()) {
                return;
            }
    ...
    static final class C03061 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C03061(continuation);
        }
    ...
    public void mo233onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.stylusHandwritingNode.mo233onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    ...
    public boolean mo234onPreKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1171onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* renamed from: onKeyEvent-ZmokQxo */
    public boolean mo232onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1170onKeyEvent6ptp14s(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.enabled && !this.readOnly, this.singleLine, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onKeyEvent$1
            {
                super(0);
            }
            ...
            public final void invoke2() {
                TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = this.this$0;
                textFieldDecoratorModifierNode.m1238onImeActionPerformedKlQnJC8(textFieldDecoratorModifierNode.getKeyboardOptions().m1049getImeActionOrDefaulteUduSuo$foundation_release());
            }
        });
    }
    ...
    public final void startInputSession(boolean fromTap) {
        if (fromTap || this.keyboardOptions.getShowKeyboardOnFocusOrDefault$foundation_release()) {
            this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03081(ReceiveContentConfigurationKt.getReceiveContentConfiguration(this), null), 3, null);
        }
    }
    ...
    static final class C03081 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03081(ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C03081> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C03081(this.$receiveContentConfiguration, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (PlatformTextInputModifierNodeKt.establishTextInputSession(TextFieldDecoratorModifierNode.this, new C00521(TextFieldDecoratorModifierNode.this, this.$receiveContentConfiguration, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
        ...
        static final class C00521 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
            final /* synthetic */ ReceiveContentConfiguration $receiveContentConfiguration;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00521(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C00521> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00521 c00521 = new C00521(this.this$0, this.$receiveContentConfiguration, continuation);
                c00521.L$0 = obj;
                return c00521;
            }
            ...
            public final Object invoke(PlatformTextInputSessionScope platformTextInputSessionScope, Continuation<?> continuation) {
                return ((C00521) create(platformTextInputSessionScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            /* synthetic */ class C00531 extends FunctionReferenceImpl implements Function1<ImeAction, Unit> {
                C00531(Object obj) {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                    m1240invokeKlQnJC8(imeAction.getValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-KlQnJC8, reason: not valid java name */
                public final void m1240invokeKlQnJC8(int i) {
                    ((TextFieldDecoratorModifierNode) this.receiver).m1238onImeActionPerformedKlQnJC8(i);
                }
            }
        }
    }
    ...
    public final void m1238onImeActionPerformedKlQnJC8(final int imeAction) {
        KeyboardActionHandler keyboardActionHandler;
        if (ImeAction.m5484equalsimpl0(imeAction, ImeAction.INSTANCE.m5501getNoneeUduSuo()) || ImeAction.m5484equalsimpl0(imeAction, ImeAction.INSTANCE.m5497getDefaulteUduSuo()) || (keyboardActionHandler = this.keyboardActionHandler) == null) {
            this.keyboardActionScope.mo1035defaultKeyboardActionKlQnJC8(imeAction);
            ...
            keyboardActionHandler.onKeyboardAction(new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.keyboardActionScope.mo1035defaultKeyboardActionKlQnJC8(imeAction);
                }
            });
        }
    }
