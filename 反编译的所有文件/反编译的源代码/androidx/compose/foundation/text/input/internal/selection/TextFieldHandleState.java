...
public final /* data */ class TextFieldHandleState {
    ...
    private static final TextFieldHandleState Hidden = new TextFieldHandleState(false, Offset.INSTANCE.m3059getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    ...
    public static /* synthetic */ TextFieldHandleState m1278copyubNVwUQ$default(TextFieldHandleState textFieldHandleState, boolean z, long j, ResolvedTextDirection resolvedTextDirection, boolean z2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldHandleState.m1280copyubNVwUQ(z, j2, resolvedTextDirection2, z2);
    }
    ...
    public final TextFieldHandleState m1280copyubNVwUQ(boolean visible, long position, ResolvedTextDirection direction, boolean handlesCrossed) {
    ...
    public boolean equals(Object other) {
        ...
        return this.visible == textFieldHandleState.visible && Offset.m3041equalsimpl0(this.position, textFieldHandleState.position) && this.direction == textFieldHandleState.direction && this.handlesCrossed == textFieldHandleState.handlesCrossed;
    }

    public int hashCode() {
        return (((((UByte$$ExternalSyntheticBackport0.m(this.visible) * 31) + Offset.m3046hashCodeimpl(this.position)) * 31) + this.direction.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m(this.handlesCrossed);
    }

    public String toString() {
        return "TextFieldHandleState(visible=" + this.visible + ", position=" + ((Object) Offset.m3052toStringimpl(this.position)) + ", direction=" + this.direction + ", handlesCrossed=" + this.handlesCrossed + ')';
    }
    ...
    public final long m1281getPositionF1C5BW0() {
        return this.position;
    }
