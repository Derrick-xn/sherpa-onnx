...
public final class RecordingInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5292getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m5296getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.eventCallback.mo1210onImeActionKlQnJC8(iM5497getDefaulteUduSuo);
        return true;
    }
