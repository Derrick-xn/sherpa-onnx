...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m3563constructorimpl$default(null, 1, null);
    ...
    public final void requestUpdates(int cursorUpdateMode) {
        ...
        requestUpdates(z6, z7, z, z2, z3, z4);
    }
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    textLayoutNodeCoordinates.mo4690transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m3156setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1176buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m3081translatek4lQ0M(textLayoutNodeCoordinates.mo4683localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m3060getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m3081translatek4lQ0M(textLayoutNodeCoordinates.mo4683localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m3060getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
