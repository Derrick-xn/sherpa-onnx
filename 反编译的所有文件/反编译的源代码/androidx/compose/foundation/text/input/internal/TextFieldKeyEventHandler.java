...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1171onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m5292getCollapsedimpl(textFieldState.getVisualText().getSelection()) || !KeyEventHelpers_androidKt.m1033cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean mo1170onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        TextRange textRangeM5286boximpl;
        Integer numM1032consumeZmokQxo;
        boolean z = false;
        if (!KeyEventType.m4395equalsimpl0(KeyEvent_androidKt.m4403getTypeZmokQxo(event), KeyEventType.INSTANCE.m4399getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m1116isTypedEventZmokQxo(event) && (numM1032consumeZmokQxo = this.deadKeyCombiner.m1032consumeZmokQxo(event)) != null) {
            String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), numM1032consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            boolean z2 = !TextFieldKeyEventHandler_androidKt.m1242isFromSoftKeyboardZmokQxo(event);
        ...
        KeyCommand keyCommandMo1034mapZmokQxo = this.keyMapping.mo1034mapZmokQxo(event);
        if (keyCommandMo1034mapZmokQxo != null && (!keyCommandMo1034mapZmokQxo.getEditsText() || editable)) {
            TextFieldPreparedSelection textFieldPreparedSelection = new TextFieldPreparedSelection(textFieldState, textLayoutState.getLayoutResult(), TextFieldKeyEventHandler_androidKt.m1242isFromSoftKeyboardZmokQxo(event), getVisibleTextLayoutHeight(textLayoutState), this.preparedSelectionState);
            switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo1034mapZmokQxo.ordinal()]) {
                case 1:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    if (TextRange.m5292getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        Integer numValueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                        if (numValueOf.intValue() == -1) {
                            numValueOf = null;
                        }
                        textRangeM5286boximpl = numValueOf != null ? TextRange.m5286boximpl(TextRangeKt.TextRange(numValueOf.intValue(), TextRange.m5293getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                        if (textRangeM5286boximpl != null) {
                            TransformedTextFieldState.m1263replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM5286boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                        TransformedTextFieldState.m1263replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 21:
                    if (TextRange.m5292getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        textRangeM5286boximpl = numValueOf2 != null ? TextRange.m5286boximpl(TextRangeKt.TextRange(TextRange.m5298getStartimpl(textFieldPreparedSelection.getSelection()), numValueOf2.intValue())) : null;
                        if (textRangeM5286boximpl != null) {
                            TransformedTextFieldState.m1263replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM5286boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 22:
                    if (!TextRange.m5292getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1263replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m5293getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 23:
                    if (!TextRange.m5292getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1263replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5298getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 24:
                    if (!TextRange.m5292getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1263replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m5293getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 25:
                    if (!TextRange.m5292getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1263replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5298getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 26:
            ...
            if (!TextRange.m5291equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelection())) {
                textFieldState.m1270selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
            }
        }
        return z;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, boolean isFromSoftKeyboard, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        state.m1270selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
    }
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null) {
                ...
                if (decoratorNodeCoordinates != null) {
                    ...
                    if (decoratorNodeCoordinates != null) {
                        rectLocalBoundingBoxOf$default = LayoutCoordinates.CC.localBoundingBoxOf$default(decoratorNodeCoordinates, textLayoutNodeCoordinates, false, 2, null);
                    }
                }
                if (rectLocalBoundingBoxOf$default != null) {
                    return Size.m3110getHeightimpl(rectLocalBoundingBoxOf$default.m3077getSizeNHjbRc());
                }
            }
        }
        return Float.NaN;
