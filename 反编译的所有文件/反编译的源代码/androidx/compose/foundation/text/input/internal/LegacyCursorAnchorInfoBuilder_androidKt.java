...
public final class LegacyCursorAnchorInfoBuilder_androidKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        int iM5296getMinimpl = TextRange.m5296getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM5296getMinimpl, TextRange.m5295getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, iM5296getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int iM5295getMaximpl = composition2 != null ? TextRange.m5295getMaximpl(composition2.getPackedValue()) : -1;
            if (iM5296getMinimpl2 >= 0 && iM5296getMinimpl2 < iM5295getMaximpl) {
                builder.setComposingText(iM5296getMinimpl2, textFieldValue.getText().subSequence(iM5296getMinimpl2, iM5295getMaximpl));
                addCharacterBounds(builder, iM5296getMinimpl2, iM5295getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, androidx.compose.ui.text.input.OffsetMapping r20, androidx.compose.ui.text.TextLayoutResult r21, androidx.compose.ui.geometry.Rect r22) {
        /*
            ...
            r5 = 0
            r7.m5163fillBoundingBoxes8ffj60Q(r8, r6, r5)
        L22:
            if (r2 >= r0) goto L8b
