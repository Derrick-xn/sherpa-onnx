...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        mainBuffer.setSelection(TextRange.m5298getStartimpl(textUndoOperation.getPreSelection()), TextRange.m5293getEndimpl(textUndoOperation.getPreSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), new TextFieldCharSequence(textFieldState.getMainBuffer().toString(), textFieldState.getMainBuffer().m1179getSelectiond9O1mEE(), textFieldState.getMainBuffer().m1178getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public static final void redo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        mainBuffer.setSelection(TextRange.m5298getStartimpl(textUndoOperation.getPostSelection()), TextRange.m5293getEndimpl(textUndoOperation.getPostSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), new TextFieldCharSequence(textFieldState.getMainBuffer().toString(), textFieldState.getMainBuffer().m1179getSelectiond9O1mEE(), textFieldState.getMainBuffer().m1178getCompositionMzsxiRA(), null, 8, null), true);
    }
}