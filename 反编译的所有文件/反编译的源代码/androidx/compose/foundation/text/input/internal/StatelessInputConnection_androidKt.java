...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m5296getMinimpl(textFieldCharSequence.getSelection());
        extractedText.selectionEnd = TextRange.m5295getMaximpl(textFieldCharSequence.getSelection());
    ...
    public static final TransferableContent toTransferableContent(InputContentInfoCompat inputContentInfoCompat, Bundle bundle) {
        ...
        int iM362getKeyboardkB6V9T0 = TransferableContent.Source.INSTANCE.m362getKeyboardkB6V9T0();
        ...
        return new TransferableContent(clipEntry, clipMetadata, iM362getKeyboardkB6V9T0, new PlatformTransferableContent(linkUri, bundle), null);
    }
}