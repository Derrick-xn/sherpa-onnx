...
public final class OffsetMappingCalculator {
    ...
    private int[] ops = OpArray.m1219constructorimpl(10);
    private int opsSize;
    ...
    public final void recordEditOperation(int sourceStart, int sourceEnd, int newLength) {
        ...
        if (iMax >= 2 || iMax != newLength) {
            ...
            if (i > OpArray.m1226getSizeimpl(this.ops)) {
                this.ops = OpArray.m1221copyOfpSmdads(this.ops, Math.max(i * 2, OpArray.m1226getSizeimpl(this.ops) * 2));
            }
            OpArray.m1228setimpl(this.ops, this.opsSize, iMin, iMax, newLength);
            this.opsSize = i;
        }
    }

    /* renamed from: mapFromSource--jx7JFs, reason: not valid java name */
    public final long m1217mapFromSourcejx7JFs(int offset) {
        return m1214mapfzxv0v0(offset, true);
    }

    /* renamed from: mapFromDest--jx7JFs, reason: not valid java name */
    public final long m1216mapFromDestjx7JFs(int offset) {
        return m1214mapfzxv0v0(offset, false);
    }

    /* renamed from: map-fzxv0v0, reason: not valid java name */
    private final long m1214mapfzxv0v0(int offset, boolean fromSource) {
        int i;
        int[] iArr = this.ops;
        int i2 = this.opsSize;
        ...
        if (i2 < 0) {
            ...
            while (-1 < i3) {
                ...
                int i6 = iArr[i4 + 1];
                int i7 = iArr[i4 + 2];
                long jM1215mapStepC6uMEY = m1215mapStepC6uMEY(iMin, i5, i6, i7, fromSource);
                long jM1215mapStepC6uMEY2 = m1215mapStepC6uMEY(offset, i5, i6, i7, fromSource);
                i3--;
                iMin = Math.min(TextRange.m5298getStartimpl(jM1215mapStepC6uMEY), TextRange.m5298getStartimpl(jM1215mapStepC6uMEY2));
                offset = Math.max(TextRange.m5293getEndimpl(jM1215mapStepC6uMEY), TextRange.m5293getEndimpl(jM1215mapStepC6uMEY2));
            }
            i = offset;
            offset = iMin;
        } else {
            ...
            while (i8 < i2) {
                ...
                int i11 = iArr[i9 + 1];
                int i12 = iArr[i9 + 2];
                long jM1215mapStepC6uMEY3 = m1215mapStepC6uMEY(iMin2, i10, i11, i12, fromSource);
                long jM1215mapStepC6uMEY4 = m1215mapStepC6uMEY(offset, i10, i11, i12, fromSource);
                i8++;
                iMin2 = Math.min(TextRange.m5298getStartimpl(jM1215mapStepC6uMEY3), TextRange.m5298getStartimpl(jM1215mapStepC6uMEY4));
                offset = Math.max(TextRange.m5293getEndimpl(jM1215mapStepC6uMEY3), TextRange.m5293getEndimpl(jM1215mapStepC6uMEY4));
            }
            i = offset;
            offset = iMin2;
        }
    ...
    private final long m1215mapStepC6uMEY(int offset, int opOffset, int untransformedLen, int transformedLen, boolean fromSource) {
