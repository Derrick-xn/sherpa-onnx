...
public final class TextFieldCoreModifierNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo114measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        if (this.orientation == Orientation.Vertical) {
            return m1235measureVerticalScroll3p2s80s(measureScope, measurable, j);
        }
        return m1234measureHorizontalScroll3p2s80s(measureScope, measurable, j);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (TextRange.m5292getCollapsedimpl(visualText.getSelection())) {
            ...
            if (visualText.shouldShowSelection()) {
                m1233drawSelectionSbBc2M(contentDrawScope, visualText.getSelection(), layoutResult);
            }
    ...
    private final MeasureResult m1235measureVerticalScroll3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(Constraints.m5778copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int iMin = Math.min(placeableMo4680measureBRTryo0.getHeight(), Constraints.m5786getMaxHeightimpl(j));
        return MeasureScope.CC.layout$default(measureScope, placeableMo4680measureBRTryo0.getWidth(), iMin, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$measureVerticalScroll$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                this.this$0.m1236updateScrollStatetIlFzwE(measureScope, iMin, placeableMo4680measureBRTryo0.getHeight(), this.this$0.textFieldState.getVisualText().getSelection(), measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4680measureBRTryo0, 0, -this.this$0.scrollState.getValue(), 0.0f, 4, null);
            }
        }, 4, null);
    }

    /* renamed from: measureHorizontalScroll-3p2s80s, reason: not valid java name */
    private final MeasureResult m1234measureHorizontalScroll3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(Constraints.m5778copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int iMin = Math.min(placeableMo4680measureBRTryo0.getWidth(), Constraints.m5787getMaxWidthimpl(j));
        return MeasureScope.CC.layout$default(measureScope, iMin, placeableMo4680measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$measureHorizontalScroll$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                this.this$0.m1236updateScrollStatetIlFzwE(measureScope, iMin, placeableMo4680measureBRTryo0.getWidth(), this.this$0.textFieldState.getVisualText().getSelection(), measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4680measureBRTryo0, -this.this$0.scrollState.getValue(), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }

    /* renamed from: calculateOffsetToFollow-72CqOWE, reason: not valid java name */
    private final int m1232calculateOffsetToFollow72CqOWE(long currSelection, int currTextLayoutSize) {
        TextRange textRange = this.previousSelection;
        if (textRange == null || TextRange.m5293getEndimpl(currSelection) != TextRange.m5293getEndimpl(textRange.getPackedValue())) {
            return TextRange.m5293getEndimpl(currSelection);
        }
        TextRange textRange2 = this.previousSelection;
        if (textRange2 == null || TextRange.m5298getStartimpl(currSelection) != TextRange.m5298getStartimpl(textRange2.getPackedValue())) {
            return TextRange.m5298getStartimpl(currSelection);
        }
    ...
    */
    public final void m1236updateScrollStatetIlFzwE(androidx.compose.ui.unit.Density r9, int r10, int r11, long r12, androidx.compose.ui.unit.LayoutDirection r14) {
        /*
            r8 = this;
            int r0 = r11 - r10
            androidx.compose.foundation.ScrollState r1 = r8.scrollState
            r1.setMaxValue$foundation_release(r0)
            int r0 = r8.m1232calculateOffsetToFollow72CqOWE(r12, r11)
            if (r0 < 0) goto Lca
        ...
        Laa:
            r1 = 0
        Lab:
            androidx.compose.ui.text.TextRange r10 = androidx.compose.ui.text.TextRange.m5286boximpl(r12)
        ...
        Lca:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode.m1236updateScrollStatetIlFzwE(androidx.compose.ui.unit.Density, int, int, long, androidx.compose.ui.unit.LayoutDirection):void");
    }

    /* renamed from: drawSelection-Sb-Bc2M, reason: not valid java name */
    private final void m1233drawSelectionSbBc2M(DrawScope drawScope, long j, TextLayoutResult textLayoutResult) {
        int iM5296getMinimpl = TextRange.m5296getMinimpl(j);
        int iM5295getMaximpl = TextRange.m5295getMaximpl(j);
        if (iM5296getMinimpl != iM5295getMaximpl) {
            DrawScope.CC.m3887drawPathLG529CI$default(drawScope, textLayoutResult.getPathForRange(iM5296getMinimpl, iM5295getMaximpl), ((TextSelectionColors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, TextSelectionColorsKt.getLocalTextSelectionColors())).getBackgroundColor(), 0.0f, null, null, 0, 60, null);
        }
    }
    ...
    private final void drawHighlight(DrawScope drawScope, Pair<TextHighlightType, TextRange> pair, TextLayoutResult textLayoutResult) {
        ...
        if (TextRange.m5292getCollapsedimpl(packedValue)) {
            return;
        }
        Path pathForRange = textLayoutResult.getPathForRange(TextRange.m5296getMinimpl(packedValue), TextRange.m5295getMaximpl(packedValue));
        if (TextHighlightType.m1153equalsimpl0(value, TextHighlightType.INSTANCE.m1157getHandwritingDeletePreviewsxJuwY())) {
            Brush brush = textLayoutResult.getLayoutInput().getStyle().getBrush();
            if (brush != null) {
                DrawScope.CC.m3886drawPathGBMwjPU$default(drawScope, pathForRange, brush, 0.2f, null, null, 0, 56, null);
                return;
            }
            long jM5328getColor0d7_KjU = textLayoutResult.getLayoutInput().getStyle().m5328getColor0d7_KjU();
            if (jM5328getColor0d7_KjU == 16) {
                jM5328getColor0d7_KjU = Color.INSTANCE.m3350getBlack0d7_KjU();
            }
            long j = jM5328getColor0d7_KjU;
            DrawScope.CC.m3887drawPathLG529CI$default(drawScope, pathForRange, Color.m3323copywmQWz5c$default(j, Color.m3326getAlphaimpl(j) * 0.2f, 0.0f, 0.0f, 0.0f, 14, null), 0.0f, null, null, 0, 60, null);
            return;
        }
        DrawScope.CC.m3887drawPathLG529CI$default(drawScope, pathForRange, ((TextSelectionColors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, TextSelectionColorsKt.getLocalTextSelectionColors())).getBackgroundColor(), 0.0f, null, null, 0, 60, null);
    }
    ...
    private final void drawCursor(DrawScope drawScope) {
        ...
        if (cursorAlpha != 0.0f && getShowCursor()) {
            ...
            DrawScope.CC.m3882drawLine1RTmtNc$default(drawScope, this.cursorBrush, cursorRect.m3078getTopCenterF1C5BW0(), cursorRect.m3071getBottomCenterF1C5BW0(), cursorRect.getWidth(), 0, null, cursorAlpha, null, 0, 432, null);
        }
    }
