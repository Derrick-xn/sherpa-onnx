...
public final class StatelessInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        String string = TextRange.m5292getCollapsedimpl(getText().getSelection()) ? null : TextFieldCharSequenceKt.getSelectedText(getText()).toString();
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m5296getMinimpl(getText().getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.session.mo1173onImeActionKlQnJC8(iM5497getDefaulteUduSuo);
        return true;
    }
