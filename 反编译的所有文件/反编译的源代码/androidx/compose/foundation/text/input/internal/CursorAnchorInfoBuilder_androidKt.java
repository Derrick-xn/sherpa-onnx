...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo m1176buildvxqZcH0(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        builder.reset();
        builder.setMatrix(matrix);
        int iM5296getMinimpl = TextRange.m5296getMinimpl(j);
        builder.setSelectionRange(iM5296getMinimpl, TextRange.m5295getMaximpl(j));
        if (z) {
            setInsertionMarker(builder, iM5296getMinimpl, textLayoutResult, rect);
        }
        if (z2) {
            int iM5296getMinimpl2 = textRange != null ? TextRange.m5296getMinimpl(textRange.getPackedValue()) : -1;
            int iM5295getMaximpl = textRange != null ? TextRange.m5295getMaximpl(textRange.getPackedValue()) : -1;
            if (iM5296getMinimpl2 >= 0 && iM5296getMinimpl2 < iM5295getMaximpl) {
                builder.setComposingText(iM5296getMinimpl2, charSequence.subSequence(iM5296getMinimpl2, iM5295getMaximpl));
                addCharacterBounds(builder, iM5296getMinimpl2, iM5295getMaximpl, textLayoutResult, rect);
            }
        }
    ...
    private static final CursorAnchorInfo.Builder setInsertionMarker(CursorAnchorInfo.Builder builder, int i, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        float fCoerceIn = RangesKt.coerceIn(cursorRect.getLeft(), 0.0f, IntSize.m6018getWidthimpl(textLayoutResult.getSize()));
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r14, int r15, int r16, androidx.compose.ui.text.TextLayoutResult r17, androidx.compose.ui.geometry.Rect r18) {
        /*
            ...
            r6 = 0
            r3.m5163fillBoundingBoxes8ffj60Q(r4, r2, r6)
            r3 = r15
        L17:
            if (r3 >= r0) goto L77
            int r4 = r3 - r15
