...
public final class TextFieldSelectionState {
    ...
    private final MutableState startTextLayoutPositionInWindow = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3033boximpl(Offset.INSTANCE.m3059getUnspecifiedF1C5BW0()), null, 2, null);

    /* renamed from: rawHandleDragPosition$delegate, reason: from kotlin metadata */
    private final MutableState rawHandleDragPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3033boximpl(Offset.INSTANCE.m3059getUnspecifiedF1C5BW0()), null, 2, null);
    ...
    private final long m1299getStartTextLayoutPositionInWindowF1C5BW0() {
    ...
    private final void m1303setStartTextLayoutPositionInWindowk4lQ0M(long j) {
        this.startTextLayoutPositionInWindow.setValue(Offset.m3033boximpl(j));
    }

    /* renamed from: getCurrentTextLayoutPositionInWindow-F1C5BW0, reason: not valid java name */
    private final long m1296getCurrentTextLayoutPositionInWindowF1C5BW0() {
        LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
        return textLayoutCoordinates != null ? LayoutCoordinatesKt.positionInWindow(textLayoutCoordinates) : Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getRawHandleDragPosition-F1C5BW0, reason: not valid java name */
    private final long m1298getRawHandleDragPositionF1C5BW0() {
    ...
    private final void m1302setRawHandleDragPositionk4lQ0M(long j) {
        this.rawHandleDragPosition.setValue(Offset.m3033boximpl(j));
    }

    /* renamed from: getHandleDragPosition-F1C5BW0, reason: not valid java name */
    public final long m1306getHandleDragPositionF1C5BW0() {
        if (OffsetKt.m3065isUnspecifiedk4lQ0M(m1298getRawHandleDragPositionF1C5BW0())) {
            return Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
        }
        if (OffsetKt.m3065isUnspecifiedk4lQ0M(m1299getStartTextLayoutPositionInWindowF1C5BW0())) {
            return TextLayoutStateKt.m1258fromDecorationToTextLayoutUv8p0NA(this.textLayoutState, m1298getRawHandleDragPositionF1C5BW0());
        }
        return Offset.m3049plusMKHz9U(m1298getRawHandleDragPositionF1C5BW0(), Offset.m3048minusMKHz9U(m1299getStartTextLayoutPositionInWindowF1C5BW0(), m1296getCurrentTextLayoutPositionInWindowF1C5BW0()));
    }
    ...
    public final TextFieldHandleState getCursorHandleState$foundation_release(boolean includePosition) {
        ...
        if (!showCursorHandle || !z || !TextRange.m5292getCollapsedimpl(visualText.getSelection()) || !visualText.shouldShowSelection() || visualText.length() <= 0 || (draggingHandle != Handle.Cursor && !isCursorHandleInVisibleBounds())) {
            return TextFieldHandleState.INSTANCE.getHidden();
        }
        return new TextFieldHandleState(true, includePosition ? getCursorRect().m3071getBottomCenterF1C5BW0() : Offset.INSTANCE.m3059getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    }
    ...
    private final boolean isCursorHandleInVisibleBounds() {
        ...
        try {
            long jM3071getBottomCenterF1C5BW0 = getCursorRect().m3071getBottomCenterF1C5BW0();
            ...
            return SelectionManagerKt.m1417containsInclusiveUv8p0NA(rectVisibleBounds, jM3071getBottomCenterF1C5BW0);
        } catch (Throwable th) {
            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
            throw th;
        }
    ...
    public final Rect getCursorRect() {
        ...
        TextFieldCharSequence visualText = this.textFieldState.getVisualText();
        if (!TextRange.m5292getCollapsedimpl(visualText.getSelection())) {
            return Rect.INSTANCE.getZero();
        }
        Rect cursorRect = layoutResult.getCursorRect(TextRange.m5298getStartimpl(visualText.getSelection()));
        float fMo397toPx0680j_4 = this.density.mo397toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (layoutResult.getLayoutInput().getLayoutDirection() == LayoutDirection.Ltr) {
            right = cursorRect.getLeft() + (fMo397toPx0680j_4 / 2);
        } else {
            right = cursorRect.getRight() - (fMo397toPx0680j_4 / 2);
        }
        float f = fMo397toPx0680j_4 / 2;
        float fCoerceAtLeast = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(right, IntSize.m6018getWidthimpl(layoutResult.getSize()) - f), f);
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, CoroutineStart.UNDISPATCHED, new C00562(TextFieldSelectionState.this, this.$this_cursorHandleGestures, null), 1, null);
                ...
                if (i == 0) {
                    ...
                    if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.cursorHandleGestures.2.3.1
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                            m1313invokek4lQ0M(offset.getPackedValue());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                        public final void m1313invokek4lQ0M(long j) {
    ...
    static final class C03262 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03262(PointerInputScope pointerInputScope, boolean z, Continuation<? super C03262> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03262 c03262 = TextFieldSelectionState.this.new C03262(this.$this_selectionHandleGestures, this.$isStartHandle, continuation);
            c03262.L$0 = obj;
            return c03262;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, CoroutineStart.UNDISPATCHED, new C00582(this.$this_selectionHandleGestures, TextFieldSelectionState.this, this.$isStartHandle, null), 1, null);
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    TapOnPosition tapOnPosition = new TapOnPosition() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.selectionHandleGestures.2.2.1
                        ...
                        public final void mo1277onEventk4lQ0M(long j) {
                            Handle handle;
                            ...
                            textFieldSelectionState2.m1307updateHandleDraggingUv8p0NA(handle, SelectionHandlesKt.m1380getAdjustedCoordinatesk4lQ0M(textFieldSelectionState.m1297getHandlePositiontuRUvjQ(z)));
                        }
                    };
    ...
    public final Object selectionHandleGestures(PointerInputScope pointerInputScope, boolean z, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C03262(pointerInputScope, z, null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    */
    public final java.lang.Object observeChanges(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r6 instanceof androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03191
            if (r0 == 0) goto L14
            r0 = r6
            androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$observeChanges$1 r0 = (androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03191) r0
            int r1 = r0.label
    ...
    static final class C03202 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;

        C03202(Continuation<? super C03202> continuation) {
            super(2, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                return BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00572(TextFieldSelectionState.this, null), 3, null);
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
    ...
    static final class C03172 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        int label;

        C03172(Continuation<? super C03172> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03172 c03172 = TextFieldSelectionState.this.new C03172(continuation);
            c03172.L$0 = obj;
            return c03172;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C03172) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L33:
                ...
                goto L23
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03172.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    public final Object detectTouchMode(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        Object objAwaitPointerEventScope = pointerInputScope.awaitPointerEventScope(new C03172(null), continuation);
    ...
    public final Object detectTextFieldTapGestures(PointerInputScope pointerInputScope, MutableInteractionSource mutableInteractionSource, final Function0<Unit> function0, final Function0<Unit> function02, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress(pointerInputScope, new C03152(mutableInteractionSource, this, null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectTextFieldTapGestures.3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m1319invokek4lQ0M(offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1319invokek4lQ0M(long j) {
                ...
                if (this.enabled && this.getIsFocused()) {
                    ...
                    long jM1251coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release = this.textLayoutState.m1251coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(j);
                    TextFieldSelectionState textFieldSelectionState = this;
                    textFieldSelectionState.m1301placeCursorAtNearestOffsetk4lQ0M(TextLayoutStateKt.m1258fromDecorationToTextLayoutUv8p0NA(textFieldSelectionState.textLayoutState, jM1251coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release));
                }
            }
        }, continuation);
    ...
    static final class C03152 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03152(MutableInteractionSource mutableInteractionSource, TextFieldSelectionState textFieldSelectionState, Continuation<? super C03152> continuation) {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m1318invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m1318invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            C03152 c03152 = new C03152(this.$interactionSource, this.this$0, continuation);
            c03152.L$0 = pressGestureScope;
            c03152.J$0 = j;
    ...
    public final boolean m1301placeCursorAtNearestOffsetk4lQ0M(long offset) {
        int iM5270getOffsetForPositionk4lQ0M;
        IndexTransformationType indexTransformationType;
        int iM5298getStartimpl;
        SelectionWedgeAffinity selectionWedgeAffinity;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null || (iM5270getOffsetForPositionk4lQ0M = layoutResult.m5270getOffsetForPositionk4lQ0M(offset)) == -1) {
            return false;
        }
        TransformedTextFieldState transformedTextFieldState = this.textFieldState;
        long jM1265mapFromTransformedjx7JFs = transformedTextFieldState.m1265mapFromTransformedjx7JFs(iM5270getOffsetForPositionk4lQ0M);
        long jM1268mapToTransformedGEjPoXI = transformedTextFieldState.m1268mapToTransformedGEjPoXI(jM1265mapFromTransformedjx7JFs);
        if (TextRange.m5292getCollapsedimpl(jM1265mapFromTransformedjx7JFs) && TextRange.m5292getCollapsedimpl(jM1268mapToTransformedGEjPoXI)) {
            indexTransformationType = IndexTransformationType.Untransformed;
        } else if (!TextRange.m5292getCollapsedimpl(jM1265mapFromTransformedjx7JFs) && !TextRange.m5292getCollapsedimpl(jM1268mapToTransformedGEjPoXI)) {
        ...
        if (i == 1 || i == 2) {
            iM5298getStartimpl = TextRange.m5298getStartimpl(jM1265mapFromTransformedjx7JFs);
        } else if (i == 3) {
            if (MathUtilsKt.m1213findClosestRect9KIMszo(offset, layoutResult.getCursorRect(TextRange.m5298getStartimpl(jM1268mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m5293getEndimpl(jM1268mapToTransformedGEjPoXI))) < 0) {
            ...
            if (MathUtilsKt.m1213findClosestRect9KIMszo(offset, layoutResult.getCursorRect(TextRange.m5298getStartimpl(jM1268mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m5293getEndimpl(jM1268mapToTransformedGEjPoXI))) < 0) {
                ...
                iM5298getStartimpl = TextRange.m5293getEndimpl(jM1265mapFromTransformedjx7JFs);
            }
        }
        long jTextRange = TextRangeKt.TextRange(iM5298getStartimpl);
        if (TextRange.m5291equalsimpl0(jTextRange, this.textFieldState.getUntransformedText().getSelection()) && (selectionWedgeAffinity2 == null || Intrinsics.areEqual(selectionWedgeAffinity2, this.textFieldState.getSelectionWedgeAffinity()))) {
            return false;
        }
        this.textFieldState.m1271selectUntransformedCharsIn5zctL8(jTextRange);
    ...
    */
    public final java.lang.Object detectCursorHandleDragGestures(androidx.compose.ui.input.pointer.PointerInputScope r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) throws java.lang.Throwable {
        ...
        L42:
            ...
            long r3 = r1.m3059getUnspecifiedF1C5BW0()
            r11.element = r3
    ...
    public static final void detectCursorHandleDragGestures$onDragStop(Ref.LongRef longRef, Ref.LongRef longRef2, TextFieldSelectionState textFieldSelectionState) {
        if (OffsetKt.m3063isSpecifiedk4lQ0M(longRef.element)) {
            longRef.element = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
            longRef2.element = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
    ...
    private final class TextFieldMouseSelectionObserver implements MouseSelectionObserver {
        ...
        private long dragBeginPosition = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
        ...
        public boolean mo1312onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
            ...
            this.dragBeginOffsetInText = TextRange.m5298getStartimpl(m1308updateSelectionr1Wruf4(downPosition, adjustment, true));
            return true;
        }

        @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
        /* renamed from: onDrag-3MmeM6k, reason: not valid java name */
        public boolean mo1309onDrag3MmeM6k(final long dragPosition, SelectionAdjustment adjustment) {
            if (!TextFieldSelectionState.this.enabled || TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0) {
                return false;
            }
            TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldMouseSelectionObserver$onDrag$1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Mouse.onDrag " + ((Object) Offset.m3052toStringimpl(dragPosition));
                }
            });
            m1308updateSelectionr1Wruf4(dragPosition, adjustment, false);
            return true;
        }

        /* renamed from: updateSelection-r1Wruf4, reason: not valid java name */
        private final long m1308updateSelectionr1Wruf4(long dragPosition, SelectionAdjustment adjustment, boolean isStartOfSelection) {
            Integer numValueOf = Integer.valueOf(this.dragBeginOffsetInText);
            if (numValueOf.intValue() < 0) {
                numValueOf = null;
            }
            int iIntValue = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1253getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
            int iM1253getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.textLayoutState.m1253getOffsetForPosition3MmeM6k(dragPosition, false);
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long jM1304updateSelectionSsLRf8 = textFieldSelectionState.m1304updateSelectionSsLRf8(textFieldSelectionState.textFieldState.getVisualText(), iIntValue, iM1253getOffsetForPosition3MmeM6k, false, adjustment, false, isStartOfSelection);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m5292getCollapsedimpl(jM1304updateSelectionSsLRf8)) {
                this.dragBeginOffsetInText = TextRange.m5298getStartimpl(jM1304updateSelectionSsLRf8);
            }
            if (TextRange.m5297getReversedimpl(jM1304updateSelectionSsLRf8)) {
                jM1304updateSelectionSsLRf8 = TextFieldSelectionStateKt.m1321reverse5zctL8(jM1304updateSelectionSsLRf8);
            }
            TextFieldSelectionState.this.textFieldState.m1270selectCharsIn5zctL8(jM1304updateSelectionSsLRf8);
            TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            return jM1304updateSelectionSsLRf8;
        }
        ...
        public boolean mo1310onExtendk4lQ0M(long downPosition) {
        ...
        public boolean mo1311onExtendDragk4lQ0M(long dragPosition) {
    ...
    private final class TextFieldTextDragObserver implements TextDragObserver {
        ...
        private int dragBeginOffsetInText = -1;
        private long dragBeginPosition = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
        private long dragTotalDistance = Offset.INSTANCE.m3060getZeroF1C5BW0();
        private Handle actingHandle = Handle.SelectionEnd;

        @Override // androidx.compose.foundation.text.TextDragObserver
        /* renamed from: onDown-k-4lQ0M */
        public void mo1095onDownk4lQ0M(long point) {
        }
        ...
        private final void onDragStop() {
            if (OffsetKt.m3063isSpecifiedk4lQ0M(this.dragBeginPosition)) {
                ...
                this.dragBeginOffsetInText = -1;
                this.dragBeginPosition = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
                this.dragTotalDistance = Offset.INSTANCE.m3060getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                TextFieldSelectionState.this.setDirectDragGestureInitiator(InputType.None);
                this.requestFocus.invoke();
            }
        ...
        public void mo1097onStartk4lQ0M(final long startPoint) {
            if (TextFieldSelectionState.this.enabled) {
                TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onStart$1
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
                        return "Touch.onDragStart after longPress at " + ((Object) Offset.m3052toStringimpl(startPoint));
                    }
                });
                TextFieldSelectionState.this.m1307updateHandleDraggingUv8p0NA(this.actingHandle, startPoint);
                ...
                this.dragTotalDistance = Offset.INSTANCE.m3060getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                if (!TextFieldSelectionState.this.textLayoutState.m1254isPositionOnTextk4lQ0M(startPoint)) {
                    int iM1250getOffsetForPosition3MmeM6k$default = TextLayoutState.m1250getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                    HapticFeedback hapticFeedback = TextFieldSelectionState.this.hapticFeedBack;
                    if (hapticFeedback != null) {
                        hapticFeedback.mo4065performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m4074getTextHandleMove5zf0vsI());
                    }
                    TextFieldSelectionState.this.textFieldState.placeCursorBeforeCharAt(iM1250getOffsetForPosition3MmeM6k$default);
                ...
                int iM1250getOffsetForPosition3MmeM6k$default2 = TextLayoutState.m1250getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                long jM1305updateSelectionSsLRf8$default = TextFieldSelectionState.m1305updateSelectionSsLRf8$default(TextFieldSelectionState.this, new TextFieldCharSequence(TextFieldSelectionState.this.textFieldState.getVisualText(), TextRange.INSTANCE.m5303getZerod9O1mEE(), null, null, 12, null), iM1250getOffsetForPosition3MmeM6k$default2, iM1250getOffsetForPosition3MmeM6k$default2, false, SelectionAdjustment.INSTANCE.getWord(), false, false, 96, null);
                TextFieldSelectionState.this.textFieldState.m1270selectCharsIn5zctL8(jM1305updateSelectionSsLRf8$default);
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
                this.dragBeginOffsetInText = TextRange.m5298getStartimpl(jM1305updateSelectionSsLRf8$default);
            }
        }

        @Override // androidx.compose.foundation.text.TextDragObserver
        /* renamed from: onDrag-k-4lQ0M */
        public void mo1096onDragk4lQ0M(long delta) {
            int iIntValue;
            int iM1253getOffsetForPosition3MmeM6k;
            SelectionAdjustment word;
            Handle handle;
            if (!TextFieldSelectionState.this.enabled || TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0) {
                return;
            }
            long jM3049plusMKHz9U = Offset.m3049plusMKHz9U(this.dragTotalDistance, delta);
            this.dragTotalDistance = jM3049plusMKHz9U;
            final long jM3049plusMKHz9U2 = Offset.m3049plusMKHz9U(this.dragBeginPosition, jM3049plusMKHz9U);
            TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onDrag$1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Touch.onDrag at " + ((Object) Offset.m3052toStringimpl(jM3049plusMKHz9U2));
                }
            });
            if (this.dragBeginOffsetInText < 0 && !TextFieldSelectionState.this.textLayoutState.m1254isPositionOnTextk4lQ0M(jM3049plusMKHz9U2)) {
                iIntValue = TextLayoutState.m1250getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, this.dragBeginPosition, false, 2, null);
                iM1253getOffsetForPosition3MmeM6k = TextLayoutState.m1250getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, jM3049plusMKHz9U2, false, 2, null);
                if (iIntValue == iM1253getOffsetForPosition3MmeM6k) {
                ...
                iIntValue = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1253getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
                iM1253getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.textLayoutState.m1253getOffsetForPosition3MmeM6k(jM3049plusMKHz9U2, false);
                if (this.dragBeginOffsetInText < 0 && iIntValue == iM1253getOffsetForPosition3MmeM6k) {
                    return;
                }
                word = SelectionAdjustment.INSTANCE.getWord();
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            ...
            int i = iIntValue;
            int i2 = iM1253getOffsetForPosition3MmeM6k;
            SelectionAdjustment selectionAdjustment = word;
            long jM1145getSelectiond9O1mEE = TextFieldSelectionState.this.textFieldState.getVisualText().getSelection();
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long jM1305updateSelectionSsLRf8$default = TextFieldSelectionState.m1305updateSelectionSsLRf8$default(textFieldSelectionState, textFieldSelectionState.textFieldState.getVisualText(), i, i2, false, selectionAdjustment, false, false, 64, null);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m5292getCollapsedimpl(jM1305updateSelectionSsLRf8$default)) {
                this.dragBeginOffsetInText = TextRange.m5298getStartimpl(jM1305updateSelectionSsLRf8$default);
            }
            if (TextRange.m5297getReversedimpl(jM1305updateSelectionSsLRf8$default)) {
                jM1305updateSelectionSsLRf8$default = TextFieldSelectionStateKt.m1321reverse5zctL8(jM1305updateSelectionSsLRf8$default);
            }
            if (!TextRange.m5291equalsimpl0(jM1305updateSelectionSsLRf8$default, jM1145getSelectiond9O1mEE)) {
                if (TextRange.m5298getStartimpl(jM1305updateSelectionSsLRf8$default) != TextRange.m5298getStartimpl(jM1145getSelectiond9O1mEE) && TextRange.m5293getEndimpl(jM1305updateSelectionSsLRf8$default) == TextRange.m5293getEndimpl(jM1145getSelectiond9O1mEE)) {
                    handle = Handle.SelectionStart;
                } else if ((TextRange.m5298getStartimpl(jM1305updateSelectionSsLRf8$default) == TextRange.m5298getStartimpl(jM1145getSelectiond9O1mEE) && TextRange.m5293getEndimpl(jM1305updateSelectionSsLRf8$default) != TextRange.m5293getEndimpl(jM1145getSelectiond9O1mEE)) || (TextRange.m5298getStartimpl(jM1305updateSelectionSsLRf8$default) + TextRange.m5293getEndimpl(jM1305updateSelectionSsLRf8$default)) / 2.0f > (TextRange.m5298getStartimpl(jM1145getSelectiond9O1mEE) + TextRange.m5293getEndimpl(jM1145getSelectiond9O1mEE)) / 2.0f) {
                    handle = Handle.SelectionEnd;
                } else {
                    handle = Handle.SelectionStart;
                }
            ...
            if (TextRange.m5292getCollapsedimpl(jM1145getSelectiond9O1mEE) || !TextRange.m5292getCollapsedimpl(jM1305updateSelectionSsLRf8$default)) {
                TextFieldSelectionState.this.textFieldState.m1270selectCharsIn5zctL8(jM1305updateSelectionSsLRf8$default);
            }
            TextFieldSelectionState.this.m1307updateHandleDraggingUv8p0NA(this.actingHandle, jM3049plusMKHz9U2);
        }
    }
    ...
    */
    ...
    public static final void detectSelectionHandleDragGestures$onDragStop$5(Ref.LongRef longRef, TextFieldSelectionState textFieldSelectionState, Ref.LongRef longRef2) {
        if (OffsetKt.m3063isSpecifiedk4lQ0M(longRef.element)) {
            textFieldSelectionState.clearHandleDragging();
            longRef.element = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
            longRef2.element = Offset.INSTANCE.m3060getZeroF1C5BW0();
    ...
    /* synthetic */ class C03223 extends FunctionReferenceImpl implements Function2<TextFieldCharSequence, CharSequence, Boolean> {
        public static final C03223 INSTANCE = new C03223();
    ...
    public final Object observeTextChanges(Continuation<? super Unit> continuation) {
        ...
        }), C03223.INSTANCE), 1).collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextChanges.4
    ...
    public final Object observeTextToolbarVisibility(Continuation<? super Unit> continuation) {
        Object objCollect = SnapshotStateKt.snapshotFlow(new Function0<Rect>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextToolbarVisibility.2
            ...
            public final Rect invoke() {
                Rect rectIntersect;
                boolean zM5292getCollapsedimpl = TextRange.m5292getCollapsedimpl(TextFieldSelectionState.this.textFieldState.getVisualText().getSelection());
                if (((zM5292getCollapsedimpl && TextFieldSelectionState.this.getTextToolbarState() == TextToolbarState.Cursor) || (!zM5292getCollapsedimpl && TextFieldSelectionState.this.getTextToolbarState() == TextToolbarState.Selection)) && TextFieldSelectionState.this.getDraggingHandle() == null && TextFieldSelectionState.this.isInTouchMode()) {
                    ...
                    if (rectVisibleBounds != null) {
                        ...
                        Offset offsetM3033boximpl = textLayoutCoordinates2 != null ? Offset.m3033boximpl(textLayoutCoordinates2.mo4685localToRootMKHz9U(rectVisibleBounds.m3079getTopLeftF1C5BW0())) : null;
                        Intrinsics.checkNotNull(offsetM3033boximpl);
                        Rect rectM3084Recttz77jQw = RectKt.m3084Recttz77jQw(offsetM3033boximpl.getPackedValue(), rectVisibleBounds.m3077getSizeNHjbRc());
                        Rect contentRect = TextFieldSelectionState.this.getContentRect();
                        Rect rect = rectM3084Recttz77jQw.overlaps(contentRect) ? contentRect : null;
                        return (rect == null || (rectIntersect = rect.intersect(rectM3084Recttz77jQw)) == null) ? Rect.INSTANCE.getZero() : rectIntersect;
                    }
                    return Rect.INSTANCE.getZero();
                }
                return Rect.INSTANCE.getZero();
    ...
    public final Rect getContentRect() {
        ...
        if (TextRange.m5292getCollapsedimpl(visualText.getSelection())) {
            ...
            LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
            return RectKt.m3084Recttz77jQw(textLayoutCoordinates != null ? textLayoutCoordinates.mo4685localToRootMKHz9U(cursorRect3.m3079getTopLeftF1C5BW0()) : Offset.INSTANCE.m3060getZeroF1C5BW0(), cursorRect3.m3077getSizeNHjbRc());
        }
        LayoutCoordinates textLayoutCoordinates2 = getTextLayoutCoordinates();
        long jMo4685localToRootMKHz9U = textLayoutCoordinates2 != null ? textLayoutCoordinates2.mo4685localToRootMKHz9U(m1297getHandlePositiontuRUvjQ(true)) : Offset.INSTANCE.m3060getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates3 = getTextLayoutCoordinates();
        long jMo4685localToRootMKHz9U2 = textLayoutCoordinates3 != null ? textLayoutCoordinates3.mo4685localToRootMKHz9U(m1297getHandlePositiontuRUvjQ(false)) : Offset.INSTANCE.m3060getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates4 = getTextLayoutCoordinates();
        float fM3045getYimpl2 = 0.0f;
        if (textLayoutCoordinates4 != null) {
            TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
            fM3045getYimpl = Offset.m3045getYimpl(textLayoutCoordinates4.mo4685localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (cursorRect2 = layoutResult.getCursorRect(TextRange.m5298getStartimpl(visualText.getSelection()))) == null) ? 0.0f : cursorRect2.getTop())));
        } else {
            fM3045getYimpl = 0.0f;
        }
        ...
        if (textLayoutCoordinates5 != null) {
            ...
            fM3045getYimpl2 = Offset.m3045getYimpl(textLayoutCoordinates5.mo4685localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (cursorRect = layoutResult2.getCursorRect(TextRange.m5293getEndimpl(visualText.getSelection()))) == null) ? 0.0f : cursorRect.getTop())));
        }
        return new Rect(Math.min(Offset.m3044getXimpl(jMo4685localToRootMKHz9U), Offset.m3044getXimpl(jMo4685localToRootMKHz9U2)), Math.min(fM3045getYimpl, fM3045getYimpl2), Math.max(Offset.m3044getXimpl(jMo4685localToRootMKHz9U), Offset.m3044getXimpl(jMo4685localToRootMKHz9U2)), Math.max(Offset.m3045getYimpl(jMo4685localToRootMKHz9U), Offset.m3045getYimpl(jMo4685localToRootMKHz9U2)));
    }
    ...
    public final TextFieldHandleState getSelectionHandleState$foundation_release(boolean isStartHandle, boolean includePosition) {
        ...
        long jM1145getSelectiond9O1mEE = this.textFieldState.getVisualText().getSelection();
        if (TextRange.m5292getCollapsedimpl(jM1145getSelectiond9O1mEE)) {
            return TextFieldHandleState.INSTANCE.getHidden();
        }
        long jM1297getHandlePositiontuRUvjQ = m1297getHandlePositiontuRUvjQ(isStartHandle);
        if (getDirectDragGestureInitiator() != InputType.None || (getDraggingHandle() != handle && ((textLayoutCoordinates = getTextLayoutCoordinates()) == null || (rectVisibleBounds2 = SelectionManagerKt.visibleBounds(textLayoutCoordinates)) == null || !SelectionManagerKt.m1417containsInclusiveUv8p0NA(rectVisibleBounds2, jM1297getHandlePositiontuRUvjQ)))) {
            return TextFieldHandleState.INSTANCE.getHidden();
        }
        if (!this.textFieldState.getVisualText().shouldShowSelection()) {
            return TextFieldHandleState.INSTANCE.getHidden();
        }
        ResolvedTextDirection bidiRunDirection = layoutResult.getBidiRunDirection(isStartHandle ? TextRange.m5298getStartimpl(jM1145getSelectiond9O1mEE) : Math.max(TextRange.m5293getEndimpl(jM1145getSelectiond9O1mEE) - 1, 0));
        boolean zM5297getReversedimpl = TextRange.m5297getReversedimpl(jM1145getSelectiond9O1mEE);
        if (includePosition) {
            LayoutCoordinates textLayoutCoordinates2 = getTextLayoutCoordinates();
            if (textLayoutCoordinates2 != null && (rectVisibleBounds = SelectionManagerKt.visibleBounds(textLayoutCoordinates2)) != null) {
                jM1297getHandlePositiontuRUvjQ = TextLayoutStateKt.m1257coerceIn3MmeM6k(jM1297getHandlePositiontuRUvjQ, rectVisibleBounds);
            }
        } else {
            jM1297getHandlePositiontuRUvjQ = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
        }
        return new TextFieldHandleState(true, jM1297getHandlePositiontuRUvjQ, bidiRunDirection, zM5297getReversedimpl, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getHandlePosition-tuRUvjQ, reason: not valid java name */
    public final long m1297getHandlePositiontuRUvjQ(boolean isStartHandle) {
        int iM5293getEndimpl;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
        ...
        long jM1145getSelectiond9O1mEE = this.textFieldState.getVisualText().getSelection();
        if (isStartHandle) {
            iM5293getEndimpl = TextRange.m5298getStartimpl(jM1145getSelectiond9O1mEE);
        } else {
            iM5293getEndimpl = TextRange.m5293getEndimpl(jM1145getSelectiond9O1mEE);
        }
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult, iM5293getEndimpl, isStartHandle, TextRange.m5297getReversedimpl(jM1145getSelectiond9O1mEE));
    }

    /* renamed from: updateHandleDragging-Uv8p0NA, reason: not valid java name */
    public final void m1307updateHandleDraggingUv8p0NA(Handle handle, long position) {
        setDraggingHandle(handle);
        m1302setRawHandleDragPositionk4lQ0M(position);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void markStartContentVisibleOffset() {
        m1303setStartTextLayoutPositionInWindowk4lQ0M(m1296getCurrentTextLayoutPositionInWindowF1C5BW0());
    }

    public final void clearHandleDragging() {
        setDraggingHandle(null);
        m1302setRawHandleDragPositionk4lQ0M(Offset.INSTANCE.m3059getUnspecifiedF1C5BW0());
        m1303setStartTextLayoutPositionInWindowk4lQ0M(Offset.INSTANCE.m3059getUnspecifiedF1C5BW0());
    }

    public final boolean canCut() {
        return (TextRange.m5292getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || !getEditable() || this.isPassword) ? false : true;
    }
    ...
    public final boolean canCopy() {
        return (TextRange.m5292getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || this.isPassword) ? false : true;
    }
    ...
    public final void paste() {
        ...
        TransferableContent transferableContentOnReceive = receiveContentConfigurationInvoke.getReceiveContentListener().onReceive(new TransferableContent(clip, clip.getClipMetadata(), TransferableContent.Source.INSTANCE.m360getClipboardkB6V9T0(), null, 8, null));
    ...
    public final boolean canSelectAll() {
        return TextRange.m5294getLengthimpl(this.textFieldState.getVisualText().getSelection()) != this.textFieldState.getVisualText().length();
    }
    ...
    public final void deselect() {
        if (!TextRange.m5292getCollapsedimpl(this.textFieldState.getVisualText().getSelection())) {
    ...
    static /* synthetic */ long m1305updateSelectionSsLRf8$default(TextFieldSelectionState textFieldSelectionState, TextFieldCharSequence textFieldCharSequence, int i, int i2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2, boolean z3, int i3, Object obj) {
        return textFieldSelectionState.m1304updateSelectionSsLRf8(textFieldCharSequence, i, i2, z, selectionAdjustment, (i3 & 32) != 0 ? false : z2, (i3 & 64) != 0 ? false : z3);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: updateSelection-SsL-Rf8, reason: not valid java name */
    public final long m1304updateSelectionSsLRf8(TextFieldCharSequence textFieldCharSequence, int startOffset, int endOffset, boolean isStartHandle, SelectionAdjustment adjustment, boolean allowPreviousSelectionCollapsed, boolean isStartOfSelection) {
        HapticFeedback hapticFeedback;
        TextRange textRangeM5286boximpl = TextRange.m5286boximpl(textFieldCharSequence.getSelection());
        long packedValue = textRangeM5286boximpl.getPackedValue();
        if (isStartOfSelection || (!allowPreviousSelectionCollapsed && TextRange.m5292getCollapsedimpl(packedValue))) {
            textRangeM5286boximpl = null;
        }
        long jM1300getTextFieldSelectionqeG_v_k = m1300getTextFieldSelectionqeG_v_k(startOffset, endOffset, textRangeM5286boximpl, isStartHandle, adjustment);
        if (TextRange.m5291equalsimpl0(jM1300getTextFieldSelectionqeG_v_k, textFieldCharSequence.getSelection())) {
            return jM1300getTextFieldSelectionqeG_v_k;
        }
        boolean z = TextRange.m5297getReversedimpl(jM1300getTextFieldSelectionqeG_v_k) != TextRange.m5297getReversedimpl(textFieldCharSequence.getSelection()) && TextRange.m5291equalsimpl0(TextRangeKt.TextRange(TextRange.m5293getEndimpl(jM1300getTextFieldSelectionqeG_v_k), TextRange.m5298getStartimpl(jM1300getTextFieldSelectionqeG_v_k)), textFieldCharSequence.getSelection());
    ...
    private final long m1300getTextFieldSelectionqeG_v_k(int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
            return TextRange.INSTANCE.m5303getZerod9O1mEE();
        }
        ...
        SelectionLayout selectionLayoutM1383getTextFieldSelectionLayoutRcvTLA = SelectionLayoutKt.m1383getTextFieldSelectionLayoutRcvTLA(layoutResult, rawStartOffset, rawEndOffset, this.previousRawDragOffset, previousSelection != null ? previousSelection.getPackedValue() : TextRange.INSTANCE.m5303getZerod9O1mEE(), previousSelection == null, isStartHandle);
        if (previousSelection != null && !selectionLayoutM1383getTextFieldSelectionLayoutRcvTLA.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return previousSelection.getPackedValue();
        }
        long jM1371toTextRanged9O1mEE = adjustment.adjust(selectionLayoutM1383getTextFieldSelectionLayoutRcvTLA).m1371toTextRanged9O1mEE();
        this.previousSelectionLayout = selectionLayoutM1383getTextFieldSelectionLayoutRcvTLA;
        if (!isStartHandle) {
            rawStartOffset = rawEndOffset;
        }
        this.previousRawDragOffset = rawStartOffset;
        return jM1371toTextRanged9O1mEE;
    }
}