...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope saverScope, TextUndoOperation textUndoOperation) {
            return CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m5298getStartimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m5293getEndimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m5298getStartimpl(textUndoOperation.getPostSelection())), Integer.valueOf(TextRange.m5293getEndimpl(textUndoOperation.getPostSelection())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m5292getCollapsedimpl(this.postSelection)) {
            if (TextRange.m5292getCollapsedimpl(this.preSelection)) {
                if (TextRange.m5298getStartimpl(this.preSelection) > TextRange.m5298getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m5298getStartimpl(this.preSelection) == TextRange.m5298getStartimpl(this.postSelection) && TextRange.m5298getStartimpl(this.preSelection) == this.index) {
