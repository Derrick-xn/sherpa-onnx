...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    private final MutableState magnifierSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6010boximpl(IntSize.INSTANCE.m6023getZeroYbymL2g()), null, 2, null);
    private final MagnifierNode magnifierNode = (MagnifierNode) delegate(new MagnifierNode(new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$magnifierNode$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m3033boximpl(m1287invoketuRUvjQ(density));
        }

        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m1287invoketuRUvjQ(Density density) {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
            m1288invokeEaSLcWc(dpSize.getPackedValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-EaSLcWc, reason: not valid java name */
        public final void m1288invokeEaSLcWc(long j) {
            ...
            textFieldMagnifierNodeImpl28.m1286setMagnifierSizeozmzZPI(IntSizeKt.IntSize(density.mo391roundToPx0680j_4(DpSize.m5942getWidthD9Ej5fM(j)), density.mo391roundToPx0680j_4(DpSize.m5940getHeightD9Ej5fM(j))));
        }
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean z) {
        ...
        this.visible = z;
        this.animatable = new Animatable<>(Offset.m3033boximpl(TextFieldMagnifierKt.m1282calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1285getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m3033boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getMagnifierSize-YbymL2g, reason: not valid java name */
    public final long m1285getMagnifierSizeYbymL2g() {
    ...
    public final void m1286setMagnifierSizeozmzZPI(long j) {
        this.magnifierSize.setValue(IntSize.m6010boximpl(j));
    }
            ...
            if (i == 0) {
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3033boximpl(m1289invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1289invokeF1C5BW0() {
                        ...
                        return TextFieldMagnifierKt.m1282calculateSelectionMagnifierCenterAndroidhUlJWOE(textFieldMagnifierNodeImpl28.textFieldState, textFieldMagnifierNodeImpl28.textFieldSelectionState, textFieldMagnifierNodeImpl28.textLayoutState, textFieldMagnifierNodeImpl28.m1285getMagnifierSizeYbymL2g());
                    }
                });
                ...
                if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                        return m1290emit3MmeM6k(((Offset) obj2).getPackedValue(), continuation);
                    }

                    /* renamed from: emit-3MmeM6k, reason: not valid java name */
                    public final Object m1290emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                        if (OffsetKt.m3063isSpecifiedk4lQ0M(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) && OffsetKt.m3063isSpecifiedk4lQ0M(j) && Offset.m3045getYimpl(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) != Offset.m3045getYimpl(j)) {
                            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00551(textFieldMagnifierNodeImpl282, j, null), 3, null);
                            return Unit.INSTANCE;
                        }
                        Object objSnapTo = textFieldMagnifierNodeImpl282.animatable.snapTo(Offset.m3033boximpl(j), continuation);
                    ...
                    static final class C00551 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object obj) throws Throwable {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                this.label = 1;
                                if (Animatable.animateTo$default(this.this$0.animatable, Offset.m3033boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
