...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long jMo1142getOriginalRangejx7JFs = changeList.mo1142getOriginalRangejx7JFs(0);
            long jMo1143getRangejx7JFs = changeList.mo1143getRangejx7JFs(0);
            if (TextRange.m5292getCollapsedimpl(jMo1142getOriginalRangejx7JFs) && TextRange.m5292getCollapsedimpl(jMo1143getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m5296getMinimpl(jMo1142getOriginalRangejx7JFs), TextRangeKt.m5305substringFDrldGo(textFieldCharSequence, jMo1142getOriginalRangejx7JFs), TextRangeKt.m5305substringFDrldGo(textFieldCharSequence2, jMo1143getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
