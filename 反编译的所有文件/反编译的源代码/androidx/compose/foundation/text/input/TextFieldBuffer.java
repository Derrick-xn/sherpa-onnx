...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1142getOriginalRangejx7JFs(int changeIndex);

        /* renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1143getRangejx7JFs(int changeIndex);
    }
    ...
    public final long m1138getOriginalSelectiond9O1mEE() {
    ...
    public final boolean hasSelection() {
        return !TextRange.m5292getCollapsedimpl(getSelectionInChars());
    }
    ...
    public final void m1140setSelection5zctL8(long j) {
        m1136requireValidRange5zctL8(j);
    ...
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        int iM5296getMinimpl = TextRange.m5296getMinimpl(getSelectionInChars());
        int iM5295getMaximpl = TextRange.m5295getMaximpl(getSelectionInChars());
        if (iM5295getMaximpl < iMin) {
            return;
        }
        if (iM5296getMinimpl <= iMin && iMax <= iM5295getMaximpl) {
            i = newLength - (iMax - iMin);
            if (iM5296getMinimpl == iM5295getMaximpl) {
                iM5296getMinimpl += i;
            }
            iMin = iM5295getMaximpl + i;
        } else if (iM5296getMinimpl > iMin && iM5295getMaximpl < iMax) {
            iMin += newLength;
            iM5296getMinimpl = iMin;
        } else if (iM5296getMinimpl >= iMax) {
            i = newLength - (iMax - iMin);
            iM5296getMinimpl += i;
            iMin = iM5295getMaximpl + i;
        } else if (iMin < iM5296getMinimpl) {
            iM5296getMinimpl = iMin + newLength;
            i = newLength - (iMax - iMin);
            iMin = iM5295getMaximpl + i;
        }
        this.selectionInChars = TextRangeKt.TextRange(iM5296getMinimpl, iMin);
    }
    ...
    public final void revertAllChanges() {
        ...
        m1140setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1137toTextFieldCharSequenceudt6zUU$foundation_release$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldBuffer.m1141toTextFieldCharSequenceudt6zUU$foundation_release(j, textRange);
    }

    /* renamed from: toTextFieldCharSequence-udt6zUU$foundation_release, reason: not valid java name */
    public final TextFieldCharSequence m1141toTextFieldCharSequenceudt6zUU$foundation_release(long selection, TextRange composition) {
    ...
    private final void m1136requireValidRange5zctL8(long range) {
        long jTextRange = TextRangeKt.TextRange(0, getLength());
        if (TextRange.m5288contains5zctL8(jTextRange, range)) {
            return;
        }
        throw new IllegalArgumentException(("Expected " + ((Object) TextRange.m5301toStringimpl(range)) + " to be in " + ((Object) TextRange.m5301toStringimpl(jTextRange))).toString());
    }
}