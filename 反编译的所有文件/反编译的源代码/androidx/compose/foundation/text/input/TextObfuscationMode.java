...
public final class TextObfuscationMode {
    ...
    private static final int Visible = m1160constructorimpl(0);
    private static final int RevealLastTyped = m1160constructorimpl(1);
    private static final int Hidden = m1160constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextObfuscationMode m1159boximpl(int i) {
        return new TextObfuscationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1160constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1161equalsimpl(int i, Object obj) {
        return (obj instanceof TextObfuscationMode) && i == ((TextObfuscationMode) obj).m1165unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1162equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1163hashCodeimpl(int i) {
        return i;
    }
    ...
    public final /* synthetic */ int m1165unboximpl() {
        return this.value;
    }
