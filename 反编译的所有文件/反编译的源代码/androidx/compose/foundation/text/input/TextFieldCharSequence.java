...
public final class TextFieldCharSequence implements CharSequence {
    ...
    private TextFieldCharSequence(CharSequence charSequence, long j, TextRange textRange, Pair<TextHighlightType, TextRange> pair) {
        ...
        this.selection = TextRangeKt.m5304coerceIn8ffj60Q(j, 0, charSequence.length());
        this.composition = textRange != null ? TextRange.m5286boximpl(TextRangeKt.m5304coerceIn8ffj60Q(textRange.getPackedValue(), 0, charSequence.length())) : null;
        this.highlight = pair != null ? Pair.copy$default(pair, null, TextRange.m5286boximpl(TextRangeKt.m5304coerceIn8ffj60Q(pair.getSecond().getPackedValue(), 0, charSequence.length())), 1, null) : null;
    }
    ...
    public /* synthetic */ TextFieldCharSequence(String str, long j, TextRange textRange, Pair pair, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.INSTANCE.m5303getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (i & 8) != 0 ? null : pair, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return TextRange.m5291equalsimpl0(this.selection, textFieldCharSequence.selection) && Intrinsics.areEqual(this.composition, textFieldCharSequence.composition) && Intrinsics.areEqual(this.highlight, textFieldCharSequence.highlight) && contentEquals(textFieldCharSequence.text);
    }

    public int hashCode() {
        int iHashCode = ((this.text.hashCode() * 31) + TextRange.m5299hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        int iM5299hashCodeimpl = (iHashCode + (textRange != null ? TextRange.m5299hashCodeimpl(textRange.getPackedValue()) : 0)) * 31;
        Pair<TextHighlightType, TextRange> pair = this.highlight;
        return iM5299hashCodeimpl + (pair != null ? pair.hashCode() : 0);
    }
}