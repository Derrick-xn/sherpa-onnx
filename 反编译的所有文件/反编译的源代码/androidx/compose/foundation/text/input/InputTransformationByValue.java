...
final /* data */ class InputTransformationByValue implements InputTransformation {
    ...
    public void transformInput(TextFieldBuffer textFieldBuffer) {
        TextFieldCharSequence textFieldCharSequenceM1137toTextFieldCharSequenceudt6zUU$foundation_release$default = TextFieldBuffer.m1137toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer, 0L, null, 3, null);
        CharSequence charSequenceInvoke = this.transformation.invoke(textFieldBuffer.getOriginalValue(), textFieldCharSequenceM1137toTextFieldCharSequenceudt6zUU$foundation_release$default);
        if (charSequenceInvoke == textFieldCharSequenceM1137toTextFieldCharSequenceudt6zUU$foundation_release$default) {
            return;
        }
