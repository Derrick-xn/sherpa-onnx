        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i3) {
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM5330getFontStyle4Lr2A7w = textStyle3.m5330getFontStyle4Lr2A7w();
                    int iM5432unboximpl = fontStyleM5330getFontStyle4Lr2A7w != null ? fontStyleM5330getFontStyle4Lr2A7w.m5432unboximpl() : FontStyle.INSTANCE.m5436getNormal_LCdwA();
                    FontSynthesis fontSynthesisM5331getFontSynthesisZQGJjVo = textStyle3.m5331getFontSynthesisZQGJjVo();
                    objRememberedValue2 = resolver.mo5403resolveDPcqOEQ(fontFamily, fontWeight, iM5432unboximpl, fontSynthesisM5331getFontSynthesisZQGJjVo != null ? fontSynthesisM5331getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m5446getAllGVVA2EU());
                ...
                if (zChanged3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue3 = Integer.valueOf(IntSize.m6017getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (zChanged4 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue4 = Integer.valueOf(IntSize.m6017getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
                ...
                Modifier modifierM743heightInVpY3zN4 = SizeKt.m743heightInVpY3zN4(Modifier.INSTANCE, numValueOf != null ? density.mo394toDpu2uoSUM(numValueOf.intValue()) : Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM(), numValueOf2 != null ? density.mo394toDpu2uoSUM(numValueOf2.intValue()) : Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceGroup();
                return modifierM743heightInVpY3zN4;
            }
        });
    }
}