...
final class SelectionGesturesKt$touchSelectionSubsequentPress$downResolution$1 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super DownResolution>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            Object objM440awaitTouchSlopOrCancellationjO51t88 = DragGestureDetectorKt.m440awaitTouchSlopOrCancellationjO51t88(awaitPointerEventScope2, j, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionGesturesKt$touchSelectionSubsequentPress$downResolution$1$firstDragPastSlop$1
                {
                    super(2);
                }
                ...
                public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                    m1375invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
                public final void m1375invokeUv8p0NA(PointerInputChange pointerInputChange, long j2) {
                    pointerInputChange.consume();
                    longRef.element = j2;
                }
            }, this);
            if (objM440awaitTouchSlopOrCancellationjO51t88 == coroutine_suspended) {
                return coroutine_suspended;
            }
            awaitPointerEventScope = awaitPointerEventScope2;
            obj = objM440awaitTouchSlopOrCancellationjO51t88;
        } else {
            if (i != 1) {
        ...
        if (((PointerInputChange) obj) != null && OffsetKt.m3063isSpecifiedk4lQ0M(this.$overSlop.element)) {
