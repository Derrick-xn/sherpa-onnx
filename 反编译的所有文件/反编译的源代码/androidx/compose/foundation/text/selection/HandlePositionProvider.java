...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m3060getZeroF1C5BW0();
    ...
    public long mo369calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long jMo1008provideF1C5BW0 = this.positionProvider.mo1008provideF1C5BW0();
        if (!OffsetKt.m3063isSpecifiedk4lQ0M(jMo1008provideF1C5BW0)) {
            jMo1008provideF1C5BW0 = this.prevPosition;
        }
        this.prevPosition = jMo1008provideF1C5BW0;
        return IntOffset.m5980plusqkQi6aY(IntOffset.m5980plusqkQi6aY(anchorBounds.m6004getTopLeftnOccac(), IntOffsetKt.m5992roundk4lQ0M(jMo1008provideF1C5BW0)), this.handleReferencePoint.mo2890alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m6023getZeroYbymL2g(), layoutDirection));
    }
}