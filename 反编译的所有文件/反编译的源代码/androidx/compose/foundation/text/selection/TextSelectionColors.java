...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m3325equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m3331hashCodeimpl(this.handleColor) * 31) + Color.m3331hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m3332toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m3332toStringimpl(this.backgroundColor)) + ')';
    }
}