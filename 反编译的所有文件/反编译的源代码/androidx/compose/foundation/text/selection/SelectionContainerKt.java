...
public final class SelectionContainerKt {
    ...
    public static final void SelectionContainer(final Modifier modifier, final Selection selection, final Function1<? super Selection, Unit> function1, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 1171) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            final SelectionRegistrarImpl selectionRegistrarImpl = (SelectionRegistrarImpl) RememberSaveableKt.m2871rememberSaveable(new Object[0], (Saver) SelectionRegistrarImpl.INSTANCE.getSaver(), (String) null, (Function0) new Function0<SelectionRegistrarImpl>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$registrarImpl$1
                                                ...
                                                if (selectionManager3.isInTouchMode() && selectionManager3.getHasFocus() && !selectionManager3.isTriviallyCollapsedSelection$foundation_release()) {
                                                    ...
                                                    if (selection2 == null) {
                                                        ...
                                                        for (int i8 = 0; i8 < size; i8++) {
                                                                ...
                                                                if (zBooleanValue) {
                                                                    obj = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1$1$1$1$positionProvider$1$1
                                                                        ...
                                                                        public /* bridge */ /* synthetic */ Offset invoke() {
                                                                            return Offset.m3033boximpl(m1373invokeF1C5BW0());
                                                                        }

                                                                        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                                                                        public final long m1373invokeF1C5BW0() {
                                                                            Offset offsetM1409getStartHandlePosition_m7T9E = selectionManager4.m1409getStartHandlePosition_m7T9E();
                                                                            return offsetM1409getStartHandlePosition_m7T9E != null ? offsetM1409getStartHandlePosition_m7T9E.getPackedValue() : Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
                                                                        }
                                                                    };
                                                                } else {
                                                                    obj = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1$1$1$1$positionProvider$1$2
                                                                        ...
                                                                        @Override // kotlin.jvm.functions.Function0
                                                                        public /* bridge */ /* synthetic */ Offset invoke() {
                                                                            return Offset.m3033boximpl(m1374invokeF1C5BW0());
                                                                        }

                                                                        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                                                                        public final long m1374invokeF1C5BW0() {
                                                                            Offset offsetM1408getEndHandlePosition_m7T9E = selectionManager4.m1408getEndHandlePosition_m7T9E();
                                                                            return offsetM1408getEndHandlePosition_m7T9E != null ? offsetM1408getEndHandlePosition_m7T9E.getPackedValue() : Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
                                                                        }
                                                                    };
                                                                }
                                                            ...
                                                            ComposerKt.sourceInformationMarkerEnd(composer4);
                                                            AndroidSelectionHandles_androidKt.m1360SelectionHandlepzduO1o(selectionContainerKt$sam$androidx_compose_foundation_text_selection_OffsetProvider$0, zBooleanValue, resolvedTextDirection, handlesCrossed, 0L, SuspendingPointerInputFilterKt.pointerInput(companion, textDragObserver, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue4), composer4, 0, 16);
                                                        }
