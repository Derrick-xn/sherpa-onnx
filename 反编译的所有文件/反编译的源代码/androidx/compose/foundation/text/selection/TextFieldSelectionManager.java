...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.INSTANCE.m3060getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo1097onStartk4lQ0M(long startPoint) {
                ...
                if (this.this$0.getEnabled() && this.this$0.getDraggingHandle() == null) {
                    ...
                    if (state == null || (layoutResult2 = state.getLayoutResult()) == null || !layoutResult2.m1129isPositionOnTextk4lQ0M(startPoint)) {
                        LegacyTextFieldState state2 = this.this$0.getState();
                        if (state2 != null && (layoutResult = state2.getLayoutResult()) != null) {
                            TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                            int iTransformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.m1127getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null));
                            TextFieldValue textFieldValueM1431createTextFieldValueFDrldGo = textFieldSelectionManager.m1431createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal));
                            ...
                            textFieldSelectionManager.getOnValueChange$foundation_release().invoke(textFieldValueM1431createTextFieldValueFDrldGo);
                        }
                    } else {
                        ...
                        this.this$0.dragBeginOffsetInText = Integer.valueOf(TextRange.m5298getStartimpl(textFieldSelectionManager2.m1434updateSelection8UEBfa8(TextFieldValue.m5561copy3r_uNRQ$default(textFieldSelectionManager2.getValue$foundation_release(), (AnnotatedString) null, TextRange.INSTANCE.m5303getZerod9O1mEE(), (TextRange) null, 5, (Object) null), startPoint, true, false, SelectionAdjustment.INSTANCE.getWord(), true)));
                    }
                    this.this$0.setHandleState(HandleState.None);
                    this.this$0.dragBeginPosition = startPoint;
                    TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                    textFieldSelectionManager3.m1433setCurrentDragPosition_kEHs6E(Offset.m3033boximpl(textFieldSelectionManager3.dragBeginPosition));
                    this.this$0.dragTotalDistance = Offset.INSTANCE.m3060getZeroF1C5BW0();
                }
            }
            ...
            */
            public void mo1096onDragk4lQ0M(long r10) {
                /*
                    r9 = this;
                ...
                L1c:
                    ...
                    long r10 = androidx.compose.ui.geometry.Offset.m3049plusMKHz9U(r1, r10)
                    ...
                    long r0 = androidx.compose.ui.geometry.Offset.m3049plusMKHz9U(r0, r2)
                    androidx.compose.ui.geometry.Offset r0 = androidx.compose.ui.geometry.Offset.m3033boximpl(r0)
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1429access$setCurrentDragPosition_kEHs6E(r6, r0)
                    ...
                    if (r0 != 0) goto Lb8
                    androidx.compose.ui.geometry.Offset r0 = r6.m1437getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
                    long r0 = r0.getPackedValue()
                    boolean r0 = r10.m1129isPositionOnTextk4lQ0M(r0)
                    if (r0 != 0) goto Lb8
                    ...
                    r3 = 0
                    r0 = r10
                    int r0 = androidx.compose.foundation.text.TextLayoutResultProxy.m1127getOffsetForPosition3MmeM6k$default(r0, r1, r3, r4, r5)
                    ...
                    r0 = r10
                    int r10 = androidx.compose.foundation.text.TextLayoutResultProxy.m1127getOffsetForPosition3MmeM6k$default(r0, r1, r3, r4, r5)
                ...
                L9f:
                    ...
                    r0 = r6
                    r6 = r10
                    long r0 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1430access$updateSelection8UEBfa8(r0, r1, r2, r4, r5, r6, r7)
                    goto L101
                Lb8:
                    java.lang.Integer r0 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginOffsetInText$p(r6)
                    if (r0 == 0) goto Lc3
                ...
                Lc3:
                    long r0 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginPosition$p(r6)
                    int r0 = r10.m1128getOffsetForPosition3MmeM6k(r0, r11)
                Lcb:
                    androidx.compose.ui.geometry.Offset r1 = r6.m1437getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r1)
                    long r1 = r1.getPackedValue()
                    int r10 = r10.m1128getOffsetForPosition3MmeM6k(r1, r11)
                ...
                Le3:
                    androidx.compose.ui.text.input.TextFieldValue r1 = r6.getValue$foundation_release()
                    androidx.compose.ui.geometry.Offset r10 = r6.m1437getCurrentDragPosition_m7T9E()
                    ...
                    long r0 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1430access$updateSelection8UEBfa8(r0, r1, r2, r4, r5, r6, r7)
                L101:
                    androidx.compose.ui.text.TextRange.m5286boximpl(r0)
                L104:
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager r10 = r9.this$0
                ...
                L109:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1.mo1096onDragk4lQ0M(long):void");
            }
            ...
            private final void onEnd() {
                ...
                this.this$0.m1433setCurrentDragPosition_kEHs6E(null);
                this.this$0.updateFloatingToolbar(true);
                this.this$0.dragBeginOffsetInText = null;
                boolean zM5292getCollapsedimpl = TextRange.m5292getCollapsedimpl(this.this$0.getValue$foundation_release().getSelection());
                this.this$0.setHandleState(zM5292getCollapsedimpl ? HandleState.Cursor : HandleState.Selection);
                LegacyTextFieldState state = this.this$0.getState();
                if (state != null) {
                    state.setShowSelectionHandleStart(!zM5292getCollapsedimpl && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, true));
                }
                LegacyTextFieldState state2 = this.this$0.getState();
                if (state2 != null) {
                    state2.setShowSelectionHandleEnd(!zM5292getCollapsedimpl && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, false));
                }
                LegacyTextFieldState state3 = this.this$0.getState();
                if (state3 == null) {
                    return;
                }
                state3.setShowCursorHandle(zM5292getCollapsedimpl && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, true));
            }
        };
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo1309onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                LegacyTextFieldState state;
                if (!this.this$0.getEnabled() || this.this$0.getValue$foundation_release().getText().length() == 0 || (state = this.this$0.getState()) == null || state.getLayoutResult() == null) {
                    return false;
                }
            ...
            public final void updateMouseSelection(TextFieldValue value, long currentPosition, boolean isStartOfSelection, SelectionAdjustment adjustment) {
                this.this$0.setHandleState(TextRange.m5292getCollapsedimpl(this.this$0.m1434updateSelection8UEBfa8(value, currentPosition, isStartOfSelection, false, adjustment, false)) ? HandleState.Cursor : HandleState.Selection);
            }
        };
    }
    ...
    public final void m1433setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m1437getCurrentDragPosition_m7T9E() {
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo1095onDownk4lQ0M(long point) {
                ...
                long jM1380getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1380getAdjustedCoordinatesk4lQ0M(this.this$0.m1439getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                LegacyTextFieldState state = this.this$0.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return;
                }
                long jM1131translateInnerToDecorationCoordinatesMKHz9U$foundation_release = layoutResult.m1131translateInnerToDecorationCoordinatesMKHz9U$foundation_release(jM1380getAdjustedCoordinatesk4lQ0M);
                this.this$0.dragBeginPosition = jM1131translateInnerToDecorationCoordinatesMKHz9U$foundation_release;
                this.this$0.m1433setCurrentDragPosition_kEHs6E(Offset.m3033boximpl(jM1131translateInnerToDecorationCoordinatesMKHz9U$foundation_release));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m3060getZeroF1C5BW0();
                this.this$0.previousRawDragOffset = -1;
                LegacyTextFieldState state2 = this.this$0.getState();
                if (state2 != null) {
            ...
            public void mo1096onDragk4lQ0M(long delta) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m3049plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m1433setCurrentDragPosition_kEHs6E(Offset.m3033boximpl(Offset.m3049plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, this.this$0.dragTotalDistance)));
                TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                TextFieldValue value$foundation_release = textFieldSelectionManager3.getValue$foundation_release();
                Offset offsetM1437getCurrentDragPosition_m7T9E = this.this$0.m1437getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM1437getCurrentDragPosition_m7T9E);
                textFieldSelectionManager3.m1434updateSelection8UEBfa8(value$foundation_release, offsetM1437getCurrentDragPosition_m7T9E.getPackedValue(), false, isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate(), true);
                this.this$0.updateFloatingToolbar(false);
            }
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo1097onStartk4lQ0M(long startPoint) {
                TextLayoutResultProxy layoutResult;
                long jM1380getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1380getAdjustedCoordinatesk4lQ0M(this.this$0.m1439getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState state = this.this$0.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return;
                }
            ...
            public void mo1096onDragk4lQ0M(long delta) {
                ...
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m1433setCurrentDragPosition_kEHs6E(Offset.m3033boximpl(Offset.m3049plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                OffsetMapping offsetMapping = textFieldSelectionManager2.getOffsetMapping();
                Offset offsetM1437getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m1437getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM1437getCurrentDragPosition_m7T9E);
                int iTransformedToOriginal = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1127getOffsetForPosition3MmeM6k$default(layoutResult, offsetM1437getCurrentDragPosition_m7T9E.getPackedValue(), false, 2, null));
                long jTextRange = TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal);
                if (TextRange.m5291equalsimpl0(jTextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m1431createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), jTextRange));
            }
    ...
    public static /* synthetic */ void m1432deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m1436deselect_kEHs6E$foundation_release(offset);
    }

    /* renamed from: deselect-_kEHs6E$foundation_release, reason: not valid java name */
    public final void m1436deselect_kEHs6E$foundation_release(Offset position) {
        int iM5295getMaximpl;
        if (!TextRange.m5292getCollapsedimpl(getValue$foundation_release().getSelection())) {
            LegacyTextFieldState legacyTextFieldState = this.state;
            ...
            if (position != null && layoutResult != null) {
                iM5295getMaximpl = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1127getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null));
            } else {
                iM5295getMaximpl = TextRange.m5295getMaximpl(getValue$foundation_release().getSelection());
            }
            this.onValueChange.invoke(TextFieldValue.m5561copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(iM5295getMaximpl), (TextRange) null, 5, (Object) null));
        }
    ...
    public final void m1441setSelectionPreviewHighlight5zctL8$foundation_release(long range) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1058setSelectionPreviewHighlightRange5zctL8(range);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1055setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5303getZerod9O1mEE());
        }
        if (TextRange.m5292getCollapsedimpl(range)) {
            return;
        }
    ...
    public final void m1440setDeletionPreviewHighlight5zctL8$foundation_release(long range) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1055setDeletionPreviewHighlightRange5zctL8(range);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1058setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5303getZerod9O1mEE());
        }
        if (TextRange.m5292getCollapsedimpl(range)) {
            return;
        }
    ...
    public final void clearPreviewHighlight$foundation_release() {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1055setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5303getZerod9O1mEE());
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 == null) {
            return;
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        ...
        if (cancelSelection) {
            int iM5295getMaximpl = TextRange.m5295getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m1431createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iM5295getMaximpl, iM5295getMaximpl)));
            setHandleState(HandleState.None);
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        int iM5296getMinimpl = TextRange.m5296getMinimpl(getValue$foundation_release().getSelection()) + text.length();
        this.onValueChange.invoke(m1431createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM5296getMinimpl, iM5296getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int iM5296getMinimpl = TextRange.m5296getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m1431createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM5296getMinimpl, iM5296getMinimpl)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue textFieldValueM1431createTextFieldValueFDrldGo = m1431createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(textFieldValueM1431createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m5561copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, textFieldValueM1431createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
        enterSelectionMode$foundation_release(true);
    }

    /* renamed from: getHandlePosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m1439getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        TextLayoutResultProxy layoutResult;
        ...
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(value, this.offsetMapping.originalToTransformed(isStartHandle ? TextRange.m5298getStartimpl(selection) : TextRange.m5293getEndimpl(selection)), isStartHandle, TextRange.m5297getReversedimpl(getValue$foundation_release().getSelection()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m1438getCursorPositiontuRUvjQ$foundation_release(Density density) {
        int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m5298getStartimpl(getValue$foundation_release().getSelection()));
        LegacyTextFieldState legacyTextFieldState = this.state;
        TextLayoutResultProxy layoutResult = legacyTextFieldState != null ? legacyTextFieldState.getLayoutResult() : null;
        ...
        return OffsetKt.Offset(cursorRect.getLeft() + (density.mo397toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2), cursorRect.getBottom());
    }
    ...
    public final void showSelectionToolbar$foundation_release() {
        ...
        if (getEnabled()) {
            ...
            if (legacyTextFieldState == null || legacyTextFieldState.isInTouchMode()) {
                ...
                Function0<Unit> function0 = (TextRange.m5292getCollapsedimpl(getValue$foundation_release().getSelection()) || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
                    {
                        super(0);
                    }
                ...
                Function0<Unit> function02 = (TextRange.m5292getCollapsedimpl(getValue$foundation_release().getSelection()) || !getEditable() || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
                    {
                        super(0);
                    }
                ...
                Function0<Unit> function04 = TextRange.m5294getLengthimpl(getValue$foundation_release().getSelection()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
                    {
                        super(0);
                    }
    ...
    public final void m1435contextMenuOpenAdjustmentk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState == null || (layoutResult = legacyTextFieldState.getLayoutResult()) == null) {
            return;
        }
        if (TextRange.m5289containsimpl(getValue$foundation_release().getSelection(), TextLayoutResultProxy.m1127getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null))) {
            return;
        }
        this.previousRawDragOffset = -1;
        m1434updateSelection8UEBfa8(getValue$foundation_release(), position, true, false, SelectionAdjustment.INSTANCE.getWord(), false);
    }
    ...
    private final Rect getContentRect() {
        ...
        if (legacyTextFieldState != null) {
            ...
            if (legacyTextFieldState != null) {
                int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m5298getStartimpl(getValue$foundation_release().getSelection()));
                int iOriginalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m5293getEndimpl(getValue$foundation_release().getSelection()));
                LegacyTextFieldState legacyTextFieldState2 = this.state;
                long jM3060getZeroF1C5BW0 = (legacyTextFieldState2 == null || (layoutCoordinates4 = legacyTextFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m3060getZeroF1C5BW0() : layoutCoordinates4.mo4685localToRootMKHz9U(m1439getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState legacyTextFieldState3 = this.state;
                long jM3060getZeroF1C5BW02 = (legacyTextFieldState3 == null || (layoutCoordinates3 = legacyTextFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m3060getZeroF1C5BW0() : layoutCoordinates3.mo4685localToRootMKHz9U(m1439getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (legacyTextFieldState4 == null || (layoutCoordinates2 = legacyTextFieldState4.getLayoutCoordinates()) == null) {
                    ...
                    fM3045getYimpl = Offset.m3045getYimpl(layoutCoordinates2.mo4685localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(iOriginalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (legacyTextFieldState5 != null && (layoutCoordinates = legacyTextFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    fM3045getYimpl2 = Offset.m3045getYimpl(layoutCoordinates.mo4685localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(iOriginalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m3044getXimpl(jM3060getZeroF1C5BW0), Offset.m3044getXimpl(jM3060getZeroF1C5BW02)), Math.min(fM3045getYimpl, fM3045getYimpl2), Math.max(Offset.m3044getXimpl(jM3060getZeroF1C5BW0), Offset.m3044getXimpl(jM3060getZeroF1C5BW02)), Math.max(Offset.m3045getYimpl(jM3060getZeroF1C5BW0), Offset.m3045getYimpl(jM3060getZeroF1C5BW02)) + (Dp.m5844constructorimpl(25) * legacyTextFieldState.getTextDelegate().getDensity().getDensity()));
            }
        }
    ...
    public final long m1434updateSelection8UEBfa8(TextFieldValue value, long currentPosition, boolean isStartOfSelection, boolean isStartHandle, SelectionAdjustment adjustment, boolean isTouchBasedSelection) {
        TextLayoutResultProxy layoutResult;
        HapticFeedback hapticFeedback;
        int i;
        LegacyTextFieldState legacyTextFieldState = this.state;
        ...
        long jTextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m5298getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m5293getEndimpl(value.getSelection())));
        boolean z = false;
        int iM1128getOffsetForPosition3MmeM6k = layoutResult.m1128getOffsetForPosition3MmeM6k(currentPosition, false);
        int iM5298getStartimpl = (isStartHandle || isStartOfSelection) ? iM1128getOffsetForPosition3MmeM6k : TextRange.m5298getStartimpl(jTextRange);
        int iM5293getEndimpl = (!isStartHandle || isStartOfSelection) ? iM1128getOffsetForPosition3MmeM6k : TextRange.m5293getEndimpl(jTextRange);
        ...
        SelectionLayout selectionLayoutM1383getTextFieldSelectionLayoutRcvTLA = SelectionLayoutKt.m1383getTextFieldSelectionLayoutRcvTLA(layoutResult.getValue(), iM5298getStartimpl, iM5293getEndimpl, i2, jTextRange, isStartOfSelection, isStartHandle);
        if (!selectionLayoutM1383getTextFieldSelectionLayoutRcvTLA.shouldRecomputeSelection(selectionLayout)) {
            return value.getSelection();
        }
        this.previousSelectionLayout = selectionLayoutM1383getTextFieldSelectionLayoutRcvTLA;
        this.previousRawDragOffset = iM1128getOffsetForPosition3MmeM6k;
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM1383getTextFieldSelectionLayoutRcvTLA);
        ...
        if (TextRange.m5291equalsimpl0(jTextRange2, value.getSelection())) {
            return value.getSelection();
        }
        boolean z2 = TextRange.m5297getReversedimpl(jTextRange2) != TextRange.m5297getReversedimpl(value.getSelection()) && TextRange.m5291equalsimpl0(TextRangeKt.TextRange(TextRange.m5293getEndimpl(jTextRange2), TextRange.m5298getStartimpl(jTextRange2)), value.getSelection());
        boolean z3 = TextRange.m5292getCollapsedimpl(jTextRange2) && TextRange.m5292getCollapsedimpl(value.getSelection());
        if (isTouchBasedSelection && value.getText().length() > 0 && !z2 && !z3 && (hapticFeedback = this.hapticFeedBack) != null) {
            hapticFeedback.mo4065performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m4074getTextHandleMove5zf0vsI());
        }
        this.onValueChange.invoke(m1431createTextFieldValueFDrldGo(value.getAnnotatedString(), jTextRange2));
        if (!isTouchBasedSelection) {
            updateFloatingToolbar(!TextRange.m5292getCollapsedimpl(jTextRange2));
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
        ...
        if (legacyTextFieldState3 != null) {
            legacyTextFieldState3.setShowSelectionHandleStart(!TextRange.m5292getCollapsedimpl(jTextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, true));
        }
        LegacyTextFieldState legacyTextFieldState4 = this.state;
        if (legacyTextFieldState4 != null) {
            legacyTextFieldState4.setShowSelectionHandleEnd(!TextRange.m5292getCollapsedimpl(jTextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, false));
        }
        LegacyTextFieldState legacyTextFieldState5 = this.state;
        if (legacyTextFieldState5 != null) {
            if (TextRange.m5292getCollapsedimpl(jTextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, true)) {
                z = true;
            }
    ...
    public final TextFieldValue m1431createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
