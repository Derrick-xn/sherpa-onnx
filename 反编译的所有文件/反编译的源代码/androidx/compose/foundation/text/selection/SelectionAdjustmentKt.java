...
public final class SelectionAdjustmentKt {
    ...
    public static final Selection.AnchorInfo updateSelectionBoundary(final SelectionLayout selectionLayout, final SelectableInfo selectableInfo, Selection.AnchorInfo anchorInfo) {
        ...
        Lazy lazy2 = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new Function0<Selection.AnchorInfo>() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustmentKt$updateSelectionBoundary$anchorSnappedToWordBoundary$2
            ...
            public final Selection.AnchorInfo invoke() {
                return SelectionAdjustmentKt.snapToWordBoundary(selectableInfo, SelectionAdjustmentKt.updateSelectionBoundary$lambda$0(lazy), i, rawEndHandleOffset, selectionLayout.getIsStartHandle(), selectionLayout.getCrossStatus() == CrossStatus.CROSSED);
            }
        });
        ...
        long jM5272getWordBoundaryjx7JFs = selectableInfo.getTextLayoutResult().m5272getWordBoundaryjx7JFs(offset);
        if (!isExpanding(selectableInfo, rawStartHandleOffset, selectionLayout.getIsStartHandle())) {
            return selectableInfo.anchorForOffset(rawStartHandleOffset);
        }
        if (offset == TextRange.m5298getStartimpl(jM5272getWordBoundaryjx7JFs) || offset == TextRange.m5293getEndimpl(jM5272getWordBoundaryjx7JFs)) {
            return updateSelectionBoundary$lambda$1(lazy2);
        }
        return selectableInfo.anchorForOffset(rawStartHandleOffset);
    }
    ...
    public static final Selection.AnchorInfo snapToWordBoundary(SelectableInfo selectableInfo, int i, int i2, int i3, boolean z, boolean z2) {
        int lineStart;
        int lineEnd$default;
        long jM5272getWordBoundaryjx7JFs = selectableInfo.getTextLayoutResult().m5272getWordBoundaryjx7JFs(i2);
        if (selectableInfo.getTextLayoutResult().getLineForOffset(TextRange.m5298getStartimpl(jM5272getWordBoundaryjx7JFs)) == i) {
            lineStart = TextRange.m5298getStartimpl(jM5272getWordBoundaryjx7JFs);
        ...
        if (selectableInfo.getTextLayoutResult().getLineForOffset(TextRange.m5293getEndimpl(jM5272getWordBoundaryjx7JFs)) == i) {
            lineEnd$default = TextRange.m5293getEndimpl(jM5272getWordBoundaryjx7JFs);
        } else if (i >= selectableInfo.getTextLayoutResult().getLineCount()) {
    ...
    private static final Selection.AnchorInfo anchorOnBoundary(SelectableInfo selectableInfo, boolean z, boolean z2, int i, BoundaryFunction boundaryFunction) {
        ...
        long jMo1364getBoundaryfzxv0v0 = boundaryFunction.mo1364getBoundaryfzxv0v0(selectableInfo, rawStartHandleOffset);
        return selectableInfo.anchorForOffset(z ^ z2 ? TextRange.m5298getStartimpl(jMo1364getBoundaryfzxv0v0) : TextRange.m5293getEndimpl(jMo1364getBoundaryfzxv0v0));
    }
