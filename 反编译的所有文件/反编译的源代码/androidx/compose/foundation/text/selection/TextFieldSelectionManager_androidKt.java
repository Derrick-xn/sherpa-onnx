...
public final class TextFieldSelectionManager_androidKt {
    ...
    public static final Modifier textFieldMagnifier(Modifier modifier, TextFieldSelectionManager textFieldSelectionManager) {
        return !Magnifier_androidKt.isPlatformMagnifierSupported$default(0, 1, null) ? modifier : ComposedModifierKt.composed$default(modifier, null, new C03431(textFieldSelectionManager), 1, null);
    }
    ...
    static final class C03431 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        final /* synthetic */ TextFieldSelectionManager $manager;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03431(TextFieldSelectionManager textFieldSelectionManager) {
            super(3);
            ...
            if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3033boximpl(m1443invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1443invokeF1C5BW0() {
                        return TextFieldSelectionManagerKt.m1442calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, TextFieldSelectionManager_androidKt.C03431.invoke$lambda$1(mutableState));
                    }
                };
                    ...
                    public final Modifier invoke2(final Function0<Offset> function02) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m3033boximpl(m1444invoketuRUvjQ(density2));
                            }

                            /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
                            public final long m1444invoketuRUvjQ(Density density2) {
                                return function02.invoke().getPackedValue();
                            }
                        };
                        final Density density2 = density;
                        final MutableState<IntSize> mutableState2 = mutableState;
                        return Magnifier_androidKt.m330magnifierjPUL71Q$default(companion, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                                m1445invokeEaSLcWc(dpSize.getPackedValue());
                            ...
                            public final void m1445invokeEaSLcWc(long j) {
                                ...
                                TextFieldSelectionManager_androidKt.C03431.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo391roundToPx0680j_4(DpSize.m5942getWidthD9Ej5fM(j)), density3.mo391roundToPx0680j_4(DpSize.m5940getHeightD9Ej5fM(j))));
                            }
    ...
    public static final Function1<ContextMenuScope, Unit> contextMenuBuilder(final TextFieldSelectionManager textFieldSelectionManager, final ContextMenuState contextMenuState) {
        return new Function1<ContextMenuScope, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt.contextMenuBuilder.1
            ...
            public final void invoke2(ContextMenuScope contextMenuScope) {
                ...
                boolean z2 = !TextRange.m5292getCollapsedimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
                ...
                boolean z6 = TextRange.m5294getLengthimpl(textFieldSelectionManager.getValue$foundation_release().getSelection()) != textFieldSelectionManager.getValue$foundation_release().getText().length();
