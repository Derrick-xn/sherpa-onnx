...
public final class TextFieldSelectionManagerKt {
    ...
    public static final void TextFieldSelectionHandle(final boolean z, final ResolvedTextDirection resolvedTextDirection, final TextFieldSelectionManager textFieldSelectionManager, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = (OffsetProvider) new OffsetProvider() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$TextFieldSelectionHandle$1$1
                    ...
                    public final long mo1008provideF1C5BW0() {
                        return textFieldSelectionManager.m1439getHandlePositiontuRUvjQ$foundation_release(z);
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            boolean zM5297getReversedimpl = TextRange.m5297getReversedimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            int i4 = i2 << 3;
            AndroidSelectionHandles_androidKt.m1360SelectionHandlepzduO1o(offsetProvider, z, resolvedTextDirection, zM5297getReversedimpl, 0L, SuspendingPointerInputFilterKt.pointerInput(companion, textDragObserver, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue3), composerStartRestartGroup, (i4 & 112) | (i4 & 896), 16);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final boolean isSelectionHandleInVisibleBound(TextFieldSelectionManager textFieldSelectionManager, boolean z) {
        ...
        return SelectionManagerKt.m1417containsInclusiveUv8p0NA(rectVisibleBounds, textFieldSelectionManager.m1439getHandlePositiontuRUvjQ$foundation_release(z));
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m1442calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager textFieldSelectionManager, long j) {
        int iM5298getStartimpl;
        TextLayoutResultProxy layoutResult;
        TextDelegate textDelegate;
        AnnotatedString text;
        Offset offsetM1437getCurrentDragPosition_m7T9E = textFieldSelectionManager.m1437getCurrentDragPosition_m7T9E();
        if (offsetM1437getCurrentDragPosition_m7T9E == null) {
            return Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
        }
        long packedValue = offsetM1437getCurrentDragPosition_m7T9E.getPackedValue();
        ...
        if (i == 1 || i == 2) {
            iM5298getStartimpl = TextRange.m5298getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM5298getStartimpl = TextRange.m5293getEndimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
        }
        LegacyTextFieldState state = textFieldSelectionManager.getState();
        ...
        int iCoerceIn = RangesKt.coerceIn(textFieldSelectionManager.getOffsetMapping().originalToTransformed(iM5298getStartimpl), 0, text.length());
        float fM3044getXimpl = Offset.m3044getXimpl(layoutResult.m1130translateDecorationToInnerCoordinatesMKHz9U$foundation_release(packedValue));
