...
public final class AndroidSelectionHandles_androidKt {
    ...
    */
    public static final void m1360SelectionHandlepzduO1o(final androidx.compose.foundation.text.selection.OffsetProvider r18, final boolean r19, final androidx.compose.ui.text.style.ResolvedTextDirection r20, final boolean r21, long r22, final androidx.compose.ui.Modifier r24, androidx.compose.runtime.Composer r25, final int r26, final int r27) {
        /*
            Method dump skipped, instructions count: 451
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.m1360SelectionHandlepzduO1o(androidx.compose.foundation.text.selection.OffsetProvider, boolean, androidx.compose.ui.text.style.ResolvedTextDirection, boolean, long, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void SelectionHandleIcon(final Modifier modifier, final Function0<Boolean> function0, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m758sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), function0, z), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Modifier drawSelectionHandle(Modifier modifier, final Function0<Boolean> function0, final boolean z) {
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.drawSelectionHandle.1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                final long jM1447getHandleColor0d7_KjU = ((TextSelectionColors) objConsume).getHandleColor();
                ComposerKt.sourceInformationMarkerStart(composer, 1976982956, "CC(remember):AndroidSelectionHandles.android.kt#9igjgp");
                boolean zChanged = composer.changed(jM1447getHandleColor0d7_KjU) | composer.changed(function0) | composer.changed(z);
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, Size.m3113getWidthimpl(cacheDrawScope.m2934getSizeNHjbRc()) / 2.0f);
                            final ColorFilter colorFilterM3365tintxETnrds$default = ColorFilter.Companion.m3365tintxETnrds$default(ColorFilter.INSTANCE, jM1447getHandleColor0d7_KjU, 0, 2, null);
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    if (function03.invoke().booleanValue()) {
                                        if (z3) {
                                            ...
                                            ColorFilter colorFilter = colorFilterM3365tintxETnrds$default;
                                            long jMo3805getCenterF1C5BW0 = contentDrawScope2.mo3805getCenterF1C5BW0();
                                            ...
                                            try {
                                                ...
                                                DrawScope.CC.m3881drawImagegbVJVH8$default(contentDrawScope2, imageBitmap, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                                return;
                                            } finally {
                                        ...
                                        DrawScope.CC.m3881drawImagegbVJVH8$default(contentDrawScope, imageBitmapCreateHandleImage, 0L, 0.0f, null, colorFilterM3365tintxETnrds$default, 0, 46, null);
                                    }
                                }
                            });
                        }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m3558ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m3552getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m3812setSizeuvyYCjk(jSize);
        canvas2.save();
        CanvasDrawScope canvasDrawScope3 = canvasDrawScope2;
        DrawScope.CC.m3891drawRectnJ9OG0$default(canvasDrawScope3, Color.INSTANCE.m3350getBlack0d7_KjU(), 0L, canvasDrawScope3.mo3806getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m3223getClear0nO6VwU(), 58, null);
        DrawScope.CC.m3891drawRectnJ9OG0$default(canvasDrawScope3, ColorKt.Color(4278190080L), Offset.INSTANCE.m3060getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        DrawScope.CC.m3878drawCircleVaOC9Bg$default(canvasDrawScope3, ColorKt.Color(4278190080L), f, OffsetKt.Offset(f, f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        canvas2.restore();
