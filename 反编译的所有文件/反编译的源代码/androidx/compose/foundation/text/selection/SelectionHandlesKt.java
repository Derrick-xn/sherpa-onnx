...
public final class SelectionHandlesKt {
    ...
    public static final long m1380getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m3044getXimpl(j), Offset.m3045getYimpl(j) - 1.0f);
    }
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m5844constructorimpl(f);
        HandleHeight = Dp.m5844constructorimpl(f);
    }
}