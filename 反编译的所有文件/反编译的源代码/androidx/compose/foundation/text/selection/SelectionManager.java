...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3033boximpl(Offset.INSTANCE.m3060getZeroF1C5BW0()), null, 2, null);

    /* renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3033boximpl(Offset.INSTANCE.m3060getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrarImpl) {
        ...
        selectionRegistrarImpl.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m1412invokeRg1IO4c(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Rg1IO4c, reason: not valid java name */
            public final void m1412invokeRg1IO4c(boolean z, LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment) {
                long jMo4682getSizeYbymL2g = layoutCoordinates.mo4682getSizeYbymL2g();
                Rect rect = new Rect(0.0f, 0.0f, IntSize.m6018getWidthimpl(jMo4682getSizeYbymL2g), IntSize.m6017getHeightimpl(jMo4682getSizeYbymL2g));
                if (!SelectionManagerKt.m1417containsInclusiveUv8p0NA(rect, j)) {
                    j = TextLayoutStateKt.m1257coerceIn3MmeM6k(j, rect);
                }
                long jM1396convertToContainerCoordinatesR5De75A = SelectionManager.this.m1396convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                if (OffsetKt.m3063isSpecifiedk4lQ0M(jM1396convertToContainerCoordinatesR5De75A)) {
                    SelectionManager.this.setInTouchMode(z);
                    SelectionManager.this.m1403startSelection9KIMszo(jM1396convertToContainerCoordinatesR5De75A, false, selectionAdjustment);
        ...
        selectionRegistrarImpl.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool2, SelectionAdjustment selectionAdjustment) {
                return m1413invokepGV3PM0(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool2.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-pGV3PM0, reason: not valid java name */
            public final Boolean m1413invokepGV3PM0(boolean z, LayoutCoordinates layoutCoordinates, long j, long j2, boolean z2, SelectionAdjustment selectionAdjustment) {
                long jM1396convertToContainerCoordinatesR5De75A = SelectionManager.this.m1396convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                long jM1396convertToContainerCoordinatesR5De75A2 = SelectionManager.this.m1396convertToContainerCoordinatesR5De75A(layoutCoordinates, j2);
                SelectionManager.this.setInTouchMode(z);
                return Boolean.valueOf(SelectionManager.this.m1411updateSelectionqNKwrvQ$foundation_release(Offset.m3033boximpl(jM1396convertToContainerCoordinatesR5De75A), jM1396convertToContainerCoordinatesR5De75A2, z2, selectionAdjustment));
            }
        });
        selectionRegistrarImpl.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m1398setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrarImpl.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                if (selection != null && (start = selection.getStart()) != null && j == start.getSelectableId()) {
                    SelectionManager.this.m1402setStartHandlePosition_kEHs6E(null);
                }
                ...
                if (selection2 != null && (end = selection2.getEnd()) != null && j == end.getSelectableId()) {
                    SelectionManager.this.m1401setEndHandlePosition_kEHs6E(null);
                }
                if (SelectionManager.this.selectionRegistrar.getSubselections().contains(j)) {
                    SelectionManager.this.updateSelectionToolbar();
                }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1414invokeZmokQxo(keyEvent.m4391unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1414invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean z;
                if (SelectionManager_androidKt.m1419isCopyKeyEventZmokQxo(keyEvent)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM3033boximpl = layoutCoordinates != null ? Offset.m3033boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM3033boximpl)) {
            return;
        }
        this.previousPosition = offsetM3033boximpl;
        updateHandleOffsets();
        updateSelectionToolbar();
    }
    ...
    public final void m1399setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m3033boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1406getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m1400setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m3033boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1407getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance.getValue()).getPackedValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setStartHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m1402setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getStartHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1409getStartHandlePosition_m7T9E() {
        return (Offset) this.startHandlePosition.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setEndHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m1401setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getEndHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1408getEndHandlePosition_m7T9E() {
    ...
    public final void m1398setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m1405getCurrentDragPosition_m7T9E() {
    ...
    */
    public final void updateHandleOffsets() {
        ...
        L42:
            ...
            if (r5 == 0) goto L6f
            r8 = 1
            long r8 = r3.mo1365getHandlePositiondBAh8RU(r0, r8)
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m3065isUnspecifiedk4lQ0M(r8)
            if (r3 == 0) goto L54
            goto L6f
        L54:
            long r8 = r1.mo4683localPositionOfR5De75A(r5, r8)
            androidx.compose.ui.geometry.Offset r3 = androidx.compose.ui.geometry.Offset.m3033boximpl(r8)
            ...
            if (r5 == r10) goto L70
            boolean r5 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1417containsInclusiveUv8p0NA(r7, r8)
            if (r5 == 0) goto L6f
            goto L70
        L6f:
            r3 = r2
        L70:
            r11.m1402setStartHandlePosition_kEHs6E(r3)
            if (r6 == 0) goto L9c
            r3 = 0
            long r3 = r4.mo1365getHandlePositiondBAh8RU(r0, r3)
            boolean r0 = androidx.compose.ui.geometry.OffsetKt.m3065isUnspecifiedk4lQ0M(r3)
            if (r0 == 0) goto L81
            goto L9c
        L81:
            long r0 = r1.mo4683localPositionOfR5De75A(r6, r3)
            ...
            if (r1 == r5) goto L9b
            boolean r1 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1417containsInclusiveUv8p0NA(r7, r3)
            if (r1 == 0) goto L9c
        L9b:
            r2 = r0
        L9c:
            r11.m1401setEndHandlePosition_kEHs6E(r2)
            return
        La0:
            r11.m1402setStartHandlePosition_kEHs6E(r2)
            r11.m1401setEndHandlePosition_kEHs6E(r2)
            return
        */
    ...
    public final void updateSelectionToolbar() {
        ...
        if (getHasFocus() && (textToolbar = this.textToolbar) != null) {
            if (this.showToolbar && isInTouchMode()) {
                ...
                TextToolbar.CC.showMenu$default(textToolbar, contentRect, isNonEmptySelection$foundation_release() ? new C03401(this) : null, null, null, isEntireContainerSelected$foundation_release() ? null : new C03412(this), 12, null);
                return;
            }
    ...
    /* synthetic */ class C03401 extends FunctionReferenceImpl implements Function0<Unit> {
        C03401(Object obj) {
    ...
    /* synthetic */ class C03412 extends FunctionReferenceImpl implements Function0<Unit> {
        C03412(Object obj) {
    ...
    private final Rect getContentRect() {
        ...
        Rect rectM3081translatek4lQ0M = rectIntersect.m3081translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(layoutCoordinates));
        return Rect.copy$default(rectM3081translatek4lQ0M, 0.0f, 0.0f, 0.0f, rectM3081translatek4lQ0M.getBottom() + (SelectionHandlesKt.getHandleHeight() * 4), 7, null);
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo1095onDownk4lQ0M(long point) {
                LayoutCoordinates layoutCoordinates;
                Offset offsetM1409getStartHandlePosition_m7T9E = isStartHandle ? this.m1409getStartHandlePosition_m7T9E() : this.m1408getEndHandlePosition_m7T9E();
                if (offsetM1409getStartHandlePosition_m7T9E != null) {
                    offsetM1409getStartHandlePosition_m7T9E.getPackedValue();
                    ...
                    long jMo1365getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo1365getHandlePositiondBAh8RU(selection, isStartHandle);
                    if (OffsetKt.m3065isUnspecifiedk4lQ0M(jMo1365getHandlePositiondBAh8RU)) {
                        return;
                    }
                    long jM1380getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1380getAdjustedCoordinatesk4lQ0M(jMo1365getHandlePositiondBAh8RU);
                    SelectionManager selectionManager = this;
                    selectionManager.m1398setCurrentDragPosition_kEHs6E(Offset.m3033boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo4683localPositionOfR5De75A(layoutCoordinates, jM1380getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo1097onStartk4lQ0M(long startPoint) {
                ...
                long jMo1365getHandlePositiondBAh8RU = selectable2.mo1365getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3065isUnspecifiedk4lQ0M(jMo1365getHandlePositiondBAh8RU)) {
                    return;
                }
                long jM1380getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1380getAdjustedCoordinatesk4lQ0M(jMo1365getHandlePositiondBAh8RU);
                SelectionManager selectionManager = this;
                selectionManager.m1399setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo4683localPositionOfR5De75A(layoutCoordinates, jM1380getAdjustedCoordinatesk4lQ0M));
                this.m1400setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3060getZeroF1C5BW0());
            }
            ...
            public void mo1096onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1400setDragTotalDistancek4lQ0M(Offset.m3049plusMKHz9U(selectionManager.m1407getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long jM3049plusMKHz9U = Offset.m3049plusMKHz9U(this.m1406getDragBeginPositionF1C5BW0$foundation_release(), this.m1407getDragTotalDistanceF1C5BW0$foundation_release());
                if (this.m1411updateSelectionqNKwrvQ$foundation_release(Offset.m3033boximpl(jM3049plusMKHz9U), this.m1406getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    this.m1399setDragBeginPositionk4lQ0M(jM3049plusMKHz9U);
                    this.m1400setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3060getZeroF1C5BW0());
                }
            }
            ...
            private final void done() {
                ...
                this.m1398setCurrentDragPosition_kEHs6E(null);
            }
    ...
    static final class C03372 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03372(Function1<? super Offset, Unit> function1, Continuation<? super C03372> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03372 c03372 = new C03372(this.$onTap, continuation);
            c03372.L$0 = obj;
            return c03372;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C03372) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (pointerInputChange != null) {
                this.$onTap.invoke(Offset.m3033boximpl(pointerInputChange.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope pointerInputScope, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C03372(function1, null), continuation);
    ...
    static final class C03391 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $block;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03391(Function0<Unit> function0, Continuation<? super C03391> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03391 c03391 = SelectionManager.this.new C03391(this.$block, continuation);
            c03391.L$0 = obj;
            return c03391;
        }
            ...
            if (i == 0) {
                ...
                if (selectionManager.detectNonConsumingTap(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m1415invokek4lQ0M(offset.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m1415invokek4lQ0M(long j) {
                        function0.invoke();
                    }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput(modifier, Unit.INSTANCE, new C03391(function0, null)) : modifier;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: convertToContainerCoordinates-R5De75A, reason: not valid java name */
    public final long m1396convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation_release().mo4683localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m1403startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1410updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m3059getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-qNKwrvQ$foundation_release, reason: not valid java name */
    public final boolean m1411updateSelectionqNKwrvQ$foundation_release(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m1410updateSelectionjyLRC_s$foundation_release(newPosition.getPackedValue(), previousPosition, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-jyLRC_s$foundation_release, reason: not valid java name */
    public final boolean m1410updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1398setCurrentDragPosition_kEHs6E(Offset.m3033boximpl(position));
        SelectionLayout selectionLayoutM1397getSelectionLayoutWko1d7g = m1397getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
        if (!selectionLayoutM1397getSelectionLayoutWko1d7g.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return false;
        }
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM1397getSelectionLayoutWko1d7g);
        if (!Intrinsics.areEqual(selectionAdjust, getSelection())) {
            selectionChanged(selectionLayoutM1397getSelectionLayoutWko1d7g, selectionAdjust);
        }
        this.previousSelectionLayout = selectionLayoutM1397getSelectionLayoutWko1d7g;
        return true;
    }

    /* renamed from: getSelectionLayout-Wko1d7g, reason: not valid java name */
    private final SelectionLayout m1397getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
        ...
        SelectionLayoutBuilder selectionLayoutBuilder = new SelectionLayoutBuilder(position, previousHandlePosition, layoutCoordinatesRequireContainerCoordinates$foundation_release, isStartHandle, OffsetKt.m3065isUnspecifiedk4lQ0M(previousHandlePosition) ? null : getSelection(), new Comparator() { // from class: androidx.compose.foundation.text.selection.SelectionManager$getSelectionLayout-Wko1d7g$$inlined$compareBy$1
            /* JADX WARN: Multi-variable type inference failed */
    ...
    public final void m1404contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection == null || TextRange.m5292getCollapsedimpl(selection.m1371toTextRanged9O1mEE())) {
            m1403startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}