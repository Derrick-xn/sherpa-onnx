...
public final class AndroidCursorHandle_androidKt {
    ...
    */
    public static final void m1004CursorHandleUSBMPiE(final androidx.compose.foundation.text.selection.OffsetProvider r8, final androidx.compose.ui.Modifier r9, final long r10, androidx.compose.runtime.Composer r12, final int r13, final int r14) {
        /*
            Method dump skipped, instructions count: 279
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.m1004CursorHandleUSBMPiE(androidx.compose.foundation.text.selection.OffsetProvider, androidx.compose.ui.Modifier, long, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m758sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final float fM3113getWidthimpl = Size.m3113getWidthimpl(cacheDrawScope.m2934getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, fM3113getWidthimpl);
                            final ColorFilter colorFilterM3365tintxETnrds$default = ColorFilter.Companion.m3365tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    try {
                                        ...
                                        transform.mo3819rotateUv8p0NA(45.0f, Offset.INSTANCE.m3060getZeroF1C5BW0());
    ...
    static {
        float fM5844constructorimpl = Dp.m5844constructorimpl(25);
        CursorHandleHeight = fM5844constructorimpl;
        CursorHandleWidth = Dp.m5844constructorimpl(Dp.m5844constructorimpl(fM5844constructorimpl * 2.0f) / 2.4142137f);
    }
}