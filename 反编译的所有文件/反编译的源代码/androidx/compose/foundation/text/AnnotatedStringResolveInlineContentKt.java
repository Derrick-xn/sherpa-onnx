        ...
        if ((i2 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            while (i4 < size) {
                ...
                AnnotatedStringResolveInlineContentKt$InlineChildren$1$2 annotatedStringResolveInlineContentKt$InlineChildren$1$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                    ...
                    public final MeasureResult mo61measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list2, long j) {
                        ArrayList arrayList = new ArrayList(list2.size());
                        int size2 = list2.size();
                        for (int i5 = 0; i5 < size2; i5++) {
                            arrayList.add(list2.get(i5).mo4680measureBRTryo0(j));
                        }
                        final ArrayList arrayList2 = arrayList;
                        return MeasureScope.CC.layout$default(measureScope, Constraints.m5787getMaxWidthimpl(j), Constraints.m5786getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2.1
                ...
                Updater.m2784setimpl(composerM2777constructorimpl, annotatedStringResolveInlineContentKt$InlineChildren$1$2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
