...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m5303getZerod9O1mEE();
    ...
    public final void m1121setPreviousSelection5zctL8(long j) {
    ...
    public final int m1119getOffsetToFollow5zctL8(long selection) {
        return TextRange.m5298getStartimpl(selection) != TextRange.m5298getStartimpl(this.previousSelection) ? TextRange.m5298getStartimpl(selection) : TextRange.m5293getEndimpl(selection) != TextRange.m5293getEndimpl(this.previousSelection) ? TextRange.m5293getEndimpl(selection) : TextRange.m5296getMinimpl(selection);
    }
