...
public final class InlineDensity {
    ...
    private static final long Unspecified = m1325constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1324boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static long m1326constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1328equalsimpl(long j, Object obj) {
        return (obj instanceof InlineDensity) && j == ((InlineDensity) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1329equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public boolean equals(Object obj) {
        return m1328equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1332hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1327constructorimpl(Density density) {
        return m1325constructorimpl(density.getDensity(), density.getFontScale());
    }

    public String toString() {
        return m1333toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1333toStringimpl(long j) {
        return "InlineDensity(density=" + m1330getDensityimpl(j) + ", fontScale=" + m1331getFontScaleimpl(j) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1335getUnspecifiedL26CHvs() {
            return InlineDensity.Unspecified;
        }
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1325constructorimpl(float f, float f2) {
        return m1326constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* renamed from: getDensity-impl, reason: not valid java name */
    public static final float m1330getDensityimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getFontScale-impl, reason: not valid java name */
    public static final float m1331getFontScaleimpl(long j) {
