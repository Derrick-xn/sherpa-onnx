...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean updateText$foundation_release(AnnotatedString text) {
        ...
        boolean z3 = !Intrinsics.areEqual(this.text.getSpanStyles(), text.getSpanStyles());
        boolean z4 = !Intrinsics.areEqual(this.text.getParagraphStyles(), text.getParagraphStyles());
        boolean z5 = !this.text.hasEqualAnnotations(text);
        if (!z2 && !z3 && !z4 && !z5) {
            z = false;
        }
        if (z) {
    ...
    public final boolean m1358updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m1346updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
        }
        if (getIsAttached()) {
    ...
    public final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1346updateZNqEYIc(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
                ...
                */
                public final java.lang.Boolean invoke(java.util.List<androidx.compose.ui.text.TextLayoutResult> r38) {
                    ...
                    L31:
                        ...
                        r33 = 0
                        r34 = 0
                        androidx.compose.ui.text.TextStyle r5 = androidx.compose.ui.text.TextStyle.m5318mergedA7vx0o$default(r5, r6, r8, r10, r11, r12, r13, r14, r15, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r36)
                        androidx.compose.ui.text.TextLayoutInput r3 = r2.getLayoutInput()
                        ...
                        r7 = 0
                        r4 = 0
                        androidx.compose.ui.text.TextLayoutResult r1 = androidx.compose.ui.text.TextLayoutResult.m5268copyO0kMr_c$default(r2, r3, r4, r6, r7)
                        if (r1 == 0) goto Lb8
                        r2 = r38
                        r2.add(r1)
                        goto Lb9
    ...
    public final MeasureResult m1357measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo114measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo114measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean zM1345layoutWithConstraintsK40F9xA = layoutCache.m1345layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (zM1345layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(Constraints.INSTANCE.m5796fitPrioritizingWidthZbe2FdA(IntSize.m6018getWidthimpl(textLayoutResult.getSize()), IntSize.m6018getWidthimpl(textLayoutResult.getSize()), IntSize.m6017getHeightimpl(textLayoutResult.getSize()), IntSize.m6017getHeightimpl(textLayoutResult.getSize())));
        int iM6018getWidthimpl = IntSize.m6018getWidthimpl(textLayoutResult.getSize());
        int iM6017getHeightimpl = IntSize.m6017getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(iM6018getWidthimpl, iM6017getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (getIsAttached()) {
            ...
            boolean z = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m5765equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5774getVisiblegIe3tQ8());
            if (z) {
            ...
            try {
                ...
                if (brush != null) {
                    multiParagraph.m5169painthn5TExg(canvas, brush, (64 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (64 & 8) != 0 ? null : shadow2, (64 & 16) != 0 ? null : textDecoration2, (64 & 32) != 0 ? null : drawStyle2, (64 & 64) != 0 ? DrawScope.INSTANCE.m3895getDefaultBlendMode0nO6VwU() : 0);
                } else {
                    ...
                    multiParagraph.m5167paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m3360getUnspecified0d7_KjU() : jM3405invoke0d7_KjU, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m3895getDefaultBlendMode0nO6VwU() : 0);
                }
                TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
