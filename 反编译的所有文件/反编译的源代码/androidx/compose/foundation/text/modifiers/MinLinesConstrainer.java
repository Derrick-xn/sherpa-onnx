...
public final class MinLinesConstrainer {
    ...
    public final long m1339coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        ...
        if (Float.isNaN(height) || Float.isNaN(height2)) {
            height = ParagraphKt.m5180ParagraphUdtVg6A(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & 256) != 0 ? false : false).getHeight();
            height2 = ParagraphKt.m5180ParagraphUdtVg6A(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? false : false).getHeight() - height;
            this.oneLineHeightCache = height;
            this.lineHeightCache = height2;
        }
        if (minLines != 1) {
            iM5788getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round(height + (height2 * (minLines - 1))), 0), Constraints.m5786getMaxHeightimpl(inConstraints));
        } else {
            iM5788getMinHeightimpl = Constraints.m5788getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m5789getMinWidthimpl(inConstraints), Constraints.m5787getMaxWidthimpl(inConstraints), iM5788getMinHeightimpl, Constraints.m5786getMaxHeightimpl(inConstraints));
    }
}