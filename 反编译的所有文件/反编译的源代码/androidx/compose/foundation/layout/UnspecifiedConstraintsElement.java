...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m778setMinWidth0680j_4(this.minWidth);
        node.m777setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m5842boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m5842boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5849equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m5849equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m5850hashCodeimpl(this.minWidth) * 31) + Dp.m5850hashCodeimpl(this.minHeight);
    }
}