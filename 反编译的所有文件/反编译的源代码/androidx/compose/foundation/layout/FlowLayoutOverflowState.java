...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final IntIntPair m638ellipsisSizeF35zmw$foundation_layout_release(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
    ...
    public final void m640setOverflowMeasurableshBUhpc$foundation_layout_release(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        long jM680constructorimpl = OrientationIndependentConstraints.m680constructorimpl(constraints, isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical);
        if (seeMoreMeasurable != null) {
            int iMainAxisMin = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m5786getMaxHeightimpl(jM680constructorimpl));
            this.seeMoreSize = IntIntPair.m44boximpl(IntIntPair.m47constructorimpl(iMainAxisMin, FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, iMainAxisMin)));
        ...
        if (collapseMeasurable != null) {
            int iMainAxisMin2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m5786getMaxHeightimpl(jM680constructorimpl));
            this.collapseSize = IntIntPair.m44boximpl(IntIntPair.m47constructorimpl(iMainAxisMin2, FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, iMainAxisMin2)));
    ...
    /* renamed from: setOverflowMeasurables--hBUhpc$foundation_layout_release, reason: not valid java name */
    public final void m639setOverflowMeasurableshBUhpc$foundation_layout_release(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        LayoutOrientation layoutOrientation = measurePolicy.isHorizontal() ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long jM693toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m693toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m682copyyUG9Ft0$default(OrientationIndependentConstraints.m680constructorimpl(constraints, layoutOrientation), 0, 0, 0, 0, 10, null), layoutOrientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m636measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, jM693toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$3$1
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.seeMoreSize = IntIntPair.m44boximpl(IntIntPair.m47constructorimpl(iMainAxisSize, iCrossAxisSize));
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m636measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, jM693toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$4$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.collapseSize = IntIntPair.m44boximpl(IntIntPair.m47constructorimpl(iMainAxisSize, iCrossAxisSize));
    ...
    public final void m641setOverflowMeasurablesVKLhPVY$foundation_layout_release(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        this.itemShown = 0;
        this.getOverflowMeasurable = getOverflowMeasurable;
        m639setOverflowMeasurableshBUhpc$foundation_layout_release(measurePolicy, getOverflowMeasurable.invoke(true, 0), getOverflowMeasurable.invoke(false, 0), constraints);
    }
}