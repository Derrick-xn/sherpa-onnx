...
final class IntrinsicWidthNode extends IntrinsicSizeModifier {
    ...
    public long mo665calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.width == IntrinsicSize.Min) {
            iMaxIntrinsicWidth = measurable.minIntrinsicWidth(Constraints.m5786getMaxHeightimpl(j));
        } else {
            iMaxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m5786getMaxHeightimpl(j));
        }
        if (iMaxIntrinsicWidth < 0) {
            iMaxIntrinsicWidth = 0;
        }
        return Constraints.INSTANCE.m5799fixedWidthOenEA2s(iMaxIntrinsicWidth);
    }
