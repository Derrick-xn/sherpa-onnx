...
public interface RowColumnMeasurePolicy {
    ...
    /* compiled from: RowColumnMeasurePolicy.kt */
    /* renamed from: androidx.compose.foundation.layout.RowColumnMeasurePolicy$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        /* renamed from: createConstraints-xF2OJ5Q$default, reason: not valid java name */
        public static /* synthetic */ long m736createConstraintsxF2OJ5Q$default(RowColumnMeasurePolicy rowColumnMeasurePolicy, int i, int i2, int i3, int i4, boolean z, int i5, Object obj) {
            if (obj == null) {
                return rowColumnMeasurePolicy.mo625createConstraintsxF2OJ5Q(i, i2, i3, i4, (i5 & 16) != 0 ? false : z);
            }
