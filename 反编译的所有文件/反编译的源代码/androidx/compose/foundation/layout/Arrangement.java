...
public final class Arrangement {
    ...
    private static final Horizontal Start = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Start$1
        ...
        public /* synthetic */ float getSpacing() {
            return Arrangement.Horizontal.CC.m594$default$getSpacingD9Ej5fM(this);
        }
    ...
    private static final Vertical Top = new Vertical() { // from class: androidx.compose.foundation.layout.Arrangement$Top$1
        ...
        /* renamed from: getSpacing-D9Ej5fM */
        public /* synthetic */ float getSpacing() {
            return Arrangement.Vertical.CC.m604$default$getSpacingD9Ej5fM(this);
        }
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m5844constructorimpl(0);
    ...
    public interface Horizontal {
        ...
        public final /* synthetic */ class CC {
            ...
            public static float m594$default$getSpacingD9Ej5fM(Horizontal _this) {
        ...
        public static final class DefaultImpls {
            ...
            public static float m596getSpacingD9Ej5fM(Horizontal horizontal) {
                return CC.m594$default$getSpacingD9Ej5fM(horizontal);
            }
        }
    }
    ...
    public interface Vertical {
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m604$default$getSpacingD9Ej5fM(Vertical _this) {
                return Dp.m5844constructorimpl(0);
            }
        }
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m606getSpacingD9Ej5fM(Vertical vertical) {
                return CC.m604$default$getSpacingD9Ej5fM(vertical);
            }
        }
    }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m597$default$getSpacingD9Ej5fM(HorizontalOrVertical _this) {
                return Dp.m5844constructorimpl(0);
            }
        }
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m599getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
                return CC.m597$default$getSpacingD9Ej5fM(horizontalOrVertical);
            }
        }
    }
    ...
    public final HorizontalOrVertical m587spacedBy0680j_4(float space) {
    ...
    public final Horizontal m588spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
    ...
    /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Vertical m589spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        return new SpacedAligned(Dp.m5844constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement.aligned.1
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        return new SpacedAligned(Dp.m5844constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement.aligned.2
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4, reason: not valid java name */
        public final HorizontalOrVertical m590spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, null, 0 == true ? 1 : 0);
        }

        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Horizontal m591spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
        ...
        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Vertical m592spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            return new SpacedAligned(Dp.m5844constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                {
                    super(2);
                }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m600copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m602copy8Feqmps(f, z, function2);
        }
        ...
        public final SpacedAligned m602copy8Feqmps(float space, boolean rtlMirror, Function2<? super Integer, ? super LayoutDirection, Integer> alignment) {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m5849equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }

        public int hashCode() {
            int iM5850hashCodeimpl = ((Dp.m5850hashCodeimpl(this.space) * 31) + UByte$$ExternalSyntheticBackport0.m(this.rtlMirror)) * 31;
            Function2<Integer, LayoutDirection, Integer> function2 = this.alignment;
            return iM5850hashCodeimpl + (function2 == null ? 0 : function2.hashCode());
        }
        ...
        public final float m603getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public void arrange(Density density, int i, int[] iArr, LayoutDirection layoutDirection, int[] iArr2) {
            ...
            int iMo391roundToPx0680j_4 = density.mo391roundToPx0680j_4(this.space);
            ...
            if (!z) {
                ...
                while (i3 < length) {
                    ...
                    iArr2[i4] = iMin2;
                    int iMin3 = Math.min(iMo391roundToPx0680j_4, (i - iMin2) - i5);
                ...
                for (int length2 = iArr.length - 1; -1 < length2; length2--) {
                    ...
                    iArr2[length2] = iMin4;
                    iMin = Math.min(iMo391roundToPx0680j_4, (i - iMin4) - i7);
        ...
        public String toString() {
            ...
            sb.append((Object) Dp.m5855toStringimpl(this.space));
            sb.append(", ");
