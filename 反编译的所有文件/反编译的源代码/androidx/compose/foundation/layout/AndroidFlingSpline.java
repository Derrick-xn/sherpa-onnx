...
final class AndroidFlingSpline {
    ...
    public final long m577flingPositionLfoxSSI(float time) {
        float f;
        float f2;
        float f3 = 100;
        int i = (int) (f3 * time);
        ...
        return FlingResult.m579constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m578boximpl(long j) {
        ...
        public static boolean m580equalsimpl(long j, Object obj) {
        ...
        public static int m584hashCodeimpl(long j) {
        ...
        public boolean equals(Object obj) {
            return m580equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m584hashCodeimpl(this.packedValue);
        }
        ...
        public static final float m582getDistanceCoefficientimpl(long j) {
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m583getVelocityCoefficientimpl(long j) {
