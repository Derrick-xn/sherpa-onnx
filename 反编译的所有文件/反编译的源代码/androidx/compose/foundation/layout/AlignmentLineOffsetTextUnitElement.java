...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m6042hashCodeimpl(this.before)) * 31) + TextUnit.m6042hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetTextUnitElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m6038equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m6038equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m576setBeforeR2X_6o(this.before);
        node.m575setAfterR2X_6o(this.after);
    }
}