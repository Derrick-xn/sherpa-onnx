...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m622copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m624copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m624copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m5780equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m5790hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m5792toStringimpl(this.constraints)) + ')';
    }
    ...
    public long mo617getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinWidth-D9Ej5fM */
    public float mo621getMinWidthD9Ej5fM() {
        return this.density.mo394toDpu2uoSUM(Constraints.m5789getMinWidthimpl(mo617getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo619getMaxWidthD9Ej5fM() {
        return Constraints.m5783getHasBoundedWidthimpl(mo617getConstraintsmsEJaDk()) ? this.density.mo394toDpu2uoSUM(Constraints.m5787getMaxWidthimpl(mo617getConstraintsmsEJaDk())) : Dp.INSTANCE.m5863getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo620getMinHeightD9Ej5fM() {
        return this.density.mo394toDpu2uoSUM(Constraints.m5788getMinHeightimpl(mo617getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo618getMaxHeightD9Ej5fM() {
        return Constraints.m5782getHasBoundedHeightimpl(mo617getConstraintsmsEJaDk()) ? this.density.mo394toDpu2uoSUM(Constraints.m5786getMaxHeightimpl(mo617getConstraintsmsEJaDk())) : Dp.INSTANCE.m5863getInfinityD9Ej5fM();
    }
}