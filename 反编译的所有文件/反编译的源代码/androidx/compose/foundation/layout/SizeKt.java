...
public final class SizeKt {
    ...
    public static final Modifier m761width3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m742height3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m757size6HolHcs(Modifier modifier, long j) {
        return m758sizeVpY3zN4(modifier, DpSize.m5942getWidthD9Ej5fM(j), DpSize.m5940getHeightD9Ej5fM(j));
    }

    /* renamed from: widthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m763widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m762widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m762widthInVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m5842boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m5842boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m744heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m743heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m743heightInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m760sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM();
        }
        return m759sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m759sizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
        return modifier.then(new SizeElement(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m5842boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m5842boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m5842boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m5842boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m753requiredWidth3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m745requiredHeight3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m749requiredSize6HolHcs(Modifier modifier, long j) {
        return m750requiredSizeVpY3zN4(modifier, DpSize.m5942getWidthD9Ej5fM(j), DpSize.m5940getHeightD9Ej5fM(j));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m755requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m754requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m754requiredWidthInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m747requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m746requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m746requiredHeightInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m752requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m751requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m751requiredSizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
    ...
    public static /* synthetic */ Modifier m741defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m740defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m740defaultMinSizeVpY3zN4(Modifier modifier, float f, float f2) {
        return modifier.then(new UnspecifiedConstraintsElement(f, f2, null));
    }

    /* renamed from: size-3ABfNKs, reason: not valid java name */
    public static final Modifier m756size3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m758sizeVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName("size");
                inspectorInfo.getProperties().set("width", Dp.m5842boximpl(f));
                inspectorInfo.getProperties().set("height", Dp.m5842boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-3ABfNKs, reason: not valid java name */
    public static final Modifier m748requiredSize3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m750requiredSizeVpY3zN4(Modifier modifier, final float f, final float f2) {
