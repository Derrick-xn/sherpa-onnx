...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public final void requestAnimationController() {
        ...
        if (windowInsetsController != null) {
            windowInsetsController.controlWindowInsetsAnimation(this.windowInsets.getType(), -1L, null, this.cancellationSignal, ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) this));
        }
    }
    ...
    public long mo509onPreScrollOzD1aCk(long available, int source) {
        return m785scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m3044getXimpl(available), Offset.m3045getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo507onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m785scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m3044getXimpl(available), Offset.m3045getYimpl(available)));
    }

    /* renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m785scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo737consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo508onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m784flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m6085getXimpl(j), Velocity.m6086getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo506onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m784flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m6085getXimpl(j2), Velocity.m6086getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m784flinghuYlsQE(long r26, float r28, boolean r29, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r30) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 409
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m784flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
