...
final /* data */ class BoxMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo61measure3p2s80s(final MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        ...
        if (list.isEmpty()) {
            return MeasureScope.CC.layout$default(measureScope, Constraints.m5789getMinWidthimpl(j), Constraints.m5788getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxMeasurePolicy$measure$1
        ...
        long jM5778copyZbe2FdA$default = this.propagateMinConstraints ? j : Constraints.m5778copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
        if (list.size() == 1) {
            final Measurable measurable = list.get(0);
            if (!BoxKt.getMatchesParentSize(measurable)) {
                placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(jM5778copyZbe2FdA$default);
                iM5789getMinWidthimpl = Math.max(Constraints.m5789getMinWidthimpl(j), placeableMo4680measureBRTryo0.getWidth());
                iM5788getMinHeightimpl = Math.max(Constraints.m5788getMinHeightimpl(j), placeableMo4680measureBRTryo0.getHeight());
            } else {
                iM5789getMinWidthimpl = Constraints.m5789getMinWidthimpl(j);
                iM5788getMinHeightimpl = Constraints.m5788getMinHeightimpl(j);
                placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(Constraints.INSTANCE.m5797fixedJhjzzOo(Constraints.m5789getMinWidthimpl(j), Constraints.m5788getMinHeightimpl(j)));
            }
            final int i = iM5789getMinWidthimpl;
            final int i2 = iM5788getMinHeightimpl;
        ...
        intRef.element = Constraints.m5789getMinWidthimpl(j);
        final Ref.IntRef intRef2 = new Ref.IntRef();
        intRef2.element = Constraints.m5788getMinHeightimpl(j);
        int size = list.size();
        boolean z = false;
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (BoxKt.getMatchesParentSize(measurable2)) {
                ...
                Placeable placeableMo4680measureBRTryo02 = measurable2.mo4680measureBRTryo0(jM5778copyZbe2FdA$default);
                placeableArr[i3] = placeableMo4680measureBRTryo02;
                intRef.element = Math.max(intRef.element, placeableMo4680measureBRTryo02.getWidth());
                intRef2.element = Math.max(intRef2.element, placeableMo4680measureBRTryo02.getHeight());
            }
        }
        if (z) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                ...
                if (BoxKt.getMatchesParentSize(measurable3)) {
                    placeableArr[i4] = measurable3.mo4680measureBRTryo0(jConstraints);
                }
            }
        }
