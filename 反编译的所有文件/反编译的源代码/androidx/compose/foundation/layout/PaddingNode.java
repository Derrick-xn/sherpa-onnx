...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m722setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m723setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m721setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m720setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult mo114measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        int i = measureScope.mo391roundToPx0680j_4(this.start) + measureScope.mo391roundToPx0680j_4(this.end);
        int i2 = measureScope.mo391roundToPx0680j_4(this.top) + measureScope.mo391roundToPx0680j_4(this.bottom);
        final Placeable placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(ConstraintsKt.m5806offsetNN6EwU(j, -i, -i2));
        return MeasureScope.CC.layout$default(measureScope, ConstraintsKt.m5804constrainWidthK40F9xA(j, placeableMo4680measureBRTryo0.getWidth() + i), ConstraintsKt.m5803constrainHeightK40F9xA(j, placeableMo4680measureBRTryo0.getHeight() + i2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4680measureBRTryo0, measureScope.mo391roundToPx0680j_4(this.this$0.getStart()), measureScope.mo391roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo4680measureBRTryo0, measureScope.mo391roundToPx0680j_4(this.this$0.getStart()), measureScope.mo391roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m5844constructorimpl(0) : f, (i & 2) != 0 ? Dp.m5844constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m5844constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m5844constructorimpl(0) : f4, z, null);
    }
}