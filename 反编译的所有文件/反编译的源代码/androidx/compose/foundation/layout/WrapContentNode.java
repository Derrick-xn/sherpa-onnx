...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo114measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m5789getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m5787getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m5788getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m5786getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo4680measureBRTryo0.getWidth(), Constraints.m5789getMinWidthimpl(j), Constraints.m5787getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo4680measureBRTryo0.getHeight(), Constraints.m5788getMinHeightimpl(j), Constraints.m5786getMaxHeightimpl(j));
        return MeasureScope.CC.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m4749place70tqf50$default(placementScope, placeableMo4680measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m6010boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo4680measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo4680measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}