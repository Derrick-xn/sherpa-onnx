...
public final class InsetsPaddingModifier implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo87measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo4680measureBRTryo0 = measurable.mo4680measureBRTryo0(ConstraintsKt.m5806offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.CC.layout$default(measureScope, ConstraintsKt.m5804constrainWidthK40F9xA(j, placeableMo4680measureBRTryo0.getWidth() + right), ConstraintsKt.m5803constrainHeightK40F9xA(j, placeableMo4680measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo4680measureBRTryo0, left, top, 0.0f, 4, null);
            }
        }, 4, null);
    }
