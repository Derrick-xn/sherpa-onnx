...
public final class PaddingValuesImpl implements PaddingValues {
    ...
    public static /* synthetic */ void m728getBottomD9Ej5fM$annotations() {
    }

    /* renamed from: getEnd-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m729getEndD9Ej5fM$annotations() {
    }

    /* renamed from: getStart-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m730getStartD9Ej5fM$annotations() {
    }

    /* renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m731getTopD9Ej5fM$annotations() {
    }
    ...
    public final float m735getTopD9Ej5fM() {
        return this.top;
    }
    ...
    public final float m732getBottomD9Ej5fM() {
        return this.bottom;
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateLeftPadding-u2uoSUM */
    public float mo662calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
    ...
    public float mo663calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5849equalsimpl0(this.start, paddingValuesImpl.start) && Dp.m5849equalsimpl0(this.top, paddingValuesImpl.top) && Dp.m5849equalsimpl0(this.end, paddingValuesImpl.end) && Dp.m5849equalsimpl0(this.bottom, paddingValuesImpl.bottom);
    }

    public int hashCode() {
        return (((((Dp.m5850hashCodeimpl(this.start) * 31) + Dp.m5850hashCodeimpl(this.top)) * 31) + Dp.m5850hashCodeimpl(this.end)) * 31) + Dp.m5850hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "PaddingValues(start=" + ((Object) Dp.m5855toStringimpl(this.start)) + ", top=" + ((Object) Dp.m5855toStringimpl(this.top)) + ", end=" + ((Object) Dp.m5855toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m5855toStringimpl(this.bottom)) + ')';
    }
    ...
    public /* synthetic */ PaddingValuesImpl(float f, float f2, float f3, float f4, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m5844constructorimpl(0) : f, (i & 2) != 0 ? Dp.m5844constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m5844constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m5844constructorimpl(0) : f4, null);
    }
}