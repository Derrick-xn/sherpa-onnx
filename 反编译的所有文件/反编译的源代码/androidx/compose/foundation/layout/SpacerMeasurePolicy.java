...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo61measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.CC.layout$default(measureScope, Constraints.m5785getHasFixedWidthimpl(j) ? Constraints.m5787getMaxWidthimpl(j) : 0, Constraints.m5784getHasFixedHeightimpl(j) ? Constraints.m5786getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
