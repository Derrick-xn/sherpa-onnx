...
public final class TransferableContent {
    ...
    public static final class Source {
        ...
        private static final int Keyboard = m354constructorimpl(0);
        private static final int DragAndDrop = m354constructorimpl(1);
        private static final int Clipboard = m354constructorimpl(2);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Source m353boximpl(int i) {
            return new Source(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m354constructorimpl(int i) {
            return i;
        }
        ...
        public static String m358toStringimpl(int i) {
            if (m356equalsimpl0(i, Keyboard)) {
                return "Source.Keyboard";
            }
            if (m356equalsimpl0(i, DragAndDrop)) {
                return "Source.DragAndDrop";
            }
            if (m356equalsimpl0(i, Clipboard)) {
                return "Source.Clipboard";
            }
            return "Invalid (" + i + ')';
        }
