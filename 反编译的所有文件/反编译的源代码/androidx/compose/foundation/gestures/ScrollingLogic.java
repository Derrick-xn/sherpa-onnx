...
public final class ScrollingLogic {
    ...
    private int latestScrollSource = NestedScrollSource.INSTANCE.m4443getUserInputWNlRxjI();
    ...
    private final ScrollingLogic$nestedScrollScope$1 nestedScrollScope = new NestedScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$nestedScrollScope$1
        ...
        public long mo478scrollByOzD1aCk(long offset, int source) {
            return this.this$0.m515performScroll3eAAhYA(this.this$0.outerStateScope, offset, source);
        }

        @Override // androidx.compose.foundation.gestures.NestedScrollScope
        /* renamed from: scrollByWithOverscroll-OzD1aCk */
        public long mo479scrollByWithOverscrollOzD1aCk(long offset, int source) {
            ...
            return overscrollEffect.mo242applyToScrollRhakbz0(offset, this.this$0.latestScrollSource, this.this$0.performScrollForOverscroll);
        }
    };
    private final Function1<Offset, Offset> performScrollForOverscroll = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$performScrollForOverscroll$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
            return Offset.m3033boximpl(m527invokeMKHz9U(offset.getPackedValue()));
        }

        /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
        public final long m527invokeMKHz9U(long j) {
            ScrollScope scrollScope = this.this$0.outerStateScope;
            ScrollingLogic scrollingLogic = this.this$0;
            return scrollingLogic.m515performScroll3eAAhYA(scrollScope, j, scrollingLogic.latestScrollSource);
        }
    };
    ...
    public final long m525toOffsettuRUvjQ(float f) {
        if (f == 0.0f) {
    ...
    public final long m523singleAxisOffsetMKHz9U(long j) {
        return this.orientation == Orientation.Horizontal ? Offset.m3038copydBAh8RU$default(j, 0.0f, 0.0f, 1, null) : Offset.m3038copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
    }

    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m524toFloatk4lQ0M(long j) {
    ...
    public final float m517toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6085getXimpl(j) : Velocity.m6086getYimpl(j);
    }

    /* renamed from: singleAxisVelocity-AH228Gc, reason: not valid java name */
    private final long m516singleAxisVelocityAH228Gc(long j) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6081copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null) : Velocity.m6081copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: update-QWom1Mo, reason: not valid java name */
    public final long m518updateQWom1Mo(long j, float f) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6081copyOhffZ5M$default(j, f, 0.0f, 2, null) : Velocity.m6081copyOhffZ5M$default(j, 0.0f, f, 1, null);
    }
    ...
    public final long m522reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m3051timestuRUvjQ(j, -1.0f) : j;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: performScroll-3eAAhYA, reason: not valid java name */
    public final long m515performScroll3eAAhYA(ScrollScope scrollScope, long j, int i) {
        long jM4427dispatchPreScrollOzD1aCk = this.nestedScrollDispatcher.m4427dispatchPreScrollOzD1aCk(j, i);
        long jM3048minusMKHz9U = Offset.m3048minusMKHz9U(j, jM4427dispatchPreScrollOzD1aCk);
        long jM522reverseIfNeededMKHz9U = m522reverseIfNeededMKHz9U(m525toOffsettuRUvjQ(scrollScope.scrollBy(m524toFloatk4lQ0M(m522reverseIfNeededMKHz9U(m523singleAxisOffsetMKHz9U(jM3048minusMKHz9U))))));
        return Offset.m3049plusMKHz9U(Offset.m3049plusMKHz9U(jM4427dispatchPreScrollOzD1aCk, jM522reverseIfNeededMKHz9U), this.nestedScrollDispatcher.m4425dispatchPostScrollDzOQY0M(jM522reverseIfNeededMKHz9U, Offset.m3048minusMKHz9U(jM3048minusMKHz9U, jM522reverseIfNeededMKHz9U), i));
    }
    ...
    public final long m521performRawScrollMKHz9U(long scroll) {
        if (this.scrollableState.isScrollInProgress()) {
            return Offset.INSTANCE.m3060getZeroF1C5BW0();
        }
        return m525toOffsettuRUvjQ(reverseIfNeeded(this.scrollableState.dispatchRawDelta(reverseIfNeeded(m524toFloatk4lQ0M(scroll)))));
    }

    /* renamed from: onDragStopped-sF-c-tU, reason: not valid java name */
    public final Object m520onDragStoppedsFctU(long j, Continuation<? super Unit> continuation) {
        long jM516singleAxisVelocityAH228Gc = m516singleAxisVelocityAH228Gc(j);
        ...
        if (overscrollEffect != null && getShouldDispatchOverscroll()) {
            Object objMo241applyToFlingBMRW4eQ = overscrollEffect.mo241applyToFlingBMRW4eQ(jM516singleAxisVelocityAH228Gc, scrollingLogic$onDragStopped$performFling$1, continuation);
            return objMo241applyToFlingBMRW4eQ == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMo241applyToFlingBMRW4eQ : Unit.INSTANCE;
        }
        Object objInvoke = scrollingLogic$onDragStopped$performFling$1.invoke(Velocity.m6076boximpl(jM516singleAxisVelocityAH228Gc), continuation);
    ...
    */
    public final java.lang.Object m519doFlingAnimationQWom1Mo(long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) throws java.lang.Throwable {
        /*
            r11 = this;
        ...
        L5a:
            ...
            androidx.compose.ui.unit.Velocity r12 = androidx.compose.ui.unit.Velocity.m6076boximpl(r12)
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.ScrollingLogic.m519doFlingAnimationQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
