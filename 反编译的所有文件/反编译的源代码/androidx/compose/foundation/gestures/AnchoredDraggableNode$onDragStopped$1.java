...
final class AnchoredDraggableNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (((AnchoredDraggableNode) this.this$0).overscrollEffect != null) {
                ...
                this.label = 2;
                if (overscrollEffect.mo241applyToFlingBMRW4eQ(this.this$0.m408reverseIfNeededAH228Gc(this.$velocity), new AnonymousClass1(this.this$0, null), this) == coroutine_suspended) {
                ...
                this.label = 1;
                Object obj2 = anchoredDraggableState.settle(anchoredDraggableNode3.m410toFloatTH1AsA0(anchoredDraggableNode3.m408reverseIfNeededAH228Gc(this.$velocity)), this);
                if (obj2 == coroutine_suspended) {
                    return coroutine_suspended;
                }
                anchoredDraggableNode = anchoredDraggableNode2;
                obj = obj2;
                anchoredDraggableNode.m413toVelocityadjELrA(((Number) obj).floatValue());
            }
        } else if (i == 1) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<Velocity, Continuation<? super Velocity>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Velocity velocity, Continuation<? super Velocity> continuation) {
            return m417invokesFctU(velocity.getPackedValue(), continuation);
        }

        /* renamed from: invoke-sF-c-tU, reason: not valid java name */
        public final Object m417invokesFctU(long j, Continuation<? super Velocity> continuation) {
            return ((AnonymousClass1) create(Velocity.m6076boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.J$0 = j2;
                this.label = 1;
                Object obj2 = anchoredDraggableNode2.state.settle(this.this$0.m410toFloatTH1AsA0(j2), this);
                if (obj2 == coroutine_suspended) {
                    return coroutine_suspended;
                }
                anchoredDraggableNode = anchoredDraggableNode2;
            ...
            long jM413toVelocityadjELrA = anchoredDraggableNode.m413toVelocityadjELrA(((Number) obj).floatValue());
