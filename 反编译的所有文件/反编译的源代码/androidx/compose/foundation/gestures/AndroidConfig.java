...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo418calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM3033boximpl = Offset.m3033boximpl(Offset.INSTANCE.m3060getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            offsetM3033boximpl = Offset.m3033boximpl(Offset.m3049plusMKHz9U(offsetM3033boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m3051timestuRUvjQ(offsetM3033boximpl.getPackedValue(), -density.mo397toPx0680j_4(Dp.m5844constructorimpl(64)));
    }
}