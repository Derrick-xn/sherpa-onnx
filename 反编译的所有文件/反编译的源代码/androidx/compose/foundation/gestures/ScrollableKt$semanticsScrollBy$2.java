...
final class ScrollableKt$semanticsScrollBy$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            float fM524toFloatk4lQ0M = this.$this_semanticsScrollBy.m524toFloatk4lQ0M(this.$offset);
            final Ref.FloatRef floatRef = this.$previousValue;
            final ScrollingLogic scrollingLogic = this.$this_semanticsScrollBy;
            this.label = 1;
            if (SuspendAnimationKt.animate$default(0.0f, fM524toFloatk4lQ0M, 0.0f, null, new Function2<Float, Float, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(float f, float f2) {
                    ...
                    floatRef.element += scrollingLogic2.reverseIfNeeded(scrollingLogic2.m524toFloatk4lQ0M(nestedScrollScope.mo478scrollByOzD1aCk(scrollingLogic2.m525toOffsettuRUvjQ(scrollingLogic2.reverseIfNeeded(f3)), NestedScrollSource.INSTANCE.m4443getUserInputWNlRxjI())));
                }
