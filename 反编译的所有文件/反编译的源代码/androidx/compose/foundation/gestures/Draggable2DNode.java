...
public final class Draggable2DNode extends DragGestureNode {
            ...
            if (i == 0) {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.Draggable2DNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        drag2DScope.mo427dragByk4lQ0M(draggable2DNode.m466reverseIfNeededMKHz9U(dragDelta.getDelta()));
                    }
                };
                this.label = 1;
    ...
    public void mo414onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStart.invoke(Offset.m3033boximpl(startedPosition));
    ...
    public void mo415onDragStoppedTH1AsA0(long velocity) {
        this.onDragStop.invoke(Velocity.m6076boximpl(velocity));
    ...
    public final long m465reverseIfNeededAH228Gc(long j) {
        return Velocity.m6091timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m466reverseIfNeededMKHz9U(long j) {
        return Offset.m3051timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}