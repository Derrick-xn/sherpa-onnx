...
public final class Draggable2DCompatElement extends ModifierNodeElement<Draggable2DNode> {
    ...
    public void update(Draggable2DNode node) {
        node.update(this.state, CanDrag, this.enabled, this.interactionSource, this.startDragImmediately, this.reverseDirection, (768 & 64) != 0 ? node.onDragStarted : this.onDragStarted, (768 & 128) != 0 ? node.onDragStopped : this.onDragStopped, (768 & 256) != 0 ? node.onDragStart : null, (768 & 512) != 0 ? node.onDragStop : null);
    }
