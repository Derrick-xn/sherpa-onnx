...
public final class DraggableNode extends DragGestureNode {
            ...
            if (i == 0) {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        dragScope.dragBy(DraggableKt.m470toFloat3MmeM6k(draggableNode.m477reverseIfNeededMKHz9U(dragDelta.getDelta()), draggableNode.orientation));
                    }
                };
                this.label = 1;
    ...
    public final long m476reverseIfNeededAH228Gc(long j) {
        return Velocity.m6091timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m477reverseIfNeededMKHz9U(long j) {
