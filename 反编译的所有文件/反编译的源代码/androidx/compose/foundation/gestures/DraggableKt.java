...
public final class DraggableKt {
    ...
    public static final float m470toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m3045getYimpl(j) : Offset.m3044getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m471toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m6086getYimpl(j) : Velocity.m6085getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m472toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m6085getXimpl(j)) ? 0.0f : Velocity.m6085getXimpl(j), Float.isNaN(Velocity.m6086getYimpl(j)) ? 0.0f : Velocity.m6086getYimpl(j));
    }
}