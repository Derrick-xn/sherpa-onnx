...
public final class TransformGestureDetectorKt {
    ...
    static final class AnonymousClass2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:15:0x00a2 -> B:17:0x00a5). Please report as a decompilation issue!!! */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long jM3048minusMKHz9U = Offset.m3048minusMKHz9U(pointerInputChange2.getPreviousPosition(), jCalculateCentroid2);
                long jM3048minusMKHz9U2 = Offset.m3048minusMKHz9U(position, jCalculateCentroid);
                float fM534anglek4lQ0M = m534anglek4lQ0M(jM3048minusMKHz9U2) - m534anglek4lQ0M(jM3048minusMKHz9U);
                float fM3042getDistanceimpl = Offset.m3042getDistanceimpl(Offset.m3049plusMKHz9U(jM3048minusMKHz9U2, jM3048minusMKHz9U)) / 2.0f;
                if (fM534anglek4lQ0M > 180.0f) {
                    fM534anglek4lQ0M -= 360.0f;
                } else if (fM534anglek4lQ0M < -180.0f) {
                    fM534anglek4lQ0M += 360.0f;
                }
                f2 += fM534anglek4lQ0M * fM3042getDistanceimpl;
                f += fM3042getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    private static final float m534anglek4lQ0M(long j) {
        if (Offset.m3044getXimpl(j) == 0.0f && Offset.m3045getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m3044getXimpl(j), Offset.m3045getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        long jCalculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m3041equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m3059getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m3060getZeroF1C5BW0();
        }
        return Offset.m3048minusMKHz9U(jCalculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        float fM3042getDistanceimpl = 0.0f;
        if (Offset.m3041equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m3059getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        List<PointerInputChange> changes = pointerEvent.getChanges();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                fM3042getDistanceimpl += Offset.m3042getDistanceimpl(Offset.m3048minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), jCalculateCentroid));
                i++;
            }
        }
        return fM3042getDistanceimpl / i;
    }
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                jM3060getZeroF1C5BW0 = Offset.m3049plusMKHz9U(jM3060getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m3039divtuRUvjQ(jM3060getZeroF1C5BW0, i);
    }
}