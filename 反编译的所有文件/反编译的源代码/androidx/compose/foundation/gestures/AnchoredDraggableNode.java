...
final class AnchoredDraggableNode<T> extends DragGestureNode {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        if (((AnchoredDraggableNode) anchoredDraggableNode).overscrollEffect != null) {
                            ...
                            long jM409reverseIfNeededMKHz9U = anchoredDraggableNode.m409reverseIfNeededMKHz9U(dragDelta.getDelta());
                            int iM4443getUserInputWNlRxjI = NestedScrollSource.INSTANCE.m4443getUserInputWNlRxjI();
                            ...
                            overscrollEffect.mo242applyToScrollRhakbz0(jM409reverseIfNeededMKHz9U, iM4443getUserInputWNlRxjI, new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1.1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                                ...
                                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                                    return Offset.m3033boximpl(m416invokeMKHz9U(offset.getPackedValue()));
                                }

                                /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                                public final long m416invokeMKHz9U(long j) {
                                    float fNewOffsetForDelta$foundation_release = ((AnchoredDraggableNode) anchoredDraggableNode2).state.newOffsetForDelta$foundation_release(anchoredDraggableNode2.m411toFloatk4lQ0M(j));
                                    AnchoredDraggableNode<T> anchoredDraggableNode3 = anchoredDraggableNode2;
                                    long jM412toOffsettuRUvjQ = anchoredDraggableNode3.m412toOffsettuRUvjQ(fNewOffsetForDelta$foundation_release - ((AnchoredDraggableNode) anchoredDraggableNode3).state.requireOffset());
                                    AnchoredDragScope.CC.dragTo$default(anchoredDragScope2, fNewOffsetForDelta$foundation_release, 0.0f, 2, null);
                                    return jM412toOffsettuRUvjQ;
                                }
                            });
                            return;
                        }
                        ...
                        AnchoredDragScope.CC.dragTo$default(anchoredDragScope3, anchoredDraggableState.newOffsetForDelta$foundation_release(anchoredDraggableNode3.m411toFloatk4lQ0M(anchoredDraggableNode3.m409reverseIfNeededMKHz9U(dragDelta.getDelta()))), 0.0f, 2, null);
                    }
                };
                this.label = 1;
    ...
    public final long m412toOffsettuRUvjQ(float f) {
    ...
    public final long m413toVelocityadjELrA(float f) {
        float f2 = this.orientation == Orientation.Horizontal ? f : 0.0f;
        if (this.orientation != Orientation.Vertical) {
            f = 0.0f;
        }
    ...
    public final float m410toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Vertical ? Velocity.m6086getYimpl(j) : Velocity.m6085getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m411toFloatk4lQ0M(long j) {
        return this.orientation == Orientation.Vertical ? Offset.m3045getYimpl(j) : Offset.m3044getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-AH228Gc, reason: not valid java name */
    public final long m408reverseIfNeededAH228Gc(long j) {
        return Velocity.m6091timesadjELrA(j, isReverseDirection() ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m409reverseIfNeededMKHz9U(long j) {
        return Offset.m3051timestuRUvjQ(j, isReverseDirection() ? -1.0f : 1.0f);
    }
}