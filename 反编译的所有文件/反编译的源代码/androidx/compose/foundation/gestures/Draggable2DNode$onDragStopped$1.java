...
final class Draggable2DNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            Velocity velocityM6076boximpl = Velocity.m6076boximpl(this.this$0.m465reverseIfNeededAH228Gc(this.$velocity));
            this.label = 1;
            if (function3.invoke(coroutineScope, velocityM6076boximpl, this) == coroutine_suspended) {
