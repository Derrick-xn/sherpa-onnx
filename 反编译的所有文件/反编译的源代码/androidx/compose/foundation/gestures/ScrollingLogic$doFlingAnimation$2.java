...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m524toFloatk4lQ0M(nestedScrollScope.mo479scrollByWithOverscrollOzD1aCk(scrollingLogic4.m522reverseIfNeededMKHz9U(scrollingLogic4.m525toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m4442getSideEffectWNlRxjI())));
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m517toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m518updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
