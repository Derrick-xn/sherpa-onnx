...
final class ScrollableNode extends DragGestureNode implements ObserverModifierNode, CompositionLocalConsumerModifierNode, FocusPropertiesModifierNode, KeyInputModifierNode, SemanticsModifierNode {
    ...
    public void mo414onDragStartedk4lQ0M(long startedPosition) {
    }
    ...
    public void mo415onDragStoppedTH1AsA0(long velocity) {
    ...
    public boolean mo232onKeyEventZmokQxo(KeyEvent event) {
        long jOffset;
        if (!getEnabled() || ((!Key.m4094equalsimpl0(KeyEvent_androidKt.m4402getKeyZmokQxo(event), Key.INSTANCE.m4282getPageDownEK5gGoQ()) && !Key.m4094equalsimpl0(KeyEvent_androidKt.m4402getKeyZmokQxo(event), Key.INSTANCE.m4283getPageUpEK5gGoQ())) || !KeyEventType.m4395equalsimpl0(KeyEvent_androidKt.m4403getTypeZmokQxo(event), KeyEventType.INSTANCE.m4399getKeyDownCS__XNY()) || KeyEvent_androidKt.m4406isCtrlPressedZmokQxo(event))) {
            return false;
        }
        if (this.scrollingLogic.isVertical()) {
            int iM6017getHeightimpl = IntSize.m6017getHeightimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(0.0f, Key.m4094equalsimpl0(KeyEvent_androidKt.m4402getKeyZmokQxo(event), Key.INSTANCE.m4283getPageUpEK5gGoQ()) ? iM6017getHeightimpl : -iM6017getHeightimpl);
        } else {
            int iM6018getWidthimpl = IntSize.m6018getWidthimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(Key.m4094equalsimpl0(KeyEvent_androidKt.m4402getKeyZmokQxo(event), Key.INSTANCE.m4283getPageUpEK5gGoQ()) ? iM6018getWidthimpl : -iM6018getWidthimpl, 0.0f);
        }
    ...
    public void mo233onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (pass == PointerEventPass.Main && PointerEventType.m4498equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4507getScroll7fucELk())) {
            m510processMouseWheelEventO0kMr_c(pointerEvent, bounds);
        }
    }
    ...
    private final void setScrollSemanticsActions() {
        this.scrollByAction = new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableNode.setScrollSemanticsActions.1
            ...
            static final class C00221 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) throws Throwable {
                    ...
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (ScrollableKt.m505semanticsScrollByd4ec7I(this.this$0.scrollingLogic, OffsetKt.Offset(this.$x, this.$y), this) == coroutine_suspended) {
            ...
            public final Boolean invoke(float f, float f2) {
                BuildersKt__Builders_commonKt.launch$default(ScrollableNode.this.getCoroutineScope(), null, null, new C00221(ScrollableNode.this, f, f2, null), 3, null);
                return true;
            }
        };
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Offset, Continuation<? super Offset>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Offset offset, Continuation<? super Offset> continuation) {
            return m511invoke3MmeM6k(offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-3MmeM6k, reason: not valid java name */
        public final Object m511invoke3MmeM6k(long j, Continuation<? super Offset> continuation) {
            return ((AnonymousClass2) create(Offset.m3033boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                long j = this.J$0;
                this.label = 1;
                obj = ScrollableKt.m505semanticsScrollByd4ec7I(ScrollableNode.this.scrollingLogic, j, this);
    ...
    private final void m510processMouseWheelEventO0kMr_c(PointerEvent event, long size) {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new ScrollableNode$processMouseWheelEvent$2$1(this, scrollConfig.mo418calculateMouseWheelScroll8xgXZGE(DelegatableNodeKt.requireDensity(this), event, size), null), 3, null);
