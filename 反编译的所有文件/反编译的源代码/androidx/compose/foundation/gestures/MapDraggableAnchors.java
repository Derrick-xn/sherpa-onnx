...
final class MapDraggableAnchors<T> implements DraggableAnchors<T> {
    ...
    */
    public T closestAnchor(float r20) {
        /*
            r19 = this;
            r0 = r19
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x005e A[PHI: r5 r9
      0x005e: PHI (r5v3 T) = (r5v2 T), (r5v4 T) binds: [B:6:0x0024, B:22:0x005c] A[DONT_GENERATE, DONT_INLINE]
      0x005e: PHI (r9v2 float) = (r9v1 float), (r9v3 float) binds: [B:6:0x0024, B:22:0x005c] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // androidx.compose.foundation.gestures.DraggableAnchors
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
