...
final class ScrollableElement extends ModifierNodeElement<ScrollableNode> {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((iHashCode + (overscrollEffect != null ? overscrollEffect.hashCode() : 0)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.enabled)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.reverseDirection)) * 31;
