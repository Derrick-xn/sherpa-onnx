...
public final class LazyGridState implements ScrollableState {
    ...
    /* renamed from: androidx.compose.foundation.lazy.grid.LazyGridState$scroll$1, reason: invalid class name and case insensitive filesystem */
            ...
            public List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int lineIndex) {
                ...
                try {
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        arrayList.add(lazyGridState.getPrefetchState().m890schedulePrefetch0kLqBqw(pair.getFirst().intValue(), pair.getSecond().getValue()));
                    }
    ...
    public final MutableState<Unit> m857getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final MutableState<Unit> m856getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    /* renamed from: androidx.compose.foundation.lazy.grid.LazyGridState$requestScrollToItem$1, reason: invalid class name */
    ...
    */
    public java.lang.Object scroll(androidx.compose.foundation.MutatePriority r6, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r8 instanceof androidx.compose.foundation.lazy.grid.LazyGridState.C02701
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.lazy.grid.LazyGridState$scroll$1 r0 = (androidx.compose.foundation.lazy.grid.LazyGridState.C02701) r0
            int r1 = r0.label
