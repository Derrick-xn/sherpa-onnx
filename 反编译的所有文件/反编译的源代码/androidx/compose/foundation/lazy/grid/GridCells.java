...
public interface GridCells {
    ...
    public static final class Adaptive implements GridCells {
        ...
        private Adaptive(float f) {
            ...
            throw new IllegalArgumentException(("Provided min size " + ((Object) Dp.m5855toStringimpl(f)) + " should be larger than zero.").toString());
        }

        @Override // androidx.compose.foundation.lazy.grid.GridCells
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            return LazyGridDslKt.calculateCellsCrossAxisSizeImpl(i, Math.max((i + i2) / (density.mo391roundToPx0680j_4(this.minSize) + i2), 1), i2);
        }

        public int hashCode() {
            return Dp.m5850hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m5849equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
    ...
    public static final class FixedSize implements GridCells {
        ...
        private FixedSize(float f) {
            ...
            throw new IllegalArgumentException(("Provided size " + ((Object) Dp.m5855toStringimpl(f)) + " should be larger than zero.").toString());
        }

        @Override // androidx.compose.foundation.lazy.grid.GridCells
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            int iMo391roundToPx0680j_4 = density.mo391roundToPx0680j_4(this.size);
            int i3 = iMo391roundToPx0680j_4 + i2;
            int i4 = i2 + i;
            if (i3 < i4) {
                int i5 = i4 / i3;
                ArrayList arrayList = new ArrayList(i5);
                for (int i6 = 0; i6 < i5; i6++) {
                    arrayList.add(Integer.valueOf(iMo391roundToPx0680j_4));
                }
                return arrayList;
            }
        ...
        public boolean equals(Object other) {
            return (other instanceof FixedSize) && Dp.m5849equalsimpl0(this.size, ((FixedSize) other).size);
        }
    }
}