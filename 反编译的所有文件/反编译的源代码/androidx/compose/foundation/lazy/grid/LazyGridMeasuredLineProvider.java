...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m855childConstraintsJhjzzOo$foundation_release(int startSlot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m5799fixedWidthOenEA2s(iCoerceAtLeast);
        }
        return Constraints.INSTANCE.m5798fixedHeightOenEA2s(iCoerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int iM833getCurrentLineSpanimpl = GridItemSpan.m833getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i3).getPackedValue());
            LazyGridMeasuredItem lazyGridMeasuredItemM854getAndMeasurem8Kt_7k = this.measuredItemProvider.m854getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i3, m855childConstraintsJhjzzOo$foundation_release(i2, iM833getCurrentLineSpanimpl), i2, iM833getCurrentLineSpanimpl, i);
            i2 += iM833getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i3] = lazyGridMeasuredItemM854getAndMeasurem8Kt_7k;
        }
