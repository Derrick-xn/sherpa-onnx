...
public final class LazyGridMeasureKt {
    ...
    public static final LazyGridMeasureResult m851measureLazyGridOZKpZRA(int i, LazyGridMeasuredLineProvider lazyGridMeasuredLineProvider, LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyLayoutItemAnimator<LazyGridMeasuredItem> lazyLayoutItemAnimator, int i8, List<Integer> list, CoroutineScope coroutineScope, final MutableState<Unit> mutableState, GraphicsContext graphicsContext, Function1<? super Integer, ? extends List<Pair<Integer, Constraints>>> function1, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        int iM5804constrainWidthK40F9xA;
        int iM5786getMaxHeightimpl;
        int iM5803constrainHeightK40F9xA;
        int i13;
        ...
        if (i <= 0) {
            ...
            lazyLayoutItemAnimator.onMeasured(0, iM5789getMinWidthimpl, iM5788getMinHeightimpl, new ArrayList(), lazyGridMeasuredItemProvider.getKeyIndexMap(), lazyGridMeasuredItemProvider, z, false, i8, false, 0, 0, coroutineScope, graphicsContext);
            long jM875getMinSizeToFitDisappearingItemsYbymL2g = lazyLayoutItemAnimator.m875getMinSizeToFitDisappearingItemsYbymL2g();
            if (!IntSize.m6016equalsimpl0(jM875getMinSizeToFitDisappearingItemsYbymL2g, IntSize.INSTANCE.m6023getZeroYbymL2g())) {
                iM5789getMinWidthimpl = ConstraintsKt.m5804constrainWidthK40F9xA(j, IntSize.m6018getWidthimpl(jM875getMinSizeToFitDisappearingItemsYbymL2g));
                iM5788getMinHeightimpl = ConstraintsKt.m5803constrainHeightK40F9xA(j, IntSize.m6017getHeightimpl(jM875getMinSizeToFitDisappearingItemsYbymL2g));
            }
            return new LazyGridMeasureResult(null, 0, false, 0.0f, function3.invoke(Integer.valueOf(iM5789getMinWidthimpl), Integer.valueOf(iM5788getMinHeightimpl), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$3
        ...
        while (i42 < size) {
            ...
            if (iIntValue < 0 || iIntValue >= index2) {
                ...
                i19 = i31;
                i20 = i10;
                LazyGridMeasuredItem lazyGridMeasuredItemMo824getAndMeasurehBUhpc = lazyGridMeasuredItemProvider.mo824getAndMeasurehBUhpc(iIntValue, 0, iSpanOf, lazyGridMeasuredLineProvider.m855childConstraintsJhjzzOo$foundation_release(0, iSpanOf));
                ArrayList arrayList = listEmptyList == null ? new ArrayList() : listEmptyList;
                arrayList.add(lazyGridMeasuredItemMo824getAndMeasurehBUhpc);
        ...
        while (i49 < size2) {
            ...
            if (i44 + 1 > iIntValue2 || iIntValue2 >= i) {
                ...
                i14 = i49;
                LazyGridMeasuredItem lazyGridMeasuredItemMo824getAndMeasurehBUhpc2 = lazyGridMeasuredItemProvider.mo824getAndMeasurehBUhpc(iIntValue2, 0, iSpanOf2, lazyGridMeasuredLineProvider.m855childConstraintsJhjzzOo$foundation_release(0, iSpanOf2));
                if (arrayListEmptyList == null) {
                    arrayListEmptyList = new ArrayList();
                }
                List list4 = arrayListEmptyList;
                list4.add(lazyGridMeasuredItemMo824getAndMeasurehBUhpc2);
        ...
        if (z) {
            iM5804constrainWidthK40F9xA = Constraints.m5787getMaxWidthimpl(j);
        } else {
            iM5804constrainWidthK40F9xA = ConstraintsKt.m5804constrainWidthK40F9xA(j, i9);
        }
        int i52 = iM5804constrainWidthK40F9xA;
        if (z) {
            iM5786getMaxHeightimpl = ConstraintsKt.m5803constrainHeightK40F9xA(j, i9);
        } else {
            iM5786getMaxHeightimpl = Constraints.m5786getMaxHeightimpl(j);
        }
        int i53 = iM5786getMaxHeightimpl;
        int i54 = i9;
        ...
        long jM875getMinSizeToFitDisappearingItemsYbymL2g2 = lazyLayoutItemAnimator.m875getMinSizeToFitDisappearingItemsYbymL2g();
        if (IntSize.m6016equalsimpl0(jM875getMinSizeToFitDisappearingItemsYbymL2g2, IntSize.INSTANCE.m6023getZeroYbymL2g())) {
            iM5803constrainHeightK40F9xA = i53;
            i13 = i52;
        } else {
            int i55 = z ? i53 : i52;
            int iM5804constrainWidthK40F9xA2 = ConstraintsKt.m5804constrainWidthK40F9xA(j, Math.max(i52, IntSize.m6018getWidthimpl(jM875getMinSizeToFitDisappearingItemsYbymL2g2)));
            iM5803constrainHeightK40F9xA = ConstraintsKt.m5803constrainHeightK40F9xA(j, Math.max(i53, IntSize.m6017getHeightimpl(jM875getMinSizeToFitDisappearingItemsYbymL2g2)));
            int i56 = z ? iM5803constrainHeightK40F9xA : iM5804constrainWidthK40F9xA2;
            if (i56 != i55) {
            ...
            i13 = iM5804constrainWidthK40F9xA2;
        }
        if (i44 == i - 1 && i54 <= i2) {
            z3 = false;
        }
        MeasureResult measureResultInvoke = function3.invoke(Integer.valueOf(i13), Integer.valueOf(iM5803constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$6
