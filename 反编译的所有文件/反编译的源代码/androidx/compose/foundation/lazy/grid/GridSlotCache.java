...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo837invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m5775boximpl(constraints));
