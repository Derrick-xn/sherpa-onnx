...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public int mo390roundToPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo390roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo391roundToPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo391roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo396toPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo396toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo397toPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo397toPx0680j_4(f);
    }
    ...
    public List<Placeable> mo881measure0kLqBqw(int index, long constraints) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(listSubcompose.get(i).mo4680measureBRTryo0(constraints));
        }
    ...
    public float mo392toDpGaN1DYA(long j) {
        return this.subcomposeMeasureScope.mo392toDpGaN1DYA(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo394toDpu2uoSUM(int i) {
        return this.subcomposeMeasureScope.mo394toDpu2uoSUM(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo393toDpu2uoSUM(float f) {
        return this.subcomposeMeasureScope.mo393toDpu2uoSUM(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo400toSpkPz2Gy4(float f) {
        return this.subcomposeMeasureScope.mo400toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo401toSpkPz2Gy4(int i) {
        return this.subcomposeMeasureScope.mo401toSpkPz2Gy4(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo399toSp0xMU5do(float f) {
        return this.subcomposeMeasureScope.mo399toSp0xMU5do(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSize-XkaWNTQ */
    public long mo398toSizeXkaWNTQ(long j) {
        return this.subcomposeMeasureScope.mo398toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo395toDpSizekrfVVM(long j) {
        return this.subcomposeMeasureScope.mo395toDpSizekrfVVM(j);
    }
}