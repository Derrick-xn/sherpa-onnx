...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo863layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        int firstPlacedIndex;
        if (this.state.getItemCount() <= 0 || !this.state.getHasVisibleItems()) {
            return block.invoke(emptyBeyondBoundsScope);
        }
        if (m861isForward4vf7U8o(direction)) {
        ...
        T tInvoke = null;
        while (tInvoke == null && m860hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t = (T) m859addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            tInvoke = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return this.this$0.m860hasMoreContentFR3nfPY(objectRef.element, direction);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m861isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4666getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4665getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4664getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4667getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4668getLefthoxUOeE())) {
                ...
                if (!BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4669getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m859addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    public final boolean m860hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m862isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (m861isForward4vf7U8o(i)) {
    ...
    private final boolean m862isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4664getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4667getBelowhoxUOeE())) {
            if (this.orientation == Orientation.Horizontal) {
                return true;
            }
        } else if (BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4668getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4669getRighthoxUOeE())) {
            if (this.orientation == Orientation.Vertical) {
                return true;
            }
        } else if (!BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4666getBeforehoxUOeE()) && !BeyondBoundsLayout.LayoutDirection.m4660equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4665getAfterhoxUOeE())) {
            LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
            throw new KotlinNothingValueException();
        }
        return false;
