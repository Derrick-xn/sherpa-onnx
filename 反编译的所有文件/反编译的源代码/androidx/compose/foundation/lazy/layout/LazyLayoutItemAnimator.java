...
public final class LazyLayoutItemAnimator<T extends LazyLayoutMeasuredItem> {
            ...
            if (getHasAnimations(t)) {
                ...
                if (itemInfo == null) {
                    ...
                    if (t.getIndex() == index || index == -1) {
                        long jMo822getOffsetBjo55l4 = t.mo822getOffsetBjo55l4(0);
                        initializeAnimation(t, t.getIsVertical() ? IntOffset.m5977getYimpl(jMo822getOffsetBjo55l4) : IntOffset.m5976getXimpl(jMo822getOffsetBjo55l4), itemInfo2);
                        if (z3) {
                    ...
                    while (i11 < length2) {
                        ...
                        if (lazyLayoutItemAnimation2 != null) {
                            ...
                            if (!IntOffset.m5975equalsimpl0(lazyLayoutItemAnimation2.getRawOffset(), LazyLayoutItemAnimation.INSTANCE.m874getNotInitializednOccac())) {
                                lazyLayoutItemAnimation2.m873setRawOffsetgyyYBs(IntOffset.m5980plusqkQi6aY(lazyLayoutItemAnimation2.getRawOffset(), jIntOffset));
                            }
                        } else {
                            lazyLayoutKeyIndexMap4 = lazyLayoutKeyIndexMap5;
                        }
                    ...
                    while (i19 < i18) {
                        if ((j2 & 255) < 128) {
                            ...
                            if (index2 == -1) {
                                ...
                                LazyLayoutMeasuredItem lazyLayoutMeasuredItemMo824getAndMeasurehBUhpc = itemProvider.mo824getAndMeasurehBUhpc(index2, itemInfo4.getLane(), itemInfo4.getSpan(), constraints.getValue());
                                lazyLayoutMeasuredItemMo824getAndMeasurehBUhpc.setNonScrollableItem(true);
                                ...
                                itemInfo4.updateAnimation(lazyLayoutMeasuredItemMo824getAndMeasurehBUhpc, coroutineScope, graphicsContext, layoutMinOffset, layoutMaxOffset, itemInfo4.getCrossAxisOffset());
                                if (index2 < this.firstVisibleIndex) {
                                    this.movingAwayToStartBound.add(lazyLayoutMeasuredItemMo824getAndMeasurehBUhpc);
                                } else {
                                    this.movingAwayToEndBound.add(lazyLayoutMeasuredItemMo824getAndMeasurehBUhpc);
                                }
                                j2 >>= 8;
                                i19++;
                                jArr6 = jArr2;
    ...
    */
    public final void reset() {
        /*
            r15 = this;
            androidx.collection.MutableScatterMap<java.lang.Object, androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimator<T>$ItemInfo> r0 = r15.keyToItemInfoMap
    ...
    private final void initializeAnimation(T item, int mainAxisOffset, LazyLayoutItemAnimator<T>.ItemInfo itemInfo) {
        long jM5972copyiSbpLlY$default;
        int i = 0;
        long jMo822getOffsetBjo55l4 = item.mo822getOffsetBjo55l4(0);
        if (item.getIsVertical()) {
            jM5972copyiSbpLlY$default = IntOffset.m5972copyiSbpLlY$default(jMo822getOffsetBjo55l4, 0, mainAxisOffset, 1, null);
        } else {
            jM5972copyiSbpLlY$default = IntOffset.m5972copyiSbpLlY$default(jMo822getOffsetBjo55l4, mainAxisOffset, 0, 2, null);
        }
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                lazyLayoutItemAnimation.m873setRawOffsetgyyYBs(IntOffset.m5980plusqkQi6aY(jM5972copyiSbpLlY$default, IntOffset.m5979minusqkQi6aY(item.mo822getOffsetBjo55l4(i2), jMo822getOffsetBjo55l4)));
            }
            i++;
            i2 = i3;
        }
    ...
    private final void startPlacementAnimationsIfNeeded(T item, boolean isMovingAway) {
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                long jMo822getOffsetBjo55l4 = item.mo822getOffsetBjo55l4(i2);
                long jM870getRawOffsetnOccac = lazyLayoutItemAnimation.getRawOffset();
                if (!IntOffset.m5975equalsimpl0(jM870getRawOffsetnOccac, LazyLayoutItemAnimation.INSTANCE.m874getNotInitializednOccac()) && !IntOffset.m5975equalsimpl0(jM870getRawOffsetnOccac, jMo822getOffsetBjo55l4)) {
                    lazyLayoutItemAnimation.m866animatePlacementDeltaar5cAso(IntOffset.m5979minusqkQi6aY(jMo822getOffsetBjo55l4, jM870getRawOffsetnOccac), isMovingAway);
                }
                lazyLayoutItemAnimation.m873setRawOffsetgyyYBs(jMo822getOffsetBjo55l4);
            }
            i++;
            i2 = i3;
        }
    ...
    public final long m875getMinSizeToFitDisappearingItemsYbymL2g() {
        long jM6023getZeroYbymL2g = IntSize.INSTANCE.m6023getZeroYbymL2g();
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layer != null) {
                jM6023getZeroYbymL2g = IntSizeKt.IntSize(Math.max(IntSize.m6018getWidthimpl(jM6023getZeroYbymL2g), IntOffset.m5976getXimpl(lazyLayoutItemAnimation.getRawOffset()) + IntSize.m6018getWidthimpl(layer.getSize())), Math.max(IntSize.m6017getHeightimpl(jM6023getZeroYbymL2g), IntOffset.m5977getYimpl(lazyLayoutItemAnimation.getRawOffset()) + IntSize.m6017getHeightimpl(layer.getSize())));
            }
        }
        return jM6023getZeroYbymL2g;
    }
    ...
    private final int getMainAxisOffset(LazyLayoutMeasuredItem lazyLayoutMeasuredItem) {
        long jMo822getOffsetBjo55l4 = lazyLayoutMeasuredItem.mo822getOffsetBjo55l4(0);
        return lazyLayoutMeasuredItem.getIsVertical() ? IntOffset.m5977getYimpl(jMo822getOffsetBjo55l4) : IntOffset.m5976getXimpl(jMo822getOffsetBjo55l4);
    }
    ...
    private final class ItemInfo {
        ...
        public final void m877setConstraints_Sx5XlM(Constraints constraints) {
        ...
        public final void updateAnimation(T positionedItem, CoroutineScope coroutineScope, GraphicsContext graphicsContext, int layoutMinOffset, int layoutMaxOffset, int crossAxisOffset) {
            ...
            this.constraints = Constraints.m5775boximpl(positionedItem.getConstraints());
    ...
    private static final /* data */ class DisplayingDisappearingItemsNode extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                GraphicsLayer layer = lazyLayoutItemAnimation.getLayer();
                if (layer != null) {
                    float fM5976getXimpl = IntOffset.m5976getXimpl(lazyLayoutItemAnimation.getFinalOffset());
                    ContentDrawScope contentDrawScope2 = contentDrawScope;
                    float fM5976getXimpl2 = fM5976getXimpl - IntOffset.m5976getXimpl(layer.getTopLeft());
                    float fM5977getYimpl = IntOffset.m5977getYimpl(lazyLayoutItemAnimation.getFinalOffset()) - IntOffset.m5977getYimpl(layer.getTopLeft());
                    contentDrawScope2.getDrawContext().getTransform().translate(fM5976getXimpl2, fM5977getYimpl);
                    try {
