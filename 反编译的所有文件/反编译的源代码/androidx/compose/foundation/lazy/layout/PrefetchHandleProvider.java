...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m903schedulePrefetchVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    public final PrefetchRequest m902createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    private final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest {
        ...
        public boolean execute(PrefetchRequestScope prefetchRequestScope) {
            ...
            if (!this.isMeasured && !Constraints.m5791isZeroimpl(this.constraints)) {
                ...
                try {
                    m904performMeasureBRTryo0(this.constraints);
        ...
        private final void m904performMeasureBRTryo0(long constraints) {
            if (!(!this.isCanceled)) {
            ...
            for (int i = 0; i < placeablesCount; i++) {
                precomposedSlotHandle.mo4711premeasure0kLqBqw(i, constraints);
            }
        }
        ...
        public String toString() {
            return "HandleAndRequestImpl { index = " + this.index + ", constraints = " + ((Object) Constraints.m5792toStringimpl(this.constraints)) + ", isComposed = " + isComposed() + ", isMeasured = " + this.isMeasured + ", isCanceled = " + this.isCanceled + " }";
        }
