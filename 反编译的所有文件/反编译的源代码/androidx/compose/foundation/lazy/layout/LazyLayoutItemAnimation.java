...
public final class LazyLayoutItemAnimation {
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.rawOffset = j;
        this.finalOffset = IntOffset.INSTANCE.m5986getZeronOccac();
        this.layer = graphicsContext != null ? graphicsContext.createGraphicsLayer() : null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m5967boximpl(IntOffset.INSTANCE.m5986getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, null, 12, null);
        ...
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5967boximpl(IntOffset.INSTANCE.m5986getZeronOccac()), null, 2, null);
    ...
    public final void m873setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
    ...
    public final void m871setFinalOffsetgyyYBs(long j) {
        this.finalOffset = j;
    }
    ...
    public final void m865setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m5967boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getPlacementDelta-nOcc-ac, reason: not valid java name */
    public final long m869getPlacementDeltanOccac() {
    ...
    static final class C02731 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C02731(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (LazyLayoutItemAnimation.this.placementDeltaAnimation.snapTo(IntOffset.m5967boximpl(IntOffset.INSTANCE.m5986getZeronOccac()), this) == coroutine_suspended) {
            ...
            LazyLayoutItemAnimation.this.m865setPlacementDeltagyyYBs(IntOffset.INSTANCE.m5986getZeronOccac());
    ...
    public final void cancelPlacementAnimation() {
        if (isPlacementAnimationInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C02731(null), 3, null);
        }
    }
    ...
    public final void m872setLookaheadOffsetgyyYBs(long j) {
        this.lookaheadOffset = j;
    }

    /* renamed from: animatePlacementDelta-ar5cAso, reason: not valid java name */
    public final void m866animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        FiniteAnimationSpec<IntOffset> finiteAnimationSpec = this.placementSpec;
        if (finiteAnimationSpec == null) {
            return;
        }
        long jM5979minusqkQi6aY = IntOffset.m5979minusqkQi6aY(m869getPlacementDeltanOccac(), delta);
        m865setPlacementDeltagyyYBs(jM5979minusqkQi6aY);
        setPlacementAnimationInProgress(true);
        this.isRunningMovingAwayAnimation = isMovingAway;
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new LazyLayoutItemAnimation$animatePlacementDelta$1(this, finiteAnimationSpec, jM5979minusqkQi6aY, null), 3, null);
    }
    ...
    public final void animateAppearance() {
        ...
        if (isAppearanceAnimationInProgress() || finiteAnimationSpec == null || graphicsLayer == null) {
            if (isDisappearanceAnimationInProgress()) {
                ...
                BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C02711(null), 3, null);
                return;
            }
            return;
        }
    ...
    static final class C02711 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C02711(continuation);
        }
    ...
    public final void animateDisappearance() {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C02721(finiteAnimationSpec, graphicsLayer, null), 3, null);
    }
    ...
    static final class C02721 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02721(FiniteAnimationSpec<Float> finiteAnimationSpec, GraphicsLayer graphicsLayer, Continuation<? super C02721> continuation) {
            super(2, continuation);
            this.$spec = finiteAnimationSpec;
            this.$layer = graphicsLayer;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C02721(this.$spec, this.$layer, continuation);
        }
    ...
    public final void release() {
        ...
        if (isAppearanceAnimationInProgress()) {
            ...
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C02752(null), 3, null);
        }
        if (isDisappearanceAnimationInProgress()) {
        ...
        m865setPlacementDeltagyyYBs(IntOffset.INSTANCE.m5986getZeronOccac());
    ...
    static final class C02752 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C02752(Continuation<? super C02752> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C02752(continuation);
        }
    ...
    public static final class Companion {
        ...
        public final long m874getNotInitializednOccac() {
