...
public final class ObservableScopeInvalidator {
    ...
    public static final /* synthetic */ ObservableScopeInvalidator m893boximpl(MutableState mutableState) {
        return new ObservableScopeInvalidator(mutableState);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static MutableState<Unit> m894constructorimpl(MutableState<Unit> mutableState) {
        return mutableState;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m896equalsimpl(MutableState<Unit> mutableState, Object obj) {
    ...
    public static final boolean m897equalsimpl0(MutableState<Unit> mutableState, MutableState<Unit> mutableState2) {
        return Intrinsics.areEqual(mutableState, mutableState2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m898hashCodeimpl(MutableState<Unit> mutableState) {
        return mutableState.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m900toStringimpl(MutableState<Unit> mutableState) {
        return "ObservableScopeInvalidator(state=" + mutableState + ')';
    }

    public boolean equals(Object obj) {
        return m896equalsimpl(this.state, obj);
    }

    public int hashCode() {
        return m898hashCodeimpl(this.state);
    }

    public String toString() {
        return m900toStringimpl(this.state);
    }
    ...
    public static /* synthetic */ MutableState m895constructorimpl$default(MutableState mutableState, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            mutableState = SnapshotStateKt.mutableStateOf(Unit.INSTANCE, SnapshotStateKt.neverEqualPolicy());
        }
        return m894constructorimpl(mutableState);
    }

    /* renamed from: attachToScope-impl, reason: not valid java name */
    public static final void m892attachToScopeimpl(MutableState<Unit> mutableState) {
        mutableState.getValue();
    }

    /* renamed from: invalidateScope-impl, reason: not valid java name */
    public static final void m899invalidateScopeimpl(MutableState<Unit> mutableState) {
