        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyStaggeredGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m931invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridMeasureResult m931invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    long jIntOffset;
                    ObservableScopeInvalidator.m892attachToScopeimpl(lazyStaggeredGridState.m936getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                    CheckScrollableContainerConstraintsKt.m288checkScrollableContainerConstraintsK40F9xA(j, orientation);
                    LazyStaggeredGridSlots lazyStaggeredGridSlotsMo912invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider.mo912invoke0kLqBqw(lazyLayoutMeasureScope, j);
                    ...
                    int i2 = lazyLayoutMeasureScope.mo391roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i3 = lazyLayoutMeasureScope.mo391roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i4 = lazyLayoutMeasureScope.mo391roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(paddingValues, orientation, lazyLayoutMeasureScope.getLayoutDirection()));
                    int iM5786getMaxHeightimpl = ((z2 ? Constraints.m5786getMaxHeightimpl(j) : Constraints.m5787getMaxWidthimpl(j)) - i2) - i3;
                    if (z2) {
                    ...
                    int i5 = lazyLayoutMeasureScope.mo391roundToPx0680j_4(Dp.m5844constructorimpl(PaddingKt.calculateStartPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues3 = paddingValues;
                    boolean z3 = z2;
                    LazyStaggeredGridMeasureResult lazyStaggeredGridMeasureResultM929measureStaggeredGridXtK8cYQ = LazyStaggeredGridMeasureKt.m929measureStaggeredGridXtK8cYQ(lazyLayoutMeasureScope, lazyStaggeredGridState, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridState.getPinnedItems(), lazyStaggeredGridState.getBeyondBoundsInfo()), lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridSlotsMo912invoke0kLqBqw, Constraints.m5778copyZbe2FdA$default(j, ConstraintsKt.m5804constrainWidthK40F9xA(j, i5), 0, ConstraintsKt.m5803constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo391roundToPx0680j_4(Dp.m5844constructorimpl(paddingValues3.getTop() + paddingValues3.getBottom()))), 0, 10, null), z3, z, j2, iM5786getMaxHeightimpl, lazyLayoutMeasureScope.mo391roundToPx0680j_4(f), i2, i3, coroutineScope, graphicsContext);
                    LazyStaggeredGridState.applyMeasureResult$foundation_release$default(lazyStaggeredGridState, lazyStaggeredGridMeasureResultM929measureStaggeredGridXtK8cYQ, false, 2, null);
                    return lazyStaggeredGridMeasureResultM929measureStaggeredGridXtK8cYQ;
                }
            };
