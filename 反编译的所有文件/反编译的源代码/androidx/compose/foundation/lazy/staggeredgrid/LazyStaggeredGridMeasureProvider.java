...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo926createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m932childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m5799fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m5798fixedHeightOenEA2s(i);
    }

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m933getAndMeasurejy6DScQ(int index, long span) {
        ...
        long jM932childConstraintsJhjzzOo = m932childConstraintsJhjzzOo(iCoerceAtMost, iCoerceAtMost2);
        return mo926createItempitSLOA(index, iCoerceAtMost, iCoerceAtMost2, key, contentType, this.measureScope.mo881measure0kLqBqw(index, jM932childConstraintsJhjzzOo), jM932childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* renamed from: getAndMeasure--hBUhpc */
    public LazyStaggeredGridMeasuredItem mo824getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo926createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo881measure0kLqBqw(index, constraints), constraints);
    }
