...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m5976getXimpl(getOffset()) : IntOffset.m5977getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (animation != null) {
                ...
                if ((m935getMainAxisgyyYBs(offset) <= height && m935getMainAxisgyyYBs(jM5980plusqkQi6aY) <= height) || (m935getMainAxisgyyYBs(offset) >= i2 && m935getMainAxisgyyYBs(jM5980plusqkQi6aY) >= i2)) {
            ...
            if (context.getReverseLayout()) {
                if (getIsVertical()) {
                    iM5976getXimpl = IntOffset.m5976getXimpl(offset);
                } else {
                    iM5976getXimpl = (this.mainAxisLayoutSize - IntOffset.m5976getXimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                if (!getIsVertical()) {
                    iM5977getYimpl = IntOffset.m5977getYimpl(offset);
                } else {
                    iM5977getYimpl = (this.mainAxisLayoutSize - IntOffset.m5977getYimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                offset = IntOffsetKt.IntOffset(iM5976getXimpl, iM5977getYimpl);
            }
            long jM5980plusqkQi6aY2 = IntOffset.m5980plusqkQi6aY(offset, context.getContentOffset());
            if (animation != null) {
    ...
    private final int m935getMainAxisgyyYBs(long j) {
    ...
    private final long m934copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
