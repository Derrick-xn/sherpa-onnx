    ...
    private static final List<LazyListMeasuredItem> createItemsAfterList(List<LazyListMeasuredItem> list, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, int i2, List<Integer> list2, float f, boolean z, LazyListLayoutInfo lazyListLayoutInfo) {
        ...
        if (index2 <= iMin2) {
            ...
            while (true) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m823getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, index2, 0L, 2, null));
                if (index2 == iMin2) {
                    break;
                }
                index2++;
            ...
            if (lazyListItemInfo != null && (index = lazyListItemInfo.getIndex()) <= (iMin = Math.min(lazyListItemInfo2.getIndex(), i3))) {
                while (true) {
                    ...
                    if (lazyListMeasuredItem4 == null) {
                        ...
                        arrayList.add(LazyListMeasuredItemProvider.m823getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, index, 0L, 2, null));
                    }
                    if (index == iMin) {
                        break;
                    }
            ...
            if (viewportEndOffset > 0.0f) {
                ...
                while (index3 < i && i5 < viewportEndOffset) {
                    ...
                    if (lazyListMeasuredItem != null) {
                        ...
                        arrayList.add(LazyListMeasuredItemProvider.m823getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, index3, 0L, 2, null));
                        index3++;
        ...
        for (int i8 = 0; i8 < size5; i8++) {
            ...
            if (iIntValue > iMin2) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m823getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, iIntValue, 0L, 2, null));
            }
        }
    ...
    private static final List<LazyListMeasuredItem> createItemsBeforeList(int i, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i2, List<Integer> list) {
        ...
        if (iMax <= i3) {
            while (true) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m823getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i3, 0L, 2, null));
                if (i3 == iMax) {
                    break;
                }
                i3--;
