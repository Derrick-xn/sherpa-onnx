...
public final class LazyListMeasuredItem implements LazyListItemInfo, LazyLayoutMeasuredItem {
    ...
    public final void applyScrollDelta(int delta, boolean updateAnimations) {
        ...
        if (updateAnimations) {
            ...
            for (int i2 = 0; i2 < placeablesCount; i2++) {
                ...
                if (animation != null) {
                    long jM870getRawOffsetnOccac = animation.getRawOffset();
                    int iM5976getXimpl = getIsVertical() ? IntOffset.m5976getXimpl(jM870getRawOffsetnOccac) : Integer.valueOf(IntOffset.m5976getXimpl(jM870getRawOffsetnOccac) + delta).intValue();
                    boolean isVertical = getIsVertical();
                    int iM5977getYimpl = IntOffset.m5977getYimpl(jM870getRawOffsetnOccac);
                    if (isVertical) {
                        iM5977getYimpl += delta;
                    }
                    animation.m873setRawOffsetgyyYBs(IntOffsetKt.IntOffset(iM5976getXimpl, iM5977getYimpl));
                }
            }
        }
    }
    ...
    public final void place(Placeable.PlacementScope scope, boolean isLookingAhead) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long jMo822getOffsetBjo55l4 = mo822getOffsetBjo55l4(i);
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), i);
            if (animation != null) {
                if (isLookingAhead) {
                    animation.m872setLookaheadOffsetgyyYBs(jMo822getOffsetBjo55l4);
                } else {
                    if (!IntOffset.m5975equalsimpl0(animation.getLookaheadOffset(), LazyLayoutItemAnimation.INSTANCE.m874getNotInitializednOccac())) {
                        jMo822getOffsetBjo55l4 = animation.getLookaheadOffset();
                    }
                    long jM5980plusqkQi6aY = IntOffset.m5980plusqkQi6aY(jMo822getOffsetBjo55l4, animation.m869getPlacementDeltanOccac());
                    if ((m820getMainAxisgyyYBs(jMo822getOffsetBjo55l4) <= mainAxisSize && m820getMainAxisgyyYBs(jM5980plusqkQi6aY) <= mainAxisSize) || (m820getMainAxisgyyYBs(jMo822getOffsetBjo55l4) >= i2 && m820getMainAxisgyyYBs(jM5980plusqkQi6aY) >= i2)) {
                        animation.cancelPlacementAnimation();
                    }
                    jMo822getOffsetBjo55l4 = jM5980plusqkQi6aY;
                }
            ...
            if (this.reverseLayout) {
                int iM5976getXimpl = getIsVertical() ? IntOffset.m5976getXimpl(jMo822getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m5976getXimpl(jMo822getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (getIsVertical()) {
                    iM5977getYimpl = (this.mainAxisLayoutSize - IntOffset.m5977getYimpl(jMo822getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM5977getYimpl = IntOffset.m5977getYimpl(jMo822getOffsetBjo55l4);
                }
                jMo822getOffsetBjo55l4 = IntOffsetKt.IntOffset(iM5976getXimpl, iM5977getYimpl);
            }
            long jM5980plusqkQi6aY2 = IntOffset.m5980plusqkQi6aY(jMo822getOffsetBjo55l4, this.visualOffset);
    ...
    private final int m820getMainAxisgyyYBs(long j) {
    ...
    private final long m819copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
