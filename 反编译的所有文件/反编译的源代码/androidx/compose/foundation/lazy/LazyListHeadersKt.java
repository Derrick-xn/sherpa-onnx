...
public final class LazyListHeadersKt {
    public static final LazyListMeasuredItem findOrComposeLazyListHeader(List<LazyListMeasuredItem> list, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, List<Integer> list2, int i, int i2, int i3) {
        ...
        LazyListMeasuredItem lazyListMeasuredItemM823getAndMeasure0kLqBqw$default = LazyListMeasuredItemProvider.m823getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, iIntValue2, 0L, 2, null);
        lazyListMeasuredItemM823getAndMeasure0kLqBqw$default.setNonScrollableItem(true);
        int iMax = offset != Integer.MIN_VALUE ? Math.max(-i, offset) : -i;
        if (offset2 != Integer.MIN_VALUE) {
            iMax = Math.min(iMax, offset2 - lazyListMeasuredItemM823getAndMeasure0kLqBqw$default.getSize());
        }
        lazyListMeasuredItemM823getAndMeasure0kLqBqw$default.position(iMax, i2, i3);
        if (i5 != -1) {
            list.set(i5, lazyListMeasuredItemM823getAndMeasure0kLqBqw$default);
        } else {
            list.add(0, lazyListMeasuredItemM823getAndMeasure0kLqBqw$default);
        }
        return lazyListMeasuredItemM823getAndMeasure0kLqBqw$default;
    }
}