...
public final class BasicMarqueeKt {
    ...
    public static /* synthetic */ Modifier m266basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = MarqueeDefaults.INSTANCE.getIterations();
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.INSTANCE.m338getImmediatelyZbEOnfQ();
        }
        int i6 = i2;
        if ((i5 & 4) != 0) {
        ...
        int i7 = i3;
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m334equalsimpl0(i6, MarqueeAnimationMode.INSTANCE.m338getImmediatelyZbEOnfQ()) ? i7 : 0;
        }
        int i8 = i4;
        if ((i5 & 16) != 0) {
        ...
        if ((i5 & 32) != 0) {
            f = MarqueeDefaults.INSTANCE.m340getVelocityD9Ej5fM();
        }
        return m265basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m265basicMarquee1Mj1MLw(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
    ...
    public static final AnimationSpec<Float> m267createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> tweenSpecVelocityBasedTween = velocityBasedTween(Math.abs(density.mo397toPx0680j_4(f2)), f, i3);
        long jM198constructorimpl$default = StartOffset.m198constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m162infiniteRepeatable9IiC70o$default(tweenSpecVelocityBasedTween, null, jM198constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m164repeatable91I0pcU$default(i, tweenSpecVelocityBasedTween, null, jM198constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m263MarqueeSpacing0680j_4(final float f) {
    ...
    public static final int MarqueeSpacing_0680j_4$lambda$1(float f, Density density, int i, int i2) {
        return density.mo391roundToPx0680j_4(f);
    }
}