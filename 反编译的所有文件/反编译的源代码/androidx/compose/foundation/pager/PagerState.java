...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int i, float f, PrefetchScheduler prefetchScheduler) {
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3033boximpl(Offset.INSTANCE.m3060getZeroF1C5BW0()), null, 2, null);
            ...
            this.prefetchState = new LazyLayoutPrefetchState(prefetchScheduler, null, 2, 0 == true ? 1 : 0);
            ...
            this.placementScopeInvalidator = ObservableScopeInvalidator.m895constructorimpl$default(null, 1, null);
            this.measurementScopeInvalidator = ObservableScopeInvalidator.m895constructorimpl$default(null, 1, null);
    ...
    public final long m966getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m968setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m3033boximpl(j));
    }
    ...
    public final float performScroll(float delta) {
        ...
        if (value.tryToApplyScrollWithoutRemeasure(-i)) {
            ...
            ObservableScopeInvalidator.m899invalidateScopeimpl(this.placementScopeInvalidator);
    ...
    public final float getPositionThresholdFraction$foundation_release() {
        return Math.min(this.density.mo397toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    public final void m967setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public final MutableState<Unit> m964getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final void snapToItem$foundation_release(int page, float offsetFraction, boolean forceRemeasure) {
        ...
        ObservableScopeInvalidator.m899invalidateScopeimpl(this.measurementScopeInvalidator);
    }

    /* renamed from: getMeasurementScopeInvalidator-zYiylxw$foundation_release, reason: not valid java name */
    public final MutableState<Unit> m963getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    static final class C02841 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PagerState.this.new C02841(continuation);
        }
    ...
    public final void requestScrollToPage(int page, float pageOffsetFraction) {
        if (isScrollInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.pagerLayoutInfoState.getValue().getCoroutineScope(), null, null, new C02841(null), 3, null);
        }
    ...
    */
    static /* synthetic */ java.lang.Object scroll$suspendImpl(androidx.compose.foundation.pager.PagerState r5, androidx.compose.foundation.MutatePriority r6, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) throws java.lang.Throwable {
        /*
            boolean r0 = r8 instanceof androidx.compose.foundation.pager.PagerState.C02851
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.pager.PagerState$scroll$1 r0 = (androidx.compose.foundation.pager.PagerState.C02851) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        if (getLayoutInfo().getOrientation() != Orientation.Vertical ? Math.signum(scrollDelta) != Math.signum(-Offset.m3044getXimpl(m966getUpDownDifferenceF1C5BW0$foundation_release())) : Math.signum(scrollDelta) != Math.signum(-Offset.m3045getYimpl(m966getUpDownDifferenceF1C5BW0$foundation_release()))) {
    ...
    private final boolean isNotGestureAction() {
        return ((int) Offset.m3044getXimpl(m966getUpDownDifferenceF1C5BW0$foundation_release())) == 0 && ((int) Offset.m3045getYimpl(m966getUpDownDifferenceF1C5BW0$foundation_release())) == 0;
    }
    ...
    private final void notifyPrefetch(float delta, PagerLayoutInfo info) {
        ...
        if (this.prefetchingEnabled && (!info.getVisiblePagesInfo().isEmpty())) {
            ...
            if (index != this.indexToPrefetch) {
                ...
                this.currentPrefetchHandle = this.prefetchState.m890schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
            }
            if (z) {
