...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m5844constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        DefaultPagerState defaultPagerState = (DefaultPagerState) RememberSaveableKt.m2871rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo pagerLayoutInfo, int i) {
        ...
        int iM6018getWidthimpl = pagerLayoutInfo.getOrientation() == Orientation.Horizontal ? IntSize.m6018getWidthimpl(pagerLayoutInfo.mo957getViewportSizeYbymL2g()) : IntSize.m6017getHeightimpl(pagerLayoutInfo.mo957getViewportSizeYbymL2g());
        return RangesKt.coerceAtLeast(pageSpacing - (iM6018getWidthimpl - RangesKt.coerceIn(pagerLayoutInfo.getSnapPosition().position(iM6018getWidthimpl, pagerLayoutInfo.getPageSize(), pagerLayoutInfo.getBeforeContentPadding(), pagerLayoutInfo.getAfterContentPadding(), i - 1, i), 0, iM6018getWidthimpl)), 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long calculateNewMinScrollOffset(PagerMeasureResult pagerMeasureResult, int i) {
        int iM6018getWidthimpl = pagerMeasureResult.getOrientation() == Orientation.Horizontal ? IntSize.m6018getWidthimpl(pagerMeasureResult.mo957getViewportSizeYbymL2g()) : IntSize.m6017getHeightimpl(pagerMeasureResult.mo957getViewportSizeYbymL2g());
        return RangesKt.coerceIn(pagerMeasureResult.getSnapPosition().position(iM6018getWidthimpl, pagerMeasureResult.getPageSize(), pagerMeasureResult.getBeforeContentPadding(), pagerMeasureResult.getAfterContentPadding(), 0, i), 0, iM6018getWidthimpl);
    }
    ...
    public static final Object animateScrollToPage(LazyLayoutAnimateScrollScope lazyLayoutAnimateScrollScope, int i, float f, AnimationSpec<Float> animationSpec, Function2<? super ScrollScope, ? super Integer, Unit> function2, Continuation<? super Unit> continuation) {
        Object objScroll = lazyLayoutAnimateScrollScope.scroll(new AnonymousClass2(function2, i, lazyLayoutAnimateScrollScope, f, animationSpec, null), continuation);
