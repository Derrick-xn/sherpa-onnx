...
public final class PagerLayoutInfoKt {
    public static final int getMainAxisViewportSize(PagerLayoutInfo pagerLayoutInfo) {
        return pagerLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m6017getHeightimpl(pagerLayoutInfo.mo957getViewportSizeYbymL2g()) : IntSize.m6018getWidthimpl(pagerLayoutInfo.mo957getViewportSizeYbymL2g());
    }
}