...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long jM953getOffsetBjo55l4 = m953getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                int iM5976getXimpl = this.isVertical ? IntOffset.m5976getXimpl(jM953getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m5976getXimpl(jM953getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    iM5977getYimpl = (this.mainAxisLayoutSize - IntOffset.m5977getYimpl(jM953getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM5977getYimpl = IntOffset.m5977getYimpl(jM953getOffsetBjo55l4);
                }
                jM953getOffsetBjo55l4 = IntOffsetKt.IntOffset(iM5976getXimpl, iM5977getYimpl);
            }
            long jM5980plusqkQi6aY = IntOffset.m5980plusqkQi6aY(jM953getOffsetBjo55l4, this.visualOffset);
            if (this.isVertical) {
                Placeable.PlacementScope.m4753placeWithLayeraW9wM$default(scope, placeable, jM5980plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            } else {
                Placeable.PlacementScope.m4751placeRelativeWithLayeraW9wM$default(scope, placeable, jM5980plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            }
        }
    }
    ...
    private final long m953getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
        int i = index * 2;
    ...
    private final long m952copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int iM5976getXimpl = this.isVertical ? IntOffset.m5976getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m5976getXimpl(j))).intValue();
        boolean z = this.isVertical;
