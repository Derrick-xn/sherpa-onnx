...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m288checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        ...
        } else if (Constraints.m5787getMaxWidthimpl(j) == Integer.MAX_VALUE) {
