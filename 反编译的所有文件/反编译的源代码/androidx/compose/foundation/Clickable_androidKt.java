...
public final class Clickable_androidKt {
    ...
    public static final boolean m307isPressZmokQxo(KeyEvent keyEvent) {
        return KeyEventType.m4395equalsimpl0(KeyEvent_androidKt.m4403getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4399getKeyDownCS__XNY()) && m306isEnterZmokQxo(keyEvent);
    }

    /* renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m305isClickZmokQxo(KeyEvent keyEvent) {
        return KeyEventType.m4395equalsimpl0(KeyEvent_androidKt.m4403getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4400getKeyUpCS__XNY()) && m306isEnterZmokQxo(keyEvent);
    }

    /* renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m306isEnterZmokQxo(KeyEvent keyEvent) {
        int iM4409getNativeKeyCodeYVgTNJs = Key_androidKt.m4409getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m4402getKeyZmokQxo(keyEvent));
        return iM4409getNativeKeyCodeYVgTNJs == 23 || iM4409getNativeKeyCodeYVgTNJs == 66 || iM4409getNativeKeyCodeYVgTNJs == 160;
    }
}