...
public final class DividerKt {
    ...
    public static final void m1670Divider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    f = DividerDefaults.INSTANCE.m1669getThicknessD9Ej5fM();
                }
                if ((i2 & 4) != 0) {
            ...
            if (Dp.m5849equalsimpl0(f, Dp.INSTANCE.m5862getHairlineD9Ej5fM())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object objConsume = composerStartRestartGroup.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                fM5844constructorimpl = Dp.m5844constructorimpl(1.0f / ((Density) objConsume).getDensity());
            } else {
                fM5844constructorimpl = f;
            }
            composerStartRestartGroup.endReplaceableGroup();
            BoxKt.Box(BackgroundKt.m260backgroundbw27NRU$default(SizeKt.m742height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), fM5844constructorimpl), j, null, 2, null), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer2, int i6) {
                DividerKt.m1670Divider9IZ8Weo(modifier2, f2, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}