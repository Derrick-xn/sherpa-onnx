...
public final class ScaffoldKt {
    ...
    private static final float FabSpacing = Dp.m5844constructorimpl(16);
    ...
    */
    ...
    public static final void m1851ScaffoldLayoutFMILGgc(final int i, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final WindowInsets windowInsets, final Function2<? super Composer, ? super Integer, Unit> function24, Composer composer, final int i2) {
        ...
        if ((2995931 & i5) != 599186 || !composerStartRestartGroup.getSkipping()) {
            ...
            Object[] objArr = {function2, function22, windowInsets, function23, FabPosition.m1691boximpl(i), function24, function3};
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                objRememberedValue = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                        return m1853invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                    }

                    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                    public final MeasureResult m1853invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, long j) {
                        ...
                        final long jM5778copyZbe2FdA$default = Constraints.m5778copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                        ...
                        return MeasureScope.CC.layout$default(SubcomposeLayout, iM5787getMaxWidthimpl, iM5786getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                long j2 = jM5778copyZbe2FdA$default;
                                ...
                                while (it.hasNext()) {
                                    arrayList.add(((Measurable) it.next()).mo4680measureBRTryo0(j2));
                                }
                                ...
                                long j3 = jM5778copyZbe2FdA$default;
                                ...
                                while (it3.hasNext()) {
                                    ...
                                    arrayList4.add(((Measurable) it3.next()).mo4680measureBRTryo0(ConstraintsKt.m5806offsetNN6EwU(j3, (-windowInsets3.getLeft(subcomposeMeasureScope2, subcomposeMeasureScope.getLayoutDirection())) - windowInsets3.getRight(subcomposeMeasureScope2, subcomposeMeasureScope.getLayoutDirection()), -windowInsets3.getBottom(subcomposeMeasureScope2))));
                                ...
                                if (!arrayList7.isEmpty()) {
                                    ...
                                    fabPlacement = new FabPlacement(FabPosition.m1694equalsimpl0(i7, FabPosition.INSTANCE.m1699getEndERTFSPs()) ? SubcomposeLayout.getLayoutDirection() == LayoutDirection.Ltr ? (iM5787getMaxWidthimpl - SubcomposeLayout.mo391roundToPx0680j_4(ScaffoldKt.FabSpacing)) - width6 : SubcomposeLayout.mo391roundToPx0680j_4(ScaffoldKt.FabSpacing) : (iM5787getMaxWidthimpl - width6) / 2, width6, ((Placeable) next6).getHeight());
                                } else {
                                    fabPlacement = null;
                                }
                                ...
                                List<Measurable> listSubcompose4 = subcomposeMeasureScope5.subcompose(scaffoldLayoutContent, ComposableLambdaKt.composableLambdaInstance(-1455477816, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1
                                    ...
                                    public final void invoke(Composer composer3, int i10) {
                                        ...
                                        if ((i10 & 11) != 2 || !composer3.getSkipping()) {
                                            ...
                                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ScaffoldKt.getLocalFabPlacement().provides(fabPlacement)}, function29, composer3, ((i9 >> 15) & 112) | 8);
                                            if (ComposerKt.isTraceInProgress()) {
                                ...
                                long j5 = jM5778copyZbe2FdA$default;
                                ...
                                while (it9.hasNext()) {
                                    arrayList9.add(((Measurable) it9.next()).mo4680measureBRTryo0(j5));
                                }
                                ...
                                if (fabPlacement != null) {
                                    ...
                                    numValueOf = Integer.valueOf(numValueOf2 == null ? fabPlacement.getHeight() + subcomposeMeasureScope6.mo391roundToPx0680j_4(ScaffoldKt.FabSpacing) + windowInsets2.getBottom(subcomposeMeasureScope6) : numValueOf2.intValue() + fabPlacement.getHeight() + subcomposeMeasureScope6.mo391roundToPx0680j_4(ScaffoldKt.FabSpacing));
                                } else {
                                    numValueOf = null;
                                }
                                    ...
                                    public final void invoke(Composer composer3, int i11) {
                                        ...
                                        if ((i11 & 11) != 2 || !composer3.getSkipping()) {
                                            ...
                                            if (arrayList2.isEmpty()) {
                                                ...
                                                top = subcomposeMeasureScope8.mo394toDpu2uoSUM(height3);
                                            }
                                            if (arrayList10.isEmpty() || (num2 = num) == null) {
                                                bottom = paddingValuesAsPaddingValues.getBottom();
                                            } else {
                                                bottom = subcomposeMeasureScope8.mo394toDpu2uoSUM(num2.intValue());
                                            }
                                            function33.invoke(PaddingKt.m707PaddingValuesa9UjIt4(PaddingKt.calculateStartPadding(paddingValuesAsPaddingValues, subcomposeMeasureScope8.getLayoutDirection()), top, PaddingKt.calculateEndPadding(paddingValuesAsPaddingValues, subcomposeMeasureScope8.getLayoutDirection()), bottom), composer3, Integer.valueOf((i10 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                                ...
                                long j6 = jM5778copyZbe2FdA$default;
                                ...
                                while (it11.hasNext()) {
                                    arrayList12.add(((Measurable) it11.next()).mo4680measureBRTryo0(j6));
                                }
                                ...
                                int i13 = iM5786getMaxHeightimpl;
                                ...
                                if (fabPlacement2 != null) {
                                    int i14 = iM5786getMaxHeightimpl;
            ...
            SubcomposeLayoutKt.SubcomposeLayout(null, (Function2) objRememberedValue, composer2, i3, 1);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$2
            ...
            public final void invoke(Composer composer3, int i7) {
                ScaffoldKt.m1851ScaffoldLayoutFMILGgc(i, function2, function3, function22, function23, windowInsets, function24, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
