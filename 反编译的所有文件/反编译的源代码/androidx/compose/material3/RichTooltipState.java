...
public final class RichTooltipState implements TooltipState {
    ...
    public Object show(Continuation<? super Unit> continuation) {
        Object objShow = TooltipSync.INSTANCE.show(this, isPersistent$material3_release(), continuation);
        return objShow == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objShow : Unit.INSTANCE;
    }

    @Override // androidx.compose.material3.TooltipState
    public Object dismiss(Continuation<? super Unit> continuation) {
        Object objDismissCurrentTooltip = TooltipSync.INSTANCE.dismissCurrentTooltip(this, continuation);
        return objDismissCurrentTooltip == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objDismissCurrentTooltip : Unit.INSTANCE;
    }
}