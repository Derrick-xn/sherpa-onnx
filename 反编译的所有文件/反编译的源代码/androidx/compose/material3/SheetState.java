...
public final class SheetState {
    ...
    public final Object expand(Continuation<? super Unit> continuation) {
        Object objAnimateTo$default = SwipeableV2State.animateTo$default(this.swipeableState, SheetValue.Expanded, 0.0f, continuation, 2, null);
    ...
    public final Object animateTo$material3_release(SheetValue sheetValue, float f, Continuation<? super Unit> continuation) throws Throwable {
        Object objAnimateTo = this.swipeableState.animateTo(sheetValue, f, continuation);
    ...
    public final Object snapTo$material3_release(SheetValue sheetValue, Continuation<? super Unit> continuation) {
        Object objSnapTo = this.swipeableState.snapTo(sheetValue, continuation);
    ...
    public final Object settle$material3_release(float f, Continuation<? super Unit> continuation) throws Throwable {
