...
public final class NavigationRailKt {
    ...
    private static final float NavigationRailHeaderPadding = Dp.m5844constructorimpl(8);
    private static final float NavigationRailItemWidth = NavigationRailTokens.INSTANCE.m2472getContainerWidthD9Ej5fM();
    private static final float NavigationRailItemHeight = NavigationRailTokens.INSTANCE.m2475getNoLabelActiveIndicatorHeightD9Ej5fM();
    ...
    */
    public static final void m1804NavigationRailqi6gXK8(androidx.compose.ui.Modifier r25, long r26, long r28, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r30, androidx.compose.foundation.layout.WindowInsets r31, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 415
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.NavigationRailKt.m1804NavigationRailqi6gXK8(androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
                ...
                public final MeasureResult mo61measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), NavigationRailKt.IconLayoutIdTag)) {
                            ...
                            float f2 = 2;
                            int width = placeableMo4680measureBRTryo02.getWidth() + Layout.mo391roundToPx0680j_4(Dp.m5844constructorimpl(NavigationRailKt.IndicatorHorizontalPadding * f2));
                            int iRoundToInt = MathKt.roundToInt(width * f);
                            int height = placeableMo4680measureBRTryo02.getHeight() + Layout.mo391roundToPx0680j_4(Dp.m5844constructorimpl((function24 == null ? NavigationRailKt.IndicatorVerticalPaddingNoLabel : NavigationRailKt.IndicatorVerticalPaddingWithLabel) * f2));
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), NavigationRailKt.IndicatorRippleLayoutIdTag)) {
                                    ...
                                    if (function24 == null) {
                                        return NavigationRailKt.m1807placeIconX9ElhV4(Layout, placeableMo4680measureBRTryo02, placeableMo4680measureBRTryo03, placeableMo4680measureBRTryo04, j);
                                    }
                                    Intrinsics.checkNotNull(placeableMo4680measureBRTryo0);
                                    return NavigationRailKt.m1808placeLabelAndIconzUg2_y0(Layout, placeableMo4680measureBRTryo0, placeableMo4680measureBRTryo02, placeableMo4680measureBRTryo03, placeableMo4680measureBRTryo04, j, z, f);
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
    ...
    public static final MeasureResult m1807placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int iM5804constrainWidthK40F9xA = ConstraintsKt.m5804constrainWidthK40F9xA(j, Math.max(placeable.getWidth(), Math.max(placeable2.getWidth(), placeable3 != null ? placeable3.getWidth() : 0)));
        final int iM5786getMaxHeightimpl = Constraints.m5786getMaxHeightimpl(j);
        final int width = (iM5804constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height = (iM5786getMaxHeightimpl - placeable.getHeight()) / 2;
        final int width2 = (iM5804constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int height2 = (iM5786getMaxHeightimpl - placeable2.getHeight()) / 2;
        return MeasureScope.CC.layout$default(measureScope, iM5804constrainWidthK40F9xA, iM5786getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable4, (iM5804constrainWidthK40F9xA - placeable4.getWidth()) / 2, (iM5786getMaxHeightimpl - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m1808placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        ...
        final int iM5804constrainWidthK40F9xA = ConstraintsKt.m5804constrainWidthK40F9xA(j, Math.max(placeable2.getWidth(), Math.max(placeable.getWidth(), placeable4 != null ? placeable4.getWidth() : 0)));
        final int width = (iM5804constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int width2 = (iM5804constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int width3 = (iM5804constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int i3 = i2 - measureScope.mo391roundToPx0680j_4(IndicatorVerticalPaddingWithLabel);
        return MeasureScope.CC.layout$default(measureScope, iM5804constrainWidthK40F9xA, iM5786getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$placeLabelAndIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable5 != null) {
                    int i4 = iM5804constrainWidthK40F9xA;
                    int i5 = i2;
                    MeasureScope measureScope2 = measureScope;
                    Placeable.PlacementScope.placeRelative$default(layout, placeable5, (i4 - placeable5.getWidth()) / 2, iRoundToInt + (i5 - measureScope2.mo391roundToPx0680j_4(NavigationRailKt.IndicatorVerticalPaddingWithLabel)), 0.0f, 4, null);
                }
                if (z || f != 0.0f) {
    ...
    static {
        float f = 4;
        NavigationRailVerticalPadding = Dp.m5844constructorimpl(f);
        NavigationRailItemVerticalPadding = Dp.m5844constructorimpl(f);
        float f2 = 2;
        IndicatorHorizontalPadding = Dp.m5844constructorimpl(Dp.m5844constructorimpl(NavigationRailTokens.INSTANCE.m2470getActiveIndicatorWidthD9Ej5fM() - NavigationRailTokens.INSTANCE.m2473getIconSizeD9Ej5fM()) / f2);
        IndicatorVerticalPaddingWithLabel = Dp.m5844constructorimpl(Dp.m5844constructorimpl(NavigationRailTokens.INSTANCE.m2469getActiveIndicatorHeightD9Ej5fM() - NavigationRailTokens.INSTANCE.m2473getIconSizeD9Ej5fM()) / f2);
        IndicatorVerticalPaddingNoLabel = Dp.m5844constructorimpl(Dp.m5844constructorimpl(NavigationRailTokens.INSTANCE.m2475getNoLabelActiveIndicatorHeightD9Ej5fM() - NavigationRailTokens.INSTANCE.m2473getIconSizeD9Ej5fM()) / f2);
    }
}