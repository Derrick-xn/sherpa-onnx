...
public class SwipeableState<T> {
    ...
    /* renamed from: androidx.compose.material3.SwipeableState$snapInternalToOffset$2, reason: invalid class name and case insensitive filesystem */
    static final class C04492 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04492(float f, SwipeableState<T> swipeableState, Continuation<? super C04492> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04492 c04492 = new C04492(this.$target, this.this$0, continuation);
            c04492.L$0 = obj;
            return c04492;
        }
        ...
        public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
            return ((C04492) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object snapInternalToOffset(float f, Continuation<? super Unit> continuation) {
        Object objDrag$default = DraggableState.CC.drag$default(this.draggableState, null, new C04492(f, this, null), continuation, 1, null);
    ...
    /* renamed from: androidx.compose.material3.SwipeableState$animateInternalToOffset$2, reason: invalid class name */
    ...
    public final Object animateInternalToOffset(float f, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        Object objDrag$default = DraggableState.CC.drag$default(this.draggableState, null, new AnonymousClass2(this, f, animationSpec, null), continuation, 1, null);
        return objDrag$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objDrag$default : Unit.INSTANCE;
    }
