...
public final class SwipeableV2State<T> {
    ...
    /* renamed from: androidx.compose.material3.SwipeableV2State$animateTo$1, reason: invalid class name and case insensitive filesystem */
    static final class C04541 extends ContinuationImpl {
        ...
        C04541(SwipeableV2State<T> swipeableV2State, Continuation<? super C04541> continuation) {
            super(continuation);
    ...
    public /* synthetic */ SwipeableV2State(Object obj, SpringSpec<Float> springSpec, AnonymousClass1 anonymousClass1, Function2 function2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        } : anonymousClass1, (i & 8) != 0 ? SwipeableV2Defaults.INSTANCE.getPositionalThreshold() : function2, (i & 16) != 0 ? SwipeableV2Defaults.INSTANCE.m1984getVelocityThresholdD9Ej5fM() : f, null);
    }
    ...
    /* renamed from: androidx.compose.material3.SwipeableV2State$snapTo$2, reason: invalid class name and case insensitive filesystem */
    static final class C04552 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ T $targetValue;
        int label;
        final /* synthetic */ SwipeableV2State<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04552(SwipeableV2State<T> swipeableV2State, T t, Continuation<? super C04552> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C04552(this.this$0, this.$targetValue, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C04552) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object snapTo(T t, Continuation<? super Unit> continuation) {
        Object objSwipe$default = swipe$default(this, null, new C04552(this, t, null), continuation, 1, null);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object animateTo(T r14, float r15, kotlin.coroutines.Continuation<? super kotlin.Unit> r16) throws java.lang.Throwable {
        /*
    ...
    /* renamed from: androidx.compose.material3.SwipeableV2State$animateTo$2, reason: invalid class name */
    ...
    public final T computeTarget(float offset, T currentValue, float velocity) {
        ...
        float fMo397toPx0680j_4 = densityRequireDensity.mo397toPx0680j_4(this.velocityThreshold);
        if (Intrinsics.areEqual(f, offset) || f == null) {
            return currentValue;
        }
        if (f.floatValue() < offset) {
            if (velocity >= fMo397toPx0680j_4) {
    ...
    /* renamed from: androidx.compose.material3.SwipeableV2State$swipe$2, reason: invalid class name and case insensitive filesystem */
    static final class C04562 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04562(SwipeableV2State<T> swipeableV2State, MutatePriority mutatePriority, Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super C04562> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04562(this.this$0, this.$swipePriority, this.$action, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C04562) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object swipe(MutatePriority mutatePriority, Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04562(this, mutatePriority, function1, null), continuation);
    ...
    public static final class Companion {
        ...
        public final <T> Saver<SwipeableV2State<T>, T> m1988SavereqLRuRQ(final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> confirmValueChange, final Function2<? super Density, ? super Float, Float> positionalThreshold, final float velocityThreshold) {
            Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
            Intrinsics.checkNotNullParameter(confirmValueChange, "confirmValueChange");
            Intrinsics.checkNotNullParameter(positionalThreshold, "positionalThreshold");
