...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m137animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m3325equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m3325equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m3325equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m3331hashCodeimpl(this.selectedColor) * 31) + Color.m3331hashCodeimpl(this.unselectedColor)) * 31) + Color.m3331hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m3331hashCodeimpl(this.disabledUnselectedColor);
    }
}