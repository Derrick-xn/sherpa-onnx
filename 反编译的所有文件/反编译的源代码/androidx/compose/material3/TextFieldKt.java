...
public final class TextFieldKt {
    private static final float TextFieldWithLabelVerticalPadding = Dp.m5844constructorimpl(8);
    ...
    */
    ...
    public static final void TextFieldLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> textField, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final boolean z, final float f, final Function2<? super Composer, ? super Integer, Unit> container, final Function2<? super Composer, ? super Integer, Unit> function26, final PaddingValues paddingValues, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m2784setimpl(composerM2777constructorimpl, textFieldMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            if (function23 != null) {
                fCalculateEndPadding = Dp.m5844constructorimpl(RangesKt.coerceAtLeast(Dp.m5844constructorimpl(fCalculateEndPadding - TextFieldImplKt.getHorizontalIconPadding()), Dp.m5844constructorimpl(i6)));
            }
            ...
            if (function2 != null) {
                ...
                Modifier modifierM715paddingqDBjuR0$default3 = PaddingKt.m715paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m744heightInVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.LabelId), DpKt.m5887lerpMdfbLM(TextFieldImplKt.getMinTextLineHeight(), TextFieldImplKt.getMinFocusedLabelLineHeight(), f), 0.0f, 2, null), null, false, 3, null), f3, 0.0f, fCalculateEndPadding, 0.0f, 10, null);
                composerStartRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf6 = LayoutKt.materializerOf(modifierM715paddingqDBjuR0$default3);
                if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                composerStartRestartGroup.startReusableNode();
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierM715paddingqDBjuR0$default4 = PaddingKt.m715paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m744heightInVpY3zN4$default(Modifier.INSTANCE, TextFieldImplKt.getMinTextLineHeight(), 0.0f, 2, null), null, false, 3, null), function24 == null ? f3 : Dp.m5844constructorimpl(0), 0.0f, function25 == null ? f2 : Dp.m5844constructorimpl(0), 0.0f, 10, null);
            ...
            if (function3 != null) {
                function3.invoke(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.PlaceholderId).then(modifierM715paddingqDBjuR0$default4), composerStartRestartGroup, Integer.valueOf((i3 >> 6) & 112));
            }
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierThen3 = LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.TextFieldId).then(modifierM715paddingqDBjuR0$default4);
            composerStartRestartGroup.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final int m2044calculateWidthyeHjK3Y(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j) {
        int i8 = i3 + i4;
        return Math.max(i + Math.max(i5 + i8, Math.max(i7 + i8, i6)) + i2, Constraints.m5789getMinWidthimpl(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-mKXJcVc, reason: not valid java name */
    public static final int m2043calculateHeightmKXJcVc(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z, long j, float f, PaddingValues paddingValues) {
        float fM5844constructorimpl;
        int iMax;
        boolean z2 = i2 > 0;
        if (!z2 || z) {
            fM5844constructorimpl = Dp.m5844constructorimpl(paddingValues.getTop() + paddingValues.getBottom());
        } else {
            fM5844constructorimpl = Dp.m5844constructorimpl(TextFieldImplKt.getTextFieldPadding() * 2);
        }
        float f2 = f * fM5844constructorimpl;
        if (z2 && z) {
            f2 += i2;
            iMax = Math.max(i, i7);
        } else {
        ...
        return Math.max(Constraints.m5788getMinHeightimpl(j), ComparisonsKt.maxOf(i3, i4, i5, i6, MathKt.roundToInt(f2 + iMax)) + i8);
    }
    ...
    public static final void placeWithoutLabel(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, boolean z, float f, PaddingValues paddingValues) {
        Placeable.PlacementScope.m4749place70tqf50$default(placementScope, placeable7, IntOffset.INSTANCE.m5986getZeronOccac(), 0.0f, 2, null);
    ...
    public static final Modifier drawIndicatorLine(Modifier modifier, final BorderStroke indicatorBorder) {
        ...
        return DrawModifierKt.drawWithContent(modifier, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.TextFieldKt.drawIndicatorLine.1
            ...
            public final void invoke2(ContentDrawScope drawWithContent) {
                ...
                if (Dp.m5849equalsimpl0(width, Dp.INSTANCE.m5862getHairlineD9Ej5fM())) {
                    return;
                }
                float density = width * drawWithContent.getDensity();
                float fM3110getHeightimpl = Size.m3110getHeightimpl(drawWithContent.mo3806getSizeNHjbRc()) - (density / 2);
                DrawScope.CC.m3882drawLine1RTmtNc$default(drawWithContent, indicatorBorder.getBrush(), OffsetKt.Offset(0.0f, fM3110getHeightimpl), OffsetKt.Offset(Size.m3113getWidthimpl(drawWithContent.mo3806getSizeNHjbRc()), fM3110getHeightimpl), density, 0, null, 0.0f, null, 0, 496, null);
            }
        });
    }
