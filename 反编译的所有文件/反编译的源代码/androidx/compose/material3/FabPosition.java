...
public final class FabPosition {
    ...
    private static final int Center = m1692constructorimpl(0);
    private static final int End = m1692constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1691boximpl(int i) {
        return new FabPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1692constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1693equalsimpl(int i, Object obj) {
        return (obj instanceof FabPosition) && i == ((FabPosition) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1694equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1695hashCodeimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m1698getCenterERTFSPs() {
            return FabPosition.Center;
        }

        /* renamed from: getEnd-ERTFSPs, reason: not valid java name */
        public final int m1699getEndERTFSPs() {
    ...
    public static String m1696toStringimpl(int i) {
        return m1694equalsimpl0(i, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}