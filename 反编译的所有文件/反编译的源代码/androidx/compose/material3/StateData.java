...
public final class StateData {
    ...
    private StateData(Long l, Long l2, Long l3, IntRange yearRange, int i) {
        ...
        this.displayMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m1660boximpl(i), null, 2, null);
    }
    ...
    public final void m1887switchDisplayModevCnGnXg(int displayMode) {
        ...
        this.displayMode.setValue(DisplayMode.m1660boximpl(displayMode));
    }
        ...
        public final Saver<StateData, Object> Saver() {
            return ListSaverKt.listSaver(new Function2<SaverScope, StateData, List<? extends Object>>() { // from class: androidx.compose.material3.StateData$Companion$Saver$1
                ...
                public final List<Object> invoke(SaverScope listSaver, StateData it) {
                    ...
                    Long lValueOf = value != null ? Long.valueOf(value.getUtcTimeMillis()) : null;
                    CalendarDate value2 = it.getSelectedEndDate().getValue();
                    return CollectionsKt.listOf(lValueOf, value2 != null ? Long.valueOf(value2.getUtcTimeMillis()) : null, Long.valueOf(it.getDisplayedMonth().getStartUtcTimeMillis()), Integer.valueOf(it.getYearRange().getFirst()), Integer.valueOf(it.getYearRange().getLast()), Integer.valueOf(it.getDisplayMode().getValue().getValue()));
                }
                ...
                public final StateData invoke2(List<? extends Object> value) {
                    ...
                    return new StateData(l, l2, l3, intRange, DisplayMode.m1661constructorimpl(((Integer) obj3).intValue()), null);
                }
            });
        }
    }
