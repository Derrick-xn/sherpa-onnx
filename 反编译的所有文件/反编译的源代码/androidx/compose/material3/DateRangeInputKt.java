...
public final class DateRangeInputKt {
    private static final float TextFieldSpacing = Dp.m5844constructorimpl(8);

    public static final void DateRangeInputContent(final StateData stateData, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> dateValidator, Composer composer, final int i) throws Resources.NotFoundException {
        int i2;
        int i3;
        ...
        if ((i4 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            String strM1959getStringNWtq284 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1926getDateRangeInputInvalidRangeInputadMyvUU(), composerStartRestartGroup, 6);
            ...
            if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                DateInputValidator dateInputValidator = new DateInputValidator(stateData, dateInputFormat2, dateFormatter, dateValidator, strM1959getStringNWtq28, strM1959getStringNWtq282, strM1959getStringNWtq283, strM1959getStringNWtq284);
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM587spacedBy0680j_4 = Arrangement.INSTANCE.m587spacedBy0680j_4(TextFieldSpacing);
            composerStartRestartGroup.startReplaceableGroup(693286680);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Row)P(2,1,3)78@3913L58,79@3976L130:Row.kt#2w3rfo");
            MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(horizontalOrVerticalM587spacedBy0680j_4, Alignment.INSTANCE.getTop(), composerStartRestartGroup, i3);
            ...
            final String strM1959getStringNWtq285 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1932getDateRangePickerStartHeadlineadMyvUU(), composerStartRestartGroup, i3);
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 576559191, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$1$1
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    if ((i5 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        String str2 = strM1959getStringNWtq285;
                        Modifier.Companion companion = Modifier.INSTANCE;
                        final String str3 = strM1959getStringNWtq285;
            ...
            ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1726391478, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$1$2
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    TextKt.m2047Text4IGK_g(upperCase, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$1$2.1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
            ...
            DateInputKt.m1626DateInputTextFieldzm97o8M(modifierWeight$default, composableLambda, composableLambda2, stateData, value, (Function1) objRememberedValue3, InputIdentifier.INSTANCE.m1747getStartDateInputJ2x2o4M(), dateInputValidator2, dateInputFormat, locale, composerStartRestartGroup, i5);
            final String strM1959getStringNWtq286 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1929getDateRangePickerEndHeadlineadMyvUU(), composer2, i3);
            ...
            ComposableLambda composableLambda3 = ComposableLambdaKt.composableLambda(composer2, -663502784, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$1$4
                ...
                public final void invoke(Composer composer3, int i6) {
                    ...
                    if ((i6 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        String str3 = strM1959getStringNWtq286;
                        Modifier.Companion companion = Modifier.INSTANCE;
                        final String str4 = strM1959getStringNWtq286;
                        ...
                        composer3.endReplaceableGroup();
                        TextKt.m2047Text4IGK_g(str3, SemanticsModifierKt.semantics$default(companion, false, (Function1) objRememberedValue4, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131068);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            ComposableLambda composableLambda4 = ComposableLambdaKt.composableLambda(composer2, 518729951, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$1$5
                ...
                public final void invoke(Composer composer3, int i6) {
                    ...
                    TextKt.m2047Text4IGK_g(upperCase, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$1$5.1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(SemanticsPropertyReceiver clearAndSetSemantics) {
                            Intrinsics.checkNotNullParameter(clearAndSetSemantics, "$this$clearAndSetSemantics");
                        }
            ...
            DateInputKt.m1626DateInputTextFieldzm97o8M(modifierWeight$default2, composableLambda3, composableLambda4, stateData, value2, (Function1) objRememberedValue4, InputIdentifier.INSTANCE.m1745getEndDateInputJ2x2o4M(), dateInputValidator2, dateInputFormat, locale, composer2, i5);
