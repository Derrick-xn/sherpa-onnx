...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<BorderStroke> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m287BorderStrokecXLIe8U(z2 ? this.selectedBorderWidth : this.borderWidth, j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.borderColor, selectableChipBorder.borderColor) && Color.m3325equalsimpl0(this.selectedBorderColor, selectableChipBorder.selectedBorderColor) && Color.m3325equalsimpl0(this.disabledBorderColor, selectableChipBorder.disabledBorderColor) && Color.m3325equalsimpl0(this.disabledSelectedBorderColor, selectableChipBorder.disabledSelectedBorderColor) && Dp.m5849equalsimpl0(this.borderWidth, selectableChipBorder.borderWidth) && Dp.m5849equalsimpl0(this.selectedBorderWidth, selectableChipBorder.selectedBorderWidth);
    }

    public int hashCode() {
        return (((((((((Color.m3331hashCodeimpl(this.borderColor) * 31) + Color.m3331hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m3331hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m3331hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m5850hashCodeimpl(this.borderWidth)) * 31) + Dp.m5850hashCodeimpl(this.selectedBorderWidth);
    }
}