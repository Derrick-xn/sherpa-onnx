...
final class SwipeAnchorsModifier extends InspectorValueInfo implements LayoutModifier, OnRemeasuredModifier {
    ...
    public MeasureResult mo87measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, placeableMo4680measureBRTryo0.getWidth(), placeableMo4680measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SwipeAnchorsModifier$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo4680measureBRTryo0, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public void mo1977onRemeasuredozmzZPI(long size) {
        this.onSizeChanged.invoke(IntSize.m6010boximpl(size));
    }
