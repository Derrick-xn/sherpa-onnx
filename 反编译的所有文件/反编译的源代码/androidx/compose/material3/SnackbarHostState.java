...
public final class SnackbarHostState {
    ...
    */
    public final java.lang.Object showSnackbar(androidx.compose.material3.SnackbarVisuals r9, kotlin.coroutines.Continuation<? super androidx.compose.material3.SnackbarResult> r10) throws java.lang.Throwable {
        /*
            r8 = this;
    ...
    private static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                cancellableContinuation.resumeWith(Result.m6309constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                CancellableContinuation<SnackbarResult> cancellableContinuation = this.continuation;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m6309constructorimpl(SnackbarResult.Dismissed));
            }
        }
