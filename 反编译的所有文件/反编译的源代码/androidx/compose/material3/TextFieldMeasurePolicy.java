...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo61measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
        Object next;
        Object next2;
        Object next3;
        Placeable placeable;
        ...
        int i = measure.mo391roundToPx0680j_4(this.paddingValues.getTop());
        int i2 = measure.mo391roundToPx0680j_4(this.paddingValues.getBottom());
        ...
        Placeable placeableMo4680measureBRTryo02 = measurable != null ? measurable.mo4680measureBRTryo0(jM5778copyZbe2FdA$default) : null;
        int iWidthOrZero = TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo02);
        int iMax = Math.max(0, TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo02));
        ...
        Placeable placeableMo4680measureBRTryo03 = measurable2 != null ? measurable2.mo4680measureBRTryo0(ConstraintsKt.m5807offsetNN6EwU$default(jM5778copyZbe2FdA$default, -iWidthOrZero, 0, 2, null)) : null;
        int iWidthOrZero2 = iWidthOrZero + TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo03);
        int iMax2 = Math.max(iMax, TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo03));
        ...
        if (measurable3 != null) {
            placeable = placeableMo4680measureBRTryo03;
            placeableMo4680measureBRTryo0 = measurable3.mo4680measureBRTryo0(ConstraintsKt.m5807offsetNN6EwU$default(jM5778copyZbe2FdA$default, -iWidthOrZero2, 0, 2, null));
        } else {
            placeable = placeableMo4680measureBRTryo03;
            placeableMo4680measureBRTryo0 = null;
        }
        int iWidthOrZero3 = iWidthOrZero2 + TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo0);
        int iMax3 = Math.max(iMax2, TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo0));
        ...
        final Placeable placeableMo4680measureBRTryo04 = measurable4 != null ? measurable4.mo4680measureBRTryo0(ConstraintsKt.m5807offsetNN6EwU$default(jM5778copyZbe2FdA$default, -iWidthOrZero3, 0, 2, null)) : null;
        int iWidthOrZero4 = iWidthOrZero3 + TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo04);
        int iMax4 = Math.max(iMax3, TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo04));
        int i3 = -iWidthOrZero4;
        long jM5806offsetNN6EwU = ConstraintsKt.m5806offsetNN6EwU(jM5778copyZbe2FdA$default, i3, -i2);
        ...
        Placeable placeableMo4680measureBRTryo05 = measurable5 != null ? measurable5.mo4680measureBRTryo0(jM5806offsetNN6EwU) : null;
        int iHeightOrZero = TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo05) + i;
        long jM5806offsetNN6EwU2 = ConstraintsKt.m5806offsetNN6EwU(Constraints.m5778copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null), i3, (-iHeightOrZero) - i2);
        ...
        while (true) {
            ...
            if (it7.hasNext()) {
                ...
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable6), TextFieldImplKt.TextFieldId)) {
                    final Placeable placeableMo4680measureBRTryo06 = measurable6.mo4680measureBRTryo0(jM5806offsetNN6EwU2);
                    long jM5778copyZbe2FdA$default2 = Constraints.m5778copyZbe2FdA$default(jM5806offsetNN6EwU2, 0, 0, 0, 0, 14, null);
                    ...
                    Placeable placeableMo4680measureBRTryo07 = measurable7 != null ? measurable7.mo4680measureBRTryo0(jM5778copyZbe2FdA$default2) : null;
                    long jM5778copyZbe2FdA$default3 = Constraints.m5778copyZbe2FdA$default(ConstraintsKt.m5807offsetNN6EwU$default(jM5778copyZbe2FdA$default, 0, -Math.max(iMax4, Math.max(TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo06), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo07)) + iHeightOrZero + i2), 1, null), 0, 0, 0, 0, 11, null);
                    ...
                    final Placeable placeableMo4680measureBRTryo08 = measurable8 != null ? measurable8.mo4680measureBRTryo0(jM5778copyZbe2FdA$default3) : null;
                    int iHeightOrZero2 = TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo08);
                    final int iM2044calculateWidthyeHjK3Y = TextFieldKt.m2044calculateWidthyeHjK3Y(TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo02), TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo0), TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo04), placeableMo4680measureBRTryo06.getWidth(), TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo05), TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo07), j);
                    final int iM2043calculateHeightmKXJcVc = TextFieldKt.m2043calculateHeightmKXJcVc(placeableMo4680measureBRTryo06.getHeight(), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo05), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo02), TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo0), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo04), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo07), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo08), this.animationProgress == 1.0f, j, measure.getDensity(), this.paddingValues);
                    int i5 = iM2043calculateHeightmKXJcVc - iHeightOrZero2;
                    for (Measurable measurable9 : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable9), TextFieldImplKt.ContainerId)) {
                            final Placeable placeableMo4680measureBRTryo09 = measurable9.mo4680measureBRTryo0(ConstraintsKt.Constraints(iM2044calculateWidthyeHjK3Y != Integer.MAX_VALUE ? iM2044calculateWidthyeHjK3Y : 0, iM2044calculateWidthyeHjK3Y, i5 != Integer.MAX_VALUE ? i5 : 0, i5));
                            final Placeable placeable2 = placeableMo4680measureBRTryo05;
                            final Placeable placeable3 = placeableMo4680measureBRTryo07;
                            final Placeable placeable4 = placeableMo4680measureBRTryo02;
                            final Placeable placeable5 = placeable;
                            return MeasureScope.CC.layout$default(measure, iM2044calculateWidthyeHjK3Y, iM2043calculateHeightmKXJcVc, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TextFieldMeasurePolicy$measure$1
                                ...
                                public final void invoke2(Placeable.PlacementScope layout) {
                                    ...
                                    if (placeable6 == null) {
                                        TextFieldKt.placeWithoutLabel(layout, iM2044calculateWidthyeHjK3Y, iM2043calculateHeightmKXJcVc, placeableMo4680measureBRTryo06, placeable3, placeable4, placeable5, placeableMo4680measureBRTryo0, placeableMo4680measureBRTryo04, placeableMo4680measureBRTryo09, placeableMo4680measureBRTryo08, this.singleLine, measure.getDensity(), this.paddingValues);
                                        return;
                                    }
                                    int i6 = iM2044calculateWidthyeHjK3Y;
                                    int i7 = iM2043calculateHeightmKXJcVc;
                                    Placeable placeable7 = placeableMo4680measureBRTryo06;
                                    Placeable placeable8 = placeable3;
                                    Placeable placeable9 = placeable4;
                                    Placeable placeable10 = placeable5;
                                    Placeable placeable11 = placeableMo4680measureBRTryo0;
                                    Placeable placeable12 = placeableMo4680measureBRTryo04;
                                    Placeable placeable13 = placeableMo4680measureBRTryo09;
                                    Placeable placeable14 = placeableMo4680measureBRTryo08;
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        for (Object obj2 : list) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj2), TextFieldImplKt.TextFieldId)) {
                ...
                return TextFieldKt.m2044calculateWidthyeHjK3Y(iIntValue6, iIntValue3, iIntValue4, iIntValue5, iIntValue, iIntValue2, intrinsicMeasurable6 != null ? intrinsicMeasurer.invoke(intrinsicMeasurable6, Integer.valueOf(height)).intValue() : 0, TextFieldImplKt.getZeroConstraints());
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
