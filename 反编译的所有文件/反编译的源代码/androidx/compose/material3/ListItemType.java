...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m1761constructorimpl(1);
    private static final int TwoLine = m1761constructorimpl(2);
    private static final int ThreeLine = m1761constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m1759boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1761constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1762equalsimpl(int i, Object obj) {
    ...
    public boolean equals(Object obj) {
        return m1762equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m1764hashCodeimpl(this.lines);
    }

    public String toString() {
        return m1765toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m1766compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m1760compareToyh95HIg(int i, int i2) {
        return Intrinsics.compare(i, i2);
    }

    /* renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m1766compareToyh95HIg(int i) {
        return m1760compareToyh95HIg(this.lines, i);
    }
    ...
    public static final class Companion {
        ...
        public final int m1769getOneLineAlXitO8() {
            return ListItemType.OneLine;
        }

        /* renamed from: getTwoLine-AlXitO8, reason: not valid java name */
        public final int m1771getTwoLineAlXitO8() {
            return ListItemType.TwoLine;
        }

        /* renamed from: getThreeLine-AlXitO8, reason: not valid java name */
        public final int m1770getThreeLineAlXitO8() {
            return ListItemType.ThreeLine;
        }

        /* renamed from: getListItemType-7AlIA9s$material3_release, reason: not valid java name */
        public final int m1768getListItemType7AlIA9s$material3_release(boolean hasOverline, boolean hasSupporting) {
            if (hasOverline && hasSupporting) {
                return m1770getThreeLineAlXitO8();
            }
            if (hasOverline || hasSupporting) {
                return m1771getTwoLineAlXitO8();
            }
            return m1769getOneLineAlXitO8();
        }
    }
}