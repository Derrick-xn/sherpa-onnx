...
public final class SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m3325equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m3325equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m3325equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m3325equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m3325equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m3325equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m3325equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m3325equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m3325equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m3325equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m3325equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m3325equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((Color.m3331hashCodeimpl(this.containerColor) * 31) + Color.m3331hashCodeimpl(this.labelColor)) * 31) + Color.m3331hashCodeimpl(this.leadingIconColor)) * 31) + Color.m3331hashCodeimpl(this.trailingIconColor)) * 31) + Color.m3331hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3331hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3331hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3331hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m3331hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m3331hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m3331hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m3331hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m3331hashCodeimpl(this.selectedTrailingIconColor);
    }
}