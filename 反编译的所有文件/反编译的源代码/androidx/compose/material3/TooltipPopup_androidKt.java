...
public final class TooltipPopup_androidKt {
    public static final void TooltipPopup(final PopupPositionProvider popupPositionProvider, final Function0<Unit> onDismissRequest, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TooltipPopup)P(2,1)29@1039L174:TooltipPopup.android.kt#uh7d8r");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            AndroidPopup_androidKt.Popup(popupPositionProvider, onDismissRequest, new PopupProperties(true, false, false, (SecureFlagPolicy) null, false, false, 62, (DefaultConstructorMarker) null), content, composerStartRestartGroup, (i2 & 14) | 384 | (i2 & 112) | ((i2 << 3) & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TooltipPopup_androidKt.TooltipPopup.1
            ...
            public final void invoke(Composer composer2, int i3) {
                TooltipPopup_androidKt.TooltipPopup(popupPositionProvider, onDismissRequest, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
}