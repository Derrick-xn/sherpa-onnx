...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m2171topAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        long jM1586applyTonalElevationHht5A8o = (i2 & 2) != 0 ? ColorSchemeKt.m1586applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer, 6), color, TopAppBarSmallTokens.INSTANCE.m2685getOnScrollContainerElevationD9Ej5fM()) : j2;
        ...
        TopAppBarColors topAppBarColors = new TopAppBarColors(color, jM1586applyTonalElevationHht5A8o, color2, color3, color4, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TopAppBarColors m2170smallTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        TopAppBarColors topAppBarColorsM2171topAppBarColorszjMxDiM = m2171topAppBarColorszjMxDiM(color, jM1586applyTonalElevationHht5A8o, color2, color3, color4, composer, (i & 14) | (i & 112) | (i & 896) | (i & 7168) | (57344 & i) | (i & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return topAppBarColorsM2171topAppBarColorszjMxDiM;
    }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets windowInsetsM782onlybOOhFvg = WindowInsetsKt.m782onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 8), WindowInsetsSides.m792plusgK_yJZ4(WindowInsetsSides.INSTANCE.m802getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m806getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final TopAppBarColors m2167centerAlignedTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
    ...
    public final TopAppBarColors m2169mediumTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
    ...
    public final TopAppBarColors m2168largeTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
