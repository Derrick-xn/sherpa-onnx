...
public class FloatingActionButtonElevation {
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5842boximpl(f2), new AnonymousClass2(animatable, this, f2, interaction, null), composer, 64);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5849equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m5849equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m5849equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation) && Dp.m5849equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
    }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (Dp.m5849equalsimpl0(fM5858unboximpl, this.this$0.pressedElevation)) {
                    focus = new PressInteraction.Press(Offset.INSTANCE.m3060getZeroF1C5BW0(), null);
                ...
                this.label = 1;
                if (ElevationKt.m1683animateElevationrAjV9yQ(this.$animatable, this.$target, focus, this.$interaction, this) == coroutine_suspended) {
