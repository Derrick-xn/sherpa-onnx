...
public final class SurfaceKt {
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteTonalElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material3.SurfaceKt$LocalAbsoluteTonalElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m5842boximpl(m1976invokeD9Ej5fM());
        }

        /* renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1976invokeD9Ej5fM() {
            return Dp.m5844constructorimpl(0);
        }
    }, 1, null);

    /* renamed from: Surface-T9BRK9s, reason: not valid java name */
    public static final void m1968SurfaceT9BRK9s(Modifier modifier, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, int i2) {
        ...
        final long jM1552getSurface0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1552getSurface0d7_KjU() : j;
        long jM1588contentColorForek8zF_U = (i2 & 8) != 0 ? ColorSchemeKt.m1588contentColorForek8zF_U(jM1552getSurface0d7_KjU, composer, (i >> 6) & 14) : j2;
        float fM5844constructorimpl = (i2 & 16) != 0 ? Dp.m5844constructorimpl(0) : f;
        float fM5844constructorimpl2 = (i2 & 32) != 0 ? Dp.m5844constructorimpl(0) : f2;
        ...
        final float fM5844constructorimpl3 = Dp.m5844constructorimpl(((Dp) objConsume).m5858unboximpl() + fM5844constructorimpl);
        ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m3314boximpl(jM1588contentColorForek8zF_U)), providableCompositionLocal.provides(Dp.m5842boximpl(fM5844constructorimpl3))};
        final BorderStroke borderStroke3 = borderStroke2;
        final float f3 = fM5844constructorimpl2;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, -70914509, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1
            ...
            public final void invoke(Composer composer2, int i3) {
                ...
                if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier modifierPointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(SurfaceKt.m1974surface8ww4TTg(companion, rectangleShape, SurfaceKt.m1975surfaceColorAtElevationCLU3JFs(jM1552getSurface0d7_KjU, fM5844constructorimpl3, composer2, (i >> 6) & 14), borderStroke3, f3), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1.1
    ...
    public static final void m1971Surfaceo_FOJdg(final Function0<Unit> onClick, Modifier modifier, boolean z, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        ...
        long jM1552getSurface0d7_KjU = (i3 & 16) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1552getSurface0d7_KjU() : j;
        long jM1588contentColorForek8zF_U = (i3 & 32) != 0 ? ColorSchemeKt.m1588contentColorForek8zF_U(jM1552getSurface0d7_KjU, composer, (i >> 12) & 14) : j2;
        float fM5844constructorimpl = (i3 & 64) != 0 ? Dp.m5844constructorimpl(0) : f;
        float fM5844constructorimpl2 = (i3 & 128) != 0 ? Dp.m5844constructorimpl(0) : f2;
        ...
        final long j3 = jM1552getSurface0d7_KjU;
        final BorderStroke borderStroke3 = borderStroke2;
        final float f3 = fM5844constructorimpl2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, 1279702876, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$3
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier modifierM290clickableO2vRcR0 = ClickableKt.m290clickableO2vRcR0(SurfaceKt.m1974surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier2), shape2, SurfaceKt.m1975surfaceColorAtElevationCLU3JFs(j3, fM5844constructorimpl3, composer2, (i >> 12) & 14), borderStroke3, f3), mutableInteractionSource3, RippleKt.m1460rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), (24 & 4) != 0 ? true : z2, (24 & 8) != 0 ? null : null, (24 & 16) != 0 ? null : null, onClick);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) objConsume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM290clickableO2vRcR0);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    public static final void m1969Surfaced85dljk(final boolean z, final Function0<Unit> onClick, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        MutableInteractionSource mutableInteractionSource2;
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        long jM1552getSurface0d7_KjU = (i3 & 32) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1552getSurface0d7_KjU() : j;
        long jM1588contentColorForek8zF_U = (i3 & 64) != 0 ? ColorSchemeKt.m1588contentColorForek8zF_U(jM1552getSurface0d7_KjU, composer, (i >> 15) & 14) : j2;
        float fM5844constructorimpl = (i3 & 128) != 0 ? Dp.m5844constructorimpl(0) : f;
        float fM5844constructorimpl2 = (i3 & 256) != 0 ? Dp.m5844constructorimpl(0) : f2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, -1164547968, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$5
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier modifierM970selectableO2vRcR0$default = SelectableKt.m970selectableO2vRcR0$default(SurfaceKt.m1974surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier2), shape2, SurfaceKt.m1975surfaceColorAtElevationCLU3JFs(j3, fM5844constructorimpl3, composer2, (i >> 15) & 14), borderStroke3, f3), z, mutableInteractionSource3, RippleKt.m1460rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z3, null, onClick, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) objConsume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM970selectableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    /* renamed from: Surface-d85dljk, reason: not valid java name */
    public static final void m1970Surfaced85dljk(final boolean z, final Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        MutableInteractionSource mutableInteractionSource2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, 712720927, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$7
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier modifierM975toggleableO2vRcR0$default = ToggleableKt.m975toggleableO2vRcR0$default(SurfaceKt.m1974surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier2), shape2, SurfaceKt.m1975surfaceColorAtElevationCLU3JFs(j3, fM5844constructorimpl3, composer2, (i >> 15) & 14), borderStroke3, f3), z, mutableInteractionSource3, RippleKt.m1460rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z3, null, onCheckedChange, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) objConsume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM975toggleableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    public static final Modifier m1974surface8ww4TTg(Modifier modifier, Shape shape, long j, BorderStroke borderStroke, float f) {
        return ClipKt.clip(BackgroundKt.m259backgroundbw27NRU(ShadowKt.m2949shadows4CzXII$default(modifier, f, shape, false, 0L, 0L, 24, null).then(borderStroke != null ? BorderKt.border(Modifier.INSTANCE, borderStroke, shape) : Modifier.INSTANCE), j, shape), shape);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: surfaceColorAtElevation-CLU3JFs, reason: not valid java name */
    public static final long m1975surfaceColorAtElevationCLU3JFs(long j, float f, Composer composer, int i) {
        ...
        if (Color.m3325equalsimpl0(j, MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1552getSurface0d7_KjU())) {
            j = ColorSchemeKt.m1593surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), f);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
