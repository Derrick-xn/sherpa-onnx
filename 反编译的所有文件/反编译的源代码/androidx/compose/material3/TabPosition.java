...
public final class TabPosition {
    ...
    public final float m2000getRightD9Ej5fM() {
        return Dp.m5844constructorimpl(this.left + this.width);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5849equalsimpl0(this.left, tabPosition.left) && Dp.m5849equalsimpl0(this.width, tabPosition.width);
    }

    public int hashCode() {
        return (Dp.m5850hashCodeimpl(this.left) * 31) + Dp.m5850hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m5855toStringimpl(this.left)) + ", right=" + ((Object) Dp.m5855toStringimpl(m2000getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m5855toStringimpl(this.width)) + ')';
    }
}