...
public final class InteractiveComponentSizeKt {
    ...
    static {
        ...
        float f = 48;
        minimumInteractiveComponentSize = DpKt.m5866DpSizeYgX7TsA(Dp.m5844constructorimpl(f), Dp.m5844constructorimpl(f));
    }
    ...
    public static final Modifier minimumInteractiveComponentSize(Modifier modifier) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.InteractiveComponentSizeKt$minimumInteractiveComponentSize$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                Modifier.Companion minimumInteractiveComponentSizeModifier;
                ...
                Object objConsume = composer.consume(localMinimumInteractiveComponentEnforcement);
                ComposerKt.sourceInformationMarkerEnd(composer);
                if (((Boolean) objConsume).booleanValue()) {
                    minimumInteractiveComponentSizeModifier = new MinimumInteractiveComponentSizeModifier(InteractiveComponentSizeKt.minimumInteractiveComponentSize, null);
                } else {
                    minimumInteractiveComponentSizeModifier = Modifier.INSTANCE;
                }
                if (ComposerKt.isTraceInProgress()) {
