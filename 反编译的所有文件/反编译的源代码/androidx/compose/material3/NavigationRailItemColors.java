...
public final class NavigationRailItemColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m3325equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m3325equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m3325equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m3325equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m3325equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m3325equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m3331hashCodeimpl(this.selectedIconColor) * 31) + Color.m3331hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m3331hashCodeimpl(this.selectedTextColor)) * 31) + Color.m3331hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m3331hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m3331hashCodeimpl(this.disabledIconColor)) * 31) + Color.m3331hashCodeimpl(this.disabledTextColor);
    }
}