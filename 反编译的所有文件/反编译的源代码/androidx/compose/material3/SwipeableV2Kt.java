...
public final class SwipeableV2Kt {
    ...
    public static final <T> Modifier swipeableV2(Modifier modifier, SwipeableV2State<T> state, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource) {
        ...
        return DraggableKt.draggable(modifier, state.getSwipeDraggableState(), orientation, (188 & 4) != 0 ? true : z, (188 & 8) != 0 ? null : mutableInteractionSource, (188 & 16) != 0 ? false : state.isAnimationRunning(), (188 & 32) != 0 ? DraggableKt.NoOpOnDragStarted : null, (188 & 64) != 0 ? DraggableKt.NoOpOnDragStopped : new C04531(state, null), (188 & 128) != 0 ? false : z2);
    }
    ...
    /* renamed from: androidx.compose.material3.SwipeableV2Kt$swipeableV2$1, reason: invalid class name and case insensitive filesystem */
    static final class C04531 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
        ...
        C04531(SwipeableV2State<T> swipeableV2State, Continuation<? super C04531> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, float f, Continuation<? super Unit> continuation) {
            C04531 c04531 = new C04531(this.$state, continuation);
            c04531.L$0 = coroutineScope;
            c04531.F$0 = f;
            return c04531.invokeSuspend(Unit.INSTANCE);
        }
        ...
        /* renamed from: androidx.compose.material3.SwipeableV2Kt$swipeableV2$1$1, reason: invalid class name and collision with other inner class name */
        static final class C00931 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00931(SwipeableV2State<T> swipeableV2State, float f, Continuation<? super C00931> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00931(this.$state, this.$velocity, continuation);
            }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            ResultKt.throwOnFailure(obj);
            BuildersKt__Builders_commonKt.launch$default((CoroutineScope) this.L$0, null, null, new C00931(this.$state, this.F$0, null), 3, null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final <T> Modifier swipeAnchors(Modifier modifier, final SwipeableV2State<T> state, final Set<? extends T> possibleValues, final AnchorChangeHandler<T> anchorChangeHandler, final Function2<? super T, ? super IntSize, Float> calculateAnchor) {
        ...
        return modifier.then(new SwipeAnchorsModifier(new Function1<Density, Unit>() { // from class: androidx.compose.material3.SwipeableV2Kt.swipeAnchors.1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                m1986invokeozmzZPI(intSize.getPackedValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-ozmzZPI, reason: not valid java name */
            public final void m1986invokeozmzZPI(long j) {
                ...
                for (Object obj : iterable) {
                    Float fInvoke = function2.invoke(obj, IntSize.m6010boximpl(j));
                    if (fInvoke != null) {
    ...
    public static final <T> SwipeableV2State<T> rememberSwipeableV2State(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer composer, int i, int i2) {
        ...
        SwipeableV2State<T> swipeableV2State = (SwipeableV2State) RememberSaveableKt.m2871rememberSaveable(new Object[]{initialValue, animationSpec, function1}, (Saver) SwipeableV2State.INSTANCE.m1988SavereqLRuRQ(animationSpec, function1, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m1984getVelocityThresholdD9Ej5fM()), (String) null, (Function0) new Function0<SwipeableV2State<T>>() { // from class: androidx.compose.material3.SwipeableV2Kt.rememberSwipeableV2State.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(0);
            ...
            public final SwipeableV2State<T> invoke() {
                return new SwipeableV2State<>(initialValue, animationSpec, function1, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m1984getVelocityThresholdD9Ej5fM(), null);
            }
        }, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Function2<Density, Float, Float> m1985fixedPositionalThreshold0680j_4(final float f) {
        return new Function2<Density, Float, Float>() { // from class: androidx.compose.material3.SwipeableV2Kt$fixedPositionalThreshold$1
            ...
            public final Float invoke(Density density, float f2) {
                ...
                return Float.valueOf(density.mo397toPx0680j_4(f));
            }
        };
    }
