...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2310getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2311getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2310getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m5844constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2310getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m5844constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5844constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m5844constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m5844constructorimpl(f2);
        HandleWidth = Dp.m5844constructorimpl(f2);
        InactiveTrackHeight = Dp.m5844constructorimpl(f);
    }
    ...
    public final float m2606getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2607getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2608getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2609getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2610getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2611getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2612getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2613getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2615getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m2617getTrackElevationD9Ej5fM() {
    ...
    public final float m2614getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2616getTickMarksContainerSizeD9Ej5fM() {
