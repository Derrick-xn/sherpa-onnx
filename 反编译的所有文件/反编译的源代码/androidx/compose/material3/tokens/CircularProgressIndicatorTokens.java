...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5844constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m5844constructorimpl((float) 48.0d);
    ...
    public final float m2211getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2212getSizeD9Ej5fM() {
        return Size;
    }
}