...
public final class SearchViewTokens {
    ...
    private static final float DockedHeaderContainerHeight = Dp.m5844constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens FullScreenContainerShape = ShapeKeyTokens.CornerNone;
    private static final float FullScreenHeaderContainerHeight = Dp.m5844constructorimpl((float) 72.0d);
    ...
    public final float m2599getContainerElevationD9Ej5fM() {
    ...
    public final float m2600getDockedHeaderContainerHeightD9Ej5fM() {
    ...
    public final float m2601getFullScreenHeaderContainerHeightD9Ej5fM() {
