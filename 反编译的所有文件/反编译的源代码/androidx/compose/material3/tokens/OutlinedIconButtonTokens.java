...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5844constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5844constructorimpl((float) 24.0d);
    ...
    public final float m2497getContainerSizeD9Ej5fM() {
    ...
    public final float m2499getUnselectedOutlineWidthD9Ej5fM() {
