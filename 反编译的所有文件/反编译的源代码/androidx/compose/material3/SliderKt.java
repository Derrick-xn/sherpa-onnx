...
public final class SliderKt {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void RangeSlider(final kotlin.ranges.ClosedFloatingPointRange<java.lang.Float> r46, final kotlin.jvm.functions.Function1<? super kotlin.ranges.ClosedFloatingPointRange<java.lang.Float>, kotlin.Unit> r47, androidx.compose.ui.Modifier r48, boolean r49, kotlin.ranges.ClosedFloatingPointRange<java.lang.Float> r50, kotlin.jvm.functions.Function0<kotlin.Unit> r51, androidx.compose.material3.SliderColors r52, androidx.compose.foundation.interaction.MutableInteractionSource r53, androidx.compose.foundation.interaction.MutableInteractionSource r54, kotlin.jvm.functions.Function3<? super androidx.compose.material3.SliderPositions, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r55, kotlin.jvm.functions.Function3<? super androidx.compose.material3.SliderPositions, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r56, kotlin.jvm.functions.Function3<? super androidx.compose.material3.SliderPositions, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r57, int r58, androidx.compose.runtime.Composer r59, final int r60, final int r61, final int r62) throws android.content.res.Resources.NotFoundException {
        /*
    ...
    public static final void SliderImpl(final Modifier modifier, final boolean z, final MutableInteractionSource mutableInteractionSource, final Function1<? super Float, Unit> function1, final Function0<Unit> function0, final int i, final float f, final ClosedFloatingPointRange<Float> closedFloatingPointRange, final Function3<? super SliderPositions, ? super Composer, ? super Integer, Unit> function3, final Function3<? super SliderPositions, ? super Composer, ? super Integer, Unit> function32, Composer composer, final int i2) {
        ...
        if ((1533916891 & i6) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            composer2.endReplaceableGroup();
            composer3 = composer2;
            Modifier modifierThen = FocusableKt.focusable(sliderSemantics(SizeKt.m752requiredSizeInqDBjuR0$default(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier), SliderTokens.INSTANCE.m2610getHandleWidthD9Ej5fM(), SliderTokens.INSTANCE.m2609getHandleHeightD9Ej5fM(), 0.0f, 0.0f, 12, null), f, z, function1, function0, closedFloatingPointRange, i), z, mutableInteractionSource).then(modifierSliderTapModifier).then(DraggableKt.draggable(companion2, sliderDraggableState3, orientation, (188 & 4) != 0 ? true : z, (188 & 8) != 0 ? null : mutableInteractionSource, (188 & 16) != 0 ? false : zIsDragging, (188 & 32) != 0 ? DraggableKt.NoOpOnDragStarted : null, (188 & 64) != 0 ? DraggableKt.NoOpOnDragStopped : (Function3) objRememberedValue9, (188 & 128) != 0 ? false : z2));
            final float f4 = f3;
                        ...
                        if (LayoutIdKt.getLayoutId(measurable) == SliderComponents.THUMB) {
                            ...
                            for (Measurable measurable2 : list) {
                                if (LayoutIdKt.getLayoutId(measurable2) == SliderComponents.TRACK) {
                                    final Placeable placeableMo4680measureBRTryo02 = measurable2.mo4680measureBRTryo0(Constraints.m5778copyZbe2FdA$default(ConstraintsKt.m5807offsetNN6EwU$default(j, -placeableMo4680measureBRTryo0.getWidth(), 0, 2, null), 0, 0, 0, 0, 11, null));
                                    int width = placeableMo4680measureBRTryo02.getWidth() + placeableMo4680measureBRTryo0.getWidth();
                                    int iMax = Math.max(placeableMo4680measureBRTryo02.getHeight(), placeableMo4680measureBRTryo0.getHeight());
                                    mutableState6.setValue(Float.valueOf(placeableMo4680measureBRTryo0.getWidth()));
                                    mutableState3.setValue(Integer.valueOf(width));
                                    final int width2 = placeableMo4680measureBRTryo0.getWidth() / 2;
                                    final int iRoundToInt = MathKt.roundToInt(placeableMo4680measureBRTryo02.getWidth() * f4);
                                    final int height = (iMax - placeableMo4680measureBRTryo02.getHeight()) / 2;
                                    final int height2 = (iMax - placeableMo4680measureBRTryo0.getHeight()) / 2;
                                    return MeasureScope.CC.layout$default(Layout, width, iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SliderKt$SliderImpl$2$measure$1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(1);
                                        }
                                        ...
                                        public final void invoke2(Placeable.PlacementScope layout) {
                                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo4680measureBRTryo02, width2, height, 0.0f, 4, null);
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo4680measureBRTryo0, iRoundToInt, height2, 0.0f, 4, null);
                                        }
                                    }, 4, null);
                                }
                            }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void RangeSliderImpl(final androidx.compose.ui.Modifier r35, final kotlin.ranges.ClosedFloatingPointRange<java.lang.Float> r36, final kotlin.jvm.functions.Function1<? super kotlin.ranges.ClosedFloatingPointRange<java.lang.Float>, kotlin.Unit> r37, final boolean r38, final kotlin.ranges.ClosedFloatingPointRange<java.lang.Float> r39, int r40, final kotlin.jvm.functions.Function0<kotlin.Unit> r41, final androidx.compose.foundation.interaction.MutableInteractionSource r42, final androidx.compose.foundation.interaction.MutableInteractionSource r43, final kotlin.jvm.functions.Function3<? super androidx.compose.material3.SliderPositions, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r44, final kotlin.jvm.functions.Function3<? super androidx.compose.material3.SliderPositions, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r45, final kotlin.jvm.functions.Function3<? super androidx.compose.material3.SliderPositions, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r46, androidx.compose.runtime.Composer r47, final int r48, final int r49, final int r50) throws android.content.res.Resources.NotFoundException {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object m1878awaitSlop8vUncbI(androidx.compose.ui.input.pointer.AwaitPointerEventScope r8, long r9, int r11, kotlin.coroutines.Continuation<? super kotlin.Pair<androidx.compose.ui.input.pointer.PointerInputChange, java.lang.Float>> r12) throws java.lang.Throwable {
        /*
        ...
        L37:
            ...
            r2 = r9
            r4 = r11
            java.lang.Object r8 = androidx.compose.material3.DragGestureDetectorCopyKt.m1671awaitHorizontalPointerSlopOrCancellationgDDlDlE(r1, r2, r4, r5, r6)
            if (r8 != r0) goto L55
            return r0
        L55:
            r7 = r12
        ...
        L68:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderKt.m1878awaitSlop8vUncbI(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    static final class C04342 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04342(float f, float f2, float f3, Continuation<? super C04342> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04342 c04342 = new C04342(this.$current, this.$target, this.$velocity, continuation);
            c04342.L$0 = obj;
            return c04342;
        }
        ...
        public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
            return ((C04342) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object animateToTarget(DraggableState draggableState, float f, float f2, float f3, Continuation<? super Unit> continuation) {
        Object objDrag$default = DraggableState.CC.drag$default(draggableState, null, new C04342(f, f2, f3, null), continuation, 1, null);
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (CoroutineScopeKt.coroutineScope(new C00861(pointerInputScope, this.$isRtl, this.$maxPx, rangeSliderLogic, this.$rawOffsetStart, this.$gestureEndAction, this.$rawOffsetEnd, this.$onDrag, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
        ...
        static final class C00861 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00861(PointerInputScope pointerInputScope, boolean z, int i, RangeSliderLogic rangeSliderLogic, State<Float> state, State<? extends Function1<? super Boolean, Unit>> state2, State<Float> state3, State<? extends Function2<? super Boolean, ? super Float, Unit>> state4, Continuation<? super C00861> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00861 c00861 = new C00861(this.$$this$pointerInput, this.$isRtl, this.$maxPx, this.$rangeSliderLogic, this.$rawOffsetStart, this.$gestureEndAction, this.$rawOffsetEnd, this.$onDrag, continuation);
                c00861.L$0 = obj;
                return c00861;
            }
            ...
            static final class C00871 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00871(boolean z, int i, RangeSliderLogic rangeSliderLogic, State<Float> state, CoroutineScope coroutineScope, State<? extends Function1<? super Boolean, Unit>> state2, State<Float> state3, State<? extends Function2<? super Boolean, ? super Float, Unit>> state4, Continuation<? super C00871> continuation) {
                    super(2, continuation);
                    this.$isRtl = z;
                    this.$maxPx = i;
                    this.$rangeSliderLogic = rangeSliderLogic;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    C00871 c00871 = new C00871(this.$isRtl, this.$maxPx, this.$rangeSliderLogic, this.$rawOffsetStart, this.$$this$coroutineScope, this.$gestureEndAction, this.$rawOffsetEnd, this.$onDrag, continuation);
                    c00871.L$0 = obj;
                    return c00871;
                }
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (ForEachGestureKt.awaitEachGesture(this.$$this$pointerInput, new C00871(this.$isRtl, this.$maxPx, this.$rangeSliderLogic, this.$rawOffsetStart, coroutineScope, this.$gestureEndAction, this.$rawOffsetEnd, this.$onDrag, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
    ...
    static {
        float fM2610getHandleWidthD9Ej5fM = SliderTokens.INSTANCE.m2610getHandleWidthD9Ej5fM();
        ThumbWidth = fM2610getHandleWidthD9Ej5fM;
        float fM2609getHandleHeightD9Ej5fM = SliderTokens.INSTANCE.m2609getHandleHeightD9Ej5fM();
        ThumbHeight = fM2609getHandleHeightD9Ej5fM;
        ThumbSize = DpKt.m5866DpSizeYgX7TsA(fM2610getHandleWidthD9Ej5fM, fM2609getHandleHeightD9Ej5fM);
        ThumbDefaultElevation = Dp.m5844constructorimpl(1);
        ThumbPressedElevation = Dp.m5844constructorimpl(6);
        TickSize = SliderTokens.INSTANCE.m2616getTickMarksContainerSizeD9Ej5fM();
        TrackHeight = SliderTokens.INSTANCE.m2611getInactiveTrackHeightD9Ej5fM();
        float fM5844constructorimpl = Dp.m5844constructorimpl(48);
        SliderHeight = fM5844constructorimpl;
        float fM5844constructorimpl2 = Dp.m5844constructorimpl(144);
        SliderMinWidth = fM5844constructorimpl2;
        DefaultSliderConstraints = SizeKt.m744heightInVpY3zN4$default(SizeKt.m763widthInVpY3zN4$default(Modifier.INSTANCE, fM5844constructorimpl2, 0.0f, 2, null), 0.0f, fM5844constructorimpl, 1, null);
    ...
    private static final Modifier sliderTapModifier(Modifier modifier, final DraggableState draggableState, final MutableInteractionSource mutableInteractionSource, final int i, final boolean z, final State<Float> state, final State<? extends Function0<Unit>> state2, final MutableState<Float> mutableState, final boolean z2) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.SliderKt$sliderTapModifier$$inlined$debugInspectorInfo$1
            ...
            static final class AnonymousClass1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
                ...
                static final class C00891 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
                    final /* synthetic */ boolean $isRtl;
                    final /* synthetic */ int $maxPx;
                    final /* synthetic */ MutableState<Float> $pressOffset;
                    final /* synthetic */ State<Float> $rawOffset;
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C00891(boolean z, int i, MutableState<Float> mutableState, State<Float> state, Continuation<? super C00891> continuation) {
                    ...
                    public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
                        return m1879invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
                    }

                    /* renamed from: invoke-d-4ec7I, reason: not valid java name */
                    public final Object m1879invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
                        C00891 c00891 = new C00891(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, continuation);
                    ...
                    public final Object invokeSuspend(Object obj) throws Throwable {
                        ...
                        try {
                            if (i == 0) {
                                ...
                                long j = this.J$0;
                                this.$pressOffset.setValue(Boxing.boxFloat((this.$isRtl ? this.$maxPx - Offset.m3044getXimpl(j) : Offset.m3044getXimpl(j)) - this.$rawOffset.getValue().floatValue()));
                                this.label = 1;
                ...
                public final Object invokeSuspend(Object obj) throws Throwable {
                    ...
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, c00891, new Function1<Offset, Unit>() { // from class: androidx.compose.material3.SliderKt.sliderTapModifier.2.1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                                m1880invokek4lQ0M(offset.getPackedValue());
                                return Unit.INSTANCE;
                            }

                            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                            public final void m1880invokek4lQ0M(long j) {
                                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00911(draggableState, state, null), 3, null);
                            }
                            ...
                            static final class C00911 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                ...
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                C00911(DraggableState draggableState, State<? extends Function0<Unit>> state, Continuation<? super C00911> continuation) {
                                    super(2, continuation);
                                    this.$draggableState = draggableState;
                                ...
                                static final class C00921 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
                                    private /* synthetic */ Object L$0;
                                    int label;
                                    ...
                                    @Override // kotlin.jvm.functions.Function2
                                    public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
                                        return ((C00921) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
                                    }
                                ...
                                public final Object invokeSuspend(Object obj) throws Throwable {
                                    ...
                                    if (i == 0) {
                                        ResultKt.throwOnFailure(obj);
                                        this.label = 1;
                                        if (this.$draggableState.drag(MutatePriority.UserInput, new C00921(null), this) == coroutine_suspended) {
                                            return coroutine_suspended;
                                        }
                                    } else {
                                        if (i != 1) {
