...
public final class BottomSheetScaffoldKt {
    ...
    */
    ...
    public static final void m1491StandardBottomSheet8oydGBM(final SheetState sheetState, final float f, final boolean z, final float f2, final Shape shape, final long j, final long j2, final float f3, final float f4, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        int i3;
        int i4;
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            final float fMo397toPx0680j_4 = ((Density) objConsume).mo397toPx0680j_4(f);
            ...
            Modifier modifierM747requiredHeightInVpY3zN4$default = SizeKt.m747requiredHeightInVpY3zN4$default(SizeKt.fillMaxWidth$default(SizeKt.m763widthInVpY3zN4$default(Modifier.INSTANCE, 0.0f, SheetDefaultsKt.getBottomSheetMaxWidth(), 1, null), 0.0f, 1, null), f, 0.0f, 2, null);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierSwipeableV2$default = SwipeableV2Kt.swipeableV2$default(NestedScrollModifierKt.nestedScroll$default(modifierM747requiredHeightInVpY3zN4$default, (NestedScrollConnection) objRememberedValue3, null, 2, null), sheetState.getSwipeableState$material3_release(), orientation, z, false, null, 24, null);
            ...
            Float fValueOf2 = Float.valueOf(fMo397toPx0680j_4);
            ...
            if (zChanged3 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue4 = (Function2) new Function2<SheetValue, IntSize, Float>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$2$1
                    ...
                    public /* bridge */ /* synthetic */ Float invoke(SheetValue sheetValue, IntSize intSize) {
                        return m1495invokeO0kMr_c(sheetValue, intSize.getPackedValue());
                    }

                    /* renamed from: invoke-O0kMr_c, reason: not valid java name */
                    public final Float m1495invokeO0kMr_c(SheetValue value, long j3) {
                        ...
                        if (i7 == 1) {
                            ...
                            return Float.valueOf(f2 - fMo397toPx0680j_4);
                        }
                        if (i7 == 2) {
                            if (IntSize.m6017getHeightimpl(j3) == MathKt.roundToInt(fMo397toPx0680j_4)) {
                                return null;
                            }
                            return Float.valueOf(Math.max(0.0f, f2 - IntSize.m6017getHeightimpl(j3)));
                        }
                        if (i7 != 3) {
            ...
            SurfaceKt.m1968SurfaceT9BRK9s(SwipeableV2Kt.swipeAnchors(modifierSwipeableV2$default, swipeableState$material3_release2, of, anchorChangeHandler, (Function2) objRememberedValue4), shape, j, j2, f3, f4, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1381492089, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$3
                ...
                public final void invoke(Composer composer2, int i8) throws Resources.NotFoundException {
                    ...
                    if ((i8 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function22 != null) {
                            final String strM1959getStringNWtq28 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1900getBottomSheetPartialExpandDescriptionadMyvUU(), composer2, 6);
                            final String strM1959getStringNWtq282 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1896getBottomSheetDismissDescriptionadMyvUU(), composer2, 6);
                            final String strM1959getStringNWtq283 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1898getBottomSheetExpandDescriptionadMyvUU(), composer2, 6);
                            ...
                            Modifier modifierSemantics = SemanticsModifierKt.semantics(columnScopeInstance2.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenterHorizontally()), true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$3$1$1
                                ...
                                public final void invoke2(SemanticsPropertyReceiver semantics) {
                                    ...
                                    boolean z3 = z2;
                                    String str = strM1959getStringNWtq283;
                                    String str2 = strM1959getStringNWtq28;
                                    String str3 = strM1959getStringNWtq282;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$4
            ...
            public final void invoke(Composer composer2, int i8) {
                BottomSheetScaffoldKt.m1491StandardBottomSheet8oydGBM(sheetState, f, z, f2, shape, j, j2, f3, f4, function2, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
            }
        });
    }
    ...
    public static final void m1490BottomSheetScaffoldLayoutPxNyym8(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function3<? super Integer, ? super Composer, ? super Integer, Unit> function32, final Function2<? super Composer, ? super Integer, Unit> function22, final float f, final Function0<Float> function0, final SheetState sheetState, final long j, final long j2, Composer composer, final int i) {
        ...
        int i3 = (i & 14) == 0 ? (composerStartRestartGroup.changed(modifier) ? 4 : 2) | i : i;
        if ((i & 112) == 0) {
        ...
        if ((i3 & 1533916891) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            final int i4 = i3;
            Object[] objArr = {function32, function0, function2, modifier, Color.m3314boximpl(j), Color.m3314boximpl(j2), function3, Dp.m5842boximpl(f), function22, sheetState};
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                objRememberedValue = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1
                    ...
                    public final MeasureResult m1494invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, long j3) {
                        Placeable placeableMo4680measureBRTryo0;
                        int height;
                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                        int iM5787getMaxWidthimpl = Constraints.m5787getMaxWidthimpl(j3);
                        final int iM5786getMaxHeightimpl = Constraints.m5786getMaxHeightimpl(j3);
                        long jM5778copyZbe2FdA$default = Constraints.m5778copyZbe2FdA$default(j3, 0, 0, 0, 0, 10, null);
                        ...
                        final Placeable placeableMo4680measureBRTryo02 = SubcomposeLayout.subcompose(bottomSheetScaffoldLayoutSlot, ComposableLambdaKt.composableLambdaInstance(-1192048628, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$sheetPlaceable$1
                            ...
                            public final void invoke(Composer composer3, int i7) {
                                ...
                                function33.invoke(Integer.valueOf(iM5786getMaxHeightimpl), composer3, Integer.valueOf((i6 >> 6) & 112));
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        })).get(0).mo4680measureBRTryo0(jM5778copyZbe2FdA$default);
                        final int iRoundToInt = MathKt.roundToInt(function0.invoke().floatValue());
                        final int iMax = Math.max(0, (iM5787getMaxWidthimpl - placeableMo4680measureBRTryo02.getWidth()) / 2);
                        final Function2<Composer, Integer, Unit> function23 = function2;
                        if (function23 != null) {
                            final int i7 = i4;
                            placeableMo4680measureBRTryo0 = SubcomposeLayout.subcompose(BottomSheetScaffoldLayoutSlot.TopBar, ComposableLambdaKt.composableLambdaInstance(-873203005, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$topBarPlaceable$1$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(2);
                        ...
                        long jM5778copyZbe2FdA$default2 = Constraints.m5778copyZbe2FdA$default(jM5778copyZbe2FdA$default, 0, 0, 0, iM5786getMaxHeightimpl - height2, 7, null);
                        ...
                        final float f2 = f;
                        final Placeable placeableMo4680measureBRTryo03 = SubcomposeLayout.subcompose(bottomSheetScaffoldLayoutSlot2, ComposableLambdaKt.composableLambdaInstance(-1459220575, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                                ...
                                if ((i10 & 11) != 2 || !composer3.getSkipping()) {
                                    ...
                                    ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer3, 1725620860, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1.1
                                        ...
                                        public final void invoke(Composer composer4, int i12) {
                                            ...
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventStart(1725620860, i12, -1, "androidx.compose.material3.BottomSheetScaffoldLayout.<anonymous>.<anonymous>.<anonymous>.<anonymous> (BottomSheetScaffold.kt:351)");
                                            }
                                            function35.invoke(PaddingKt.m708PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, f3, 7, null), composer4, Integer.valueOf((i11 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                            }
                                        }
                                    ...
                                    int i12 = i9;
                                    SurfaceKt.m1968SurfaceT9BRK9s(modifier3, null, j6, j7, 0.0f, 0.0f, null, composableLambda, composer3, (i12 & 14) | 12582912 | ((i12 >> 18) & 896) | ((i12 >> 18) & 7168), 114);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                        ...
                        })).get(0).mo4680measureBRTryo0(jM5778copyZbe2FdA$default2);
                        final Placeable placeableMo4680measureBRTryo04 = SubcomposeLayout.subcompose(BottomSheetScaffoldLayoutSlot.Snackbar, function22).get(0).mo4680measureBRTryo0(jM5778copyZbe2FdA$default);
                        final int width = (iM5787getMaxWidthimpl - placeableMo4680measureBRTryo04.getWidth()) / 2;
                        int i10 = WhenMappings.$EnumSwitchMapping$0[sheetState.getCurrentValue().ordinal()];
                        if (i10 == 1) {
                            height = iRoundToInt - placeableMo4680measureBRTryo04.getHeight();
                        } else {
                            if (i10 != 2 && i10 != 3) {
                                throw new NoWhenBranchMatchedException();
                            }
                            height = iM5786getMaxHeightimpl - placeableMo4680measureBRTryo04.getHeight();
                        }
                        final int i11 = height;
                        return MeasureScope.CC.layout$default(SubcomposeLayout, iM5787getMaxWidthimpl, iM5786getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo4680measureBRTryo03, 0, i8, 0.0f, 4, null);
                                Placeable placeable2 = placeable;
                                if (placeable2 != null) {
                                    Placeable.PlacementScope.placeRelative$default(layout, placeable2, 0, 0, 0.0f, 4, null);
                                }
                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo4680measureBRTryo02, iMax, iRoundToInt, 0.0f, 4, null);
                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo4680measureBRTryo04, width, i11, 0.0f, 4, null);
                            }
                        }, 4, null);
                    }
                };
            ...
            composer2.endReplaceableGroup();
            SubcomposeLayoutKt.SubcomposeLayout(null, (Function2) objRememberedValue, composer2, i2, 1);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$2
            ...
            public final void invoke(Composer composer3, int i6) {
                BottomSheetScaffoldKt.m1490BottomSheetScaffoldLayoutPxNyym8(modifier, function2, function3, function32, function22, f, function0, sheetState, j, j2, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final AnchorChangeHandler<SheetValue> BottomSheetScaffoldAnchorChangeHandler(final SheetState sheetState, final Function2<? super SheetValue, ? super Float, Unit> function2, final Function1<? super SheetValue, Unit> function1) {
        return new AnchorChangeHandler<SheetValue>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt.BottomSheetScaffoldAnchorChangeHandler.1
            ...
            /* compiled from: BottomSheetScaffold.kt */
            @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
            /* renamed from: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldAnchorChangeHandler$1$WhenMappings */
            public /* synthetic */ class WhenMappings {
                public static final /* synthetic */ int[] $EnumSwitchMapping$0;
