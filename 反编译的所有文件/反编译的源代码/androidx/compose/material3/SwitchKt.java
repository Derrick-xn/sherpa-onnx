...
public final class SwitchKt {
    ...
    */
    ...
    public static final void m1991SwitchImpl0DmnUew(final BoxScope boxScope, final boolean z, final boolean z2, final SwitchColors switchColors, final State<Float> state, final Function2<? super Composer, ? super Integer, Unit> function2, final InteractionSource interactionSource, final Shape shape, final float f, final float f2, final float f3, Composer composer, final int i, final int i2) {
        int i3;
        int i4;
        float fM5844constructorimpl;
        final float fFloatValue;
        float fM2641getTrackOutlineWidthD9Ej5fM;
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            float fMo393toDpu2uoSUM = ((Density) objConsume).mo393toDpu2uoSUM(state.getValue().floatValue());
            if (SwitchImpl_0DmnUew$lambda$7(stateCollectIsPressedAsState)) {
                fM5844constructorimpl = SwitchTokens.INSTANCE.m2635getPressedHandleWidthD9Ej5fM();
            } else {
                fM5844constructorimpl = Dp.m5844constructorimpl(Dp.m5844constructorimpl(Dp.m5844constructorimpl(ThumbDiameter - f) * (Dp.m5844constructorimpl(fMo393toDpu2uoSUM - f2) / Dp.m5844constructorimpl(f3 - f2))) + f);
            }
            ...
            if (SwitchImpl_0DmnUew$lambda$7(stateCollectIsPressedAsState)) {
                ...
                if (!z) {
                    fM2641getTrackOutlineWidthD9Ej5fM = SwitchTokens.INSTANCE.m2641getTrackOutlineWidthD9Ej5fM();
                } else {
                    fM2641getTrackOutlineWidthD9Ej5fM = Dp.m5844constructorimpl(ThumbPathLength - SwitchTokens.INSTANCE.m2641getTrackOutlineWidthD9Ej5fM());
                }
                fFloatValue = density.mo397toPx0680j_4(fM2641getTrackOutlineWidthD9Ej5fM);
            } else {
            ...
            Modifier modifierM259backgroundbw27NRU = BackgroundKt.m259backgroundbw27NRU(BorderKt.m271borderxT4_qwU(SizeKt.m742height3ABfNKs(SizeKt.m761width3ABfNKs(boxScope.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenter()), SwitchWidth), SwitchHeight), SwitchTokens.INSTANCE.m2641getTrackOutlineWidthD9Ej5fM(), switchColors.borderColor$material3_release(z2, z, composerStartRestartGroup, i5).getValue().m3334unboximpl(), shape2), SwitchImpl_0DmnUew$lambda$6(stateTrackColor$material3_release), shape2);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM259backgroundbw27NRU);
            ...
            Updater.m2784setimpl(composerM2777constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(Density density3) {
                        return IntOffset.m5967boximpl(m1993invokeBjo55l4(density3));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m1993invokeBjo55l4(Density offset) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierM259backgroundbw27NRU2 = BackgroundKt.m259backgroundbw27NRU(SizeKt.m748requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(modifierAlign, (Function1) objRememberedValue), interactionSource, RippleKt.m1460rememberRipple9IZ8Weo(false, Dp.m5844constructorimpl(SwitchTokens.INSTANCE.m2639getStateLayerSizeD9Ej5fM() / 2), 0L, composerStartRestartGroup, 54, 4)), fM5844constructorimpl), jSwitchImpl_0DmnUew$lambda$13$lambda$10, shape);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf2 = LayoutKt.materializerOf(modifierM259backgroundbw27NRU2);
            if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            composerStartRestartGroup.startReusableNode();
            ...
            Updater.m2784setimpl(composerM2777constructorimpl2, measurePolicyRememberBoxMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2784setimpl(composerM2777constructorimpl2, density3, ComposeUiNode.INSTANCE.getSetDensity());
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$2
            ...
            public final void invoke(Composer composer2, int i7) {
                SwitchKt.m1991SwitchImpl0DmnUew(boxScope, z, z2, switchColors, state, function2, interactionSource, shape, f, f2, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
            }
        });
    }

    static {
        float fM2637getSelectedHandleWidthD9Ej5fM = SwitchTokens.INSTANCE.m2637getSelectedHandleWidthD9Ej5fM();
        ThumbDiameter = fM2637getSelectedHandleWidthD9Ej5fM;
        UncheckedThumbDiameter = SwitchTokens.INSTANCE.m2644getUnselectedHandleWidthD9Ej5fM();
        float fM2642getTrackWidthD9Ej5fM = SwitchTokens.INSTANCE.m2642getTrackWidthD9Ej5fM();
        SwitchWidth = fM2642getTrackWidthD9Ej5fM;
        float fM2640getTrackHeightD9Ej5fM = SwitchTokens.INSTANCE.m2640getTrackHeightD9Ej5fM();
        SwitchHeight = fM2640getTrackHeightD9Ej5fM;
        float fM5844constructorimpl = Dp.m5844constructorimpl(Dp.m5844constructorimpl(fM2640getTrackHeightD9Ej5fM - fM2637getSelectedHandleWidthD9Ej5fM) / 2);
        ThumbPadding = fM5844constructorimpl;
        ThumbPathLength = Dp.m5844constructorimpl(Dp.m5844constructorimpl(fM2642getTrackWidthD9Ej5fM - fM2637getSelectedHandleWidthD9Ej5fM) - fM5844constructorimpl);
