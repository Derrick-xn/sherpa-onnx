...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo87measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final int iMax = Math.max(placeableMo4680measureBRTryo0.getWidth(), measure.mo391roundToPx0680j_4(DpSize.m5942getWidthD9Ej5fM(this.size)));
        final int iMax2 = Math.max(placeableMo4680measureBRTryo0.getHeight(), measure.mo391roundToPx0680j_4(DpSize.m5940getHeightD9Ej5fM(this.size)));
        return MeasureScope.CC.layout$default(measure, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo4680measureBRTryo0, MathKt.roundToInt((iMax - placeableMo4680measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((iMax2 - placeableMo4680measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m5939equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }

    public int hashCode() {
        return DpSize.m5944hashCodeimpl(this.size);
    }
}