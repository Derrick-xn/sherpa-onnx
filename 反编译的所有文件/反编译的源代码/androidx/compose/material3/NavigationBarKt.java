...
public final class NavigationBarKt {
    ...
    private static final float NavigationBarHeight = NavigationBarTokens.INSTANCE.m2461getContainerHeightD9Ej5fM();
    private static final float NavigationBarItemHorizontalPadding = Dp.m5844constructorimpl(8);
    private static final float NavigationBarItemVerticalPadding = Dp.m5844constructorimpl(16);
    private static final float IndicatorVerticalOffset = Dp.m5844constructorimpl(12);
    ...
    */
    public static final void m1785NavigationBarHsRjFd4(androidx.compose.ui.Modifier r25, long r26, long r28, float r30, androidx.compose.foundation.layout.WindowInsets r31, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 426
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.NavigationBarKt.m1785NavigationBarHsRjFd4(androidx.compose.ui.Modifier, long, long, float, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    public static final void NavigationBarItemBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean z, final float f, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(NavigationBarItemBaselineLayout)P(4,3,2,5)434@18867L2465:NavigationBar.kt#uh7d8r");
        if ((i & 14) == 0) {
        ...
        if ((374491 & i2) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationBarKt.NavigationBarItemBaselineLayout.2
                ...
                public final MeasureResult mo61measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), NavigationBarKt.IconLayoutIdTag)) {
                            Placeable placeableMo4680measureBRTryo02 = measurable.mo4680measureBRTryo0(j);
                            float f2 = 2;
                            int width = placeableMo4680measureBRTryo02.getWidth() + Layout.mo391roundToPx0680j_4(Dp.m5844constructorimpl(NavigationBarKt.IndicatorHorizontalPadding * f2));
                            int iRoundToInt = MathKt.roundToInt(width * f);
                            int height = placeableMo4680measureBRTryo02.getHeight() + Layout.mo391roundToPx0680j_4(Dp.m5844constructorimpl(NavigationBarKt.IndicatorVerticalPadding * f2));
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), NavigationBarKt.IndicatorRippleLayoutIdTag)) {
                                    Placeable placeableMo4680measureBRTryo03 = measurable2.mo4680measureBRTryo0(Constraints.INSTANCE.m5797fixedJhjzzOo(width, height));
                                    ...
                                    Placeable placeableMo4680measureBRTryo04 = measurable3 != null ? measurable3.mo4680measureBRTryo0(Constraints.INSTANCE.m5797fixedJhjzzOo(iRoundToInt, height)) : null;
                                    if (function24 != null) {
                                        for (Measurable measurable4 : list) {
                                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), NavigationBarKt.LabelLayoutIdTag)) {
                                                placeableMo4680measureBRTryo0 = measurable4.mo4680measureBRTryo0(Constraints.m5778copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                                            }
                                        }
                                    ...
                                    if (function24 == null) {
                                        return NavigationBarKt.m1788placeIconX9ElhV4(Layout, placeableMo4680measureBRTryo02, placeableMo4680measureBRTryo03, placeableMo4680measureBRTryo04, j);
                                    }
                                    Intrinsics.checkNotNull(placeableMo4680measureBRTryo0);
                                    return NavigationBarKt.m1789placeLabelAndIconzUg2_y0(Layout, placeableMo4680measureBRTryo0, placeableMo4680measureBRTryo02, placeableMo4680measureBRTryo03, placeableMo4680measureBRTryo04, j, z, f);
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -311734425, "C435@18884L17,440@18982L50:NavigationBar.kt#uh7d8r");
            function2.invoke(composerStartRestartGroup, Integer.valueOf(i2 & 14));
            composerStartRestartGroup.startReplaceableGroup(-311734399);
            ComposerKt.sourceInformation(composerStartRestartGroup, "437@18951L11");
            if (f > 0.0f) {
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1248851348, "C440@19024L6:NavigationBar.kt#uh7d8r");
            ...
            ComposerKt.sourceInformation(composerStartRestartGroup, "443@19075L260");
            if (function24 != null) {
                Modifier modifierM713paddingVpY3zN4$default = PaddingKt.m713paddingVpY3zN4$default(AlphaKt.alpha(LayoutIdKt.layoutId(Modifier.INSTANCE, LabelLayoutIdTag), z ? 1.0f : f), Dp.m5844constructorimpl(NavigationBarItemHorizontalPadding / 2), 0.0f, 2, null);
                composerStartRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf3 = LayoutKt.materializerOf(modifierM713paddingVpY3zN4$default);
                if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                composerStartRestartGroup.startReusableNode();
                ...
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1248851650, "C448@19326L7:NavigationBar.kt#uh7d8r");
    ...
    public static final MeasureResult m1788placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int iM5787getMaxWidthimpl = Constraints.m5787getMaxWidthimpl(j);
        final int iM5786getMaxHeightimpl = Constraints.m5786getMaxHeightimpl(j);
        final int width = (iM5787getMaxWidthimpl - placeable.getWidth()) / 2;
        final int height = (iM5786getMaxHeightimpl - placeable.getHeight()) / 2;
        final int width2 = (iM5787getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int height2 = (iM5786getMaxHeightimpl - placeable2.getHeight()) / 2;
        return MeasureScope.CC.layout$default(measureScope, iM5787getMaxWidthimpl, iM5786getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable4, (iM5787getMaxWidthimpl - placeable4.getWidth()) / 2, (iM5786getMaxHeightimpl - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m1789placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        int iM5786getMaxHeightimpl = Constraints.m5786getMaxHeightimpl(j);
        int height = iM5786getMaxHeightimpl - placeable.getHeight();
        float f2 = NavigationBarItemVerticalPadding;
        final int i = height - measureScope.mo391roundToPx0680j_4(f2);
        final int i2 = measureScope.mo391roundToPx0680j_4(f2);
        final int iRoundToInt = MathKt.roundToInt(((z ? i2 : (iM5786getMaxHeightimpl - placeable2.getHeight()) / 2) - i2) * (1 - f));
        final int iM5787getMaxWidthimpl = Constraints.m5787getMaxWidthimpl(j);
        final int width = (iM5787getMaxWidthimpl - placeable.getWidth()) / 2;
        final int width2 = (iM5787getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int width3 = (iM5787getMaxWidthimpl - placeable3.getWidth()) / 2;
        final int i3 = i2 - measureScope.mo391roundToPx0680j_4(IndicatorVerticalPadding);
        return MeasureScope.CC.layout$default(measureScope, iM5787getMaxWidthimpl, iM5786getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeLabelAndIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable5 != null) {
                    int i4 = iM5787getMaxWidthimpl;
                    int i5 = i2;
                    MeasureScope measureScope2 = measureScope;
                    Placeable.PlacementScope.placeRelative$default(layout, placeable5, (i4 - placeable5.getWidth()) / 2, iRoundToInt + (i5 - measureScope2.mo391roundToPx0680j_4(NavigationBarKt.IndicatorVerticalPadding)), 0.0f, 4, null);
                }
                if (z || f != 0.0f) {
    ...
    static {
        float f = 2;
        IndicatorHorizontalPadding = Dp.m5844constructorimpl(Dp.m5844constructorimpl(NavigationBarTokens.INSTANCE.m2459getActiveIndicatorWidthD9Ej5fM() - NavigationBarTokens.INSTANCE.m2462getIconSizeD9Ej5fM()) / f);
        IndicatorVerticalPadding = Dp.m5844constructorimpl(Dp.m5844constructorimpl(NavigationBarTokens.INSTANCE.m2458getActiveIndicatorHeightD9Ej5fM() - NavigationBarTokens.INSTANCE.m2462getIconSizeD9Ej5fM()) / f);
    }
