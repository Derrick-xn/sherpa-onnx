...
public final class RichTooltipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m3325equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m3325equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m3325equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m3331hashCodeimpl(this.containerColor) * 31) + Color.m3331hashCodeimpl(this.contentColor)) * 31) + Color.m3331hashCodeimpl(this.titleContentColor)) * 31) + Color.m3331hashCodeimpl(this.actionContentColor);
    }
}