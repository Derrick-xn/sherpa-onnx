...
public final class ChipColors {
    ...
    public final State<Color> labelColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(z ? this.labelColor : this.disabledLabelColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> leadingIconContentColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(z ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconContentColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(z ? this.trailingIconContentColor : this.disabledTrailingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m3325equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m3325equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m3325equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m3325equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m3325equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m3325equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m3325equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m3331hashCodeimpl(this.containerColor) * 31) + Color.m3331hashCodeimpl(this.labelColor)) * 31) + Color.m3331hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m3331hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m3331hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3331hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3331hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m3331hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}