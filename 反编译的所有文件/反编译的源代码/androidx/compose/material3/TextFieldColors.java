...
public final class TextFieldColors {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = leadingIconColor$lambda$0(stateCollectIsFocusedAsState) ? this.focusedLeadingIconColor : this.unfocusedLeadingIconColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> trailingIconColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = trailingIconColor$lambda$1(stateCollectIsFocusedAsState) ? this.focusedTrailingIconColor : this.unfocusedTrailingIconColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> indicatorColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = indicatorColor$lambda$2(stateCollectIsFocusedAsState) ? this.focusedIndicatorColor : this.unfocusedIndicatorColor;
        }
        long j2 = j;
        if (z) {
            composer.startReplaceableGroup(715788864);
            ComposerKt.sourceInformation(composer, "1814@99574L75");
            stateRememberUpdatedState = SingleValueAnimationKt.m137animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(715788969);
            ComposerKt.sourceInformation(composer, "1816@99679L33");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> containerColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = containerColor$lambda$3(stateCollectIsFocusedAsState) ? this.focusedContainerColor : this.unfocusedContainerColor;
        }
        State<Color> stateM137animateColorAsStateeuL9pac = SingleValueAnimationKt.m137animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> placeholderColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = placeholderColor$lambda$4(stateCollectIsFocusedAsState) ? this.focusedPlaceholderColor : this.unfocusedPlaceholderColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> labelColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = labelColor$lambda$5(stateCollectIsFocusedAsState) ? this.focusedLabelColor : this.unfocusedLabelColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> textColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = textColor$lambda$6(stateCollectIsFocusedAsState) ? this.focusedTextColor : this.unfocusedTextColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> supportingTextColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = supportingTextColor$lambda$7(stateCollectIsFocusedAsState) ? this.focusedSupportingTextColor : this.unfocusedSupportingTextColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> prefixColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = prefixColor$lambda$8(stateCollectIsFocusedAsState) ? this.focusedPrefixColor : this.unfocusedPrefixColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> suffixColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = suffixColor$lambda$9(stateCollectIsFocusedAsState) ? this.focusedSuffixColor : this.unfocusedSuffixColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> cursorColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3314boximpl(z ? this.errorCursorColor : this.cursorColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.focusedTextColor, textFieldColors.focusedTextColor) && Color.m3325equalsimpl0(this.unfocusedTextColor, textFieldColors.unfocusedTextColor) && Color.m3325equalsimpl0(this.disabledTextColor, textFieldColors.disabledTextColor) && Color.m3325equalsimpl0(this.errorTextColor, textFieldColors.errorTextColor) && Color.m3325equalsimpl0(this.focusedContainerColor, textFieldColors.focusedContainerColor) && Color.m3325equalsimpl0(this.unfocusedContainerColor, textFieldColors.unfocusedContainerColor) && Color.m3325equalsimpl0(this.disabledContainerColor, textFieldColors.disabledContainerColor) && Color.m3325equalsimpl0(this.errorContainerColor, textFieldColors.errorContainerColor) && Color.m3325equalsimpl0(this.cursorColor, textFieldColors.cursorColor) && Color.m3325equalsimpl0(this.errorCursorColor, textFieldColors.errorCursorColor) && Intrinsics.areEqual(this.textSelectionColors, textFieldColors.textSelectionColors) && Color.m3325equalsimpl0(this.focusedIndicatorColor, textFieldColors.focusedIndicatorColor) && Color.m3325equalsimpl0(this.unfocusedIndicatorColor, textFieldColors.unfocusedIndicatorColor) && Color.m3325equalsimpl0(this.disabledIndicatorColor, textFieldColors.disabledIndicatorColor) && Color.m3325equalsimpl0(this.errorIndicatorColor, textFieldColors.errorIndicatorColor) && Color.m3325equalsimpl0(this.focusedLeadingIconColor, textFieldColors.focusedLeadingIconColor) && Color.m3325equalsimpl0(this.unfocusedLeadingIconColor, textFieldColors.unfocusedLeadingIconColor) && Color.m3325equalsimpl0(this.disabledLeadingIconColor, textFieldColors.disabledLeadingIconColor) && Color.m3325equalsimpl0(this.errorLeadingIconColor, textFieldColors.errorLeadingIconColor) && Color.m3325equalsimpl0(this.focusedTrailingIconColor, textFieldColors.focusedTrailingIconColor) && Color.m3325equalsimpl0(this.unfocusedTrailingIconColor, textFieldColors.unfocusedTrailingIconColor) && Color.m3325equalsimpl0(this.disabledTrailingIconColor, textFieldColors.disabledTrailingIconColor) && Color.m3325equalsimpl0(this.errorTrailingIconColor, textFieldColors.errorTrailingIconColor) && Color.m3325equalsimpl0(this.focusedLabelColor, textFieldColors.focusedLabelColor) && Color.m3325equalsimpl0(this.unfocusedLabelColor, textFieldColors.unfocusedLabelColor) && Color.m3325equalsimpl0(this.disabledLabelColor, textFieldColors.disabledLabelColor) && Color.m3325equalsimpl0(this.errorLabelColor, textFieldColors.errorLabelColor) && Color.m3325equalsimpl0(this.focusedPlaceholderColor, textFieldColors.focusedPlaceholderColor) && Color.m3325equalsimpl0(this.unfocusedPlaceholderColor, textFieldColors.unfocusedPlaceholderColor) && Color.m3325equalsimpl0(this.disabledPlaceholderColor, textFieldColors.disabledPlaceholderColor) && Color.m3325equalsimpl0(this.errorPlaceholderColor, textFieldColors.errorPlaceholderColor) && Color.m3325equalsimpl0(this.focusedSupportingTextColor, textFieldColors.focusedSupportingTextColor) && Color.m3325equalsimpl0(this.unfocusedSupportingTextColor, textFieldColors.unfocusedSupportingTextColor) && Color.m3325equalsimpl0(this.disabledSupportingTextColor, textFieldColors.disabledSupportingTextColor) && Color.m3325equalsimpl0(this.errorSupportingTextColor, textFieldColors.errorSupportingTextColor) && Color.m3325equalsimpl0(this.focusedPrefixColor, textFieldColors.focusedPrefixColor) && Color.m3325equalsimpl0(this.unfocusedPrefixColor, textFieldColors.unfocusedPrefixColor) && Color.m3325equalsimpl0(this.disabledPrefixColor, textFieldColors.disabledPrefixColor) && Color.m3325equalsimpl0(this.errorPrefixColor, textFieldColors.errorPrefixColor) && Color.m3325equalsimpl0(this.focusedSuffixColor, textFieldColors.focusedSuffixColor) && Color.m3325equalsimpl0(this.unfocusedSuffixColor, textFieldColors.unfocusedSuffixColor) && Color.m3325equalsimpl0(this.disabledSuffixColor, textFieldColors.disabledSuffixColor) && Color.m3325equalsimpl0(this.errorSuffixColor, textFieldColors.errorSuffixColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((Color.m3331hashCodeimpl(this.focusedTextColor) * 31) + Color.m3331hashCodeimpl(this.unfocusedTextColor)) * 31) + Color.m3331hashCodeimpl(this.disabledTextColor)) * 31) + Color.m3331hashCodeimpl(this.errorTextColor)) * 31) + Color.m3331hashCodeimpl(this.focusedContainerColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedContainerColor)) * 31) + Color.m3331hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3331hashCodeimpl(this.errorContainerColor)) * 31) + Color.m3331hashCodeimpl(this.cursorColor)) * 31) + Color.m3331hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m3331hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m3331hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m3331hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m3331hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m3331hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3331hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m3331hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m3331hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m3331hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m3331hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m3331hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3331hashCodeimpl(this.errorLabelColor)) * 31) + Color.m3331hashCodeimpl(this.focusedPlaceholderColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedPlaceholderColor)) * 31) + Color.m3331hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m3331hashCodeimpl(this.errorPlaceholderColor)) * 31) + Color.m3331hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m3331hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m3331hashCodeimpl(this.errorSupportingTextColor)) * 31) + Color.m3331hashCodeimpl(this.focusedPrefixColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedPrefixColor)) * 31) + Color.m3331hashCodeimpl(this.disabledPrefixColor)) * 31) + Color.m3331hashCodeimpl(this.errorPrefixColor)) * 31) + Color.m3331hashCodeimpl(this.focusedSuffixColor)) * 31) + Color.m3331hashCodeimpl(this.unfocusedSuffixColor)) * 31) + Color.m3331hashCodeimpl(this.disabledSuffixColor)) * 31) + Color.m3331hashCodeimpl(this.errorSuffixColor);
    }
