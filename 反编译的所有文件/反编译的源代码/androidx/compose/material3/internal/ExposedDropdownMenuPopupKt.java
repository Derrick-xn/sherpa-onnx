...
public final class ExposedDropdownMenuPopupKt {
    ...
    public static final void ExposedDropdownMenuPopup(Function0<Unit> function0, final PopupPositionProvider popupPositionProvider, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        if ((i6 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            UUID popupId = (UUID) RememberSaveableKt.m2871rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupId$1
                @Override // kotlin.jvm.functions.Function0
                        ...
                        if ((i7 & 11) != 2 || !composer5.getSkipping()) {
                            ...
                            Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                    m2173invokeozmzZPI(intSize.getPackedValue());
                                    return Unit.INSTANCE;
                                }

                                /* renamed from: invoke-ozmzZPI, reason: not valid java name */
                                public final void m2173invokeozmzZPI(long j) {
                                    popupLayout2.m2175setPopupContentSizefhxjrPA(IntSize.m6010boximpl(j));
                            ...
                            ExposedDropdownMenuPopupKt.C04921 c04921 = ExposedDropdownMenuPopupKt.C04921.INSTANCE;
                            ...
                            Composer composerM2777constructorimpl = Updater.m2777constructorimpl(composer5);
                            Updater.m2784setimpl(composerM2777constructorimpl, c04921, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                            Updater.m2784setimpl(composerM2777constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
                            Updater.m2784setimpl(composerM2777constructorimpl, layoutDirection3, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                            Updater.m2784setimpl(composerM2777constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                            function3MaterializerOf.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer5)), composer5, 0);
            ...
            Modifier modifierOnGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.INSTANCE, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt.ExposedDropdownMenuPopup.5
                ...
                public final void invoke2(LayoutCoordinates childCoordinates) {
                    ...
                    long jMo4682getSizeYbymL2g = parentLayoutCoordinates.mo4682getSizeYbymL2g();
                    long jPositionInWindow = LayoutCoordinatesKt.positionInWindow(parentLayoutCoordinates);
                    popupLayout2.setParentBounds(IntRectKt.m6008IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m3044getXimpl(jPositionInWindow)), MathKt.roundToInt(Offset.m3045getYimpl(jPositionInWindow))), jMo4682getSizeYbymL2g));
                    popupLayout2.updatePosition();
                }
            });
    ...
    public static final class C04921 implements MeasurePolicy {
        ...
        public final MeasureResult mo61measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
            ...
            int i3 = 0;
            if (size == 1) {
                final Placeable placeableMo4680measureBRTryo0 = measurables.get(0).mo4680measureBRTryo0(j);
                return MeasureScope.CC.layout$default(Layout, placeableMo4680measureBRTryo0.getWidth(), placeableMo4680measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$SimpleStack$1$measure$2
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(Placeable.PlacementScope layout) {
                        Intrinsics.checkNotNullParameter(layout, "$this$layout");
                        Placeable.PlacementScope.placeRelative$default(layout, placeableMo4680measureBRTryo0, 0, 0, 0.0f, 4, null);
                    }
                }, 4, null);
            }
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                arrayList.add(measurables.get(i4).mo4680measureBRTryo0(j));
            }
            ...
            return MeasureScope.CC.layout$default(Layout, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$SimpleStack$1$measure$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(1);
    ...
    private static final void SimpleStack(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        Composer composerM2777constructorimpl = Updater.m2777constructorimpl(composer);
        Updater.m2784setimpl(composerM2777constructorimpl, c04921, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        ...
        Updater.m2784setimpl(composerM2777constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
        function3MaterializerOf.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer)), composer, 0);
