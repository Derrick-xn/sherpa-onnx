...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m1739constructorimpl(0);
    private static final int StartDateInput = m1739constructorimpl(1);
    private static final int EndDateInput = m1739constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m1738boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1739constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1740equalsimpl(int i, Object obj) {
        return (obj instanceof InputIdentifier) && i == ((InputIdentifier) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1741equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1742hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m1740equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1742hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1746getSingleDateInputJ2x2o4M() {
            return InputIdentifier.SingleDateInput;
        }

        /* renamed from: getStartDateInput-J2x2o4M, reason: not valid java name */
        public final int m1747getStartDateInputJ2x2o4M() {
            return InputIdentifier.StartDateInput;
        }

        /* renamed from: getEndDateInput-J2x2o4M, reason: not valid java name */
        public final int m1745getEndDateInputJ2x2o4M() {
            return InputIdentifier.EndDateInput;
        }
    }

    public String toString() {
        return m1743toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1743toStringimpl(int i) {
        return m1741equalsimpl0(i, SingleDateInput) ? "SingleDateInput" : m1741equalsimpl0(i, StartDateInput) ? "StartDateInput" : m1741equalsimpl0(i, EndDateInput) ? "EndDateInput" : "Unknown";
    }
}