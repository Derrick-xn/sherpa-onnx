...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo61measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        int i = measure.mo391roundToPx0680j_4(this.paddingValues.getBottom());
        ...
        Placeable placeableMo4680measureBRTryo04 = measurable3 != null ? measurable3.mo4680measureBRTryo0(ConstraintsKt.m5807offsetNN6EwU$default(jM5778copyZbe2FdA$default, -iWidthOrZero2, 0, 2, null)) : null;
        int iWidthOrZero3 = iWidthOrZero2 + TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo04);
        int iMax3 = Math.max(iMax2, TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo04));
        ...
        if (measurable4 != null) {
            ...
            placeableMo4680measureBRTryo0 = measurable4.mo4680measureBRTryo0(ConstraintsKt.m5807offsetNN6EwU$default(jM5778copyZbe2FdA$default, -iWidthOrZero3, 0, 2, null));
        } else {
            placeable = placeableMo4680measureBRTryo03;
            placeableMo4680measureBRTryo0 = null;
        }
        int iWidthOrZero4 = iWidthOrZero3 + TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo0);
        int iMax4 = Math.max(iMax3, TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo0));
        boolean z = this.animationProgress < 1.0f;
        int i2 = measure.mo391roundToPx0680j_4(this.paddingValues.mo662calculateLeftPaddingu2uoSUM(measure.getLayoutDirection())) + measure.mo391roundToPx0680j_4(this.paddingValues.mo663calculateRightPaddingu2uoSUM(measure.getLayoutDirection()));
        int i3 = z ? (-iWidthOrZero4) - i2 : -i2;
        int i4 = -i;
        long jM5806offsetNN6EwU = ConstraintsKt.m5806offsetNN6EwU(jM5778copyZbe2FdA$default, i3, i4);
        Iterator<T> it5 = list.iterator();
        while (true) {
            if (!it5.hasNext()) {
                placeable2 = placeableMo4680measureBRTryo0;
                next5 = null;
                break;
            }
            next5 = it5.next();
            ...
            placeableMo4680measureBRTryo0 = placeable2;
        }
        Measurable measurable5 = (Measurable) next5;
        final Placeable placeableMo4680measureBRTryo05 = measurable5 != null ? measurable5.mo4680measureBRTryo0(jM5806offsetNN6EwU) : null;
        if (placeableMo4680measureBRTryo05 != null) {
            this.onLabelMeasured.invoke(Size.m3101boximpl(SizeKt.Size(placeableMo4680measureBRTryo05.getWidth(), placeableMo4680measureBRTryo05.getHeight())));
        }
        int iMax5 = Math.max(TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo05) / 2, measure.mo391roundToPx0680j_4(this.paddingValues.getTop()));
        long jM5778copyZbe2FdA$default2 = Constraints.m5778copyZbe2FdA$default(ConstraintsKt.m5806offsetNN6EwU(j, -iWidthOrZero4, i4 - iMax5), 0, 0, 0, 0, 11, null);
        ...
        while (it6.hasNext()) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable6), TextFieldImplKt.TextFieldId)) {
                final Placeable placeableMo4680measureBRTryo06 = measurable6.mo4680measureBRTryo0(jM5778copyZbe2FdA$default2);
                long jM5778copyZbe2FdA$default3 = Constraints.m5778copyZbe2FdA$default(jM5778copyZbe2FdA$default2, 0, 0, 0, 0, 14, null);
                ...
                Placeable placeableMo4680measureBRTryo07 = measurable7 != null ? measurable7.mo4680measureBRTryo0(jM5778copyZbe2FdA$default3) : null;
                long jM5778copyZbe2FdA$default4 = Constraints.m5778copyZbe2FdA$default(ConstraintsKt.m5807offsetNN6EwU$default(jM5778copyZbe2FdA$default, 0, -Math.max(iMax4, Math.max(TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo06), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo07)) + iMax5 + i), 1, null), 0, 0, 0, 0, 11, null);
                ...
                Placeable placeableMo4680measureBRTryo08 = measurable8 != null ? measurable8.mo4680measureBRTryo0(jM5778copyZbe2FdA$default4) : null;
                int iHeightOrZero = TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo08);
                final int iM1820calculateWidthDHJA7U0 = OutlinedTextFieldKt.m1820calculateWidthDHJA7U0(TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo02), TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo04), TextFieldImplKt.widthOrZero(placeable2), placeableMo4680measureBRTryo06.getWidth(), TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo05), TextFieldImplKt.widthOrZero(placeableMo4680measureBRTryo07), z, j, measure.getDensity(), this.paddingValues);
                final int iM1819calculateHeightDHJA7U0 = OutlinedTextFieldKt.m1819calculateHeightDHJA7U0(TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo02), TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo04), TextFieldImplKt.heightOrZero(placeable2), placeableMo4680measureBRTryo06.getHeight(), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo05), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo07), TextFieldImplKt.heightOrZero(placeableMo4680measureBRTryo08), j, measure.getDensity(), this.paddingValues);
                int i5 = iM1819calculateHeightDHJA7U0 - iHeightOrZero;
                for (Measurable measurable9 : list) {
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable9), TextFieldImplKt.ContainerId)) {
                        final Placeable placeableMo4680measureBRTryo09 = measurable9.mo4680measureBRTryo0(ConstraintsKt.Constraints(iM1820calculateWidthDHJA7U0 != Integer.MAX_VALUE ? iM1820calculateWidthDHJA7U0 : 0, iM1820calculateWidthDHJA7U0, i5 != Integer.MAX_VALUE ? i5 : 0, i5));
                        final Placeable placeable3 = placeableMo4680measureBRTryo02;
                        final Placeable placeable4 = placeable;
                        final Placeable placeable5 = placeableMo4680measureBRTryo04;
                        final Placeable placeable6 = placeable2;
                        final Placeable placeable7 = placeableMo4680measureBRTryo07;
                        final Placeable placeable8 = placeableMo4680measureBRTryo08;
                        return MeasureScope.CC.layout$default(measure, iM1820calculateWidthDHJA7U0, iM1819calculateHeightDHJA7U0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$measure$2
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                OutlinedTextFieldKt.place(layout, iM1819calculateHeightDHJA7U0, iM1820calculateWidthDHJA7U0, placeable3, placeable4, placeable5, placeable6, placeableMo4680measureBRTryo06, placeableMo4680measureBRTryo05, placeable7, placeableMo4680measureBRTryo09, placeable8, this.animationProgress, this.singleLine, measure.getDensity(), measure.getLayoutDirection(), this.paddingValues);
                            }
                        }, 4, null);
                    }
                }
