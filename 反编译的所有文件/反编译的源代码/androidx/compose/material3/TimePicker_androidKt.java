...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            iM2085getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2084getHorizontalQJTpgSE();
        } else {
            iM2085getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2085getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return iM2085getVerticalQJTpgSE;
    }
}