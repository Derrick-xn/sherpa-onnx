...
public final class DisplayMode {
    ...
    private static final int Picker = m1661constructorimpl(0);
    private static final int Input = m1661constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1660boximpl(int i) {
        return new DisplayMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1661constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1662equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1663equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1664hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m1662equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1664hashCodeimpl(this.value);
    }
    ...
    public static String m1665toStringimpl(int i) {
        return m1663equalsimpl0(i, Picker) ? "Picker" : m1663equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}