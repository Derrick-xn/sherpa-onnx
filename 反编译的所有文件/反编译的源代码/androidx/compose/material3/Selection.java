...
public final class Selection {
    ...
    private static final int Hour = m1867constructorimpl(0);
    private static final int Minute = m1867constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Selection m1866boximpl(int i) {
        return new Selection(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1867constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1868equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m1872unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1869equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1870hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1871toStringimpl(int i) {
        return "Selection(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m1868equalsimpl(this.value, obj);
    }
