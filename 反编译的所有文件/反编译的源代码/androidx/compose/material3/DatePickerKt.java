...
public final class DatePickerKt {
    ...
    private static final float RecommendedSizeForAccessibility = Dp.m5844constructorimpl(48);
    private static final float MonthYearHeight = Dp.m5844constructorimpl(56);
    ...
    */
    ...
    public static final DatePickerState m1641rememberDatePickerStateNVmSL94(final Long l, final Long l2, final IntRange intRange, final int i, Composer composer, int i2, int i3) {
        ...
        if ((i3 & 8) != 0) {
            i = DisplayMode.INSTANCE.m1668getPickerjFl4v0();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1574672255, i2, -1, "androidx.compose.material3.rememberDatePickerState (DatePicker.kt:219)");
        }
        DatePickerState datePickerState = (DatePickerState) RememberSaveableKt.m2871rememberSaveable(new Object[0], (Saver) DatePickerState.INSTANCE.Saver(), (String) null, (Function0) new Function0<DatePickerState>() { // from class: androidx.compose.material3.DatePickerKt$rememberDatePickerState$1
    ...
    public static final void m1638DateEntryContainerau3_HiA(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final DatePickerColors colors, final TextStyle headlineTextStyle, final float f, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        if ((23967451 & i3) != 4793490 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierSemantics$default = SemanticsModifierKt.semantics$default(SizeKt.m760sizeInqDBjuR0$default(modifier, DatePickerModalTokens.INSTANCE.m2278getContainerWidthD9Ej5fM(), 0.0f, 0.0f, 0.0f, 14, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$1
            ...
            m1639DatePickerHeaderpc5RIQQ(Modifier.INSTANCE, function2, colors.getTitleContentColor(), colors.getHeadlineContentColor(), f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -229007058, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        Composer composerM2777constructorimpl2 = Updater.m2777constructorimpl(composer3);
                        Updater.m2784setimpl(composerM2777constructorimpl2, measurePolicyColumnMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                        ...
                        function3MaterializerOf2.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer3)), composer3, 0);
                        ...
                        composer3.disableReusing();
                        Composer composerM2777constructorimpl3 = Updater.m2777constructorimpl(composer3);
                        Updater.m2784setimpl(composerM2777constructorimpl3, measurePolicyRowMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                        ...
                        composer3.enableReusing();
                        function3MaterializerOf3.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer3)), composer3, 0);
                        composer3.startReplaceableGroup(2058660585);
                            ...
                            TextKt.ProvideTextStyle(textStyle, ComposableLambdaKt.composableLambda(composer3, -962031352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1$1$1$1
                                ...
                                public final void invoke(Composer composer4, int i6) {
                                    ...
                                    if ((i6 & 11) != 2 || !composer4.getSkipping()) {
                                        ...
                                        Modifier modifierWeight$default = RowScope.CC.weight$default(rowScopeInstance, Modifier.INSTANCE, 1.0f, false, 2, null);
                                        ...
                                        Composer composerM2777constructorimpl4 = Updater.m2777constructorimpl(composer4);
                                        Updater.m2784setimpl(composerM2777constructorimpl4, measurePolicyRememberBoxMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                                        ...
                                        function3MaterializerOf4.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer4)), composer4, 0);
                        ...
                        if (function26 != null || function24 != null || function25 != null) {
                            DividerKt.m1670Divider9IZ8Weo(null, 0.0f, 0L, composer3, 0, 7);
                        }
                        composer3.endReplaceableGroup();
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$3
            ...
            public final void invoke(Composer composer3, int i4) {
                DatePickerKt.m1638DateEntryContainerau3_HiA(modifier, function2, function22, function23, colors, headlineTextStyle, f, content, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    /* renamed from: DisplayModeToggleButton-tER2X8s, reason: not valid java name */
    public static final void m1640DisplayModeToggleButtontER2X8s(final Modifier modifier, final int i, final Function1<? super DisplayMode, Unit> onDisplayModeChange, Composer composer, final int i2) {
        int i3;
        Intrinsics.checkNotNullParameter(modifier, "modifier");
        ...
        if ((i3 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (DisplayMode.m1663equalsimpl0(i, DisplayMode.INSTANCE.m1668getPickerjFl4v0())) {
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$1$1
                        ...
                        public final void invoke2() {
                            onDisplayModeChange.invoke(DisplayMode.m1660boximpl(DisplayMode.INSTANCE.m1667getInputjFl4v0()));
                        }
                    };
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                }
                composerStartRestartGroup.endReplaceableGroup();
                IconButtonKt.IconButton((Function0) objRememberedValue, modifier, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1608getLambda1$material3_release(), composerStartRestartGroup, ((i3 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                composerStartRestartGroup.endReplaceableGroup();
            } else {
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue2 = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$2$1
                        ...
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2() {
                            onDisplayModeChange.invoke(DisplayMode.m1660boximpl(DisplayMode.INSTANCE.m1668getPickerjFl4v0()));
                        }
                    };
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue2);
                }
                composerStartRestartGroup.endReplaceableGroup();
                IconButtonKt.IconButton((Function0) objRememberedValue2, modifier, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1609getLambda2$material3_release(), composerStartRestartGroup, ((i3 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                composerStartRestartGroup.endReplaceableGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$3
            ...
            public final void invoke(Composer composer2, int i4) {
                DatePickerKt.m1640DisplayModeToggleButtontER2X8s(modifier, i, onDisplayModeChange, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
    ...
    public static final void SwitchableDateEntryContent(final DatePickerState datePickerState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            int iM1644getDisplayModejFl4v0 = datePickerState.m1644getDisplayModejFl4v0();
            CrossfadeKt.Crossfade(DisplayMode.m1660boximpl(iM1644getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.SwitchableDateEntryContent.1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer2, Integer num) throws Resources.NotFoundException {
                    m1643invokeQujVXRc(displayMode.getValue(), composer2, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m1643invokeQujVXRc(int i4, Composer composer2, int i5) throws Resources.NotFoundException {
                    int i6;
                    ...
                    if ((i6 & 91) != 18 || !composer2.getSkipping()) {
                        ...
                        if (DisplayMode.m1663equalsimpl0(i4, DisplayMode.INSTANCE.m1668getPickerjFl4v0())) {
                            ...
                            StateData stateData$material3_release = datePickerState.getStateData();
                            DatePickerFormatter datePickerFormatter2 = datePickerFormatter;
                            Function1<Long, Boolean> function12 = function1;
                            DatePickerColors datePickerColors2 = datePickerColors;
                            int i7 = i3;
                            DatePickerKt.DatePickerContent(stateData$material3_release, datePickerFormatter2, function12, datePickerColors2, composer2, (i7 & 112) | (i7 & 896) | (i7 & 7168));
                            composer2.endReplaceableGroup();
                            ...
                            StateData stateData$material3_release2 = datePickerState.getStateData();
                            DatePickerFormatter datePickerFormatter3 = datePickerFormatter;
                            Function1<Long, Boolean> function13 = function1;
                            int i8 = i3;
                            DateInputKt.DateInputContent(stateData$material3_release2, datePickerFormatter3, function13, composer2, (i8 & 896) | (i8 & 112));
                            composer2.endReplaceableGroup();
                        } else {
    ...
    public static final void DatePickerContent(final StateData stateData, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) == 1170 && composerStartRestartGroup.getSkipping()) {
            ...
            final MutableState mutableState = (MutableState) RememberSaveableKt.m2871rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<MutableState<Boolean>>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$yearPickerVisible$2
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function0
            ...
            Modifier modifierM713paddingVpY3zN4$default = PaddingKt.m713paddingVpY3zN4$default(companion2, f, 0.0f, 2, null);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            MonthsNavigation(modifierM713paddingVpY3zN4$default, canScrollForward, canScrollBackward, zDatePickerContent$lambda$5, monthYear$material3_release, function0, function02, (Function0) objRememberedValue3, composerStartRestartGroup, 6);
            ...
            Modifier modifierM713paddingVpY3zN4$default2 = PaddingKt.m713paddingVpY3zN4$default(Modifier.INSTANCE, f, 0.0f, 2, null);
            composerStartRestartGroup.startReplaceableGroup(-483455358);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Column)P(2,3,1)77@3913L61,78@3979L133:Column.kt#2w3rfo");
            ...
            ViewConfiguration viewConfiguration3 = (ViewConfiguration) objConsume9;
            Function0<ComposeUiNode> constructor3 = ComposeUiNode.INSTANCE.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf3 = LayoutKt.materializerOf(modifierM713paddingVpY3zN4$default2);
            if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            composerStartRestartGroup.startReusableNode();
            ...
            Updater.m2784setimpl(composerM2777constructorimpl3, measurePolicyColumnMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2784setimpl(composerM2777constructorimpl3, density3, ComposeUiNode.INSTANCE.getSetDensity());
            Updater.m2784setimpl(composerM2777constructorimpl3, layoutDirection3, ComposeUiNode.INSTANCE.getSetLayoutDirection());
            Updater.m2784setimpl(composerM2777constructorimpl3, viewConfiguration3, ComposeUiNode.INSTANCE.getSetViewConfiguration());
            composerStartRestartGroup.enableReusing();
            ...
            AnimatedVisibilityKt.AnimatedVisibility(DatePickerContent$lambda$5(mutableState), ClipKt.clipToBounds(Modifier.INSTANCE), EnterExitTransitionKt.expandVertically$default(null, null, false, null, 15, null).plus(EnterExitTransitionKt.fadeIn$default(null, 0.6f, 1, null)), EnterExitTransitionKt.shrinkVertically$default(null, null, false, null, 15, null).plus(EnterExitTransitionKt.fadeOut$default(null, 0.0f, 3, null)), (String) null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 760161496, true, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$1$4$2
                ...
                public final void invoke(AnimatedVisibilityScope AnimatedVisibility, Composer composer3, int i5) throws Resources.NotFoundException {
                    ...
                    final String strM1959getStringNWtq28 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1925getDatePickerYearPickerPaneTitleadMyvUU(), composer3, 6);
                    Modifier.Companion companion4 = Modifier.INSTANCE;
                    composer3.startReplaceableGroup(1157296644);
                    ComposerKt.sourceInformation(composer3, "CC(remember)P(1):Composables.kt#9igjgp");
                    boolean zChanged3 = composer3.changed(strM1959getStringNWtq28);
                    ...
                    if (zChanged3 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue4 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$1$4$2$1$1
                            ...
                            public final void invoke2(SemanticsPropertyReceiver semantics) {
                                Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                                SemanticsPropertiesKt.setPaneTitle(semantics, strM1959getStringNWtq28);
                            }
                        };
                    ...
                    composer3.disableReusing();
                    Composer composerM2777constructorimpl4 = Updater.m2777constructorimpl(composer3);
                    Updater.m2784setimpl(composerM2777constructorimpl4, measurePolicyColumnMeasurePolicy3, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                    Updater.m2784setimpl(composerM2777constructorimpl4, density4, ComposeUiNode.INSTANCE.getSetDensity());
                    Updater.m2784setimpl(composerM2777constructorimpl4, layoutDirection4, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                    Updater.m2784setimpl(composerM2777constructorimpl4, viewConfiguration4, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                    composer3.enableReusing();
                    function3MaterializerOf4.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer3)), composer3, 0);
                    composer3.startReplaceableGroup(2058660585);
                    ComposerKt.sourceInformationMarkerStart(composer3, 276693704, "C79@4027L9:Column.kt#2w3rfo");
                    ...
                    DatePickerKt.YearPicker(PaddingKt.m713paddingVpY3zN4$default(SizeKt.m745requiredHeight3ABfNKs(Modifier.INSTANCE, Dp.m5844constructorimpl(Dp.m5844constructorimpl(DatePickerKt.getRecommendedSizeForAccessibility() * 7) - DividerDefaults.INSTANCE.m1669getThicknessD9Ej5fM())), DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null), new Function1<Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$1$4$2$2$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
    ...
    public static final void m1639DatePickerHeaderpc5RIQQ(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final long j, final long j2, final float f, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        final int i2;
        Modifier.Companion companionM741defaultMinSizeVpY3zN4$default;
        Intrinsics.checkNotNullParameter(modifier, "modifier");
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        if ((374491 & i2) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (function2 != null) {
                companionM741defaultMinSizeVpY3zN4$default = SizeKt.m741defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, f, 1, null);
            } else {
                companionM741defaultMinSizeVpY3zN4$default = Modifier.INSTANCE;
            }
            Modifier modifierThen = SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null).then(companionM741defaultMinSizeVpY3zN4$default);
            ...
            if (function2 != null) {
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3314boximpl(j))}, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1005061498, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3314boximpl(j2))}, content, composerStartRestartGroup, ((i2 >> 12) & 112) | 8);
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endNode();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$2
            ...
            public final void invoke(Composer composer2, int i3) {
                DatePickerKt.m1639DatePickerHeaderpc5RIQQ(modifier, function2, j, j2, f, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void HorizontalMonthsList(final Function1<? super Long, Unit> function1, final StateData stateData, final LazyListState lazyListState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function12, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        int i2 = (i & 14) == 0 ? (composerStartRestartGroup.changedInstance(function1) ? 4 : 2) | i : i;
        if ((i & 112) == 0) {
        ...
        if ((374491 & i3) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            FlingBehavior flingBehaviorRememberSnapFlingBehavior$material3_release = DatePickerDefaults.INSTANCE.rememberSnapFlingBehavior$material3_release(lazyListState, null, composerStartRestartGroup, i4 | 384, 2);
            ...
            for (int i5 = 0; i5 < 7; i5++) {
                zChanged2 |= composerStartRestartGroup.changed(objArr[i5]);
            }
            Object objRememberedValue2 = composerStartRestartGroup.rememberedValue();
            if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                composer2 = composerStartRestartGroup;
                        ...
                        LazyListScope.CC.items$default(LazyRow, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(-65053693, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$HorizontalMonthsList$2$1.1
                            ...
                            public final void invoke(LazyItemScope items, int i7, Composer composer4, int i8) {
                                ...
                                if ((i9 & 731) != 146 || !composer4.getSkipping()) {
                                    ...
                                    CalendarMonth calendarMonthPlusMonths = stateData2.getCalendarModel().plusMonths(calendarMonth2, i7);
                                    ...
                                    composer4.disableReusing();
                                    Composer composerM2777constructorimpl = Updater.m2777constructorimpl(composer4);
                                    ...
                                    Updater.m2784setimpl(composerM2777constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                                    composer4.enableReusing();
                                    function3MaterializerOf.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer4)), composer4, 0);
                                    composer4.startReplaceableGroup(2058660585);
                                    ComposerKt.sourceInformationMarkerStart(composer4, -1253629305, "C72@3384L9:Box.kt#2w3rfo");
                                    BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                                    ...
                                    int i11 = i10 << 3;
                                    int i12 = i10 << 6;
                                    DatePickerKt.Month(calendarMonthPlusMonths, function15, calendarDate2, stateData3, false, function16, datePickerFormatter3, datePickerColors3, composer4, (i11 & 458752) | (i11 & 112) | 24576 | (i12 & 7168) | ((i10 << 9) & 3670016) | (29360128 & i12));
                                    ComposerKt.sourceInformationMarkerEnd(composer4);
                                    ComposerKt.sourceInformationMarkerEnd(composer4);
                                    composer4.endReplaceableGroup();
                                    composer4.endNode();
            ...
            composer2.endReplaceableGroup();
            composer3 = composer2;
            LazyDslKt.LazyRow(modifierSemantics$default, lazyListState, null, false, null, null, flingBehaviorRememberSnapFlingBehavior$material3_release, false, (Function1) objRememberedValue2, composer3, (i3 >> 3) & 112, 188);
            composer3.startReplaceableGroup(511388516);
            ComposerKt.sourceInformation(composer3, "CC(remember)P(1,2):Composables.kt#9igjgp");
            boolean zChanged3 = composer3.changed(lazyListState) | composer3.changed(stateData);
            DatePickerKt$HorizontalMonthsList$3$1 datePickerKt$HorizontalMonthsList$3$1RememberedValue = composer3.rememberedValue();
            if (zChanged3 || datePickerKt$HorizontalMonthsList$3$1RememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                composer3.updateRememberedValue(datePickerKt$HorizontalMonthsList$3$1RememberedValue);
            }
            composer3.endReplaceableGroup();
            EffectsKt.LaunchedEffect(lazyListState, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) datePickerKt$HorizontalMonthsList$3$1RememberedValue, composer3, i4 | 64);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                        ...
                        TextKt.ProvideTextStyle(textStyleFromToken, ComposableLambdaKt.composableLambda(composer2, 2133710592, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.WeekDays.1.1
                            ...
                            public final void invoke(Composer composer3, int i7) {
                                ...
                                if ((i7 & 11) != 2 || !composer3.getSkipping()) {
                                    ...
                                    Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(SizeKt.m741defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, DatePickerKt.getRecommendedSizeForAccessibility(), 1, null), 0.0f, 1, null);
                                    ...
                                    composer3.enableReusing();
                                    ?? r7 = 0;
                                    function3MaterializerOf.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer3)), composer4, 0);
                                    int i10 = 2058660585;
                                    composer4.startReplaceableGroup(2058660585);
                                    ...
                                    while (it.hasNext()) {
                                        ...
                                        composer3.endReplaceableGroup();
                                        Modifier modifierM758sizeVpY3zN4 = SizeKt.m758sizeVpY3zN4(SemanticsModifierKt.clearAndSetSemantics(companion, (Function1) objRememberedValue), DatePickerKt.getRecommendedSizeForAccessibility(), DatePickerKt.getRecommendedSizeForAccessibility());
                                        Alignment center = Alignment.INSTANCE.getCenter();
                                        composer4.startReplaceableGroup(733328855);
                                        ComposerKt.sourceInformation(composer4, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                                        MeasurePolicy measurePolicyRememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(center, r7, composer4, 6);
                                        ...
                                        ViewConfiguration viewConfiguration2 = (ViewConfiguration) objConsume6;
                                        Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
                                        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf2 = LayoutKt.materializerOf(modifierM758sizeVpY3zN4);
                                        if (!(composer3.getApplier() instanceof Applier)) {
                                            ComposablesKt.invalidApplier();
                                        }
                                        composer3.startReusableNode();
                                        ...
                                        Updater.m2784setimpl(composerM2777constructorimpl2, viewConfiguration2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                                        composer3.enableReusing();
                                        function3MaterializerOf2.invoke(SkippableUpdater.m2768boximpl(SkippableUpdater.m2769constructorimpl(composer3)), composer4, Integer.valueOf((int) r7));
                                        ...
                                        TextKt.m2047Text4IGK_g((String) pair.getSecond(), SizeKt.wrapContentSize$default(Modifier.INSTANCE, alignment, r7, 3, alignment), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m5716boximpl(TextAlign.INSTANCE.m5723getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 48, 0, 130556);
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                        composer3.endReplaceableGroup();
                                        composer3.endNode();
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue2 = (Function1) new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$rangeSelectionDrawModifier$1$1
                        ...
                        public final void invoke2(ContentDrawScope drawWithContent) {
                            ...
                            if (value != null) {
                                DateRangePickerKt.m1646drawRangeBackgroundmxwnekA(drawWithContent, value, colors.getDayInSelectionRangeContainerColor());
                            }
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composerStartRestartGroup, 6), DatePickerModalTokens.INSTANCE.getDateLabelTextFont()), ComposableLambdaKt.composableLambda(composer2, -1776200645, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.Month.1
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        Modifier modifierThen = SizeKt.m745requiredHeight3ABfNKs(Modifier.INSTANCE, Dp.m5844constructorimpl(DatePickerKt.getRecommendedSizeForAccessibility() * 6)).then(modifier);
                        Arrangement.HorizontalOrVertical spaceEvenly = Arrangement.INSTANCE.getSpaceEvenly();
                        ...
                        while (i11 < i10) {
                            ...
                            composer3.disableReusing();
                            Composer composerM2777constructorimpl2 = Updater.m2777constructorimpl(composer3);
                            Updater.m2784setimpl(composerM2777constructorimpl2, measurePolicyRowMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                            Updater.m2784setimpl(composerM2777constructorimpl2, density2, ComposeUiNode.INSTANCE.getSetDensity());
                            Updater.m2784setimpl(composerM2777constructorimpl2, layoutDirection2, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                            Updater.m2784setimpl(composerM2777constructorimpl2, viewConfiguration2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                            composer3.enableReusing();
                            ...
                            ComposerKt.sourceInformationMarkerStart(composer3, -326682283, "C80@4021L9:Row.kt#2w3rfo");
                            RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                            ComposerKt.sourceInformationMarkerStart(composer3, -1481813225, str7);
                            ...
                            while (i15 < 7) {
                                if (i14 < calendarMonth2.getDaysFromStartOfWeekToFirstOfMonth() || i14 >= calendarMonth2.getDaysFromStartOfWeekToFirstOfMonth() + calendarMonth2.getNumberOfDays()) {
                                    ...
                                    SpacerKt.Spacer(SizeKt.m750requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerKt.getRecommendedSizeForAccessibility(), DatePickerKt.getRecommendedSizeForAccessibility()), composer3, 6);
                                    composer3.endReplaceableGroup();
                                } else {
                                    ...
                                    final int daysFromStartOfWeekToFirstOfMonth = i14 - calendarMonth2.getDaysFromStartOfWeekToFirstOfMonth();
                                    calendarMonth = calendarMonth2;
                                    ...
                                    if (zChanged5 || objRememberedValue5 == Composer.INSTANCE.getEmpty()) {
                                        ...
                                        function1 = function15;
                                        Boolean boolInvoke = function1.invoke(lValueOf);
                                        boolInvoke.booleanValue();
                                        composer3.updateRememberedValue(boolInvoke);
                                        obj = boolInvoke;
                                    } else {
                                        function1 = function15;
                                    ...
                                    if (strDayContentDescription != null) {
                                        str4 = strDayContentDescription + ", " + withSkeleton;
                                    } else {
                                        str4 = withSkeleton;
                                    }
                                    ...
                                    DatePickerKt.Day(companion2, z9, function0, z10, zBooleanValue, z11, zBooleanValue2, str9, datePickerColors, ComposableLambdaKt.composableLambda(composer3, 1633583293, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$1$1$1$1$1$3
                                        ...
                                        public final void invoke(Composer composer4, int i18) {
                                            ...
                                            if ((i18 & 11) != 2 || !composer4.getSkipping()) {
                                                ...
                                                TextKt.m2047Text4IGK_g(DatePickerKt.toLocalString(daysFromStartOfWeekToFirstOfMonth + 1), SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$1$1$1$1$1$3.1
                                                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                                    public final void invoke2(SemanticsPropertyReceiver clearAndSetSemantics) {
                                                        Intrinsics.checkNotNullParameter(clearAndSetSemantics, "$this$clearAndSetSemantics");
                                                    }
                                                ...
                                                }), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m5716boximpl(TextAlign.INSTANCE.m5723getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer4, 0, 0, 130556);
                                                if (ComposerKt.isTraceInProgress()) {
                                                    ComposerKt.traceEventEnd();
                                                    return;
                                                }
    ...
    public static final String dayContentDescription(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, Composer composer, int i) {
        ...
        if (z) {
            if (z3) {
                ...
                sb.append(Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1932getDateRangePickerStartHeadlineadMyvUU(), composer, 6));
                composer.endReplaceableGroup();
            } else if (z4) {
                composer.startReplaceableGroup(-852203980);
                ComposerKt.sourceInformation(composer, "1553@64360L54");
                sb.append(Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1929getDateRangePickerEndHeadlineadMyvUU(), composer, 6));
                composer.endReplaceableGroup();
            } else if (z5) {
                composer.startReplaceableGroup(-852203842);
                ComposerKt.sourceInformation(composer, "1557@64498L53");
                sb.append(Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1928getDateRangePickerDayInRangeadMyvUU(), composer, 6));
                composer.endReplaceableGroup();
            } else {
        ...
        if (z2) {
            ...
            sb.append(Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1924getDatePickerTodayDescriptionadMyvUU(), composer, 6));
        }
    ...
    public static final void Day(final Modifier modifier, final boolean z, final Function0<Unit> function0, final boolean z2, final boolean z3, final boolean z4, final boolean z5, final String str, final DatePickerColors datePickerColors, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((1533916891 & i3) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM750requiredSizeVpY3zN4 = SizeKt.m750requiredSizeVpY3zN4(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier), DatePickerModalTokens.INSTANCE.m2282getDateStateLayerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m2281getDateStateLayerHeightD9Ej5fM());
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierSemantics = SemanticsModifierKt.semantics(modifierM750requiredSizeVpY3zN4, true, (Function1) objRememberedValue);
            Shape shape = ShapesKt.toShape(DatePickerModalTokens.INSTANCE.getDateContainerShape(), composerStartRestartGroup, 6);
            int i4 = i3 >> 3;
            int i5 = i4 & 14;
            int i6 = i3 >> 15;
            long jM3334unboximpl = datePickerColors.dayContainerColor$material3_release(z, z3, z2, composerStartRestartGroup, i5 | ((i3 >> 9) & 112) | (i4 & 896) | (i6 & 7168)).getValue().m3334unboximpl();
            int i7 = (i6 & 14) | (i3 & 112);
            int i8 = i3 >> 12;
            int i9 = i4 & 7168;
            composer2 = composerStartRestartGroup;
            SurfaceKt.m1969Surfaced85dljk(z, function0, modifierSemantics, z3, shape, jM3334unboximpl, datePickerColors.dayContentColor$material3_release(z4, z, z5, z3, composerStartRestartGroup, i7 | (i8 & 896) | i9 | (i8 & 57344)).getValue().m3334unboximpl(), 0.0f, 0.0f, (!z4 || z) ? null : BorderStrokeKt.m287BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m2283getDateTodayContainerOutlineWidthD9Ej5fM(), datePickerColors.getTodayDateBorderColor()), (MutableInteractionSource) null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2031780827, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.Day.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
        ...
        if ((i3 & 5851) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composerStartRestartGroup, 6), DatePickerModalTokens.INSTANCE.getSelectionYearLabelTextFont()), ComposableLambdaKt.composableLambda(composerStartRestartGroup, -145469688, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1
                ...
                public final void invoke(Composer composer2, int i4) throws Resources.NotFoundException {
                    long jM1628getContainerColor0d7_KjU$material3_release;
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        final LazyGridState lazyGridStateRememberLazyGridState = LazyGridStateKt.rememberLazyGridState(Math.max(0, (year2 - stateData.getYearRange().getFirst()) - 3), 0, composer2, 0, 2);
                        composer2.startReplaceableGroup(-969349200);
                        ComposerKt.sourceInformation(composer2, "1649@67705L11,1649@67769L7");
                        if (Color.m3325equalsimpl0(datePickerColors.getContainerColor(), MaterialTheme.INSTANCE.getColorScheme(composer2, 6).m1552getSurface0d7_KjU())) {
                            ...
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            jM1628getContainerColor0d7_KjU$material3_release = ColorSchemeKt.m1593surfaceColorAtElevation3ABfNKs(colorScheme, ((Dp) objConsume).m5858unboximpl());
                        } else {
                            jM1628getContainerColor0d7_KjU$material3_release = datePickerColors.getContainerColor();
                        }
                        long j = jM1628getContainerColor0d7_KjU$material3_release;
                        composer2.endReplaceableGroup();
                        ...
                        final CoroutineScope coroutineScope = ((CompositionScopedCoroutineScopeCanceller) objRememberedValue).getCoroutineScope();
                        composer2.endReplaceableGroup();
                        final String strM1959getStringNWtq28 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1915getDatePickerScrollToShowEarlierYearsadMyvUU(), composer2, 6);
                        final String strM1959getStringNWtq282 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1916getDatePickerScrollToShowLaterYearsadMyvUU(), composer2, 6);
                        GridCells.Fixed fixed = new GridCells.Fixed(3);
                        Modifier modifierSemantics$default = SemanticsModifierKt.semantics$default(BackgroundKt.m260backgroundbw27NRU$default(modifier, j, null, 2, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.1
                            @Override // kotlin.jvm.functions.Function1
                            public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                invoke2(semanticsPropertyReceiver);
                                return Unit.INSTANCE;
                        ...
                        final int i5 = i3;
                        final DatePickerColors datePickerColors2 = datePickerColors;
                        LazyGridDslKt.LazyVerticalGrid(fixed, modifierSemantics$default, lazyGridStateRememberLazyGridState, null, false, Arrangement.INSTANCE.m587spacedBy0680j_4(DatePickerKt.YearsVerticalPadding), spaceEvenly, null, false, new Function1<LazyGridScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                                ...
                                LazyGridScope.CC.items$default(LazyVerticalGrid, iCount, null, null, null, ComposableLambdaKt.composableLambdaInstance(1369226173, true, new Function4<LazyGridItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1
                                    ...
                                    public final void invoke(LazyGridItemScope items, final int i9, Composer composer3, int i10) {
                                        ...
                                        if ((i11 & 721) != 144 || !composer3.getSkipping()) {
                                            ...
                                            Modifier modifierM750requiredSizeVpY3zN4 = SizeKt.m750requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerModalTokens.INSTANCE.m2290getSelectionYearContainerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m2289getSelectionYearContainerHeightD9Ej5fM());
                                            final LazyGridState lazyGridState2 = lazyGridState;
                                            final CoroutineScope coroutineScope3 = coroutineScope2;
                                            final String str3 = str;
                                            final String str4 = str2;
                                            Modifier modifierSemantics$default2 = SemanticsModifierKt.semantics$default(modifierM750requiredSizeVpY3zN4, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.1
                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                {
                                                    super(1);
                                                }
                                            ...
                                            composer3.endReplaceableGroup();
                                            String str5 = String.format(Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1913getDatePickerNavigateToYearDescriptionadMyvUU(), composer3, 6), Arrays.copyOf(new Object[]{localString}, 1));
                                            ...
                                            DatePickerKt.Year(modifierSemantics$default2, z, z2, (Function0) objRememberedValue2, str5, datePickerColors3, ComposableLambdaKt.composableLambda(composer3, 2095319565, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.3
                                                ...
                                                public final void invoke(Composer composer4, int i12) {
                                                    ...
                                                    if ((i12 & 11) != 2 || !composer4.getSkipping()) {
                                                        ...
                                                        TextKt.m2047Text4IGK_g(localString, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.3.1
                                                            /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                                            public final void invoke2(SemanticsPropertyReceiver clearAndSetSemantics) {
                                                                Intrinsics.checkNotNullParameter(clearAndSetSemantics, "$this$clearAndSetSemantics");
                                                            }
    ...
    public static final void Year(final Modifier modifier, final boolean z, final boolean z2, final Function0<Unit> function0, final String str, final DatePickerColors datePickerColors, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((2995931 & i2) != 599186 || !composerStartRestartGroup.getSkipping()) {
            ...
            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (!z2 || z) ? null : BorderStrokeKt.m287BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m2283getDateTodayContainerOutlineWidthD9Ej5fM(), datePickerColors.getTodayDateBorderColor());
                composerStartRestartGroup.updateRememberedValue(objRememberedValue);
            }
            composerStartRestartGroup.endReplaceableGroup();
            ...
            int i6 = (i2 >> 3) & 14;
            composer2 = composerStartRestartGroup;
            SurfaceKt.m1969Surfaced85dljk(z, function0, SemanticsModifierKt.semantics(modifier, true, (Function1) objRememberedValue2), false, ShapesKt.toShape(DatePickerModalTokens.INSTANCE.getSelectionYearStateLayerShape(), composerStartRestartGroup, 6), datePickerColors.yearContainerColor$material3_release(z, composerStartRestartGroup, i6 | (i5 & 112)).getValue().m3334unboximpl(), datePickerColors.yearContentColor$material3_release(z2, z, composerStartRestartGroup, i4 | ((i2 >> 9) & 896)).getValue().m3334unboximpl(), 0.0f, 0.0f, borderStroke, (MutableInteractionSource) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composerStartRestartGroup, -68753950, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.Year.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer composer3, int i7) {
                    ...
                    if ((i7 & 11) != 2 || !composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-68753950, i7, -1, "androidx.compose.material3.Year.<anonymous> (DatePicker.kt:1753)");
                        }
                        Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null);
                        Alignment center = Alignment.INSTANCE.getCenter();
                        Function2<Composer, Integer, Unit> function22 = function2;
                        ...
                        function22.invoke(composer3, Integer.valueOf((i8 >> 18) & 14));
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        composer3.endReplaceableGroup();
                        composer3.endNode();
    ...
    public static final void MonthsNavigation(final Modifier modifier, final boolean z, final boolean z2, final boolean z3, final String str, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> function03, Composer composer, final int i) {
        ...
        if ((23967451 & i3) != 4793490 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM745requiredHeight3ABfNKs = SizeKt.m745requiredHeight3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), MonthYearHeight);
            if (z3) {
            ...
            ViewConfiguration viewConfiguration = (ViewConfiguration) objConsume3;
            Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM745requiredHeight3ABfNKs);
            if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            composerStartRestartGroup.startReusableNode();
                    ...
                    if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$1$1$1
                                ...
                                public final void invoke2(SemanticsPropertyReceiver semantics) {
                                    Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                                    SemanticsPropertiesKt.m5126setLiveRegionhR3wRGc(semantics, LiveRegionMode.INSTANCE.m5100getPolite0phEisY());
            ...
            if (z3) {
                ...
                composerStartRestartGroup.disableReusing();
                Composer composerM2777constructorimpl2 = Updater.m2777constructorimpl(composerStartRestartGroup);
                Updater.m2784setimpl(composerM2777constructorimpl2, measurePolicyRowMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                Updater.m2784setimpl(composerM2777constructorimpl2, density2, ComposeUiNode.INSTANCE.getSetDensity());
                Updater.m2784setimpl(composerM2777constructorimpl2, layoutDirection2, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                Updater.m2784setimpl(composerM2777constructorimpl2, viewConfiguration2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                composerStartRestartGroup.enableReusing();
                ...
                IconButtonKt.IconButton(function02, null, z2, null, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1143715416, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$2$1
                    ...
                    public final void invoke(Composer composer3, int i4) {
                        ...
                        if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                            ...
                            IconKt.m1730Iconww6aTOc(keyboardArrowLeft, Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1921getDatePickerSwitchToPreviousMonthadMyvUU(), composer3, 6), (Modifier) null, 0L, composer3, 0, 12);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                IconButtonKt.IconButton(function0, null, z, null, null, ComposableLambdaKt.composableLambda(composer2, 1336532191, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$2$2
                    ...
                    public final void invoke(Composer composer3, int i4) {
                        ...
                        if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                            ...
                            IconKt.m1730Iconww6aTOc(keyboardArrowRight, Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1920getDatePickerSwitchToNextMonthadMyvUU(), composer3, 6), (Modifier) null, 0L, composer3, 0, 12);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void YearPickerMenuButton(final kotlin.jvm.functions.Function0<kotlin.Unit> r21, final boolean r22, androidx.compose.ui.Modifier r23, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r24, androidx.compose.runtime.Composer r25, final int r26, final int r27) {
        /*
    ...
    static {
        float f = 12;
        DatePickerHorizontalPadding = Dp.m5844constructorimpl(f);
        DatePickerModeTogglePadding = PaddingKt.m708PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m5844constructorimpl(f), Dp.m5844constructorimpl(f), 3, null);
        float f2 = 24;
        float f3 = 16;
        DatePickerTitlePadding = PaddingKt.m708PaddingValuesa9UjIt4$default(Dp.m5844constructorimpl(f2), Dp.m5844constructorimpl(f3), Dp.m5844constructorimpl(f), 0.0f, 8, null);
        DatePickerHeadlinePadding = PaddingKt.m708PaddingValuesa9UjIt4$default(Dp.m5844constructorimpl(f2), 0.0f, Dp.m5844constructorimpl(f), Dp.m5844constructorimpl(f), 2, null);
        YearsVerticalPadding = Dp.m5844constructorimpl(f3);
    }
}