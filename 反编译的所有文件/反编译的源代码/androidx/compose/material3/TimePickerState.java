...
public final class TimePickerState {
    ...
    public TimePickerState(int i, int i2, final boolean z) {
        ...
        this.selectorPos = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<DpOffset>() { // from class: androidx.compose.material3.TimePickerState$selectorPos$2
            ...
            public /* bridge */ /* synthetic */ DpOffset invoke() {
                return DpOffset.m5899boximpl(m2091invokeRKDOV3M());
            }

            /* renamed from: invoke-RKDOV3M, reason: not valid java name */
            public final long m2091invokeRKDOV3M() {
                boolean zIsInnerCircle$material3_release = this.this$0.isInnerCircle$material3_release();
                float f = 2;
                float fM5844constructorimpl = Dp.m5844constructorimpl(TimePickerTokens.INSTANCE.m2657getClockDialSelectorHandleContainerSizeD9Ej5fM() / f);
                float fM5844constructorimpl2 = Dp.m5844constructorimpl(Dp.m5844constructorimpl(((z && zIsInnerCircle$material3_release && Selection.m1869equalsimpl0(this.this$0.m2087getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1873getHourJiIwxys())) ? TimePickerKt.InnerCircleRadius : TimePickerKt.OuterCircleSizeRadius) - fM5844constructorimpl) + fM5844constructorimpl);
                return DpKt.m5865DpOffsetYgX7TsA(Dp.m5844constructorimpl(Dp.m5844constructorimpl(((float) Math.cos(this.this$0.getCurrentAngle$material3_release().getValue().floatValue())) * fM5844constructorimpl2) + Dp.m5844constructorimpl(TimePickerTokens.INSTANCE.m2655getClockDialContainerSizeD9Ej5fM() / f)), Dp.m5844constructorimpl(Dp.m5844constructorimpl(fM5844constructorimpl2 * ((float) Math.sin(this.this$0.getCurrentAngle$material3_release().getValue().floatValue()))) + Dp.m5844constructorimpl(TimePickerTokens.INSTANCE.m2655getClockDialContainerSizeD9Ej5fM() / f)));
            }
        });
        this.center = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5967boximpl(IntOffset.INSTANCE.m5986getZeronOccac()), null, 2, null);
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Selection.m1866boximpl(Selection.INSTANCE.m1873getHourJiIwxys()), null, 2, null);
    ...
    public final long m2088getSelectorPosRKDOV3M$material3_release() {
    ...
    public final long m2086getCenternOccac$material3_release() {
    ...
    public final void m2089setCentergyyYBs$material3_release(long j) {
        this.center.setValue(IntOffset.m5967boximpl(j));
    }

    public final List<Integer> getValues$material3_release() {
        return Selection.m1869equalsimpl0(m2087getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1874getMinuteJiIwxys()) ? TimePickerKt.Minutes : TimePickerKt.Hours;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getSelection-JiIwxys$material3_release, reason: not valid java name */
    public final int m2087getSelectionJiIwxys$material3_release() {
        return ((Selection) this.selection.getValue()).m1872unboximpl();
    }

    /* renamed from: setSelection-iHAOin8$material3_release, reason: not valid java name */
    public final void m2090setSelectioniHAOin8$material3_release(int i) {
        this.selection.setValue(Selection.m1866boximpl(i));
    }
    ...
    public final void moveSelector$material3_release(float x, float y, float maxDist) {
        if (Selection.m1869equalsimpl0(m2087getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1873getHourJiIwxys()) && this.is24hour) {
            setInnerCircle$material3_release(TimePickerKt.dist(x, y, IntOffset.m5976getXimpl(m2086getCenternOccac$material3_release()), IntOffset.m5977getYimpl(m2086getCenternOccac$material3_release())) < maxDist);
        }
    }

    public final boolean isSelected$material3_release(int value) {
        if (Selection.m1869equalsimpl0(m2087getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1874getMinuteJiIwxys())) {
            if (value == getMinute()) {
                return true;
            }
        } else {
    ...
    */
    public final java.lang.Object animateToCurrent$material3_release(kotlin.coroutines.Continuation<? super kotlin.Unit> r11) throws java.lang.Throwable {
        /*
            r10 = this;
        ...
        L41:
            kotlin.ResultKt.throwOnFailure(r11)
            int r11 = r10.m2087getSelectionJiIwxys$material3_release()
            androidx.compose.material3.Selection$Companion r1 = androidx.compose.material3.Selection.INSTANCE
            int r1 = r1.m1873getHourJiIwxys()
            boolean r11 = androidx.compose.material3.Selection.m1869equalsimpl0(r11, r1)
            if (r11 == 0) goto L61
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object settle(kotlin.coroutines.Continuation<? super kotlin.Unit> r11) throws java.lang.Throwable {
        /*
            r10 = this;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object onTap$material3_release(float r11, float r12, float r13, boolean r14, kotlin.coroutines.Continuation<? super kotlin.Unit> r15) throws java.lang.Throwable {
        /*
