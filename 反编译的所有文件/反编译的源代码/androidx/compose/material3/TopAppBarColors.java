...
public final class TopAppBarColors {
    ...
    public final long m2163containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long jM3375lerpjxsXWHM = ColorKt.m3375lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM3375lerpjxsXWHM;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m3325equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m3325equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m3325equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m3325equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m3331hashCodeimpl(this.containerColor) * 31) + Color.m3331hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m3331hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m3331hashCodeimpl(this.titleContentColor)) * 31) + Color.m3331hashCodeimpl(this.actionIconContentColor);
    }
}