...
public final class TimePickerColors {
    ...
    public final long m2055periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m2056periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m2057timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m2058timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m2050clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m3325equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m3325equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m3325equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m3325equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m3325equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m3325equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m3325equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m3325equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m3325equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m3325equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m3325equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m3331hashCodeimpl(this.clockDialColor) * 31) + Color.m3331hashCodeimpl(this.selectorColor)) * 31) + Color.m3331hashCodeimpl(this.containerColor)) * 31) + Color.m3331hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m3331hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m3331hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m3331hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m3331hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m3331hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m3331hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m3331hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m3331hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}