...
public final class DateRangePickerDefaults {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void DateRangePickerHeadline(final androidx.compose.material3.DateRangePickerState r18, final androidx.compose.material3.DatePickerFormatter r19, androidx.compose.ui.Modifier r20, androidx.compose.runtime.Composer r21, final int r22, final int r23) throws android.content.res.Resources.NotFoundException {
        /*
    ...
    public final void DateRangePickerHeadline(final DateRangePickerState dateRangePickerState, final DatePickerFormatter datePickerFormatter, final Modifier modifier, final String str, final String str2, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, Composer composer, final int i) throws Resources.NotFoundException {
        int i2;
        Composer composer2;
        ...
        if ((23967451 & i3) != 4793490 || !composerStartRestartGroup.getSkipping()) {
            ...
            String strM1959getStringNWtq28 = "";
            ComposerKt.sourceInformation(composerStartRestartGroup, "");
            if (date$material3_release == null) {
                int value = stateData.getDisplayMode().getValue().getValue();
                if (DisplayMode.m1663equalsimpl0(value, DisplayMode.INSTANCE.m1668getPickerjFl4v0())) {
                    ...
                    date$material3_release = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1914getDatePickerNoSelectionDescriptionadMyvUU(), composerStartRestartGroup, 6);
                    composerStartRestartGroup.endReplaceableGroup();
                } else if (DisplayMode.m1663equalsimpl0(value, DisplayMode.INSTANCE.m1667getInputjFl4v0())) {
                    ...
                    date$material3_release = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1909getDateInputNoInputDescriptionadMyvUU(), composerStartRestartGroup, 6);
                    composerStartRestartGroup.endReplaceableGroup();
                } else {
            ...
            if (date$material3_release2 == null) {
                ...
                if (DisplayMode.m1663equalsimpl0(value2, DisplayMode.INSTANCE.m1668getPickerjFl4v0())) {
                    ...
                    strM1959getStringNWtq28 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1914getDatePickerNoSelectionDescriptionadMyvUU(), composerStartRestartGroup, 6);
                    composerStartRestartGroup.endReplaceableGroup();
                } else if (DisplayMode.m1663equalsimpl0(value2, DisplayMode.INSTANCE.m1667getInputjFl4v0())) {
                    ...
                    strM1959getStringNWtq28 = Strings_androidKt.m1959getStringNWtq28(Strings.INSTANCE.m1909getDateInputNoInputDescriptionadMyvUU(), composerStartRestartGroup, 6);
                    composerStartRestartGroup.endReplaceableGroup();
                } else {
                ...
                strM1959getStringNWtq28 = date$material3_release2;
            }
            composerStartRestartGroup.endReplaceableGroup();
            final String str3 = str + ": " + date$material3_release;
            final String str4 = str2 + ": " + strM1959getStringNWtq28;
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerHeadline$4$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver clearAndSetSemantics) {
                        ...
                        SemanticsPropertiesKt.m5126setLiveRegionhR3wRGc(clearAndSetSemantics, LiveRegionMode.INSTANCE.m5100getPolite0phEisY());
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM587spacedBy0680j_4 = Arrangement.INSTANCE.m587spacedBy0680j_4(Dp.m5844constructorimpl(4));
            composerStartRestartGroup.startReplaceableGroup(693286680);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Row)P(2,1,3)78@3913L58,79@3976L130:Row.kt#2w3rfo");
            MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(horizontalOrVerticalM587spacedBy0680j_4, centerVertically, composerStartRestartGroup, 54);
            ...
            if (date$material3_release$default != null) {
                ...
                TextKt.m2047Text4IGK_g(date$material3_release$default, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
            ...
            if (date$material3_release$default2 != null) {
                ...
                TextKt.m2047Text4IGK_g(date$material3_release$default2, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                composer2.endReplaceableGroup();
            } else {
