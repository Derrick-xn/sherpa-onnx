...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m756size3ABfNKs(Modifier.INSTANCE, IconButtonTokens.INSTANCE.m2429getIconSizeD9Ej5fM());
    ...
    */
    public static final void m1730Iconww6aTOc(final androidx.compose.ui.graphics.vector.ImageVector r17, final java.lang.String r18, androidx.compose.ui.Modifier r19, long r20, androidx.compose.runtime.Composer r22, final int r23, final int r24) {
        /*
            Method dump skipped, instructions count: 301
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.IconKt.m1730Iconww6aTOc(androidx.compose.ui.graphics.vector.ImageVector, java.lang.String, androidx.compose.ui.Modifier, long, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1728Iconww6aTOc(final ImageBitmap bitmap, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        ...
        m1729Iconww6aTOc((BitmapPainter) objRememberedValue, str, modifier2, jM3334unboximpl, composerStartRestartGroup, (i3 & 112) | 8 | (i3 & 896) | (i3 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$2
            ...
            public final void invoke(Composer composer2, int i4) {
                IconKt.m1728Iconww6aTOc(bitmap, str, modifier3, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }

    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1729Iconww6aTOc(final Painter painter, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        long jM3334unboximpl;
        int i3;
        ...
        ColorFilter colorFilterM3365tintxETnrds$default = Color.m3325equalsimpl0(jM3334unboximpl, Color.INSTANCE.m3360getUnspecified0d7_KjU()) ? null : ColorFilter.Companion.m3365tintxETnrds$default(ColorFilter.INSTANCE, jM3334unboximpl, 0, 2, null);
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$semantics$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semantics) {
                        ...
                        SemanticsPropertiesKt.m5127setRolekuIjeqM(semantics, Role.INSTANCE.m5111getImageo7Vup1c());
                    }
                };
        ...
        composerStartRestartGroup.endReplaceableGroup();
        final long j2 = jM3334unboximpl;
        BoxKt.Box(PainterModifierKt.paint$default(defaultSizeFor(GraphicsLayerModifierKt.toolingGraphicsLayer(modifier2), painter), painter, false, null, ContentScale.INSTANCE.getFit(), 0.0f, colorFilterM3365tintxETnrds$default, 22, null).then(companionSemantics$default), composerStartRestartGroup, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$3
            ...
            public final void invoke(Composer composer2, int i4) {
                IconKt.m1729Iconww6aTOc(painter, str, modifier3, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    private static final Modifier defaultSizeFor(Modifier modifier, Painter painter) {
        ...
        if (Size.m3109equalsimpl0(painter.mo4014getIntrinsicSizeNHjbRc(), Size.INSTANCE.m3121getUnspecifiedNHjbRc()) || m1731isInfiniteuvyYCjk(painter.mo4014getIntrinsicSizeNHjbRc())) {
    ...
    private static final boolean m1731isInfiniteuvyYCjk(long j) {
        return Float.isInfinite(Size.m3113getWidthimpl(j)) && Float.isInfinite(Size.m3110getHeightimpl(j));
    }
}