...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m5775boximpl(long j) {
    ...
    public static boolean m5779equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5780equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getFocusIndex-impl, reason: not valid java name */
    private static final int m5781getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m5782getHasBoundedHeightimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final boolean m5783getHasBoundedWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final boolean m5784getHasFixedHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int i3 = (1 << (18 - i2)) - 1;
    ...
    public static final boolean m5785getHasFixedWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final int m5786getMaxHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public static final int m5787getMaxWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final int m5788getMinHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public static final int m5789getMinWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static int m5790hashCodeimpl(long j) {
    ...
    public static final boolean m5791isZeroimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        if ((((int) (j >> 33)) & ((1 << (i2 + 13)) - 1)) - 1 == 0) {
            return true;
        }
        return (((1 << (18 - i2)) - 1) & ((int) (j >> (i2 + 46)))) - 1 == 0;
    }

    public boolean equals(Object obj) {
        return m5779equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5790hashCodeimpl(this.value);
    }
    ...
    public static /* synthetic */ long m5778copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m5789getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m5787getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m5788getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m5786getMaxHeightimpl(j);
        }
        return m5777copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m5777copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        if (!(i3 >= 0 && i >= 0)) {
    ...
    public String toString() {
        return m5792toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5792toStringimpl(long j) {
        int iM5787getMaxWidthimpl = m5787getMaxWidthimpl(j);
        String strValueOf = "Infinity";
        String strValueOf2 = iM5787getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(iM5787getMaxWidthimpl);
        int iM5786getMaxHeightimpl = m5786getMaxHeightimpl(j);
        if (iM5786getMaxHeightimpl != Integer.MAX_VALUE) {
            strValueOf = String.valueOf(iM5786getMaxHeightimpl);
        }
        return "Constraints(minWidth = " + m5789getMinWidthimpl(j) + ", maxWidth = " + strValueOf2 + ", minHeight = " + m5788getMinHeightimpl(j) + ", maxHeight = " + strValueOf + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m5797fixedJhjzzOo(int width, int height) {
            if (!(width >= 0 && height >= 0)) {
        ...
        public final long m5799fixedWidthOenEA2s(int width) {
            if (!(width >= 0)) {
        ...
        public final long m5798fixedHeightOenEA2s(int height) {
            if (!(height >= 0)) {
        ...
        public final long m5800restrictConstraintsxF2OJ5Q(int minWidth, int maxWidth, int minHeight, int maxHeight, boolean prioritizeWidth) {
            if (prioritizeWidth) {
                return m5796fitPrioritizingWidthZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
            }
            return m5795fitPrioritizingHeightZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
        }

        /* renamed from: fitPrioritizingWidth-Zbe2FdA, reason: not valid java name */
        public final long m5796fitPrioritizingWidthZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
        ...
        public final long m5795fitPrioritizingHeightZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
