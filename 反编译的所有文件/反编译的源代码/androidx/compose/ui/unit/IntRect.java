...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m5994getSizeYbymL2g$annotations() {
    }
    ...
    public final long m6002getSizeYbymL2g() {
    ...
    public final IntRect m6006translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m5976getXimpl(offset), this.top + IntOffset.m5977getYimpl(offset), this.right + IntOffset.m5976getXimpl(offset), this.bottom + IntOffset.m5977getYimpl(offset));
    }
