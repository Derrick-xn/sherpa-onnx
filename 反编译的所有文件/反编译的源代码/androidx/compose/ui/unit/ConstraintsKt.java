...
public final class ConstraintsKt {
    ...
    public static final long createConstraints(int i, int i2, int i3, int i4) {
        ...
        return Constraints.m5776constructorimpl((i8 << 33) | i11 | (i << 2) | (i3 << (i12 + 15)) | (i10 << (i12 + 46)));
    }
    ...
    public static final long m5802constrainN9IONVI(long j, long j2) {
        return Constraints(RangesKt.coerceIn(Constraints.m5789getMinWidthimpl(j2), Constraints.m5789getMinWidthimpl(j), Constraints.m5787getMaxWidthimpl(j)), RangesKt.coerceIn(Constraints.m5787getMaxWidthimpl(j2), Constraints.m5789getMinWidthimpl(j), Constraints.m5787getMaxWidthimpl(j)), RangesKt.coerceIn(Constraints.m5788getMinHeightimpl(j2), Constraints.m5788getMinHeightimpl(j), Constraints.m5786getMaxHeightimpl(j)), RangesKt.coerceIn(Constraints.m5786getMaxHeightimpl(j2), Constraints.m5788getMinHeightimpl(j), Constraints.m5786getMaxHeightimpl(j)));
    }

    /* renamed from: constrain-4WqzIAM, reason: not valid java name */
    public static final long m5801constrain4WqzIAM(long j, long j2) {
        return IntSizeKt.IntSize(RangesKt.coerceIn(IntSize.m6018getWidthimpl(j2), Constraints.m5789getMinWidthimpl(j), Constraints.m5787getMaxWidthimpl(j)), RangesKt.coerceIn(IntSize.m6017getHeightimpl(j2), Constraints.m5788getMinHeightimpl(j), Constraints.m5786getMaxHeightimpl(j)));
    }

    /* renamed from: constrainWidth-K40F9xA, reason: not valid java name */
    public static final int m5804constrainWidthK40F9xA(long j, int i) {
        return RangesKt.coerceIn(i, Constraints.m5789getMinWidthimpl(j), Constraints.m5787getMaxWidthimpl(j));
    }

    /* renamed from: constrainHeight-K40F9xA, reason: not valid java name */
    public static final int m5803constrainHeightK40F9xA(long j, int i) {
        return RangesKt.coerceIn(i, Constraints.m5788getMinHeightimpl(j), Constraints.m5786getMaxHeightimpl(j));
    }
    ...
    public static final boolean m5805isSatisfiedBy4WqzIAM(long j, long j2) {
        ...
        int iM6018getWidthimpl = IntSize.m6018getWidthimpl(j2);
        if (iM5789getMinWidthimpl <= iM6018getWidthimpl && iM6018getWidthimpl <= iM5787getMaxWidthimpl) {
            ...
            int iM6017getHeightimpl = IntSize.m6017getHeightimpl(j2);
            if (iM5788getMinHeightimpl <= iM6017getHeightimpl && iM6017getHeightimpl <= iM5786getMaxHeightimpl) {
                return true;
            }
        }
        return false;
    ...
    public static /* synthetic */ long m5807offsetNN6EwU$default(long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
        ...
        return m5806offsetNN6EwU(j, i, i2);
    }

    /* renamed from: offset-NN6Ew-U, reason: not valid java name */
    public static final long m5806offsetNN6EwU(long j, int i, int i2) {
        return Constraints(RangesKt.coerceAtLeast(Constraints.m5789getMinWidthimpl(j) + i, 0), addMaxWithMinimum(Constraints.m5787getMaxWidthimpl(j), i), RangesKt.coerceAtLeast(Constraints.m5788getMinHeightimpl(j) + i2, 0), addMaxWithMinimum(Constraints.m5786getMaxHeightimpl(j), i2));
    }
