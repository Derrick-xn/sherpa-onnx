...
public final class FontScaleConverterFactory {
    ...
    public final FontScaleConverter forScale(float fontScale) {
        ...
        FontScaleConverter fontScaleConverterCreateInterpolatedTableBetween = createInterpolatedTableBetween(fontScaleConverterValueAt, sLookupTables.valueAt(i), MathUtils.INSTANCE.constrainedMap(0.0f, 1.0f, f, getScaleFromKey(sLookupTables.keyAt(i)), fontScale));
    ...
    private final void put(float scaleKey, FontScaleConverter fontScaleConverter) {
        synchronized (LookupTablesWriteLock) {
            ...
            SparseArrayCompat<FontScaleConverter> sparseArrayCompatM57clone = sLookupTables.m57clone();
            fontScaleConverterFactory.putInto(sparseArrayCompatM57clone, scaleKey, fontScaleConverter);
            sLookupTables = sparseArrayCompatM57clone;
            Unit unit = Unit.INSTANCE;
        }
    }
