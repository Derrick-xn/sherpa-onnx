...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m5296getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m5295getMaximpl(textFieldValue.getSelection());
