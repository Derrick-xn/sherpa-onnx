...
public interface PlatformResolveInterceptor {
    ...
    public final /* synthetic */ class CC {
        ...
        public static int m5454$default$interceptFontStyleT2F_aPo(PlatformResolveInterceptor _this, int i) {
            return i;
        }

        /* renamed from: $default$interceptFontSynthesis-Mscr08Y, reason: not valid java name */
        public static int m5455$default$interceptFontSynthesisMscr08Y(PlatformResolveInterceptor _this, int i) {
            return i;
        }
    ...
    int mo5380interceptFontStyleT2F_aPo(int fontStyle);

    /* renamed from: interceptFontSynthesis-Mscr08Y */
    int mo5381interceptFontSynthesisMscr08Y(int fontSynthesis);
    ...
    public static final class Companion {
        ...
        private static final PlatformResolveInterceptor Default = new PlatformResolveInterceptor() { // from class: androidx.compose.ui.text.font.PlatformResolveInterceptor$Companion$Default$1
            ...
            @Override // androidx.compose.ui.text.font.PlatformResolveInterceptor
            /* renamed from: interceptFontStyle-T2F_aPo */
            public /* synthetic */ int mo5380interceptFontStyleT2F_aPo(int i) {
                return PlatformResolveInterceptor.CC.m5454$default$interceptFontStyleT2F_aPo(this, i);
            }

            @Override // androidx.compose.ui.text.font.PlatformResolveInterceptor
            /* renamed from: interceptFontSynthesis-Mscr08Y */
            public /* synthetic */ int mo5381interceptFontSynthesisMscr08Y(int i) {
                return PlatformResolveInterceptor.CC.m5455$default$interceptFontSynthesisMscr08Y(this, i);
            }
