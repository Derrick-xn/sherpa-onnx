...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m5382getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m5429equalsimpl0(i, FontStyle.INSTANCE.m5435getItalic_LCdwA()));
    }
}