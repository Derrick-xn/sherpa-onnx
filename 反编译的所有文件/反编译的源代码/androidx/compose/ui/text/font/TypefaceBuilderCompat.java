...
final class TypefaceBuilderCompat {
    ...
    public final android.graphics.Typeface createFromAssets(AssetManager assetManager, String path, Context context, FontVariation.Settings variationSettings) {
        ...
        return Paint29$$ExternalSyntheticApiModelOutline0.m(assetManager, path).setFontVariationSettings(toVariationSettings(variationSettings, context)).build();
    }
    ...
    public final android.graphics.Typeface createFromFile(File file, Context context, FontVariation.Settings variationSettings) {
        ...
        return Paint29$$ExternalSyntheticApiModelOutline0.m(file).setFontVariationSettings(toVariationSettings(variationSettings, context)).build();
    }
    ...
    public final android.graphics.Typeface createFromFileDescriptor(ParcelFileDescriptor fileDescriptor, Context context, FontVariation.Settings variationSettings) {
        ...
        ColorKt$$ExternalSyntheticApiModelOutline0.m6146m$1();
        return ColorKt$$ExternalSyntheticApiModelOutline0.m(fileDescriptor.getFileDescriptor()).setFontVariationSettings(toVariationSettings(variationSettings, context)).build();
    }
    ...
    private final FontVariationAxis[] toVariationSettings(FontVariation.Settings settings, Context context) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            ColorKt$$ExternalSyntheticApiModelOutline0.m6133m();
            arrayList.add(Paint29$$ExternalSyntheticApiModelOutline0.m(setting.getAxisName(), setting.toVariationValue(Density)));
        }
