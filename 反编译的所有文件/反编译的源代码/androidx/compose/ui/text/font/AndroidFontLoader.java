...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) throws Resources.NotFoundException {
        ...
        } else if (FontLoadingStrategy.m5416equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5422getOptionalLocalPKNRLFQ())) {
            try {
                Result.Companion companion = Result.INSTANCE;
                AndroidFontLoader androidFontLoader = this;
                objM6309constructorimpl = Result.m6309constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, this.context));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6309constructorimpl = Result.m6309constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m6315isFailureimpl(objM6309constructorimpl) ? null : objM6309constructorimpl);
        } else {
            if (FontLoadingStrategy.m5416equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5420getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m5418toStringimpl(font.getLoadingStrategy())));
        }
    ...
    */
    public java.lang.Object awaitLoad(androidx.compose.ui.text.font.Font r6, kotlin.coroutines.Continuation<? super android.graphics.Typeface> r7) throws java.lang.Throwable {
        /*
            r5 = this;
