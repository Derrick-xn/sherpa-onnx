...
public final class Placeholder {
    ...
    private Placeholder(long j, long j2, int i) {
        ...
        if (!(!TextUnitKt.m6059isUnspecifiedR2X_6o(j2))) {
    ...
    public static /* synthetic */ Placeholder m5208copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m5209copyK8Q__8(j3, j4, i);
    }

    /* renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m5209copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m6038equalsimpl0(this.width, placeholder.width) && TextUnit.m6038equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m5216equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }

    public int hashCode() {
        return (((TextUnit.m6042hashCodeimpl(this.width) * 31) + TextUnit.m6042hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m5217hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m6048toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m6048toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m5218toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}