...
public final class SpanStyleKt {
    ...
    private static final long DefaultBackgroundColor = Color.INSTANCE.m3359getTransparent0d7_KjU();
    ...
    static {
        long jM3350getBlack0d7_KjU = Color.INSTANCE.m3350getBlack0d7_KjU();
        DefaultColor = jM3350getBlack0d7_KjU;
        DefaultColorForegroundStyle = TextForegroundStyle.INSTANCE.m5744from8_81llA(jM3350getBlack0d7_KjU);
    }

    /* renamed from: lerpTextUnitInheritable-C3pnCVY, reason: not valid java name */
    public static final long m5254lerpTextUnitInheritableC3pnCVY(long j, long j2, float f) {
        if (TextUnitKt.m6059isUnspecifiedR2X_6o(j) || TextUnitKt.m6059isUnspecifiedR2X_6o(j2)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m6031boximpl(j), TextUnit.m6031boximpl(j2), f)).getPackedValue();
        }
        return TextUnitKt.m6061lerpC3pnCVY(j, j2, f);
    }
    ...
    public static final SpanStyle lerp(SpanStyle spanStyle, SpanStyle spanStyle2, float f) {
        ...
        long jM5254lerpTextUnitInheritableC3pnCVY = m5254lerpTextUnitInheritableC3pnCVY(spanStyle.getFontSize(), spanStyle2.getFontSize(), f);
        ...
        long jM5254lerpTextUnitInheritableC3pnCVY2 = m5254lerpTextUnitInheritableC3pnCVY(spanStyle.getLetterSpacing(), spanStyle2.getLetterSpacing(), f);
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        float fM5613unboximpl = baselineShift != null ? baselineShift.m5613unboximpl() : BaselineShift.m5608constructorimpl(0.0f);
        BaselineShift baselineShift2 = spanStyle2.getBaselineShift();
        float fM5620lerpjWV1Mfo = BaselineShiftKt.m5620lerpjWV1Mfo(fM5613unboximpl, baselineShift2 != null ? baselineShift2.m5613unboximpl() : BaselineShift.m5608constructorimpl(0.0f), f);
        ...
        long jM3375lerpjxsXWHM = ColorKt.m3375lerpjxsXWHM(spanStyle.getBackground(), spanStyle2.getBackground(), f);
        ...
        return new SpanStyle(textForegroundStyleLerp, jM5254lerpTextUnitInheritableC3pnCVY, fontWeightLerp, fontStyle, fontSynthesis, fontFamily, str, jM5254lerpTextUnitInheritableC3pnCVY2, BaselineShift.m5607boximpl(fM5620lerpjWV1Mfo), textGeometricTransformLerp, localeList, jM3375lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, f), lerpPlatformStyle(spanStyle.getPlatformStyle(), spanStyle2.getPlatformStyle(), f), (DrawStyle) lerpDiscrete(spanStyle.getDrawStyle(), spanStyle2.getDrawStyle(), f), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle spanStyle) {
        ...
        long fontSize = TextUnitKt.m6059isUnspecifiedR2X_6o(spanStyle.getFontSize()) ? DefaultFontSize : spanStyle.getFontSize();
        FontWeight fontWeight = spanStyle.getFontWeight();
        if (fontWeight == null) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        ...
        FontSynthesis fontSynthesisM5437boximpl = FontSynthesis.m5437boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5446getAllGVVA2EU());
        ...
        if (TextUnitKt.m6059isUnspecifiedR2X_6o(spanStyle.getLetterSpacing())) {
        ...
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        BaselineShift baselineShiftM5607boximpl = BaselineShift.m5607boximpl(baselineShift != null ? baselineShift.m5613unboximpl() : BaselineShift.INSTANCE.m5617getNoney9eOQZs());
        TextGeometricTransform textGeometricTransform = spanStyle.getTextGeometricTransform();
        if (textGeometricTransform == null) {
            textGeometricTransform = TextGeometricTransform.INSTANCE.getNone$ui_text_release();
        }
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM5426boximpl, fontSynthesisM5437boximpl, fontFamily2, str, j, baselineShiftM5607boximpl, textGeometricTransform2, localeList2, j2, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    */
    public static final androidx.compose.ui.text.SpanStyle m5253fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle r21, long r22, androidx.compose.ui.graphics.Brush r24, float r25, long r26, androidx.compose.ui.text.font.FontWeight r28, androidx.compose.ui.text.font.FontStyle r29, androidx.compose.ui.text.font.FontSynthesis r30, androidx.compose.ui.text.font.FontFamily r31, java.lang.String r32, long r33, androidx.compose.ui.text.style.BaselineShift r35, androidx.compose.ui.text.style.TextGeometricTransform r36, androidx.compose.ui.text.intl.LocaleList r37, long r38, androidx.compose.ui.text.style.TextDecoration r40, androidx.compose.ui.graphics.Shadow r41, androidx.compose.ui.text.PlatformSpanStyle r42, androidx.compose.ui.graphics.drawscope.DrawStyle r43) {
        /*
            Method dump skipped, instructions count: 510
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.SpanStyleKt.m5253fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle, long, androidx.compose.ui.graphics.Brush, float, long, androidx.compose.ui.text.font.FontWeight, androidx.compose.ui.text.font.FontStyle, androidx.compose.ui.text.font.FontSynthesis, androidx.compose.ui.text.font.FontFamily, java.lang.String, long, androidx.compose.ui.text.style.BaselineShift, androidx.compose.ui.text.style.TextGeometricTransform, androidx.compose.ui.text.intl.LocaleList, long, androidx.compose.ui.text.style.TextDecoration, androidx.compose.ui.graphics.Shadow, androidx.compose.ui.text.PlatformSpanStyle, androidx.compose.ui.graphics.drawscope.DrawStyle):androidx.compose.ui.text.SpanStyle");
    }
}