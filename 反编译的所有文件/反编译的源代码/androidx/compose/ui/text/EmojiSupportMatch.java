...
public final class EmojiSupportMatch {
    ...
    private static final int Default = m5151constructorimpl(0);
    private static final int None = m5151constructorimpl(1);
    private static final int All = m5151constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ EmojiSupportMatch m5150boximpl(int i) {
        return new EmojiSupportMatch(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m5151constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m5158getDefault_3YsG6Y() {
            return EmojiSupportMatch.Default;
        }

        /* renamed from: getNone-_3YsG6Y, reason: not valid java name */
        public final int m5159getNone_3YsG6Y() {
            return EmojiSupportMatch.None;
        }

        /* renamed from: getAll-_3YsG6Y, reason: not valid java name */
        public final int m5157getAll_3YsG6Y() {
            return EmojiSupportMatch.All;
        }
    }
}