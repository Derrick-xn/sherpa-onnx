...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo5571getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m5382getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m5429equalsimpl0(fontStyle, FontStyle.INSTANCE.m5435getItalic_LCdwA()));
    }
}