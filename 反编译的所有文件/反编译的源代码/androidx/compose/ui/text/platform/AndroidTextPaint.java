...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m5581getBrushSizeVsRJwc0$ui_text_release$annotations() {
    }
    ...
    public AndroidTextPaint(int i, float f) {
        ...
        this.backingBlendMode = DrawScope.INSTANCE.m3895getDefaultBlendMode0nO6VwU();
    ...
    public final void m5587setBrushSizeiaC8Vc4$ui_text_release(Size size) {
        this.brushSize = size;
    }
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m3044getXimpl(this.shadow.getOffset()), Offset.m3045getYimpl(this.shadow.getOffset()), ColorKt.m3378toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m5588setColor8_81llA(long color) {
        if (color != 16) {
            setColor(ColorKt.m3378toArgb8_81llA(color));
            clearShader();
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m5582setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m5586setBrush12SF9DM(brush, j, f);
    }

    /* renamed from: setBrush-12SF9DM, reason: not valid java name */
    public final void m5586setBrush12SF9DM(final Brush brush, final long size, float alpha) {
        Size size2;
        if (brush == null) {
            clearShader();
            return;
        ...
        if (brush instanceof SolidColor) {
            m5588setColor8_81llA(TextDrawStyleKt.m5743modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            return;
        }
        if (brush instanceof ShaderBrush) {
            if ((!Intrinsics.areEqual(this.brush, brush) || (size2 = this.brushSize) == null || !Size.m3109equalsimpl0(size2.getPackedValue(), size)) && size != InlineClassHelperKt.UnspecifiedPackedFloats) {
                this.brush = brush;
                this.brushSize = Size.m3101boximpl(size);
                this.shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.AndroidTextPaint$setBrush$1
                    ...
                    public final Shader invoke() {
                        return ((ShaderBrush) brush).mo3277createShaderuvyYCjk(size);
                    }
                });
            }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            getComposePaint().mo3169setStylek9PVt8s(PaintingStyle.INSTANCE.m3600getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            getComposePaint().setStrokeWidth(stroke.getWidth());
            getComposePaint().setStrokeMiterLimit(stroke.getMiter());
            getComposePaint().mo3168setStrokeJoinWw9F2mQ(stroke.getJoin());
            getComposePaint().mo3167setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final void m5585setBlendModes9anfk8(int i) {
        if (BlendMode.m3219equalsimpl0(i, this.backingBlendMode)) {
            return;
        }
        getComposePaint().mo3164setBlendModes9anfk8(i);
