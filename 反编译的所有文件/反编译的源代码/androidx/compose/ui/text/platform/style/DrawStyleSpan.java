...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m5604toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m5603toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m5604toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m3692equalsimpl0(i, StrokeJoin.INSTANCE.m3697getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m3692equalsimpl0(i, StrokeJoin.INSTANCE.m3698getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m3692equalsimpl0(i, StrokeJoin.INSTANCE.m3696getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m5603toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m3682equalsimpl0(i, StrokeCap.INSTANCE.m3686getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m3682equalsimpl0(i, StrokeCap.INSTANCE.m3687getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m3682equalsimpl0(i, StrokeCap.INSTANCE.m3688getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}