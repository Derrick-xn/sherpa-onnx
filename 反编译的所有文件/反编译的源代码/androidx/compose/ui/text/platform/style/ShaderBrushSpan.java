...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3101boximpl(Size.INSTANCE.m3121getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            if (this.this$0.m5605getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m3115isEmptyimpl(this.this$0.m5605getSizeNHjbRc())) {
                return null;
            }
            return this.this$0.getShaderBrush().mo3277createShaderuvyYCjk(this.this$0.m5605getSizeNHjbRc());
        }
    });
    ...
    public final long m5605getSizeNHjbRc() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m5606setSizeuvyYCjk(long j) {
