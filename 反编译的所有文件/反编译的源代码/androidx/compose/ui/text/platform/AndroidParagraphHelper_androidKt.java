...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String str, float f, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean z) {
        ...
        if (z && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch emojiSupportMatchM5150boximpl = (platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m5150boximpl(paragraphStyle.getEmojiSupportMatch());
            strProcess = EmojiCompat.get().process(str, 0, str.length(), Integer.MAX_VALUE, emojiSupportMatchM5150boximpl == null ? 0 : EmojiSupportMatch.m5153equalsimpl0(emojiSupportMatchM5150boximpl.getValue(), EmojiSupportMatch.INSTANCE.m5157getAll_3YsG6Y()));
            Intrinsics.checkNotNull(strProcess);
        } else {
            strProcess = str;
        }
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(textStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m6059isUnspecifiedR2X_6o(textStyle.m5337getLineHeightXSAIIZE())) {
            return strProcess;
        }
        ...
        if (isIncludeFontPaddingEnabled(textStyle) && textStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m5601setLineHeightr9BaKPg(spannableString, textStyle.m5337getLineHeightXSAIIZE(), f, density);
        } else {
            LineHeightStyle lineHeightStyle = textStyle.getLineHeightStyle();
            if (lineHeightStyle == null) {
                lineHeightStyle = LineHeightStyle.INSTANCE.getDefault();
            }
            SpannableExtensions_androidKt.m5600setLineHeightKmRG4DE(spannableString, textStyle.m5337getLineHeightXSAIIZE(), f, density, lineHeightStyle);
        }
