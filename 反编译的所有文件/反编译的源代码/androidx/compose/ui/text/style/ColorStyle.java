...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m5622copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m5624copy8_81llA(j);
    }
    ...
    public final ColorStyle m5624copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m3325equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m3332toStringimpl(this.value)) + ')';
    }
    ...
    public final long m5625getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m3326getAlphaimpl(mo5621getColor0d7_KjU());
    }
}