...
public final class LineHeightStyle {
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m5701getProportionalPIaL0Z0(), Trim.INSTANCE.m5712getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Alignment.m5695equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m5706equalsimpl0(this.trim, lineHeightStyle.trim);
    }

    public int hashCode() {
        return (Alignment.m5696hashCodeimpl(this.alignment) * 31) + Trim.m5707hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m5697toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m5710toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m5704constructorimpl(1);
        private static final int LastLineBottom = m5704constructorimpl(16);
        private static final int Both = m5704constructorimpl(17);
        private static final int None = m5704constructorimpl(0);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m5703boximpl(int i) {
            return new Trim(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m5704constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5705equalsimpl(int i, Object obj) {
            return (obj instanceof Trim) && i == ((Trim) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5706equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5707hashCodeimpl(int i) {
            return i;
        }

        /* renamed from: isTrimFirstLineTop-impl$ui_text_release, reason: not valid java name */
        public static final boolean m5708isTrimFirstLineTopimpl$ui_text_release(int i) {
            return (i & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m5709isTrimLastLineBottomimpl$ui_text_release(int i) {
            return (i & 16) > 0;
        }
        ...
        public static String m5710toStringimpl(int i) {
        ...
        public static final class Companion {
            ...
            public final int m5713getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU, reason: not valid java name */
            public final int m5714getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getBoth-EVpEnUU, reason: not valid java name */
            public final int m5712getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getNone-EVpEnUU, reason: not valid java name */
            public final int m5715getNoneEVpEnUU() {
                return Trim.None;
            }
        }
    }
    ...
    public static final class Alignment {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m5693constructorimpl(0.0f);
        private static final float Center = m5693constructorimpl(0.5f);
        private static final float Proportional = m5693constructorimpl(-1.0f);
        private static final float Bottom = m5693constructorimpl(1.0f);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m5692boximpl(float f) {
            return new Alignment(f);
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5694equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5695equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5696hashCodeimpl(float f) {
            return Float.floatToIntBits(f);
        }

        public boolean equals(Object obj) {
            return m5694equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m5696hashCodeimpl(this.topRatio);
        }
        ...
        /* renamed from: constructor-impl, reason: not valid java name */
        public static float m5693constructorimpl(float f) {
        ...
        public String toString() {
            return m5697toStringimpl(this.topRatio);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m5697toStringimpl(float f) {
            if (f == Top) {
        ...
        public static final class Companion {
            ...
            public final float m5702getTopPIaL0Z0() {
                return Alignment.Top;
            }

            /* renamed from: getCenter-PIaL0Z0, reason: not valid java name */
            public final float m5700getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0, reason: not valid java name */
            public final float m5701getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getBottom-PIaL0Z0, reason: not valid java name */
            public final float m5699getBottomPIaL0Z0() {
