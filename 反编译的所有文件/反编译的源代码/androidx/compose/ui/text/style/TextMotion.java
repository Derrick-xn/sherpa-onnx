...
public final class TextMotion {
    ...
    static {
        ...
        Static = new TextMotion(Linearity.INSTANCE.m5759getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(Linearity.INSTANCE.m5760getLinear4e0Vf04(), true, defaultConstructorMarker);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release$default, reason: not valid java name */
    public static /* synthetic */ TextMotion m5749copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m5750copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release, reason: not valid java name */
    public final TextMotion m5750copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return Linearity.m5755equalsimpl0(this.linearity, textMotion.linearity) && this.subpixelTextPositioning == textMotion.subpixelTextPositioning;
    }

    public int hashCode() {
        return (Linearity.m5756hashCodeimpl(this.linearity) * 31) + UByte$$ExternalSyntheticBackport0.m(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        ...
        private static final int Linear = m5753constructorimpl(1);
        private static final int FontHinting = m5753constructorimpl(2);
        private static final int None = m5753constructorimpl(3);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Linearity m5752boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m5753constructorimpl(int i) {
            return i;
        }
        ...
        public boolean equals(Object obj) {
            return m5754equalsimpl(this.value, obj);
        }
        ...
        public static final class Companion {
            ...
            public final int m5760getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04, reason: not valid java name */
            public final int m5759getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04, reason: not valid java name */
            public final int m5761getNone4e0Vf04() {
        ...
        public static String m5757toStringimpl(int i) {
            return m5755equalsimpl0(i, Linear) ? "Linearity.Linear" : m5755equalsimpl0(i, FontHinting) ? "Linearity.FontHinting" : m5755equalsimpl0(i, None) ? "Linearity.None" : "Invalid";
        }
    }
}