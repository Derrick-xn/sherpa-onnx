...
public final class TextStyleKt {
    ...
    public static final int m5344resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m5733equalsimpl0(i, TextDirection.INSTANCE.m5737getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m5738getContentOrLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m5739getContentOrRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
        if (!TextDirection.m5733equalsimpl0(i, TextDirection.INSTANCE.m5742getUnspecifieds_7Xco())) {
            return i;
        }
        int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        if (i3 == 1) {
            return TextDirection.INSTANCE.m5740getLtrs_7Xco();
        }
        if (i3 == 2) {
            return TextDirection.INSTANCE.m5741getRtls_7Xco();
        }
        throw new NoWhenBranchMatchedException();
    }
