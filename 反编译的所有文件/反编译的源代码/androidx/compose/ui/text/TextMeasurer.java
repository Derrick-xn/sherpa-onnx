...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m5274measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        return textMeasurer.m5276measurexDpz5zY(annotatedString, (i3 & 2) != 0 ? TextStyle.INSTANCE.getDefault() : textStyle, (i3 & 4) != 0 ? TextOverflow.INSTANCE.m5772getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.defaultLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.defaultDensity : density, (i3 & 512) != 0 ? textMeasurer.defaultFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* renamed from: measure-xDpz5zY, reason: not valid java name */
    public final TextLayoutResult m5276measurexDpz5zY(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m5269copyO0kMr_c(textLayoutInput, ConstraintsKt.m5801constrain4WqzIAM(constraints, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
    ...
    public final TextLayoutResult m5275measurewNUYSr0(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        return m5274measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int iM5789getMinWidthimpl = Constraints.m5789getMinWidthimpl(textLayoutInput.getConstraints());
            int iM5787getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m5765equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5773getEllipsisgIe3tQ8())) && Constraints.m5783getHasBoundedWidthimpl(textLayoutInput.getConstraints())) ? Constraints.m5787getMaxWidthimpl(textLayoutInput.getConstraints()) : Integer.MAX_VALUE;
            int maxLines = (textLayoutInput.getSoftWrap() || !TextOverflow.m5765equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5773getEllipsisgIe3tQ8())) ? textLayoutInput.getMaxLines() : 1;
            if (iM5789getMinWidthimpl != iM5787getMaxWidthimpl) {
                iM5787getMaxWidthimpl = RangesKt.coerceIn(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), iM5789getMinWidthimpl, iM5787getMaxWidthimpl);
            }
            return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, Constraints.INSTANCE.m5796fitPrioritizingWidthZbe2FdA(0, iM5787getMaxWidthimpl, 0, Constraints.m5786getMaxHeightimpl(textLayoutInput.getConstraints())), maxLines, TextOverflow.m5765equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5773getEllipsisgIe3tQ8()), null), ConstraintsKt.m5801constrain4WqzIAM(textLayoutInput.getConstraints(), IntSizeKt.IntSize((int) Math.ceil(r13.getWidth()), (int) Math.ceil(r13.getHeight()))), null);
        }
    }
}