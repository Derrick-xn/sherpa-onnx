...
final class DeprecatedBridgeFontResourceLoader implements Font.ResourceLoader {
    ...
    public Object load(Font font) {
        return FontFamily.Resolver.CC.m5404resolveDPcqOEQ$default(this.fontFamilyResolver, FontKt.toFontFamily(font), font.getWeight(), font.getStyle(), 0, 8, null).getValue();
    }
