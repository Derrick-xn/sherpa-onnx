...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if (Constraints.m5788getMinHeightimpl(j) != 0 || Constraints.m5789getMinWidthimpl(j) != 0) {
        ...
        int iM5143toLayoutAlignaXe7zB0 = AndroidParagraph_androidKt.m5143toLayoutAlignaXe7zB0(style.m5339getTextAligne0LSkKk());
        boolean zM5719equalsimpl0 = TextAlign.m5719equalsimpl0(style.m5339getTextAligne0LSkKk(), TextAlign.INSTANCE.m5725getJustifye0LSkKk());
        int iM5145toLayoutHyphenationFrequency3fSNIE = AndroidParagraph_androidKt.m5145toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
        int iM5144toLayoutBreakStrategyxImikfE = AndroidParagraph_androidKt.m5144toLayoutBreakStrategyxImikfE(LineBreak.m5643getStrategyfcGXIks(style.m5336getLineBreakrAG3T2k()));
        int iM5146toLayoutLineBreakStylehpcqdu8 = AndroidParagraph_androidKt.m5146toLayoutLineBreakStylehpcqdu8(LineBreak.m5644getStrictnessusljTpc(style.m5336getLineBreakrAG3T2k()));
        int iM5147toLayoutLineBreakWordStylewPN0Rpw = AndroidParagraph_androidKt.m5147toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m5645getWordBreakjp8hJ3c(style.m5336getLineBreakrAG3T2k()));
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout textLayoutConstructTextLayout = constructTextLayout(iM5143toLayoutAlignaXe7zB0, zM5719equalsimpl0 ? 1 : 0, truncateAt, i, iM5145toLayoutHyphenationFrequency3fSNIE, iM5144toLayoutBreakStrategyxImikfE, iM5146toLayoutLineBreakStylehpcqdu8, iM5147toLayoutLineBreakWordStylewPN0Rpw);
        if (z && textLayoutConstructTextLayout.getHeight() > Constraints.m5786getMaxHeightimpl(j) && i > 1) {
            int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout, Constraints.m5786getMaxHeightimpl(j));
            if (iNumberOfLinesThatFitMaxHeight >= 0 && iNumberOfLinesThatFitMaxHeight != i) {
                textLayoutConstructTextLayout = constructTextLayout(iM5143toLayoutAlignaXe7zB0, zM5719equalsimpl0 ? 1 : 0, truncateAt, RangesKt.coerceAtLeast(iNumberOfLinesThatFitMaxHeight, 1), iM5145toLayoutHyphenationFrequency3fSNIE, iM5144toLayoutBreakStrategyxImikfE, iM5146toLayoutLineBreakStylehpcqdu8, iM5147toLayoutLineBreakWordStylewPN0Rpw);
            }
            this.layout = textLayoutConstructTextLayout;
        } else {
            this.layout = textLayoutConstructTextLayout;
        }
        getTextPaint$ui_text_release().m5586setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        ...
        if (shaderBrushSpans != null) {
            ...
            while (it.hasNext()) {
                ((ShaderBrushSpan) it.next()).m5606setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
            }
        }
    ...
    public float getWidth() {
        return Constraints.m5787getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo5131getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m3045getYimpl(position)), Offset.m3044getXimpl(position));
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public long mo5132getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int[] rangeForRect = this.layout.getRangeForRect(RectHelper_androidKt.toAndroidRectF(rect), AndroidParagraph_androidKt.m5148toLayoutTextGranularityduNsdkg(granularity), new Function2<RectF, RectF, Boolean>() { // from class: androidx.compose.ui.text.AndroidParagraph$getRangeForRect$range$1
            {
                super(2);
            }
    ...
    public void mo5129fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m5296getMinimpl(range), TextRange.m5295getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo5133getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5135paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5588setColor8_81llA(color);
    ...
    public void mo5134paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        ...
        textPaint$ui_text_release.m5585setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5585setBlendModes9anfk8(backingBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo5136painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int backingBlendMode = getTextPaint$ui_text_release().getBackingBlendMode();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5586setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5585setBlendModes9anfk8(blendMode);
