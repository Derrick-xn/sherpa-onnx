...
public final class TextGranularity {
    ...
    private static final int Character = m5256constructorimpl(0);
    private static final int Word = m5256constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextGranularity m5255boximpl(int i) {
        return new TextGranularity(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m5256constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5257equalsimpl(int i, Object obj) {
        return (obj instanceof TextGranularity) && i == ((TextGranularity) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5258equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5259hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5260toStringimpl(int i) {
        return "TextGranularity(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m5257equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5259hashCodeimpl(this.value);
    }

    public String toString() {
        return m5260toStringimpl(this.value);
    }
