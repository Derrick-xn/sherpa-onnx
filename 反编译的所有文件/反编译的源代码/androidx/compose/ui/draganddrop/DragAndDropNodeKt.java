...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m2918containsUv8p0NA(DragAndDropModifierNode dragAndDropModifierNode, long j) {
        ...
        long jMo4682getSizeYbymL2g = coordinates.mo4682getSizeYbymL2g();
        int iM6018getWidthimpl = IntSize.m6018getWidthimpl(jMo4682getSizeYbymL2g);
        int iM6017getHeightimpl = IntSize.m6017getHeightimpl(jMo4682getSizeYbymL2g);
        long jPositionInRoot = LayoutCoordinatesKt.positionInRoot(coordinates);
        float fM3044getXimpl = Offset.m3044getXimpl(jPositionInRoot);
        float fM3045getYimpl = Offset.m3045getYimpl(jPositionInRoot);
        float f = iM6018getWidthimpl + fM3044getXimpl;
        float f2 = iM6017getHeightimpl + fM3045getYimpl;
        float fM3044getXimpl2 = Offset.m3044getXimpl(j);
        if (fM3044getXimpl > fM3044getXimpl2 || fM3044getXimpl2 > f) {
            return false;
        }
        float fM3045getYimpl2 = Offset.m3045getYimpl(j);
        return fM3045getYimpl <= fM3045getYimpl2 && fM3045getYimpl2 <= f2;
    }
