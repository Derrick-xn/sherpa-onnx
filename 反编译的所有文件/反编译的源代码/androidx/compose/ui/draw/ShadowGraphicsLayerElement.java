...
public final /* data */ class ShadowGraphicsLayerElement extends ModifierNodeElement<BlockGraphicsLayerModifier> {
    ...
    public static /* synthetic */ ShadowGraphicsLayerElement m2940copygNMxBKI$default(ShadowGraphicsLayerElement shadowGraphicsLayerElement, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return shadowGraphicsLayerElement.m2944copygNMxBKI(f, shape2, z2, j3, j2);
    }
    ...
    public final ShadowGraphicsLayerElement m2944copygNMxBKI(float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5849equalsimpl0(this.elevation, shadowGraphicsLayerElement.elevation) && Intrinsics.areEqual(this.shape, shadowGraphicsLayerElement.shape) && this.clip == shadowGraphicsLayerElement.clip && Color.m3325equalsimpl0(this.ambientColor, shadowGraphicsLayerElement.ambientColor) && Color.m3325equalsimpl0(this.spotColor, shadowGraphicsLayerElement.spotColor);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m5850hashCodeimpl(this.elevation) * 31) + this.shape.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m(this.clip)) * 31) + Color.m3331hashCodeimpl(this.ambientColor)) * 31) + Color.m3331hashCodeimpl(this.spotColor);
    }

    public String toString() {
        return "ShadowGraphicsLayerElement(elevation=" + ((Object) Dp.m5855toStringimpl(this.elevation)) + ", shape=" + this.shape + ", clip=" + this.clip + ", ambientColor=" + ((Object) Color.m3332toStringimpl(this.ambientColor)) + ", spotColor=" + ((Object) Color.m3332toStringimpl(this.spotColor)) + ')';
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m2946getElevationD9Ej5fM() {
        return this.elevation;
    }
    ...
    public final long m2945getAmbientColor0d7_KjU() {
        return this.ambientColor;
    }

    /* renamed from: getSpotColor-0d7_KjU, reason: not valid java name */
    public final long m2947getSpotColor0d7_KjU() {
        return this.spotColor;
    }
    ...
    private final Function1<GraphicsLayerScope, Unit> createBlock() {
        return new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowGraphicsLayerElement.createBlock.1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                graphicsLayerScope.setShadowElevation(graphicsLayerScope.mo397toPx0680j_4(ShadowGraphicsLayerElement.this.m2946getElevationD9Ej5fM()));
                ...
                graphicsLayerScope.mo3496setAmbientShadowColor8_81llA(ShadowGraphicsLayerElement.this.m2945getAmbientColor0d7_KjU());
                graphicsLayerScope.mo3498setSpotShadowColor8_81llA(ShadowGraphicsLayerElement.this.m2947getSpotColor0d7_KjU());
            }
        };
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("elevation", Dp.m5842boximpl(this.elevation));
        inspectorInfo.getProperties().set("shape", this.shape);
        inspectorInfo.getProperties().set("clip", Boolean.valueOf(this.clip));
        inspectorInfo.getProperties().set("ambientColor", Color.m3314boximpl(this.ambientColor));
        inspectorInfo.getProperties().set("spotColor", Color.m3314boximpl(this.spotColor));
    }
}