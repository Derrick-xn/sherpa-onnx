...
final /* data */ class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int iHashCode = ((((((((this.painter.hashCode() * 31) + UByte$$ExternalSyntheticBackport0.m(this.sizeToIntrinsics)) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.floatToIntBits(this.alpha)) * 31;
    ...
    public void update(PainterNode node) {
        ...
        boolean z2 = sizeToIntrinsics != z || (z && !Size.m3109equalsimpl0(node.getPainter().mo4014getIntrinsicSizeNHjbRc(), this.painter.mo4014getIntrinsicSizeNHjbRc()));
