        ...
        if ((i3 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            AnonymousClass1 anonymousClass1 = new MeasurePolicy() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt.DialogLayout.1
                ...
                public final MeasureResult mo61measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                    ...
                    int width3 = placeable2 != null ? placeable2.getWidth() : Constraints.m5789getMinWidthimpl(j);
                    if (!arrayList2.isEmpty()) {
                    ...
                    return MeasureScope.CC.layout$default(measureScope, width3, placeable3 != null ? placeable3.getHeight() : Constraints.m5788getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt.DialogLayout.1.1
