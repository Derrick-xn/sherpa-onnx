...
public final class DialogProperties {
    ...
    public int hashCode() {
        return (((((((UByte$$ExternalSyntheticBackport0.m(this.dismissOnBackPress) * 31) + UByte$$ExternalSyntheticBackport0.m(this.dismissOnClickOutside)) * 31) + this.securePolicy.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m(this.usePlatformDefaultWidth)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.decorFitsSystemWindows);
    }
}