...
public final class OutlineResolver {
    ...
    public OutlineResolver() {
        ...
        this.rectTopLeft = Offset.INSTANCE.m3060getZeroF1C5BW0();
        this.rectSize = Size.INSTANCE.m3122getZeroNHjbRc();
    }
    ...
    public final boolean m5078updateS_szKao(androidx.compose.ui.graphics.Outline outline, float alpha, boolean clipToOutline, float elevation, long size) {
    ...
    public final boolean m5077isInOutlinek4lQ0M(long position) {
        androidx.compose.ui.graphics.Outline outline;
        if (this.outlineNeeded && (outline = this.outline) != null) {
            return ShapeContainingUtilKt.isInOutline(outline, Offset.m3044getXimpl(position), Offset.m3045getYimpl(position), this.tmpTouchPointPath, this.tmpOpPath);
        }
        return true;
    }
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (clipPath != null) {
            Canvas.CC.m3280clipPathmtrdDE$default(canvas, clipPath, 0, 2, null);
            return;
        }
        ...
        if (f > 0.0f) {
            ...
            if (Path == null || !m5076isSameBounds4L21HEs(roundRect, this.rectTopLeft, this.rectSize, f)) {
                RoundRect roundRectM3098RoundRectgG7oq9Y = RoundRectKt.m3098RoundRectgG7oq9Y(Offset.m3044getXimpl(this.rectTopLeft), Offset.m3045getYimpl(this.rectTopLeft), Offset.m3044getXimpl(this.rectTopLeft) + Size.m3113getWidthimpl(this.rectSize), Offset.m3045getYimpl(this.rectTopLeft) + Size.m3110getHeightimpl(this.rectSize), CornerRadiusKt.CornerRadius$default(this.roundedCornerRadius, 0.0f, 2, null));
                if (Path == null) {
                    Path = AndroidPath_androidKt.Path();
                } else {
                    Path.reset();
                }
                Path.CC.addRoundRect$default(Path, roundRectM3098RoundRectgG7oq9Y, null, 2, null);
                this.tmpRoundRect = roundRectM3098RoundRectgG7oq9Y;
                this.tmpPath = Path;
            }
            Canvas.CC.m3280clipPathmtrdDE$default(canvas, Path, 0, 2, null);
            return;
        }
        Canvas.CC.m3281clipRectN_I0leg$default(canvas, Offset.m3044getXimpl(this.rectTopLeft), Offset.m3045getYimpl(this.rectTopLeft), Offset.m3044getXimpl(this.rectTopLeft) + Size.m3113getWidthimpl(this.rectSize), Offset.m3045getYimpl(this.rectTopLeft) + Size.m3110getHeightimpl(this.rectSize), 0, 16, null);
    }
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            if (outline != null && this.outlineNeeded && Size.m3113getWidthimpl(this.rectSize) > 0.0f && Size.m3110getHeightimpl(this.rectSize) > 0.0f) {
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float fM3019getXimpl = CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs());
        ...
        if (RoundRectKt.isSimple(roundRect)) {
            this.cachedOutline.setRoundRect(Math.round(roundRect.getLeft()), Math.round(roundRect.getTop()), Math.round(roundRect.getRight()), Math.round(roundRect.getBottom()), fM3019getXimpl);
            this.roundedCornerRadius = fM3019getXimpl;
            return;
        }
    ...
    private final boolean m5076isSameBounds4L21HEs(RoundRect roundRect, long j, long j2, float f) {
        return roundRect != null && RoundRectKt.isSimple(roundRect) && roundRect.getLeft() == Offset.m3044getXimpl(j) && roundRect.getTop() == Offset.m3045getYimpl(j) && roundRect.getRight() == Offset.m3044getXimpl(j) + Size.m3113getWidthimpl(j2) && roundRect.getBottom() == Offset.m3045getYimpl(j) + Size.m3110getHeightimpl(j2) && CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == f;
    }
}