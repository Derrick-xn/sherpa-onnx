...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m3378toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m3378toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m3719getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m3720getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo5038setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public boolean mo4970isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM3044getXimpl && fM3044getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM3045getYimpl && fM3045getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mo4973resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m3719getPivotFractionXimpl(this.transformOrigin) * iM6018getWidthimpl);
        this.renderNode.setPivotY(TransformOrigin.m3720getPivotFractionYimpl(this.transformOrigin) * iM6017getHeightimpl);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM6018getWidthimpl, this.renderNode.getTop() + iM6017getHeightimpl)) {
            this.renderNode.setOutline(this.outlineResolver.getAndroidOutline());
            invalidate();
            this.matrixCache.invalidate();
        }
    ...
    public void mo4972movegyyYBs(long position) {
        ...
        if (left == iM5976getXimpl && top == iM5977getYimpl) {
            return;
        }
        if (left != iM5976getXimpl) {
            this.renderNode.offsetLeftAndRight(iM5976getXimpl - left);
        }
        if (top != iM5977getYimpl) {
            this.renderNode.offsetTopAndBottom(iM5977getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo3141concat58bKbWc(this.matrixCache.m5055calculateMatrixGrdbGEg(this.renderNode));
    ...
    public long mo4971mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM5054calculateInverseMatrixbWbORWo = this.matrixCache.m5054calculateInverseMatrixbWbORWo(this.renderNode);
        ...
        return androidx.compose.ui.graphics.Matrix.m3569mapMKHz9U(this.matrixCache.m5055calculateMatrixGrdbGEg(this.renderNode), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m3571mapimpl(this.matrixCache.m5055calculateMatrixGrdbGEg(this.renderNode), rect);
    }
    ...
    public void mo4974transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m3580timesAssign58bKbWc(matrix, this.matrixCache.m5055calculateMatrixGrdbGEg(this.renderNode));
    }
