...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m3414getAutoNrFUSI();
    ...
    public void mo5038setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m3410equalsimpl0(i, CompositingStrategy.INSTANCE.m3416getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3410equalsimpl0(i, CompositingStrategy.INSTANCE.m3415getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m3410equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m3416getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.CC.m3280clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
