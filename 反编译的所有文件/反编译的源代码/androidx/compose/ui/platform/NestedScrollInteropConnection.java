...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo509onPreScrollOzD1aCk(long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m5073getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m5075toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3044getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3045getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m5075toViewTypeGyEprt8(source));
            return NestedScrollInteropConnectionKt.m5074toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
    ...
    public long mo507onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m5073getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m5075toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3044getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3045getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3044getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3045getYimpl(available)), null, NestedScrollInteropConnectionKt.m5075toViewTypeGyEprt8(source), this.consumedScrollCache);
            return NestedScrollInteropConnectionKt.m5074toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
        return Offset.INSTANCE.m3060getZeroF1C5BW0();
    }
    ...
    public Object mo508onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6085getXimpl(j)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6086getYimpl(j)))) {
    ...
    public Object mo506onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6085getXimpl(j2)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6086getYimpl(j2)), true)) {
            j2 = Velocity.INSTANCE.m6096getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
