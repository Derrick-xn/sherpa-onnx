...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                ...
                if (bDecodeByte == 2) {
                    ...
                    mutableSpanStyle.m5066setFontSizeR2X_6o(m5036decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m5067setFontStylemLjRB2g(FontStyle.m5426boximpl(m5034decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (bDecodeByte != 8) {
                                if (bDecodeByte != 9) {
                                    if (bDecodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m5063setBackground8_81llA(m5033decodeColor0d7_KjU());
                                    }
                                } else {
                                    if (dataAvailable() < 8) {
                                        break;
                                ...
                                mutableSpanStyle.m5064setBaselineShift_isdbwI(BaselineShift.m5607boximpl(m5031decodeBaselineShifty9eOQZs()));
                            }
                        } else {
                            if (dataAvailable() < 5) {
                                break;
                            }
                            mutableSpanStyle.m5069setLetterSpacingR2X_6o(m5036decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m5068setFontSynthesistDdu0R4(FontSynthesis.m5437boximpl(m5035decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m5065setColor8_81llA(m5033decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m5033decodeColor0d7_KjU() {
        return Color.m3320constructorimpl(m5032decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m5036decodeTextUnitXSAIIZE() {
        long jM6075getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM6075getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6074getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM6075getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6073getEmUIouoOA();
        } else {
            jM6075getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6075getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m6069equalsimpl0(jM6075getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m6075getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m6052getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m6053TextUnitanM5pPY(decodeFloat(), jM6075getUnspecifiedUIouoOA);
    }
    ...
    public final int m5034decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontStyle.INSTANCE.m5436getNormal_LCdwA();
        }
        if (bDecodeByte == 1) {
            return FontStyle.INSTANCE.m5435getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m5436getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m5035decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m5447getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m5446getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m5448getStyleGVVA2EU();
        }
        if (bDecodeByte == 2) {
            return FontSynthesis.INSTANCE.m5449getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m5447getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m5031decodeBaselineShifty9eOQZs() {
        return BaselineShift.m5608constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m5033decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m5032decodeULongsVKNKU() {
        return ULong.m6484constructorimpl(this.parcel.readLong());
    }
