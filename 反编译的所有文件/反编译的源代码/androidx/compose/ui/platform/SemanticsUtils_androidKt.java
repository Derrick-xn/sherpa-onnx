...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m5079toLegacyClassNameV4PA4sw(int i) {
        if (Role.m5104equalsimpl0(i, Role.INSTANCE.m5108getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m5104equalsimpl0(i, Role.INSTANCE.m5109getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m5104equalsimpl0(i, Role.INSTANCE.m5112getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m5104equalsimpl0(i, Role.INSTANCE.m5111getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m5104equalsimpl0(i, Role.INSTANCE.m5110getDropdownListo7Vup1c())) {
