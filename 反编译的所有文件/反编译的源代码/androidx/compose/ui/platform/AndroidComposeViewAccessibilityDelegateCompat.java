...
public final class AndroidComposeViewAccessibilityDelegateCompat extends AccessibilityDelegateCompat {
    ...
    public final boolean m5020canScroll0AR0LA0$ui_release(boolean vertical, int direction, long position) {
        if (Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
            return m5019canScrollmoWRBKg(getCurrentSemanticsNodes(), vertical, direction, position);
        }
        return false;
    }
    ...
    */
    private final boolean m5019canScrollmoWRBKg(androidx.collection.IntObjectMap<androidx.compose.ui.platform.SemanticsNodeWithAdjustedBounds> r22, boolean r23, int r24, long r25) {
        /*
            Method dump skipped, instructions count: 236
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat.m5019canScrollmoWRBKg(androidx.collection.IntObjectMap, boolean, int, long):boolean");
    }
    ...
    public final Rect boundsInScreen(SemanticsNodeWithAdjustedBounds node) {
        ...
        long jMo4632localToScreenMKHz9U = this.view.mo4632localToScreenMKHz9U(OffsetKt.Offset(adjustedBounds.left, adjustedBounds.top));
        long jMo4632localToScreenMKHz9U2 = this.view.mo4632localToScreenMKHz9U(OffsetKt.Offset(adjustedBounds.right, adjustedBounds.bottom));
        return new Rect((int) Math.floor(Offset.m3044getXimpl(jMo4632localToScreenMKHz9U)), (int) Math.floor(Offset.m3045getYimpl(jMo4632localToScreenMKHz9U)), (int) Math.ceil(Offset.m3044getXimpl(jMo4632localToScreenMKHz9U2)), (int) Math.ceil(Offset.m3045getYimpl(jMo4632localToScreenMKHz9U2)));
    }
    ...
    */
    ...
    private final String getInfoStateDescriptionOrNull(SemanticsNode node) throws Resources.NotFoundException {
        ...
        if (toggleableState != null) {
            ...
            if (i == 1) {
                int iM5113getSwitcho7Vup1c = Role.INSTANCE.m5113getSwitcho7Vup1c();
                if (role != null && Role.m5104equalsimpl0(role.getValue(), iM5113getSwitcho7Vup1c) && orNull == null) {
                    orNull = this.view.getContext().getResources().getString(R.string.state_on);
                }
            } else if (i == 2) {
                int iM5113getSwitcho7Vup1c2 = Role.INSTANCE.m5113getSwitcho7Vup1c();
                if (role != null && Role.m5104equalsimpl0(role.getValue(), iM5113getSwitcho7Vup1c2) && orNull == null) {
        ...
        if (bool != null) {
            ...
            int iM5114getTabo7Vup1c = Role.INSTANCE.m5114getTabo7Vup1c();
            if ((role == null || !Role.m5104equalsimpl0(role.getValue(), iM5114getTabo7Vup1c)) && orNull == null) {
                if (zBooleanValue) {
    ...
    private final boolean getInfoIsCheckable(SemanticsNode node) {
        ...
        bool.booleanValue();
        int iM5114getTabo7Vup1c = Role.INSTANCE.m5114getTabo7Vup1c();
        if (role != null && Role.m5104equalsimpl0(role.getValue(), iM5114getTabo7Vup1c)) {
            z = z2;
        }
        return z;
    }
    ...
    private final RectF toScreenCoords(SemanticsNode textNode, androidx.compose.ui.geometry.Rect bounds) {
        ...
        androidx.compose.ui.geometry.Rect rectM3081translatek4lQ0M = bounds.m3081translatek4lQ0M(textNode.m5116getPositionInRootF1C5BW0());
        androidx.compose.ui.geometry.Rect boundsInRoot = textNode.getBoundsInRoot();
        androidx.compose.ui.geometry.Rect rectIntersect = rectM3081translatek4lQ0M.overlaps(boundsInRoot) ? rectM3081translatek4lQ0M.intersect(boundsInRoot) : null;
        if (rectIntersect == null) {
            return null;
        }
        long jMo4632localToScreenMKHz9U = this.view.mo4632localToScreenMKHz9U(OffsetKt.Offset(rectIntersect.getLeft(), rectIntersect.getTop()));
        long jMo4632localToScreenMKHz9U2 = this.view.mo4632localToScreenMKHz9U(OffsetKt.Offset(rectIntersect.getRight(), rectIntersect.getBottom()));
        return new RectF(Offset.m3044getXimpl(jMo4632localToScreenMKHz9U), Offset.m3045getYimpl(jMo4632localToScreenMKHz9U), Offset.m3044getXimpl(jMo4632localToScreenMKHz9U2), Offset.m3045getYimpl(jMo4632localToScreenMKHz9U2));
    }
    ...
    public final int hitTestSemanticsAt$ui_release(float x, float y) {
        ...
        this.view.getRoot().m4840hitTestSemanticsM_7yMNQ$ui_release(OffsetKt.Offset(x, y), hitTestResult, (12 & 4) != 0, (12 & 8) != 0);
        ...
        if (layoutNodeRequireLayoutNode != null && (nodes = layoutNodeRequireLayoutNode.getNodes()) != null && nodes.m4883hasH91voCI$ui_release(NodeKind.m4922constructorimpl(8)) && AndroidComposeViewAccessibilityDelegateCompat_androidKt.isVisible(SemanticsNodeKt.SemanticsNode(layoutNodeRequireLayoutNode, false)) && this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().get(layoutNodeRequireLayoutNode) == null) {
    ...
    */
    ...
    public final void notifySubtreeAccessibilityStateChangedIfNeeded(LayoutNode layoutNode) {
        if (this.subtreeChangedLayoutNodes.add(layoutNode)) {
            this.boundsUpdateChannel.mo7829trySendJP2dKIU(Unit.INSTANCE);
        }
    }
    ...
    private final void sendSubtreeChangeAccessibilityEvents(LayoutNode layoutNode, MutableIntSet subtreeChangedSemanticsNodesIds) {
        ...
        if (layoutNode.isAttached() && !this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().containsKey(layoutNode)) {
            if (!layoutNode.getNodes().m4883hasH91voCI$ui_release(NodeKind.m4922constructorimpl(8))) {
                layoutNode = AndroidComposeViewAccessibilityDelegateCompat_androidKt.findClosestParentNode(layoutNode, new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat$sendSubtreeChangeAccessibilityEvents$semanticsNode$1
                    ...
                    public final Boolean invoke(LayoutNode layoutNode2) {
                        return Boolean.valueOf(layoutNode2.getNodes().m4883hasH91voCI$ui_release(NodeKind.m4922constructorimpl(8)));
                    }
                });
            }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final void sendAccessibilitySemanticsStructureChangeEvents(androidx.compose.ui.semantics.SemanticsNode r18, androidx.compose.ui.platform.SemanticsNodeCopy r19) {
        /*
            r17 = this;
            r0 = r17
            androidx.collection.MutableIntSet r1 = androidx.collection.IntSetKt.mutableIntSetOf()
            java.util.List r2 = r18.getReplacedChildren$ui_release()
            int r3 = r2.size()
            r4 = 0
            r5 = 0
        L10:
            ...
            androidx.collection.IntObjectMap r7 = r17.getCurrentSemanticsNodes()
            int r8 = r6.getId()
            boolean r7 = r7.contains(r8)
            if (r7 == 0) goto L43
            androidx.collection.MutableIntSet r7 = r19.getChildren()
            int r8 = r6.getId()
            boolean r7 = r7.contains(r8)
            if (r7 != 0) goto L3c
        ...
        L43:
            ...
            goto L10
        L46:
            androidx.collection.MutableIntSet r2 = r19.getChildren()
        ...
        L94:
            ...
            goto L56
        L99:
            java.util.List r1 = r18.getReplacedChildren$ui_release()
            int r2 = r1.size()
        La1:
            if (r4 >= r2) goto Lcc
            java.lang.Object r3 = r1.get(r4)
            androidx.compose.ui.semantics.SemanticsNode r3 = (androidx.compose.ui.semantics.SemanticsNode) r3
            androidx.collection.IntObjectMap r5 = r17.getCurrentSemanticsNodes()
            int r6 = r3.getId()
    ...
    private final int getAccessibilitySelectionStart(SemanticsNode node) {
        if (!node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getContentDescription()) && node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getTextSelectionRange())) {
            return TextRange.m5298getStartimpl(((TextRange) node.getUnmergedConfig().get(SemanticsProperties.INSTANCE.getTextSelectionRange())).getPackedValue());
        }
    ...
    private final int getAccessibilitySelectionEnd(SemanticsNode node) {
        if (!node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getContentDescription()) && node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getTextSelectionRange())) {
            return TextRange.m5293getEndimpl(((TextRange) node.getUnmergedConfig().get(SemanticsProperties.INSTANCE.getTextSelectionRange())).getPackedValue());
        }
        return this.accessibilityCursorPosition;
    }
