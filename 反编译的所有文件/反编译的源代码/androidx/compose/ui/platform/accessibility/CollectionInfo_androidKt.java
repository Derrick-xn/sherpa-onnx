    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayListEmptyList.add(Offset.m3033boximpl(OffsetKt.Offset(Math.abs(Offset.m3044getXimpl(semanticsNode4.getBoundsInRoot().m3074getCenterF1C5BW0()) - Offset.m3044getXimpl(semanticsNode3.getBoundsInRoot().m3074getCenterF1C5BW0())), Math.abs(Offset.m3045getYimpl(semanticsNode4.getBoundsInRoot().m3074getCenterF1C5BW0()) - Offset.m3045getYimpl(semanticsNode3.getBoundsInRoot().m3074getCenterF1C5BW0())))));
        ...
        if (arrayListEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m3033boximpl(Offset.m3049plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) arrayListEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m3045getYimpl(packedValue) < Offset.m3044getXimpl(packedValue);
    }
