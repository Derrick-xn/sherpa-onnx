...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m3724getCenterSzJe1aQ();
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 4096) != 0) {
            ...
            setPivotX(TransformOrigin.m3719getPivotFractionXimpl(transformOrigin) * getWidth());
            setPivotY(TransformOrigin.m3720getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        boolean zM5078updateS_szKao = this.outlineResolver.m5078updateS_szKao(scope.getOutline(), scope.getAlpha(), z3, scope.getShadowElevation(), scope.getSize());
        if (this.outlineResolver.getCacheIsDirty()) {
            updateOutlineResolver();
        }
        boolean z4 = getManualClipPath() != null;
        if (z2 != z4 || (z4 && zM5078updateS_szKao)) {
            invalidate();
        }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            if ((mutatedFields & 64) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m3378toArgb8_81llA(scope.getAmbientShadowColor()));
            }
            if ((mutatedFields & 128) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m3378toArgb8_81llA(scope.getSpotShadowColor()));
            }
        }
        ...
        if ((mutatedFields & 32768) != 0) {
            ...
            if (CompositingStrategy.m3410equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m3416getOffscreenNrFUSI())) {
                setLayerType(2, null);
            } else if (CompositingStrategy.m3410equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m3415getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
    ...
    public boolean mo4970isInLayerk4lQ0M(long position) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= fM3044getXimpl && fM3044getXimpl < ((float) getWidth()) && 0.0f <= fM3045getYimpl && fM3045getYimpl < ((float) getHeight());
        }
        if (getClipToOutline()) {
            return this.outlineResolver.m5077isInOutlinek4lQ0M(position);
        }
        return true;
    }
    ...
    public void mo4973resizeozmzZPI(long size) {
        int iM6018getWidthimpl = IntSize.m6018getWidthimpl(size);
        int iM6017getHeightimpl = IntSize.m6017getHeightimpl(size);
        if (iM6018getWidthimpl == getWidth() && iM6017getHeightimpl == getHeight()) {
            return;
        }
        setPivotX(TransformOrigin.m3719getPivotFractionXimpl(this.mTransformOrigin) * iM6018getWidthimpl);
        setPivotY(TransformOrigin.m3720getPivotFractionYimpl(this.mTransformOrigin) * iM6017getHeightimpl);
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + iM6018getWidthimpl, getTop() + iM6017getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo4972movegyyYBs(long position) {
        int iM5976getXimpl = IntOffset.m5976getXimpl(position);
        if (iM5976getXimpl != getLeft()) {
            offsetLeftAndRight(iM5976getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int iM5977getYimpl = IntOffset.m5977getYimpl(position);
        if (iM5977getYimpl != getTop()) {
            offsetTopAndBottom(iM5977getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public void destroy() {
        ...
        boolean zRecycle$ui_release = this.ownerView.recycle$ui_release(this);
        if (Build.VERSION.SDK_INT >= 23 || shouldUseDispatchDraw || !zRecycle$ui_release) {
    ...
    public long mo4971mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM5054calculateInverseMatrixbWbORWo = this.matrixCache.m5054calculateInverseMatrixbWbORWo(this);
            return fArrM5054calculateInverseMatrixbWbORWo != null ? androidx.compose.ui.graphics.Matrix.m3569mapMKHz9U(fArrM5054calculateInverseMatrixbWbORWo, point) : Offset.INSTANCE.m3058getInfiniteF1C5BW0();
        }
        return androidx.compose.ui.graphics.Matrix.m3569mapMKHz9U(this.matrixCache.m5055calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        if (inverse) {
            float[] fArrM5054calculateInverseMatrixbWbORWo = this.matrixCache.m5054calculateInverseMatrixbWbORWo(this);
            if (fArrM5054calculateInverseMatrixbWbORWo != null) {
                androidx.compose.ui.graphics.Matrix.m3571mapimpl(fArrM5054calculateInverseMatrixbWbORWo, rect);
                return;
            } else {
        ...
        androidx.compose.ui.graphics.Matrix.m3571mapimpl(this.matrixCache.m5055calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4974transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m3580timesAssign58bKbWc(matrix, this.matrixCache.m5055calculateMatrixGrdbGEg(this));
    }
    ...
    public void mo4969inverseTransform58bKbWc(float[] matrix) {
        float[] fArrM5054calculateInverseMatrixbWbORWo = this.matrixCache.m5054calculateInverseMatrixbWbORWo(this);
        if (fArrM5054calculateInverseMatrixbWbORWo != null) {
            androidx.compose.ui.graphics.Matrix.m3580timesAssign58bKbWc(matrix, fArrM5054calculateInverseMatrixbWbORWo);
        }
    }
