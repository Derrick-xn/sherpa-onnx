...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        super(context);
        this.lastDownPointerPosition = Offset.INSTANCE.m3059getUnspecifiedF1C5BW0();
        ...
        Modifier modifierOnKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m5015invokeZmokQxo(keyEvent.m4391unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m5015invokeZmokQxo(android.view.KeyEvent keyEvent) {
                final FocusDirection focusDirectionMo4977getFocusDirectionP8AzH3I = this.this$0.mo4977getFocusDirectionP8AzH3I(keyEvent);
                if (focusDirectionMo4977getFocusDirectionP8AzH3I != null && KeyEventType.m4395equalsimpl0(KeyEvent_androidKt.m4403getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4399getKeyDownCS__XNY())) {
                    Rect rectOnFetchFocusRect = this.this$0.onFetchFocusRect();
                    Boolean boolMo2975focusSearchULY8qGw = this.this$0.getFocusOwner().mo2975focusSearchULY8qGw(focusDirectionMo4977getFocusDirectionP8AzH3I.getValue(), rectOnFetchFocusRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1$focusWasMovedOrCancelled$1
                        {
                            super(1);
                        }
                        ...
                        public final Boolean invoke(FocusTargetNode focusTargetNode) {
                            Boolean boolM2995requestFocusMxy_nc0 = FocusTransactionsKt.m2995requestFocusMxy_nc0(focusTargetNode, focusDirectionMo4977getFocusDirectionP8AzH3I.getValue());
                            return Boolean.valueOf(boolM2995requestFocusMxy_nc0 != null ? boolM2995requestFocusMxy_nc0.booleanValue() : true);
                        }
                    });
                    if (boolMo2975focusSearchULY8qGw == null || boolMo2975focusSearchULY8qGw.booleanValue()) {
                        return true;
                    }
                    if (!FocusOwnerImplKt.m2982is1dFocusSearch3ESFkO8(focusDirectionMo4977getFocusDirectionP8AzH3I.getValue())) {
                        return false;
                    }
                    Integer numM2970toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m2970toAndroidFocusDirection3ESFkO8(focusDirectionMo4977getFocusDirectionP8AzH3I.getValue());
                    if (numM2970toAndroidFocusDirection3ESFkO8 == null) {
                        throw new IllegalStateException("Invalid focus direction".toString());
                    }
                    int iIntValue = numM2970toAndroidFocusDirection3ESFkO8.intValue();
                    ...
                    if (androidRect != null) {
                        ...
                        if ((viewFindNextNonChildView == null || !FocusInteropUtils_androidKt.requestInteropFocus(viewFindNextNonChildView, Integer.valueOf(iIntValue), androidRect)) && this.this$0.getFocusOwner().mo2972clearFocusI7lrPNg(false, true, false, focusDirectionMo4977getFocusDirectionP8AzH3I.getValue())) {
                            Boolean boolMo2975focusSearchULY8qGw2 = this.this$0.getFocusOwner().mo2975focusSearchULY8qGw(focusDirectionMo4977getFocusDirectionP8AzH3I.getValue(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1.1
                                {
                                    super(1);
                                }
                            ...
                            return Boolean.valueOf(boolMo2975focusSearchULY8qGw2 != null ? boolMo2975focusSearchULY8qGw2.booleanValue() : true);
                        }
                        return true;
                    }
        ...
        this.tmpMatrix = fArrM3563constructorimpl$default;
        this.viewToWindowMatrix = Matrix.m3563constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m3563constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m3058getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m2893constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m4085getTouchaOaMEAU() : InputMode.INSTANCE.m4084getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m5011invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m5011invokeiuPiT84(int i) {
                boolean zRequestFocusFromTouch;
                if (InputMode.m4080equalsimpl0(i, InputMode.INSTANCE.m4085getTouchaOaMEAU())) {
                    zRequestFocusFromTouch = this.this$0.isInTouchMode();
                } else {
                    zRequestFocusFromTouch = InputMode.m4080equalsimpl0(i, InputMode.INSTANCE.m4084getKeyboardaOaMEAU()) ? this.this$0.isInTouchMode() ? this.this$0.requestFocusFromTouch() : true : false;
                }
        ...
        this.matrixToWindow = Build.VERSION.SDK_INT < 29 ? new CalculateMatrixToWindowApi21(fArrM3563constructorimpl$default, b == true ? 1 : 0) : new CalculateMatrixToWindowApi29();
    ...
    public void setCoroutineContext(CoroutineContext coroutineContext) {
        ...
        while (layoutNodeRequireLayoutNode != null) {
            ...
            if ((child.getAggregateChildKindSet() & iM4922constructorimpl) != 0) {
                while (child != null) {
                    if ((child.getKindSet() & iM4922constructorimpl) != 0) {
    ...
    public final boolean m5006onMoveFocusInChildren3ESFkO8(int focusDirection) {
        View viewFindNextFocusFromRect;
        if (FocusDirection.m2956equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2963getEnterdhqQ8s()) || FocusDirection.m2956equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2964getExitdhqQ8s())) {
            return false;
        }
        Integer numM2970toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m2970toAndroidFocusDirection3ESFkO8(focusDirection);
        if (numM2970toAndroidFocusDirection3ESFkO8 == null) {
            throw new IllegalStateException("Invalid focus direction".toString());
        }
        int iIntValue = numM2970toAndroidFocusDirection3ESFkO8.intValue();
    ...
    public static final void touchModeChangeListener$lambda$6(AndroidComposeView androidComposeView, boolean z) {
        androidComposeView._inputModeManager.m4088setInputModeiuPiT84(z ? InputMode.INSTANCE.m4085getTouchaOaMEAU() : InputMode.INSTANCE.m4084getKeyboardaOaMEAU());
    }
    ...
    */
    public java.lang.Object textInputSession(kotlin.jvm.functions.Function2<? super androidx.compose.ui.platform.PlatformTextInputSessionScope, ? super kotlin.coroutines.Continuation<?>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<?> r6) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r6 instanceof androidx.compose.ui.platform.AndroidComposeView.C05311
            if (r0 == 0) goto L14
            r0 = r6
            androidx.compose.ui.platform.AndroidComposeView$textInputSession$1 r0 = (androidx.compose.ui.platform.AndroidComposeView.C05311) r0
            int r1 = r0.label
        ...
        L32:
            ...
            r0.label = r3
            java.lang.Object r5 = androidx.compose.ui.SessionMutex.m2900withSessionCancellingPreviousimpl(r6, r2, r5, r0)
            if (r5 != r1) goto L47
            return r1
        L47:
    ...
    public static final void sendHoverExitEvent$lambda$8(AndroidComposeView androidComposeView) {
        ...
        androidComposeView.m5009sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public View focusSearch(View focused, int direction) {
        if (focused != null) {
            ...
            if (Intrinsics.areEqual((Object) getFocusOwner().mo2975focusSearchULY8qGw(focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m2962getDowndhqQ8s(), rectCalculateBoundingRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.focusSearch.1
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(FocusTargetNode focusTargetNode) {
                    return true;
                }
    ...
    public boolean requestFocus(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m2963getEnterdhqQ8s();
        Boolean boolMo2975focusSearchULY8qGw = getFocusOwner().mo2975focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.requestFocus.1
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                Boolean boolM2995requestFocusMxy_nc0 = FocusTransactionsKt.m2995requestFocusMxy_nc0(focusTargetNode, value);
                return Boolean.valueOf(boolM2995requestFocusMxy_nc0 != null ? boolM2995requestFocusMxy_nc0.booleanValue() : false);
            }
        });
        if (boolMo2975focusSearchULY8qGw != null) {
            return boolMo2975focusSearchULY8qGw.booleanValue();
        }
        return false;
    }
    ...
    public final boolean m5007onRequestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
        Integer numM2970toAndroidFocusDirection3ESFkO8;
        if (isFocused() || hasFocus()) {
            return true;
        }
        return super.requestFocus((focusDirection == null || (numM2970toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m2970toAndroidFocusDirection3ESFkO8(focusDirection.getValue())) == null) ? 130 : numM2970toAndroidFocusDirection3ESFkO8.intValue(), previouslyFocusedRect != null ? RectHelper_androidKt.toAndroidRect(previouslyFocusedRect) : null);
    }
    ...
    public boolean mo4979sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        return getFocusOwner().mo2973dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.CC.m2978dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchKeyEvent(final android.view.KeyEvent event) {
        if (isFocused()) {
            this._windowInfo.m5090setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4613constructorimpl(event.getMetaState()));
            return FocusOwner.CC.m2978dispatchKeyEventYhN2O0w$default(getFocusOwner(), KeyEvent.m4386constructorimpl(event), null, 2, null) || super.dispatchKeyEvent(event);
        }
        return getFocusOwner().mo2974dispatchKeyEventYhN2O0w(KeyEvent.m4386constructorimpl(event), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.dispatchKeyEvent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        return (isFocused() && getFocusOwner().mo2973dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m4386constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public final boolean m5010startDrag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
                    ...
                    androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1 r0 = new kotlin.jvm.functions.Function1<androidx.compose.ui.node.LayoutNode, java.lang.Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                        ...
                        public final java.lang.Boolean invoke(androidx.compose.ui.node.LayoutNode r2) {
                            /*
                                ...
                                r0 = 8
                                int r0 = androidx.compose.ui.node.NodeKind.m4922constructorimpl(r0)
                                boolean r2 = r2.m4883hasH91voCI$ui_release(r0)
    ...
    public void mo4978measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m4876measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long jM5004convertMeasureSpecI7RO_PI = m5004convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int iM6484constructorimpl = (int) ULong.m6484constructorimpl(jM5004convertMeasureSpecI7RO_PI >>> 32);
            int iM6484constructorimpl2 = (int) ULong.m6484constructorimpl(jM5004convertMeasureSpecI7RO_PI & 4294967295L);
            long jM5004convertMeasureSpecI7RO_PI2 = m5004convertMeasureSpecI7RO_PI(heightMeasureSpec);
            long jM5795fitPrioritizingHeightZbe2FdA = Constraints.INSTANCE.m5795fitPrioritizingHeightZbe2FdA(iM6484constructorimpl, iM6484constructorimpl2, (int) ULong.m6484constructorimpl(jM5004convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m6484constructorimpl(4294967295L & jM5004convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m5775boximpl(jM5795fitPrioritizingHeightZbe2FdA);
                this.wasMeasuredWithMultipleConstraints = false;
            } else if (constraints == null || !Constraints.m5780equalsimpl0(constraints.getValue(), jM5795fitPrioritizingHeightZbe2FdA)) {
                this.wasMeasuredWithMultipleConstraints = true;
            }
            this.measureAndLayoutDelegate.m4877updateRootConstraintsBRTryo0(jM5795fitPrioritizingHeightZbe2FdA);
    ...
    private final int m5002component1VKZWuLQ(long j) {
        return (int) ULong.m6484constructorimpl(j >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m5003component2VKZWuLQ(long j) {
        return (int) ULong.m6484constructorimpl(j & 4294967295L);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m5008packZIaKswc(int a, int b) {
        return ULong.m6484constructorimpl(ULong.m6484constructorimpl(b) | ULong.m6484constructorimpl(ULong.m6484constructorimpl(a) << 32));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m5004convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m5008packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m5008packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m5008packZIaKswc(size, size);
        }
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        int iM5976getXimpl = IntOffset.m5976getXimpl(j);
        int iM5977getYimpl = IntOffset.m5977getYimpl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (iM5976getXimpl != i || iM5977getYimpl != iArr[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(i, iArr[1]);
            if (iM5976getXimpl != Integer.MAX_VALUE && iM5977getYimpl != Integer.MAX_VALUE) {
    ...
    public OwnedLayer createLayer(Function2<? super androidx.compose.ui.graphics.Canvas, ? super GraphicsLayer, Unit> drawBlock, Function0<Unit> invalidateParentLayer, GraphicsLayer explicitLayer) {
        ...
        if (isHardwareAccelerated() && Build.VERSION.SDK_INT >= 23 && Build.VERSION.SDK_INT != 28) {
    ...
    public FocusDirection mo4977getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        long jM4402getKeyZmokQxo = KeyEvent_androidKt.m4402getKeyZmokQxo(keyEvent);
        if (Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4330getTabEK5gGoQ())) {
            return FocusDirection.m2953boximpl(KeyEvent_androidKt.m4408isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m2967getPreviousdhqQ8s() : FocusDirection.INSTANCE.m2966getNextdhqQ8s());
        }
        if (Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4171getDirectionRightEK5gGoQ())) {
            return FocusDirection.m2953boximpl(FocusDirection.INSTANCE.m2968getRightdhqQ8s());
        }
        if (Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4170getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m2953boximpl(FocusDirection.INSTANCE.m2965getLeftdhqQ8s());
        }
        if (Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4172getDirectionUpEK5gGoQ()) || Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4283getPageUpEK5gGoQ())) {
            return FocusDirection.m2953boximpl(FocusDirection.INSTANCE.m2969getUpdhqQ8s());
        }
        if (Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4167getDirectionDownEK5gGoQ()) || Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4282getPageDownEK5gGoQ())) {
            return FocusDirection.m2953boximpl(FocusDirection.INSTANCE.m2962getDowndhqQ8s());
        }
        if (Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4166getDirectionCenterEK5gGoQ()) || Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4180getEnterEK5gGoQ()) || Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4272getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m2953boximpl(FocusDirection.INSTANCE.m2963getEnterdhqQ8s());
        }
        if (Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4109getBackEK5gGoQ()) || Key.m4094equalsimpl0(jM4402getKeyZmokQxo, Key.INSTANCE.m4183getEscapeEK5gGoQ())) {
            return FocusDirection.m2953boximpl(FocusDirection.INSTANCE.m2964getExitdhqQ8s());
        }
        return null;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m4088setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m4085getTouchaOaMEAU() : InputMode.INSTANCE.m4084getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return motionEvent.isFromSource(4194304) ? handleRotaryEvent(motionEvent) : ProcessResult.m4639getDispatchedToAPointerInputModifierimpl(m5005handleMotionEvent8iAsVTc(motionEvent));
        }
        return super.dispatchGenericMotionEvent(motionEvent);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int iM5005handleMotionEvent8iAsVTc = m5005handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m4638getAnyMovementConsumedimpl(iM5005handleMotionEvent8iAsVTc)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m4639getDispatchedToAPointerInputModifierimpl(iM5005handleMotionEvent8iAsVTc);
    }
    ...
    private final int m5005handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        int i;
        int i2;
        ...
        try {
            ...
            try {
                ...
                return m5009sendMotionEvent8iAsVTc(motionEvent);
            } finally {
                Trace.endSection();
            }
        } finally {
    ...
    private final int m5009sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m5090setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4613constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (pointerInputEventConvertToPointerInputEvent$ui_release != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m4566getPositionF1C5BW0();
            }
            int iM4571processBIzXfog = this.pointerInputEventProcessor.m4571processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked != 0 && actionMasked != 5) || ProcessResult.m4639getDispatchedToAPointerInputModifierimpl(iM4571processBIzXfog)) {
                return iM4571processBIzXfog;
            }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long jMo4632localToScreenMKHz9U = mo4632localToScreenMKHz9U(OffsetKt.Offset(pointerCoords.x, pointerCoords.y));
            pointerCoords.x = Offset.m3044getXimpl(jMo4632localToScreenMKHz9U);
            pointerCoords.y = Offset.m3045getYimpl(jMo4632localToScreenMKHz9U);
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m4571processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, androidComposeView, true);
        motionEventObtain.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.composeAccessibilityDelegate.m5020canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.composeAccessibilityDelegate.m5020canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo4632localToScreenMKHz9U(long localPosition) {
        ...
        long jM3569mapMKHz9U = Matrix.m3569mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m3044getXimpl(jM3569mapMKHz9U) + Offset.m3044getXimpl(this.windowPosition), Offset.m3045getYimpl(jM3569mapMKHz9U) + Offset.m3045getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: localToScreen-58bKbWc */
    public void mo4631localToScreen58bKbWc(float[] localTransform) {
        recalculateWindowPosition();
        Matrix.m3580timesAssign58bKbWc(localTransform, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m5025preTranslatecG2Xzmc(localTransform, Offset.m3044getXimpl(this.windowPosition), Offset.m3045getYimpl(this.windowPosition), this.tmpMatrix);
    }
    ...
    public long mo4633screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        return Matrix.m3569mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(Offset.m3044getXimpl(positionOnScreen) - Offset.m3044getXimpl(this.windowPosition), Offset.m3045getYimpl(positionOnScreen) - Offset.m3045getYimpl(this.windowPosition)));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long jM3569mapMKHz9U = Matrix.m3569mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m3044getXimpl(jM3569mapMKHz9U), motionEvent.getRawY() - Offset.m3045getYimpl(jM3569mapMKHz9U));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo5026calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m5052invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }

    @Override // android.view.View
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession androidPlatformTextInputSession = (AndroidPlatformTextInputSession) SessionMutex.m2897getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo4975calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m3569mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo4976calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m3569mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        return ProcessResult.m4639getDispatchedToAPointerInputModifierimpl(m5005handleMotionEvent8iAsVTc(event));
    }
