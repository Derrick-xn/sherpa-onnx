    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (scrollCaptureScrollByAction != null) {
                ...
                Offset offsetM3033boximpl = Offset.m3033boximpl(OffsetKt.Offset(0.0f, f));
                this.Z$0 = reverseScrolling;
                this.label = 1;
                obj = scrollCaptureScrollByAction.invoke(offsetM3033boximpl, this);
        ...
        float fM3045getYimpl = Offset.m3045getYimpl(((Offset) obj).getPackedValue());
        if (z) {
            fM3045getYimpl = -fM3045getYimpl;
        }
        return Boxing.boxFloat(fM3045getYimpl);
    }
}