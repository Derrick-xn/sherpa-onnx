...
final class RelativeScroller {
    ...
    public final Object scrollRangeIntoView(int i, int i2, Continuation<? super Unit> continuation) throws Throwable {
        if (i > i2) {
    ...
    public final Object scrollTo(float f, Continuation<? super Unit> continuation) throws Throwable {
    ...
    */
    public final java.lang.Object scrollBy(float r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r4 = this;
