...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long jM6004getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m6004getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTargetM = Paint29$$ExternalSyntheticApiModelOutline0.m(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(rectBoundsInRoot)), new Point(IntOffset.m5976getXimpl(jM6004getTopLeftnOccac), IntOffset.m5977getYimpl(jM6004getTopLeftnOccac)), Paint29$$ExternalSyntheticApiModelOutline0.m5347m((Object) composeScrollCaptureCallback));
