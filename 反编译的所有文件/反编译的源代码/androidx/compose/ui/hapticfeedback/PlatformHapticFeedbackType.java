...
public final class PlatformHapticFeedbackType {
    ...
    private static final int LongPress = HapticFeedbackType.m4067constructorimpl(0);
    private static final int TextHandleMove = HapticFeedbackType.m4067constructorimpl(9);

    private PlatformHapticFeedbackType() {
    }

    /* renamed from: getLongPress-5zf0vsI, reason: not valid java name */
    public final int m4075getLongPress5zf0vsI() {
        return LongPress;
    }

    /* renamed from: getTextHandleMove-5zf0vsI, reason: not valid java name */
    public final int m4076getTextHandleMove5zf0vsI() {
