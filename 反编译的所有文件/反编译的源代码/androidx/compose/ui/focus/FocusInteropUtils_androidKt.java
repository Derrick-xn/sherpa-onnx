...
public final class FocusInteropUtils_androidKt {
    public static final FocusDirection toFocusDirection(int i) {
        if (i == 1) {
            return FocusDirection.m2953boximpl(FocusDirection.INSTANCE.m2967getPreviousdhqQ8s());
        }
        if (i == 2) {
            return FocusDirection.m2953boximpl(FocusDirection.INSTANCE.m2966getNextdhqQ8s());
        }
        if (i == 17) {
    ...
    public static final Integer m2970toAndroidFocusDirection3ESFkO8(int i) {
        ...
        return FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2967getPreviousdhqQ8s()) ? 1 : null;
    }
