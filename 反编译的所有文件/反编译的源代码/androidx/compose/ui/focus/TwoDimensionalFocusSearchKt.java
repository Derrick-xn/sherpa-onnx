...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m3009twoDimensionalFocusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m3005findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 == 4) {
                ...
                return Boolean.valueOf(m3008searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
            }
        ...
        if (i3 == 1) {
            Boolean boolM3009twoDimensionalFocusSearchsMXa3k8 = m3009twoDimensionalFocusSearchsMXa3k8(activeChild, i, rect, function1);
            if (!Intrinsics.areEqual((Object) boolM3009twoDimensionalFocusSearchsMXa3k8, (Object) false)) {
                return boolM3009twoDimensionalFocusSearchsMXa3k8;
            }
            if (rect == null) {
                rect = FocusTraversalKt.focusRect(activeNode(activeChild));
            }
            return Boolean.valueOf(m3006generateAndSearchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        if (i3 == 2 || i3 == 3) {
            if (rect == null) {
    ...
    private static final boolean m3006generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final Rect rect, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m3008searchChildren4C6V_qg(focusTargetNode, rect, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2952searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                boolean zM3008searchChildren4C6V_qg = TwoDimensionalFocusSearchKt.m3008searchChildren4C6V_qg(focusTargetNode, rect, i, function1);
                Boolean boolValueOf = Boolean.valueOf(zM3008searchChildren4C6V_qg);
                boolValueOf.getClass();
                if (zM3008searchChildren4C6V_qg || !beyondBoundsScope.getHasMoreContent()) {
                    return boolValueOf;
                }
                return null;
            }
    ...
    private static final FocusTargetNode m3004findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2965getLeftdhqQ8s())) {
            ...
            rectTranslate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2969getUpdhqQ8s())) {
            rectTranslate = rect.translate(0.0f, rect.getHeight() + 1);
        } else {
            if (!FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2962getDowndhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m3007isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2965getLeftdhqQ8s())) {
            if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2968getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float top2;
        float height;
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2965getLeftdhqQ8s()) || FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2968getRightdhqQ8s())) {
            f = 2;
            top = rect2.getTop() + (rect2.getHeight() / f);
            top2 = rect.getTop();
            height = rect.getHeight();
        } else {
            if (!FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2969getUpdhqQ8s()) && !FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2962getDowndhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m3007isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m3003beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m3003beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    private static final boolean m3003beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2965getLeftdhqQ8s()) || FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2968getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
    ...
    public static final boolean m3005findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2963getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m2968getRightdhqQ8s();
        }
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2968getRightdhqQ8s()) || FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2962getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            if (!FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2965getLeftdhqQ8s()) && !FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2969getUpdhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        }
        FocusTargetNode focusTargetNodeM3004findBestCandidate4WY_MpI = m3004findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM3004findBestCandidate4WY_MpI != null) {
            return function1.invoke(focusTargetNodeM3004findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m3008searchChildren4C6V_qg(FocusTargetNode focusTargetNode, Rect rect, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode focusTargetNodeM3004findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector2.isNotEmpty()) {
            ...
            if ((nodePop.getAggregateChildKindSet() & iM4922constructorimpl) == 0) {
                ...
                while (true) {
                    ...
                    if ((nodePop.getKindSet() & iM4922constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            ...
                            } else if ((nodePop.getKindSet() & iM4922constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
                                int i2 = 0;
        ...
        while (mutableVector.isNotEmpty() && (focusTargetNodeM3004findBestCandidate4WY_MpI = m3004findBestCandidate4WY_MpI(mutableVector, rect, i)) != null) {
            if (focusTargetNodeM3004findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(focusTargetNodeM3004findBestCandidate4WY_MpI).booleanValue();
            }
            if (m3006generateAndSearchChildren4C6V_qg(focusTargetNodeM3004findBestCandidate4WY_MpI, rect, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM3004findBestCandidate4WY_MpI);
        }
        return false;
    }
