...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public void onDetach() {
        ...
        if (i == 1 || i == 2) {
            DelegatableNodeKt.requireOwner(this).getFocusOwner().mo2972clearFocusI7lrPNg(true, true, false, FocusDirection.INSTANCE.m2964getExitdhqQ8s());
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int iM4922constructorimpl = NodeKind.m4922constructorimpl(2048);
        int iM4922constructorimpl2 = NodeKind.m4922constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = iM4922constructorimpl | iM4922constructorimpl2;
            ...
            if ((layoutNodeRequireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & i) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & i) != 0) {
                        if (node2 != node && (node2.getKindSet() & iM4922constructorimpl2) != 0) {
                            break loop0;
                        }
    ...
    public final void m2989fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        if (this.isProcessingCustomEnter) {
            return;
        }
        this.isProcessingCustomEnter = true;
        try {
            FocusRequester focusRequesterInvoke = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2953boximpl(focusDirection));
    ...
    public final void m2990fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        if (this.isProcessingCustomExit) {
            return;
        }
        this.isProcessingCustomExit = true;
        try {
            FocusRequester focusRequesterInvoke = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2953boximpl(focusDirection));
            if (focusRequesterInvoke != FocusRequester.INSTANCE.getDefault()) {
                block.invoke(focusRequesterInvoke);
            }
        } finally {
        ...
        while (mutableVector.isNotEmpty()) {
            ...
            if ((node.getAggregateChildKindSet() & iM4922constructorimpl) != 0) {
                for (Modifier.Node child2 = node; child2 != null; child2 = child2.getChild()) {
                    if ((child2.getKindSet() & iM4922constructorimpl) != 0) {
