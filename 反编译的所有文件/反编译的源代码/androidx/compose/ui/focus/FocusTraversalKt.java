...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m2996customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2965getLeftdhqQ8s())) {
            ...
            if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2963getEnterdhqQ8s())) {
                return focusPropertiesFetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m2953boximpl(i));
            }
            if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2964getExitdhqQ8s())) {
                return focusPropertiesFetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m2953boximpl(i));
            }
    ...
    public static final Boolean m2997focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int iM2968getRightdhqQ8s;
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2966getNextdhqQ8s()) || FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2967getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m3000oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2965getLeftdhqQ8s()) || FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2968getRightdhqQ8s()) || FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2969getUpdhqQ8s()) || FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2962getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m3009twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2963getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                iM2968getRightdhqQ8s = FocusDirection.INSTANCE.m2968getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                iM2968getRightdhqQ8s = FocusDirection.INSTANCE.m2965getLeftdhqQ8s();
            }
            FocusTargetNode focusTargetNodeFindActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (focusTargetNodeFindActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m3009twoDimensionalFocusSearchsMXa3k8(focusTargetNodeFindActiveFocusNode, iM2968getRightdhqQ8s, rect, function1);
            }
            return null;
        }
        if (FocusDirection.m2956equalsimpl0(i, FocusDirection.INSTANCE.m2964getExitdhqQ8s())) {
        ...
        throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m2958toStringimpl(i))).toString());
    }
