...
public interface FocusOwner extends FocusManager {
    ...
    boolean mo2972clearFocusI7lrPNg(boolean force, boolean refreshFocusEvents, boolean clearOwnerFocus, int focusDirection);

    /* renamed from: dispatchInterceptedSoftKeyboardEvent-ZmokQxo, reason: not valid java name */
    boolean mo2973dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* renamed from: dispatchKeyEvent-YhN2O0w, reason: not valid java name */
    boolean mo2974dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> onFocusedItem);

    boolean dispatchRotaryEvent(RotaryScrollEvent event);

    /* renamed from: focusSearch-ULY8qGw, reason: not valid java name */
    Boolean mo2975focusSearchULY8qGw(int focusDirection, Rect focusedRect, Function1<? super FocusTargetNode, Boolean> onFound);
    ...
    boolean mo2976requestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);
    ...
    boolean mo2977takeFocusaToIllA(int focusDirection, Rect previouslyFocusedRect);

    /* compiled from: FocusOwner.kt */
    /* renamed from: androidx.compose.ui.focus.FocusOwner$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: dispatchKeyEvent-YhN2O0w$default, reason: not valid java name */
        public static /* synthetic */ boolean m2978dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
            if (obj != null) {
            ...
            return focusOwner.mo2974dispatchKeyEventYhN2O0w(keyEvent, function0);
        }
    }
}