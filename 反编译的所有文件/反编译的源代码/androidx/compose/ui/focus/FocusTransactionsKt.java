...
public final class FocusTransactionsKt {
    ...
    public static final boolean requestFocus(FocusTargetNode focusTargetNode) {
        Boolean boolM2995requestFocusMxy_nc0 = m2995requestFocusMxy_nc0(focusTargetNode, FocusDirection.INSTANCE.m2963getEnterdhqQ8s());
        if (boolM2995requestFocusMxy_nc0 != null) {
            return boolM2995requestFocusMxy_nc0.booleanValue();
        }
        return false;
    }

    /* renamed from: requestFocus-Mxy_nc0, reason: not valid java name */
    public static final Boolean m2995requestFocusMxy_nc0(final FocusTargetNode focusTargetNode, int i) {
        Boolean boolValueOf;
        ...
        try {
            ...
            int i2 = WhenMappings.$EnumSwitchMapping$0[m2994performCustomRequestFocusMxy_nc0(focusTargetNode, i).ordinal()];
            if (i2 == 1) {
    ...
    */
    ...
    private static final boolean requestFocusForChild(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2) {
        ...
        if (i2 != 2) {
            if (i2 == 3) {
                ...
                int iM4922constructorimpl2 = NodeKind.m4922constructorimpl(1024);
                ...
                loop4: while (true) {
                    ...
                    if ((layoutNodeRequireLayoutNode2.getNodes().getHead().getAggregateChildKindSet() & iM4922constructorimpl2) != 0) {
                        while (parent2 != null) {
                            if ((parent2.getKindSet() & iM4922constructorimpl2) != 0) {
                                ...
                                while (nodePop2 != null) {
                                    ...
                                    if ((nodePop2.getKindSet() & iM4922constructorimpl2) != 0 && (nodePop2 instanceof DelegatingNode)) {
                                        int i3 = 0;
    ...
    private static final boolean requestFocusForOwner(FocusTargetNode focusTargetNode) {
        return DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().mo2976requestFocusForOwner7o62pno(null, null);
    }
    ...
    public static final CustomDestinationResult m2994performCustomRequestFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        Modifier.Node nodePop;
        NodeChain nodes;
        int i2 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
        if (i2 == 1 || i2 == 2) {
        ...
        if (i2 == 3) {
            return m2991performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
        }
        if (i2 == 4) {
            ...
            if (i4 == 1) {
                return m2992performCustomEnterMxy_nc0(focusTargetNode3, i);
            }
            if (i4 == 2) {
                return CustomDestinationResult.Cancelled;
            }
            if (i4 == 3) {
                return m2994performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
            }
            if (i4 != 4) {
                throw new NoWhenBranchMatchedException();
            }
            CustomDestinationResult customDestinationResultM2994performCustomRequestFocusMxy_nc0 = m2994performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
            CustomDestinationResult customDestinationResult = customDestinationResultM2994performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None ? customDestinationResultM2994performCustomRequestFocusMxy_nc0 : null;
            return customDestinationResult == null ? m2992performCustomEnterMxy_nc0(focusTargetNode3, i) : customDestinationResult;
        }
        throw new NoWhenBranchMatchedException();
    }

    /* renamed from: performCustomClearFocus-Mxy_nc0, reason: not valid java name */
    public static final CustomDestinationResult m2991performCustomClearFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        int i2 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                return CustomDestinationResult.Cancelled;
            ...
            if (i2 == 3) {
                CustomDestinationResult customDestinationResultM2991performCustomClearFocusMxy_nc0 = m2991performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
                if (customDestinationResultM2991performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                    customDestinationResultM2991performCustomClearFocusMxy_nc0 = null;
                }
                return customDestinationResultM2991performCustomClearFocusMxy_nc0 == null ? m2993performCustomExitMxy_nc0(focusTargetNode, i) : customDestinationResultM2991performCustomClearFocusMxy_nc0;
            }
            if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
            }
    ...
    private static final CustomDestinationResult m2992performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            focusTargetNode.isProcessingCustomEnter = true;
            try {
                FocusRequester focusRequesterInvoke = focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2953boximpl(i));
    ...
    private static final CustomDestinationResult m2993performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomExit) {
            focusTargetNode.isProcessingCustomExit = true;
            try {
                FocusRequester focusRequesterInvoke = focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2953boximpl(i));
                if (focusRequesterInvoke != FocusRequester.INSTANCE.getDefault()) {
                    if (focusRequesterInvoke == FocusRequester.INSTANCE.getCancel()) {
                        return CustomDestinationResult.Cancelled;
                    }
