...
public interface Path {
    ...
    void mo3176addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo3178opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo3179setFillTypeoQ8Xj4U(int i);

    /* renamed from: transform-58bKbWc */
    void mo3180transform58bKbWc(float[] matrix);

    /* renamed from: translate-k-4lQ0M */
    void mo3181translatek4lQ0M(long offset);
    ...
    public final /* synthetic */ class CC {
        ...
        public static void m3601$default$transform58bKbWc(Path _this, float[] fArr) {
        }
        ...
        public static /* synthetic */ void m3603addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
            if (obj != null) {
            ...
            path.mo3176addPathUv8p0NA(path2, j);
        }
        ...
        public static Path $default$plus(Path _this, Path path) {
            ...
            Path.mo3178opN5in7k0(_this, path, PathOperation.INSTANCE.m3628getUnionb3I0S0c());
            return Path;
        }

        public static Path $default$minus(Path _this, Path path) {
            Path Path = AndroidPath_androidKt.Path();
            Path.mo3178opN5in7k0(_this, path, PathOperation.INSTANCE.m3625getDifferenceb3I0S0c());
            return Path;
        }

        public static Path $default$and(Path _this, Path path) {
            Path Path = AndroidPath_androidKt.Path();
            Path.mo3178opN5in7k0(_this, path, PathOperation.INSTANCE.m3626getIntersectb3I0S0c());
            return Path;
        }

        public static Path $default$xor(Path _this, Path path) {
            Path Path = AndroidPath_androidKt.Path();
            Path.mo3178opN5in7k0(_this, path, PathOperation.INSTANCE.m3629getXorb3I0S0c());
            return Path;
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static void m3606transform58bKbWc(Path path, float[] fArr) {
            CC.m3601$default$transform58bKbWc(path, fArr);
        }
    ...
    public static final class Companion {
        ...
        public final Path m3604combinexh6zSI8(int operation, Path path1, Path path2) {
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo3178opN5in7k0(path1, path2, operation)) {
                return Path;
            }
