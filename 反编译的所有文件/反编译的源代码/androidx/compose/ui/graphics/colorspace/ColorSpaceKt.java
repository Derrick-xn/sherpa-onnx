...
public final class ColorSpaceKt {
    ...
    private static final Connector m3753createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.INSTANCE.identity$ui_graphics_release(colorSpace);
        }
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (ColorModel.m3740equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m3747getRgbxdoWZVw()) && ColorModel.m3740equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m3747getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m3752connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m3768getPerceptualuksYyKA();
        }
        return m3751connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m3751connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        if ((id$ui_graphics_release | id$ui_graphics_release2) < 0) {
            return m3753createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        ...
        Connector connectorM3753createConnectorYBCOT_4 = connectors.get(i2);
        if (connectorM3753createConnectorYBCOT_4 == null) {
            connectorM3753createConnectorYBCOT_4 = m3753createConnectorYBCOT_4(colorSpace, colorSpace2, i);
            connectors.set(i2, connectorM3753createConnectorYBCOT_4);
        }
        return connectorM3753createConnectorYBCOT_4;
    }
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (!ColorModel.m3740equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m3747getRgbxdoWZVw())) {
            return colorSpace;
        }
        Intrinsics.checkNotNull(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
