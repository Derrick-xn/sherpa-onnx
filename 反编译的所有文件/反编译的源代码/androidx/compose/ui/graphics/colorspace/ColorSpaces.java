...
public final class ColorSpaces {
    ...
    static {
        ...
        double d = 0.0d;
        double d2 = 0.0d;
        TransferParameters transferParameters2 = new TransferParameters(2.2d, 0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, d, d2, i, defaultConstructorMarker);
        ...
        double d4 = 0.2222222222222222d;
        Rgb rgb5 = new Rgb("Rec. ITU-R BT.709-5", new float[]{0.64f, 0.33f, 0.3f, 0.6f, 0.15f, 0.06f}, Illuminant.INSTANCE.getD65(), new TransferParameters(d3, 0.9099181073703367d, 0.09008189262966333d, d4, 0.081d, d, d2, i, defaultConstructorMarker), 4);
        Bt709 = rgb5;
        Rgb rgb6 = new Rgb("Rec. ITU-R BT.2020-1", new float[]{0.708f, 0.292f, 0.17f, 0.797f, 0.131f, 0.046f}, Illuminant.INSTANCE.getD65(), new TransferParameters(d3, 0.9096697898662786d, 0.09033021013372146d, d4, 0.08145d, d, d2, i, defaultConstructorMarker), 5);
        Bt2020 = rgb6;
