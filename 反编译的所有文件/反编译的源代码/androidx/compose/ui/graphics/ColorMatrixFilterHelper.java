...
final class ColorMatrixFilterHelper {
    ...
    public final float[] m3404getColorMatrix8unuwjk(android.graphics.ColorMatrixColorFilter colorFilter) {
        android.graphics.ColorMatrix colorMatrix = new android.graphics.ColorMatrix();
        colorFilter.getColorMatrix(colorMatrix);
        return ColorMatrix.m3380constructorimpl(colorMatrix.getArray());
    }
}