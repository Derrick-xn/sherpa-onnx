...
public final class BezierKt {
    ...
    */
    private static final float findFirstQuadraticRoot(float r20, float r21, float r22) {
        /*
            r0 = r20
            double r0 = (double) r0
            r2 = r21
            ...
            r15 = -1251999744(0xffffffffb5600000, float:-8.34465E-7)
    ...
    public static final long computeHorizontalBounds(PathSegment pathSegment, float[] fArr, int i) {
        ...
        return FloatFloatPair.m35constructorimpl(fMin, fMax);
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final float findFirstCubicRoot(float r24, float r25, float r26, float r27) {
        /*
