...
public final class AndroidPath implements Path {
    ...
    public /* synthetic */ Path and(Path path) {
        return Path.CC.$default$and(this, path);
    }
    ...
    @Override // androidx.compose.ui.graphics.Path
    public /* synthetic */ PathIterator iterator(PathIterator.ConicEvaluation conicEvaluation, float f) {
        return AndroidPathIterator_androidKt.PathIterator(this, conicEvaluation, f);
    }

    @Override // androidx.compose.ui.graphics.Path
    public /* synthetic */ Path minus(Path path) {
        return Path.CC.$default$minus(this, path);
    }
    ...
    public /* synthetic */ Path plus(Path path) {
        return Path.CC.$default$plus(this, path);
    }

    @Override // androidx.compose.ui.graphics.Path
    public /* synthetic */ Path xor(Path path) {
        return Path.CC.$default$xor(this, path);
    }
    ...
    public int mo3177getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m3615getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m3616getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo3179setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m3611equalsimpl0(i, PathFillType.INSTANCE.m3615getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs());
        fArr[1] = CornerRadius.m3020getYimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs());
        fArr[2] = CornerRadius.m3019getXimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs());
        fArr[3] = CornerRadius.m3020getYimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs());
        fArr[4] = CornerRadius.m3019getXimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs());
        fArr[5] = CornerRadius.m3020getYimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs());
        fArr[6] = CornerRadius.m3019getXimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs());
        fArr[7] = CornerRadius.m3020getYimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo3176addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m3044getXimpl(offset), Offset.m3045getYimpl(offset));
            return;
        }
    ...
    public void mo3181translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m3044getXimpl(offset), Offset.m3045getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo3180transform58bKbWc(float[] matrix) {
    ...
    public boolean mo3178opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m3621equalsimpl0(operation, PathOperation.INSTANCE.m3625getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m3621equalsimpl0(operation, PathOperation.INSTANCE.m3626getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m3621equalsimpl0(operation, PathOperation.INSTANCE.m3627getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m3621equalsimpl0(operation, PathOperation.INSTANCE.m3628getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
