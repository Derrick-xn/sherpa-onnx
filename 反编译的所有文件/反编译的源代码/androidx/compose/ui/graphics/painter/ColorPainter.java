...
public final class ColorPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        DrawScope.CC.m3891drawRectnJ9OG0$default(drawScope, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m3325equalsimpl0(this.color, ((ColorPainter) other).color);
    }

    public int hashCode() {
        return Color.m3331hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m3332toStringimpl(this.color)) + ')';
    }
