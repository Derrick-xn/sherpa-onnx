...
public final class StrokeJoin {
    ...
    private static final int Miter = m3690constructorimpl(0);
    private static final int Round = m3690constructorimpl(1);
    private static final int Bevel = m3690constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m3689boximpl(int i) {
        return new StrokeJoin(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3690constructorimpl(int i) {
        return i;
    }
    ...
    public static int m3693hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m3691equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3693hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3697getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8, reason: not valid java name */
        public final int m3698getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8, reason: not valid java name */
        public final int m3696getBevelLxFBmk8() {
    ...
    public static String m3694toStringimpl(int i) {
        return m3692equalsimpl0(i, Miter) ? "Miter" : m3692equalsimpl0(i, Round) ? "Round" : m3692equalsimpl0(i, Bevel) ? "Bevel" : "Unknown";
    }
}