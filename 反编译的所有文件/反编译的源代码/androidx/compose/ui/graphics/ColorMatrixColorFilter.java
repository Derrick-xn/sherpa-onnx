...
public final class ColorMatrixColorFilter extends ColorFilter {
    ...
    private ColorMatrixColorFilter(float[] fArr) {
        this(fArr, AndroidColorFilter_androidKt.m3150actualColorMatrixColorFilterjHGOpc(fArr), null);
    }

    /* renamed from: copyColorMatrix-gBh15pI$default, reason: not valid java name */
    public static /* synthetic */ float[] m3401copyColorMatrixgBh15pI$default(ColorMatrixColorFilter colorMatrixColorFilter, float[] fArr, int i, Object obj) {
        if ((i & 1) != 0) {
            fArr = ColorMatrix.m3381constructorimpl$default(null, 1, null);
        }
        return colorMatrixColorFilter.m3403copyColorMatrixgBh15pI(fArr);
    }

    /* renamed from: copyColorMatrix-gBh15pI, reason: not valid java name */
    public final float[] m3403copyColorMatrixgBh15pI(float[] targetColorMatrix) {
        ArraysKt.copyInto$default(m3402obtainColorMatrixp10uLo(), targetColorMatrix, 0, 0, 0, 14, (Object) null);
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorMatrixColorFilter) && Arrays.equals(m3402obtainColorMatrixp10uLo(), ((ColorMatrixColorFilter) other).m3402obtainColorMatrixp10uLo());
    }

    /* renamed from: obtainColorMatrix-p10-uLo, reason: not valid java name */
    private final float[] m3402obtainColorMatrixp10uLo() {
    ...
    public int hashCode() {
        float[] fArr = this.colorMatrix;
        if (fArr != null) {
            return ColorMatrix.m3388hashCodeimpl(fArr);
        }
        return 0;
    }
    ...
    public String toString() {
        ...
        float[] fArr = this.colorMatrix;
        sb.append((Object) (fArr == null ? "null" : ColorMatrix.m3399toStringimpl(fArr)));
        sb.append(')');
        return sb.toString();
    }
}