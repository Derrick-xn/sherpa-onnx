...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo3277createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m3065isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m3123getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset(Offset.m3044getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3113getWidthimpl(size) : Offset.m3044getXimpl(this.center), Offset.m3045getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3110getHeightimpl(size) : Offset.m3045getYimpl(this.center));
        }
        return ShaderKt.m3652SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m3041equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iM3046hashCodeimpl = ((Offset.m3046hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return iM3046hashCodeimpl + (list != null ? list.hashCode() : 0);
    }
