...
public final class BlendModeColorFilter extends ColorFilter {
    ...
    private BlendModeColorFilter(long j, int i) {
        this(j, i, AndroidColorFilter_androidKt.m3152actualTintColorFilterxETnrds(j, i), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.color, blendModeColorFilter.color) && BlendMode.m3219equalsimpl0(this.blendMode, blendModeColorFilter.blendMode);
    }

    public int hashCode() {
        return (Color.m3331hashCodeimpl(this.color) * 31) + BlendMode.m3220hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "BlendModeColorFilter(color=" + ((Object) Color.m3332toStringimpl(this.color)) + ", blendMode=" + ((Object) BlendMode.m3221toStringimpl(this.blendMode)) + ')';
    }
}