...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m3670constructorimpl(0);
    private static final int Rotate = m3670constructorimpl(1);
    private static final int Morph = m3670constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m3669boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3670constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3671equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3672equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3673hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m3671equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3673hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3678getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk, reason: not valid java name */
        public final int m3677getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk, reason: not valid java name */
        public final int m3676getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    public String toString() {
        return m3674toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3674toStringimpl(int i) {
        return m3672equalsimpl0(i, Translate) ? "Translate" : m3672equalsimpl0(i, Rotate) ? "Rotate" : m3672equalsimpl0(i, Morph) ? "Morph" : "Unknown";
    }
}