...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3060getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m4010applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4010applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m3976getOffscreenke2Ky5w());
        } else {
            m4010applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m3970equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m3976getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m3219equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m3250getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo4005setPivotOffsetk4lQ0M(long j) {
        ...
        if (OffsetKt.m3065isUnspecifiedk4lQ0M(j)) {
            ...
            this.viewLayer.setPivotX(IntSize.m6018getWidthimpl(this.size) / 2.0f);
            this.viewLayer.setPivotY(IntSize.m6017getHeightimpl(this.size) / 2.0f);
            return;
        }
        this.shouldManuallySetCenterPivot = false;
        this.viewLayer.setPivotX(Offset.m3044getXimpl(j));
        this.viewLayer.setPivotY(Offset.m3045getYimpl(j));
    }
    ...
    public void mo4002setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m3378toArgb8_81llA(j));
        }
    }
    ...
    public void mo4007setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m3378toArgb8_81llA(j));
        }
    }
    ...
    public void mo4006setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m6016equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x, y, IntSize.m6018getWidthimpl(size) + x, IntSize.m6017getHeightimpl(size) + y);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m6018getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m6017getHeightimpl(size) / 2.0f);
            }
        } else {
            int i = this.x;
            if (i != x) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (picture != null) {
                Canvas canvasBeginRecording = picture.beginRecording(IntSize.m6018getWidthimpl(this.size), IntSize.m6017getHeightimpl(this.size));
                try {
                    ...
                    if (canvasHolder2 != null) {
                        ...
                        if (canvasDrawScope != null) {
                            ...
                            drawParams2.m3812setSizeuvyYCjk(jM6030toSizeozmzZPI);
                            androidCanvas.save();
                            ...
                            drawParams3.m3812setSizeuvyYCjk(size);
                        } else {
                            canvasHolder = canvasHolder2;
                            canvas = internalCanvas;
                        }
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            canvas = new Canvas() { // from class: androidx.compose.ui.graphics.layer.GraphicsViewLayer$Companion$PlaceholderCanvas$1
            ...
            canvas = (Canvas) new PlaceholderHardwareCanvas();
        }
