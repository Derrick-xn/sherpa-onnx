...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        RenderNode renderNodeM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m("graphicsLayer");
        this.renderNode = renderNodeM;
        this.size = Size.INSTANCE.m3122getZeroNHjbRc();
        renderNodeM.setClipToBounds(false);
        m4009applyCompositingStrategyZ1X6vPc(renderNodeM, CompositingStrategy.INSTANCE.m3974getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo4003setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m3136toAndroidBlendModes9anfk8(i));
    ...
    public void mo4002setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m3378toArgb8_81llA(j));
    }
    ...
    public void mo4007setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m3378toArgb8_81llA(j));
    }
    ...
    private final void m4009applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m3970equalsimpl0(i, CompositingStrategy.INSTANCE.m3976getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3970equalsimpl0(i, CompositingStrategy.INSTANCE.m3975getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4009applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m3976getOffscreenke2Ky5w());
        } else {
            m4009applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo4006setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setPosition(x, y, IntSize.m6018getWidthimpl(size) + x, IntSize.m6017getHeightimpl(size) + y);
        this.size = IntSizeKt.m6030toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo3814setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m3970equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m3976getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
