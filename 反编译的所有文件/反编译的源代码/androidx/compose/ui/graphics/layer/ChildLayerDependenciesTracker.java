    ...
    */
    public final void withTracking(kotlin.jvm.functions.Function1<? super androidx.compose.ui.graphics.layer.GraphicsLayer, kotlin.Unit> r19, kotlin.jvm.functions.Function0<kotlin.Unit> r20) {
        /*
            ...
            r0 = r18
            r1 = r19
            androidx.compose.ui.graphics.layer.GraphicsLayer r2 = access$getDependency$p(r18)
            access$setOldDependency$p(r0, r2)
            androidx.collection.MutableScatterSet r2 = access$getDependenciesSet$p(r18)
            if (r2 == 0) goto L2d
            boolean r3 = r2.isNotEmpty()
            if (r3 == 0) goto L2d
            androidx.collection.MutableScatterSet r3 = access$getOldDependenciesSet$p(r18)
            if (r3 != 0) goto L24
        ...
        L2d:
            ...
            r2 = 0
            access$setTrackingInProgress$p(r0, r2)
            androidx.compose.ui.graphics.layer.GraphicsLayer r3 = access$getOldDependency$p(r18)
            if (r3 == 0) goto L41
            r1.invoke(r3)
        L41:
            androidx.collection.MutableScatterSet r3 = access$getOldDependenciesSet$p(r18)
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void removeDependencies(kotlin.jvm.functions.Function1<? super androidx.compose.ui.graphics.layer.GraphicsLayer, kotlin.Unit> r19) {
        /*
            r18 = this;
            r0 = r19
            androidx.compose.ui.graphics.layer.GraphicsLayer r1 = access$getDependency$p(r18)
            if (r1 == 0) goto L12
            r0.invoke(r1)
            r1 = 0
            r2 = r18
        ...
        L12:
            r2 = r18
        L14:
            androidx.collection.MutableScatterSet r1 = access$getDependenciesSet$p(r18)
            if (r1 == 0) goto L63
            r3 = r1
