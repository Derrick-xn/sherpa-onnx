...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m3414getAutoNrFUSI();
    private long size = Size.INSTANCE.m3121getUnspecifiedNHjbRc();
    ...
    public void mo3496setAmbientShadowColor8_81llA(long j) {
        if (Color.m3325equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo3498setSpotShadowColor8_81llA(long j) {
        if (Color.m3325equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo3499setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m3718equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo3497setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m3410equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m3645setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo3496setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3498setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3499setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m3724getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3497setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m3414getAutoNrFUSI());
        m3645setSizeuvyYCjk(Size.INSTANCE.m3121getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui_release() {
        this.outline = getShape().mo308createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}