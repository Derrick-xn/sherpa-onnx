...
public final class SolidColor extends Brush {
    ...
    public void mo3255applyToPq9zytI(long size, Paint p, float alpha) {
        long jM3323copywmQWz5c$default;
        p.setAlpha(1.0f);
        if (alpha != 1.0f) {
            long j = this.value;
            jM3323copywmQWz5c$default = Color.m3323copywmQWz5c$default(j, Color.m3326getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            jM3323copywmQWz5c$default = this.value;
        }
        p.mo3165setColor8_81llA(jM3323copywmQWz5c$default);
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m3325equalsimpl0(this.value, ((SolidColor) other).value);
    }

    public int hashCode() {
        return Color.m3331hashCodeimpl(this.value);
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m3332toStringimpl(this.value)) + ')';
    }
}