...
public final class LightingColorFilter extends ColorFilter {
    ...
    private LightingColorFilter(long j, long j2) {
        this(j, j2, AndroidColorFilter_androidKt.m3151actualLightingColorFilterOWjLjI(j, j2), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3325equalsimpl0(this.multiply, lightingColorFilter.multiply) && Color.m3325equalsimpl0(this.add, lightingColorFilter.add);
    }

    public int hashCode() {
        return (Color.m3331hashCodeimpl(this.multiply) * 31) + Color.m3331hashCodeimpl(this.add);
    }

    public String toString() {
        return "LightingColorFilter(multiply=" + ((Object) Color.m3332toStringimpl(this.multiply)) + ", add=" + ((Object) Color.m3332toStringimpl(this.add)) + ')';
    }
}