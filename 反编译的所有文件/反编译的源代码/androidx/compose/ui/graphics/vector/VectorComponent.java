...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent groupComponent) {
        ...
        this.viewportSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3101boximpl(Size.INSTANCE.m3122getZeroNHjbRc()), null, 2, null);
        this.previousDrawSize = Size.INSTANCE.m3121getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                long jM3060getZeroF1C5BW0 = Offset.INSTANCE.m3060getZeroF1C5BW0();
                DrawContext drawContext = drawScope.getDrawContext();
                long jMo3813getSizeNHjbRc = drawContext.mo3813getSizeNHjbRc();
                drawContext.getCanvas().save();
                try {
                    drawContext.getTransform().mo3820scale0AR0LA0(f, f2, jM3060getZeroF1C5BW0);
                    root.draw(drawScope);
                } finally {
    ...
    public final int m4038getCacheBitmapConfig_sVssgQ$ui_release() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo3153getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m3553getArgb8888_sVssgQ();
    }
    ...
    public final long m4039getViewportSizeNHjbRc$ui_release() {
        return ((Size) this.viewportSize.getValue()).getPackedValue();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m4040setViewportSizeuvyYCjk$ui_release(long j) {
        this.viewportSize.setValue(Size.m3101boximpl(j));
    }

    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        int iM3553getArgb8888_sVssgQ;
        if (this.root.getIsTintable() && this.root.getTintColor() != 16 && VectorKt.tintableWithAlphaMask(getIntrinsicColorFilter$ui_release()) && VectorKt.tintableWithAlphaMask(colorFilter)) {
            iM3553getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m3552getAlpha8_sVssgQ();
        } else {
            iM3553getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m3553getArgb8888_sVssgQ();
        }
        int i = iM3553getArgb8888_sVssgQ;
        if (this.isDirty || !Size.m3109equalsimpl0(this.previousDrawSize, drawScope.mo3806getSizeNHjbRc()) || !ImageBitmapConfig.m3548equalsimpl0(i, m4038getCacheBitmapConfig_sVssgQ$ui_release())) {
            this.tintFilter = ImageBitmapConfig.m3548equalsimpl0(i, ImageBitmapConfig.INSTANCE.m3552getAlpha8_sVssgQ()) ? ColorFilter.Companion.m3365tintxETnrds$default(ColorFilter.INSTANCE, this.root.getTintColor(), 0, 2, null) : null;
            this.rootScaleX = Size.m3113getWidthimpl(drawScope.mo3806getSizeNHjbRc()) / Size.m3113getWidthimpl(m4039getViewportSizeNHjbRc$ui_release());
            this.rootScaleY = Size.m3110getHeightimpl(drawScope.mo3806getSizeNHjbRc()) / Size.m3110getHeightimpl(m4039getViewportSizeNHjbRc$ui_release());
            this.cacheDrawScope.m4021drawCachedImageFqjB98A(i, IntSizeKt.IntSize((int) Math.ceil(Size.m3113getWidthimpl(drawScope.mo3806getSizeNHjbRc())), (int) Math.ceil(Size.m3110getHeightimpl(drawScope.mo3806getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo3806getSizeNHjbRc();
        }
        if (colorFilter == null) {
    ...
    public String toString() {
        String str = "Params: \tname: " + this.name + "\n\tviewportWidth: " + Size.m3113getWidthimpl(m4039getViewportSizeNHjbRc$ui_release()) + "\n\tviewportHeight: " + Size.m3110getHeightimpl(m4039getViewportSizeNHjbRc$ui_release()) + "\n";
