...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m4056rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        ...
        long jM3360getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m3360getUnspecified0d7_KjU() : j;
        int iM3248getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m3248getSrcIn0nO6VwU() : i;
        ...
        VectorPainter vectorPainterM4057rememberVectorPaintervIP8VLU = m4057rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, jM3360getUnspecified0d7_KjU, iM3248getSrcIn0nO6VwU, false, function4, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return vectorPainterM4057rememberVectorPaintervIP8VLU;
    }

    /* JADX WARN: Removed duplicated region for block: B:49:0x00c5  */
    /* JADX WARN: Removed duplicated region for block: B:77:0x015d A[PHI: r4
      0x015d: PHI (r4v16 kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>) = 
      ...
      (r4v17 kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>)
     binds: [B:76:0x015b, B:72:0x0155] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private static final long m4054obtainSizePxVpY3zN4(Density density, float f, float f2) {
        return SizeKt.Size(density.mo397toPx0680j_4(f), density.mo397toPx0680j_4(f2));
    }

    /* renamed from: obtainViewportSize-Pq9zytI, reason: not valid java name */
    private static final long m4055obtainViewportSizePq9zytI(long j, float f, float f2) {
        if (Float.isNaN(f)) {
            f = Size.m3113getWidthimpl(j);
        }
        if (Float.isNaN(f2)) {
            f2 = Size.m3110getHeightimpl(j);
        }
        return SizeKt.Size(f, f2);
    }

    /* renamed from: createColorFilter-xETnrds, reason: not valid java name */
    private static final ColorFilter m4053createColorFilterxETnrds(long j, int i) {
        if (j != 16) {
            return ColorFilter.INSTANCE.m3368tintxETnrds(j, i);
        }
        return null;
    }

    /* renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m4051configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z) {
        vectorPainter.m4049setSizeuvyYCjk$ui_release(j);
        vectorPainter.setAutoMirror$ui_release(z);
        vectorPainter.setIntrinsicColorFilter$ui_release(colorFilter);
        vectorPainter.m4050setViewportSizeuvyYCjk$ui_release(j2);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long jM4054obtainSizePxVpY3zN4 = m4054obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        return m4051configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), jM4054obtainSizePxVpY3zN4, m4055obtainViewportSizePq9zytI(jM4054obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m4053createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m4035setPathFillTypeoQ8Xj4U(vectorPath.getPathFillType());
                ...
                pathComponent.m4036setStrokeLineCapBeK7IIE(vectorPath.getStrokeLineCap());
                pathComponent.m4037setStrokeLineJoinWw9F2mQ(vectorPath.getStrokeLineJoin());
    ...
    */
    ...
    private static final void mirror(DrawScope drawScope, Function1<? super DrawScope, Unit> function1) {
        long jMo3805getCenterF1C5BW0 = drawScope.mo3805getCenterF1C5BW0();
        DrawContext drawContext = drawScope.getDrawContext();
        long jMo3813getSizeNHjbRc = drawContext.mo3813getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo3820scale0AR0LA0(-1.0f, 1.0f, jMo3805getCenterF1C5BW0);
