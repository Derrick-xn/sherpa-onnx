...
public final class PathComponent extends VNode {
    ...
    public final void m4035setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo3179setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m4036setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m4037setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo3177getFillTypeRgk1Os = this.renderPath.mo3177getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo3179setFillTypeoQ8Xj4U(iMo3177getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.CC.m3886drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.CC.m3886drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
