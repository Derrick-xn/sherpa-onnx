...
public final class DrawCache {
    ...
    private int config = ImageBitmapConfig.INSTANCE.m3553getArgb8888_sVssgQ();
    ...
    public final void m4021drawCachedImageFqjB98A(int config, long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap imageBitmapM3558ImageBitmapx__hDU$default = this.mCachedImage;
        Canvas Canvas = this.cachedCanvas;
        if (imageBitmapM3558ImageBitmapx__hDU$default == null || Canvas == null || IntSize.m6018getWidthimpl(size) > imageBitmapM3558ImageBitmapx__hDU$default.getWidth() || IntSize.m6017getHeightimpl(size) > imageBitmapM3558ImageBitmapx__hDU$default.getHeight() || !ImageBitmapConfig.m3548equalsimpl0(this.config, config)) {
            imageBitmapM3558ImageBitmapx__hDU$default = ImageBitmapKt.m3558ImageBitmapx__hDU$default(IntSize.m6018getWidthimpl(size), IntSize.m6017getHeightimpl(size), config, false, null, 24, null);
            Canvas = CanvasKt.Canvas(imageBitmapM3558ImageBitmapx__hDU$default);
            this.mCachedImage = imageBitmapM3558ImageBitmapx__hDU$default;
            this.cachedCanvas = Canvas;
            this.config = config;
        }
        this.size = size;
        CanvasDrawScope canvasDrawScope = this.cacheScope;
        long jM6030toSizeozmzZPI = IntSizeKt.m6030toSizeozmzZPI(size);
        ...
        imageBitmapM3558ImageBitmapx__hDU$default.prepareToDraw();
    }
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.CC.m3880drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.CC.m3891drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m3350getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m3223getClear0nO6VwU(), 62, null);
    }
}