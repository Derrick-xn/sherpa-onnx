...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m3686getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m3697getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m3248getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m3359getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m3616getNonZeroRgk1Os();
    ...
    public static final boolean m4045rgbEqualOWjLjI(long j, long j2) {
        return Color.m3330getRedimpl(j) == Color.m3330getRedimpl(j2) && Color.m3329getGreenimpl(j) == Color.m3329getGreenimpl(j2) && Color.m3327getBlueimpl(j) == Color.m3327getBlueimpl(j2);
    }

    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        if (colorFilter instanceof BlendModeColorFilter) {
            BlendModeColorFilter blendModeColorFilter = (BlendModeColorFilter) colorFilter;
            if (BlendMode.m3219equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m3248getSrcIn0nO6VwU()) || BlendMode.m3219equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m3250getSrcOver0nO6VwU())) {
                return true;
            }
