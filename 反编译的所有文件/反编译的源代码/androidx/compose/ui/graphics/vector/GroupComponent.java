...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m3360getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m4022markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m4022markTintForColor8_81llA(long color) {
        if (this.isTintable && color != 16) {
            long j = this.tintColor;
            if (j == 16) {
                this.tintColor = color;
            } else {
                if (VectorKt.m4045rgbEqualOWjLjI(j, color)) {
                    return;
                }
                markNotTintable();
            }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m4022markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        float[] fArrM3563constructorimpl$default = this.groupMatrix;
        if (fArrM3563constructorimpl$default == null) {
            fArrM3563constructorimpl$default = Matrix.m3563constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM3563constructorimpl$default;
        } else {
            Matrix.m3572resetimpl(fArrM3563constructorimpl$default);
        }
        Matrix.m3583translateimpl$default(fArrM3563constructorimpl$default, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m3575rotateZimpl(fArrM3563constructorimpl$default, this.rotation);
        Matrix.m3576scaleimpl(fArrM3563constructorimpl$default, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3583translateimpl$default(fArrM3563constructorimpl$default, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        try {
            ...
            if (fArr != null) {
                transform.mo3821transform58bKbWc((fArr != null ? Matrix.m3561boximpl(fArr) : null).m3584unboximpl());
            }
            Path path = this.clipPath;
            if (getWillClipPath() && path != null) {
                DrawTransform.CC.m3950clipPathmtrdDE$default(transform, path, 0, 2, null);
            }
