...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4062getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m3686getButtKaPHkGw();
        }
        return m4061getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4061getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m3686getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m3688getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m3687getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m4064getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m3697getMiterLxFBmk8();
        }
        return m4063getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4063getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m3697getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m3696getBevelLxFBmk8();
        }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) throws XmlPullParserException {
        long jM3360getUnspecified0d7_KjU;
        int iM3248getSrcIn0nO6VwU;
        ...
        if (typedArrayObtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type != 2 && (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                jM3360getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
            } else {
                jM3360getUnspecified0d7_KjU = Color.INSTANCE.m3360getUnspecified0d7_KjU();
            }
        } else {
            jM3360getUnspecified0d7_KjU = Color.INSTANCE.m3360getUnspecified0d7_KjU();
        }
        long j = jM3360getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            iM3248getSrcIn0nO6VwU = BlendMode.INSTANCE.m3248getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM3248getSrcIn0nO6VwU = BlendMode.INSTANCE.m3250getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM3248getSrcIn0nO6VwU = BlendMode.INSTANCE.m3248getSrcIn0nO6VwU();
        } else if (i == 9) {
            iM3248getSrcIn0nO6VwU = BlendMode.INSTANCE.m3247getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    iM3248getSrcIn0nO6VwU = BlendMode.INSTANCE.m3239getModulate0nO6VwU();
                    break;
                case 15:
                    iM3248getSrcIn0nO6VwU = BlendMode.INSTANCE.m3244getScreen0nO6VwU();
                    break;
                case 16:
                    iM3248getSrcIn0nO6VwU = BlendMode.INSTANCE.m3242getPlus0nO6VwU();
                    break;
                default:
                    iM3248getSrcIn0nO6VwU = BlendMode.INSTANCE.m3248getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = iM3248getSrcIn0nO6VwU;
        float fM5844constructorimpl = Dp.m5844constructorimpl(dimension / resources.getDisplayMetrics().density);
        float fM5844constructorimpl2 = Dp.m5844constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM5844constructorimpl, fM5844constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM4061getStrokeLineCapCSYIeUk = m4061getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m3686getButtKaPHkGw());
        int iM4063getStrokeLineJoinkLtJ_vA = m4063getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m3696getBevelLxFBmk8());
        ...
        builder.m4029addPathoIyEayM(list, namedInt == 0 ? companion.m3616getNonZeroRgk1Os() : companion.m3615getEvenOddRgk1Os(), str, brushObtainBrushFromComplexColor, namedFloat, brushObtainBrushFromComplexColor2, namedFloat3, namedFloat4, iM4061getStrokeLineCapCSYIeUk, iM4063getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
