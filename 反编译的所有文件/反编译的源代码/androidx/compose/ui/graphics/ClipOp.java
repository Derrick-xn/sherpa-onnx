...
public final class ClipOp {
    ...
    private static final int Difference = m3306constructorimpl(0);
    private static final int Intersect = m3306constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ClipOp m3305boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public static String m3310toStringimpl(int i) {
        return m3308equalsimpl0(i, Difference) ? "Difference" : m3308equalsimpl0(i, Intersect) ? "Intersect" : "Unknown";
    }
}