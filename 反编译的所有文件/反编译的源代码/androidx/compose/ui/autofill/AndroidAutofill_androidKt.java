...
public final class AndroidAutofill_androidKt {
    public static final void populateViewStructure(AndroidAutofill androidAutofill, ViewStructure viewStructure) {
        ...
        for (Map.Entry<Integer, AutofillNode> entry : androidAutofill.getAutofillTree().getChildren().entrySet()) {
            ...
            if (viewStructureNewChild != null) {
                ...
                AutofillApi26Helper.INSTANCE.setAutofillType(viewStructureNewChild, ContentDataType.INSTANCE.m2913getTextA48pgw8());
                ...
                if (boundingBox == null) {
                    ...
                    int iRound4 = Math.round(boundingBox.getBottom()) - iRound2;
                    AutofillApi23Helper.INSTANCE.setDimens(viewStructureNewChild, iRound, iRound2, 0, 0, iRound3 - iRound, iRound4);
                }
            }
            iAddChildCount++;
        }
    ...
    public static final void performAutofill(AndroidAutofill androidAutofill, SparseArray<AutofillValue> sparseArray) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            AutofillValue autofillValueM3199m = Api26Bitmap$$ExternalSyntheticApiModelOutline0.m3199m((Object) sparseArray.get(iKeyAt));
            if (AutofillApi26Helper.INSTANCE.isText(autofillValueM3199m)) {
                androidAutofill.getAutofillTree().performAutofill(iKeyAt, AutofillApi26Helper.INSTANCE.textValue(autofillValueM3199m).toString());
            } else {
                if (AutofillApi26Helper.INSTANCE.isDate(autofillValueM3199m)) {
                    throw new NotImplementedError("An operation is not implemented: b/138604541: Add onFill() callback for date");
                }
                if (AutofillApi26Helper.INSTANCE.isList(autofillValueM3199m)) {
                    throw new NotImplementedError("An operation is not implemented: b/138604541: Add onFill() callback for list");
                }
                if (AutofillApi26Helper.INSTANCE.isToggle(autofillValueM3199m)) {
