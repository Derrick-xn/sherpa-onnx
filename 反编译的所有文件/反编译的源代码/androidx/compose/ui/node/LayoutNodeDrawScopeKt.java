...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode delegatableNode) {
        ...
        int iM4922constructorimpl2 = NodeKind.m4922constructorimpl(2);
        Modifier.Node child = delegatableNode.getNode().getChild();
        if (child == null || (child.getAggregateChildKindSet() & iM4922constructorimpl) == 0) {
            return null;
        }
        while (child != null && (child.getKindSet() & iM4922constructorimpl2) == 0) {
