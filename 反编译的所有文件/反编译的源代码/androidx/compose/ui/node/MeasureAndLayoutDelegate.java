...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4877updateRootConstraintsBRTryo0(long constraints) {
        Constraints constraints2 = this.rootConstraints;
        if (constraints2 != null && Constraints.m5780equalsimpl0(constraints2.getValue(), constraints)) {
            return;
        }
        if (!(!this.duringMeasureLayout)) {
            InlineClassHelperKt.throwIllegalArgumentException("updateRootConstraints called while measuring");
        }
        this.rootConstraints = Constraints.m5775boximpl(constraints);
    ...
    private final boolean m4874doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM4837lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            zM4837lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4841lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM4837lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4837lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM4837lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM4837lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m4875doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM4838remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            zM4838remeasure_Sx5XlM$ui_release$default = layoutNode.m4842remeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM4838remeasure_Sx5XlM$ui_release$default = LayoutNode.m4838remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM4838remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM4838remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m4876measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m4874doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m5775boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m4875doRemeasuresdFAvZA(layoutNode, Constraints.m5775boximpl(constraints));
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        if (layoutNode.isPlaced() || layoutNode.isPlacedByParent() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (affectsLookahead) {
                zM4874doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m4874doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
                if (relayoutNeeded && ((zM4874doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true))) {
                    layoutNode.lookaheadReplace$ui_release();
                }
            } else {
                boolean zM4875doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m4875doRemeasuresdFAvZA(layoutNode, constraints) : false;
                ...
                zM4874doLookaheadRemeasuresdFAvZA = zM4875doRemeasuresdFAvZA;
            }
            drainPostponedMeasureRequests();
        }
        return zM4874doLookaheadRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m4874doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m4875doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
