...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo4680measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateImpl.m4748setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo61measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), constraints));
    ...
    public Placeable mo4680measureBRTryo0(long constraints) {
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints = lookaheadDelegate.m4868getConstraintsmsEJaDk$ui_release();
        }
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo61measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), constraints));
        onMeasured();
        return this;
    }
    ...
    */
    public void mo4830hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator.HitTestSource r16, long r17, androidx.compose.ui.node.HitTestResult r19, boolean r20, boolean r21) {
        /*
            r15 = this;
            r0 = r15
            r8 = r17
            ...
            r3 = 0
            if (r1 == 0) goto L34
            boolean r1 = r15.m4916withinLayerBoundsk4lQ0M(r8)
            if (r1 == 0) goto L1b
            r11 = r21
            r3 = 1
            goto L36
        L1b:
            if (r20 == 0) goto L34
            long r4 = r15.m4907getMinimumTouchTargetSizeNHjbRc()
            float r1 = r15.m4904distanceInMinimumTouchTargettz77jQw(r8, r4)
        ...
        L50:
            ...
            r6 = r20
            r7 = r11
            r1.mo4917childHitTestYqVAtuI(r2, r3, r5, r6, r7)
        ...
        L80:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.InnerNodeCoordinator.mo4830hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator$HitTestSource, long, androidx.compose.ui.node.HitTestResult, boolean, boolean):void");
    }
    ...
    static {
        ...
        Paint.mo3165setColor8_81llA(Color.INSTANCE.m3358getRed0d7_KjU());
