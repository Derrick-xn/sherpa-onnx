...
public final class NodeKindKt {
    ...
    public static final boolean m4930contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m4932or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int iM4922constructorimpl = NodeKind.m4922constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(256);
        }
        if (node instanceof ApproachLayoutModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(32768);
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            iM4922constructorimpl |= NodeKind.m4922constructorimpl(131072);
        }
        int iM4922constructorimpl2 = node instanceof TraversableNode ? NodeKind.m4922constructorimpl(262144) | iM4922constructorimpl : iM4922constructorimpl;
        mutableObjectIntMap.set(objClassKeyForObject, iM4922constructorimpl2);
        return iM4922constructorimpl2;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m4922constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m4808requireCoordinator64DMado(node, NodeKind.m4922constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m4922constructorimpl(128) & i) != 0 && (node instanceof LayoutAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m4922constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateOnPositioned$ui_release();
            }
            if ((NodeKind.m4922constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m4922constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m4922constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m4922constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode) && i2 != 2) {
                FocusTargetNodeKt.invalidateFocusTarget((FocusTargetNode) node);
            }
            if ((NodeKind.m4922constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m4922constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m4931getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m4922constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? iM4922constructorimpl | NodeKind.m4922constructorimpl(128) : iM4922constructorimpl;
    }
}