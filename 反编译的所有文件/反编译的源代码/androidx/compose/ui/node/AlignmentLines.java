...
public abstract class AlignmentLines {
    ...
    protected abstract long mo4793calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo4793calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            fM3044getXimpl = Offset.m3045getYimpl(jOffset);
        } else {
            fM3044getXimpl = Offset.m3044getXimpl(jOffset);
        }
        int iRound = Math.round(fM3044getXimpl);
