...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode, MotionReferencePlacementDelegate {
    ...
    public final int get(AlignmentLine alignmentLine) {
        ...
        if (alignmentLine instanceof VerticalAlignmentLine) {
            iM5977getYimpl = IntOffset.m5976getXimpl(getApparentToRealOffset());
        } else {
            iM5977getYimpl = IntOffset.m5977getYimpl(getApparentToRealOffset());
        }
        return iCalculateAlignmentLine + iM5977getYimpl;
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void captureRulers$ui_release(androidx.compose.ui.layout.MeasureResult r15) {
        /*
            r14 = this;
            if (r15 == 0) goto Lb
            androidx.compose.ui.node.PlaceableResult r0 = new androidx.compose.ui.node.PlaceableResult
            r0.<init>(r15, r14)
            r14.captureRulers(r0)
            goto L64
        Lb:
            androidx.collection.MutableScatterMap<androidx.compose.ui.layout.Ruler, androidx.collection.MutableScatterSet<java.lang.ref.WeakReference<androidx.compose.ui.node.LayoutNode>>> r15 = r14.rulerReaders
            if (r15 == 0) goto L56
        ...
        L56:
            ...
            r15.clear()
        L5d:
            androidx.collection.MutableObjectFloatMap<androidx.compose.ui.layout.Ruler> r15 = r14.rulerValues
            if (r15 == 0) goto L64
            r15.clear()
        L64:
            return
