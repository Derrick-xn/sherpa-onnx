...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo61measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) m4844measure3p2s80s(measureScope, (List<? extends Measurable>) list, j);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m4844measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo4843getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m5952getZeroMYxV2XQ();
        }
    };
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        ...
        if (!this.nodes.m4883hasH91voCI$ui_release(NodeKind.m4922constructorimpl(8)) || this._collapsedSemantics != null) {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1
            ...
            public final void invoke2() {
                ...
                int iM4922constructorimpl = NodeKind.m4922constructorimpl(8);
                Ref.ObjectRef<SemanticsConfiguration> objectRef2 = objectRef;
                if ((nodes.getAggregateChildKindSet() & iM4922constructorimpl) != 0) {
                    for (Modifier.Node tail = nodes.getTail(); tail != null; tail = tail.getParent()) {
                        if ((tail.getKindSet() & iM4922constructorimpl) != 0) {
    ...
    */
    ...
    public final void detach$ui_release() {
        ...
        if (this.nodes.m4883hasH91voCI$ui_release(NodeKind.m4922constructorimpl(8))) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long jM4906getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m4906getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m5785getHasFixedWidthimpl(jM4906getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m5784getHasFixedHeightimpl(jM4906getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4845maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4846maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4847minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4848minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        /* renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m4848minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicHeight, reason: collision with other method in class */
        public Void m4847minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicWidth, reason: collision with other method in class */
        public Void m4846maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m4845maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    public void setDensity(Density density) {
        ...
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if ((NodeKind.m4922constructorimpl(16) & head.getKindSet()) != 0) {
    ...
    public void setLayoutDirection(LayoutDirection layoutDirection) {
        if (this.layoutDirection != layoutDirection) {
            ...
            if ((nodeChain.getAggregateChildKindSet() & iM4922constructorimpl) != 0) {
                for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                    if ((head.getKindSet() & iM4922constructorimpl) != 0) {
                    ...
                    if ((head.getAggregateChildKindSet() & iM4922constructorimpl) == 0) {
                        return;
                    }
                }
            }
    ...
    public void setCompositionLocalMap(CompositionLocalMap compositionLocalMap) {
        ...
        NodeChain nodeChain = this.nodes;
        int iM4922constructorimpl = NodeKind.m4922constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & iM4922constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM4922constructorimpl) != 0) {
                    DelegatingNode delegatingNodePop = head;
    ...
    private final void applyModifier(Modifier modifier) {
        ...
        if (this.lookaheadRoot == null && this.nodes.m4883hasH91voCI$ui_release(NodeKind.m4922constructorimpl(512))) {
    ...
    public final void m4839hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        getOuterCoordinator$ui_release().m4909hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), NodeCoordinator.m4893fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null), hitTestResult, isTouchEvent, isInLayer);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m4840hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        getOuterCoordinator$ui_release().m4909hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), NodeCoordinator.m4893fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null), hitSemanticsEntities, true, isInLayer);
    }
    ...
    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m4922constructorimpl(1024) | NodeKind.m4922constructorimpl(2048) | NodeKind.m4922constructorimpl(4096))) {
            for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
                if (((NodeKind.m4922constructorimpl(1024) & head.getKindSet()) != 0) | ((NodeKind.m4922constructorimpl(2048) & head.getKindSet()) != 0) | ((NodeKind.m4922constructorimpl(4096) & head.getKindSet()) != 0)) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain nodeChain = this.nodes;
        int iM4922constructorimpl = NodeKind.m4922constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & iM4922constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM4922constructorimpl) != 0) {
                    DelegatingNode delegatingNodePop = head;
                    ...
                    while (delegatingNodePop != 0) {
                        if (delegatingNodePop instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m4808requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m4922constructorimpl(256)));
                        } else if ((delegatingNodePop.getKindSet() & iM4922constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
                            Modifier.Node delegate$ui_release = delegatingNodePop.getDelegate();
                            int i = 0;
                            delegatingNodePop = delegatingNodePop;
    ...
    public static /* synthetic */ boolean m4837lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4856getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m4841lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: lookaheadRemeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m4841lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m4860remeasureBRTryo0(constraints.getValue());
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release$default, reason: not valid java name */
    public static /* synthetic */ boolean m4838remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4855getLastConstraintsDWUhwKw();
        }
        return layoutNode.m4842remeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m4842remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate$ui_release().m4864remeasureBRTryo0(constraints.getValue());
    }
                ...
                if ((head.getKindSet() & iM4922constructorimpl) != 0) {
                    ...
                    while (delegatingNodePop != 0) {
                        if (delegatingNodePop instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m4808requireCoordinator64DMado((LayoutModifierNode) delegatingNodePop, NodeKind.m4922constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if ((delegatingNodePop.getKindSet() & iM4922constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
    ...
    public void forceRemeasure() {
        ...
        Constraints constraintsM4855getLastConstraintsDWUhwKw = this.layoutDelegate.m4855getLastConstraintsDWUhwKw();
        if (constraintsM4855getLastConstraintsDWUhwKw != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo4978measureAndLayout0kLqBqw(this, constraintsM4855getLastConstraintsDWUhwKw.getValue());
                return;
            }
            return;
        }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node nodeHeadNode = innerCoordinator$ui_release.headNode(zM4931getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & iM4922constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m4883hasH91voCI$ui_release(NodeKind.m4922constructorimpl(4)) && !this.nodes.m4883hasH91voCI$ui_release(NodeKind.m4922constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if ((NodeKind.m4922constructorimpl(2) & head.getKindSet()) != 0 && DelegatableNodeKt.m4808requireCoordinator64DMado(head, NodeKind.m4922constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((NodeKind.m4922constructorimpl(4) & head.getKindSet()) != 0) {
                return true;
            }
        }
        return true;
