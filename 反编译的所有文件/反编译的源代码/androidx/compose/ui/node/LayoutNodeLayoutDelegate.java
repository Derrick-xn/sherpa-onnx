...
public final class LayoutNodeLayoutDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            this.this$0.getOuterCoordinator().mo4680measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    ...
    public final Constraints m4855getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m4863getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m4856getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        private long lastPosition = IntOffset.INSTANCE.m5986getZeronOccac();
        ...
        private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m5986getZeronOccac();
            ...
            this.placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinatorBlock$1
                ...
                public final void invoke2() {
                    ...
                    if (graphicsLayer != null) {
                        placementScope2.m4764placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, graphicsLayer, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else if (function1 == null) {
                        placementScope2.m4755place70tqf50(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else {
                        placementScope2.m4763placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, function1);
                    }
                }
            };
        }
        ...
        /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m4863getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m5775boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo4680measureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                lookaheadPassDelegate.mo4680measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m4864remeasureBRTryo0(constraints);
            return this;
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m4864remeasureBRTryo0(long constraints) {
            boolean z = true;
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m5780equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            long jMo4682getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4682getSizeYbymL2g();
            m4748setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m4854performMeasureBRTryo0(constraints);
            if (IntSize.m6016equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4682getSizeYbymL2g(), jMo4682getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m4747setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        public void mo4681placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m4862placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        public void mo4746placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m4862placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        private final void m4862placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            Placeable.PlacementScope placementScope;
            this.isPlacedByParent = true;
            boolean z = false;
            if (!IntOffset.m5975equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate, IntOffset.m5976getXimpl(position), IntOffset.m5977getYimpl(position), 0.0f, 4, null);
            }
            ...
            m4861placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
        }

        /* renamed from: placeOuterCoordinator-MLgxB_4, reason: not valid java name */
        private final void m4861placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (!(!LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated())) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending() && getIsPlaced()) {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m4912placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
        ...
        public final void replace() {
            ...
            try {
                ...
                boolean isPlaced = getIsPlaced();
                m4861placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m4838remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadPassDelegate != null) {
                if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                    ...
                    mo4680measureBRTryo0(lookaheadConstraints.getValue());
                    return;
                } else {
                    if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InLayoutBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.LayingOut) {
                        ...
                        mo4680measureBRTryo0(lookaheadConstraints2.getValue());
                        return;
                    }
                    return;
                }
        ...
        public final void placeBasedOnLookahead() {
            LookaheadPassDelegate lookaheadPassDelegate = LayoutNodeLayoutDelegate.this.getLookaheadPassDelegate();
            if (lookaheadPassDelegate != null) {
                m4862placeSelfMLgxB_4(lookaheadPassDelegate.getLastPosition(), lookaheadPassDelegate.getLastZIndex(), lookaheadPassDelegate.getLastLayerBlock$ui_release(), lookaheadPassDelegate.getLastExplicitLayer());
            } else {
                InlineClassHelperKt.throwIllegalStateExceptionForNullCheck("invalid lookaheadDelegate");
                throw new KotlinNothingValueException();
            }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        */
        public androidx.compose.ui.layout.Placeable mo4680measureBRTryo0(long r4) {
            /*
                r3 = this;
            ...
            L51:
                r3.m4860remeasureBRTryo0(r4)
                r4 = r3
                androidx.compose.ui.layout.Placeable r4 = (androidx.compose.ui.layout.Placeable) r4
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.mo4680measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
        }
        ...
        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m4860remeasureBRTryo0(long constraints) {
            long jIntSize;
            ...
            LayoutNode parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release();
            LayoutNodeLayoutDelegate.this.layoutNode.setCanMultiMeasure$ui_release(LayoutNodeLayoutDelegate.this.layoutNode.getCanMultiMeasure() || (parent$ui_release != null && parent$ui_release.getCanMultiMeasure()));
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release() && (constraints2 = this.lookaheadConstraints) != null && Constraints.m5780equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m5775boximpl(constraints);
            m4748setMeasurementConstraintsBRTryo0(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            LayoutNodeLayoutDelegate.this.m4853performLookaheadMeasureBRTryo0(constraints);
            m4747setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m6018getWidthimpl(jIntSize) == lookaheadDelegate.getWidth() && IntSize.m6017getHeightimpl(jIntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo4681placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m4857placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo4746placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m4857placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
        private final void m4857placeSelfMLgxB_4(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (!(!LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated())) {
                InlineClassHelperKt.throwIllegalArgumentException("place is called on a deactivated node");
            }
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            this.onNodePlacedCalled = false;
            if (!IntOffset.m5975equalsimpl0(position, this.lastPosition)) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() && getIsPlaced()) {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m4871placeSelfApparentToRealOffsetgyyYBs$ui_release(position);
                onNodePlaced$ui_release();
            } else {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeSelf$2
                    ...
                    public final void invoke2() {
                        ...
                        Placeable.PlacementScope.m4749place70tqf50$default(placementScope, lookaheadDelegate3, j, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = position;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        LookaheadPassDelegate lookaheadPassDelegate = layoutNode2.getLayoutDelegate().getLookaheadPassDelegate();
                        Intrinsics.checkNotNull(lookaheadPassDelegate);
                        Constraints constraintsM4856getLastLookaheadConstraintsDWUhwKw = layoutNode2.getLayoutDelegate().m4856getLastLookaheadConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(constraintsM4856getLastLookaheadConstraintsDWUhwKw);
                        if (lookaheadPassDelegate.m4860remeasureBRTryo0(constraintsM4856getLastLookaheadConstraintsDWUhwKw.getValue())) {
        ...
        public final void replace() {
            ...
            try {
                ...
                this.onNodePlacedCalled = false;
                boolean isPlaced = getIsPlaced();
                m4857placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
                if (isPlaced && !this.onNodePlacedCalled && (parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release()) != null) {
                    LayoutNode.requestLookaheadRelayout$ui_release$default(parent$ui_release, false, 1, null);
                }
            } finally {
    ...
    public final void m4854performMeasureBRTryo0(long constraints) {
    ...
    public final void m4853performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo4680measureBRTryo0(constraints);
            }
        }, 2, null);
