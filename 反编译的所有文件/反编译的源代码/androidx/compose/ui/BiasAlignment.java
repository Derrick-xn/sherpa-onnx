...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo2890alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        float f;
        float fM6018getWidthimpl = (IntSize.m6018getWidthimpl(space) - IntSize.m6018getWidthimpl(size)) / 2.0f;
        float fM6017getHeightimpl = (IntSize.m6017getHeightimpl(space) - IntSize.m6017getHeightimpl(size)) / 2.0f;
        ...
        float f2 = 1;
        return IntOffsetKt.IntOffset(Math.round(fM6018getWidthimpl * (f + f2)), Math.round(fM6017getHeightimpl * (f2 + this.verticalBias)));
    }
