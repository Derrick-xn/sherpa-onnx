...
public final class RoundRectKt {
    ...
    public static final RoundRect m3098RoundRectgG7oq9Y(float f, float f2, float f3, float f4, long j) {
        return RoundRect(f, f2, f3, f4, CornerRadius.m3019getXimpl(j), CornerRadius.m3020getYimpl(j));
    }
    ...
    public static final RoundRect m3099RoundRectsniSvfs(Rect rect, long j) {
        return RoundRect(rect, CornerRadius.m3019getXimpl(j), CornerRadius.m3020getYimpl(j));
    }

    /* renamed from: RoundRect-ZAM2FJo, reason: not valid java name */
    public static final RoundRect m3096RoundRectZAM2FJo(Rect rect, long j, long j2, long j3, long j4) {
        return new RoundRect(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), j, j2, j3, j4, null);
    }

    /* renamed from: translate-Uv8p0NA, reason: not valid java name */
    public static final RoundRect m3100translateUv8p0NA(RoundRect roundRect, long j) {
        return new RoundRect(Offset.m3044getXimpl(j) + roundRect.getLeft(), Offset.m3045getYimpl(j) + roundRect.getTop(), Offset.m3044getXimpl(j) + roundRect.getRight(), Offset.m3045getYimpl(j) + roundRect.getBottom(), roundRect.m3094getTopLeftCornerRadiuskKHJgLs(), roundRect.m3095getTopRightCornerRadiuskKHJgLs(), roundRect.m3093getBottomRightCornerRadiuskKHJgLs(), roundRect.m3092getBottomLeftCornerRadiuskKHJgLs(), null);
    }
    ...
    public static final Rect getSafeInnerRect(RoundRect roundRect) {
        return new Rect(roundRect.getLeft() + (Math.max(CornerRadius.m3019getXimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs())) * 0.29289323f), roundRect.getTop() + (Math.max(CornerRadius.m3020getYimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()), CornerRadius.m3020getYimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs())) * 0.29289323f), roundRect.getRight() - (Math.max(CornerRadius.m3019getXimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()), CornerRadius.m3019getXimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs())) * 0.29289323f), roundRect.getBottom() - (Math.max(CornerRadius.m3020getYimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()), CornerRadius.m3020getYimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs())) * 0.29289323f));
    }
    ...
    public static final boolean isRect(RoundRect roundRect) {
        return (CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == 0.0f || CornerRadius.m3020getYimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == 0.0f) && (CornerRadius.m3019getXimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()) == 0.0f || CornerRadius.m3020getYimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()) == 0.0f) && ((CornerRadius.m3019getXimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs()) == 0.0f || CornerRadius.m3020getYimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs()) == 0.0f) && (CornerRadius.m3019getXimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()) == 0.0f || CornerRadius.m3020getYimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()) == 0.0f));
    }

    public static final boolean isEllipse(RoundRect roundRect) {
        return CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3019getXimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()) && CornerRadius.m3020getYimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3020getYimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()) && CornerRadius.m3019getXimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m3019getXimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()) && CornerRadius.m3020getYimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m3020getYimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()) && CornerRadius.m3019getXimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m3019getXimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs()) && CornerRadius.m3020getYimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m3020getYimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs()) && ((double) roundRect.getWidth()) <= ((double) CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs())) * 2.0d && ((double) roundRect.getHeight()) <= ((double) CornerRadius.m3020getYimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs())) * 2.0d;
    }
    ...
    public static final boolean isSimple(RoundRect roundRect) {
        return CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3020getYimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) && CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3019getXimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()) && CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3020getYimpl(roundRect.m3095getTopRightCornerRadiuskKHJgLs()) && CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3019getXimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()) && CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3020getYimpl(roundRect.m3093getBottomRightCornerRadiuskKHJgLs()) && CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3019getXimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs()) && CornerRadius.m3019getXimpl(roundRect.m3094getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m3020getYimpl(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs());
    }

    public static final RoundRect lerp(RoundRect roundRect, RoundRect roundRect2, float f) {
        return new RoundRect(MathHelpersKt.lerp(roundRect.getLeft(), roundRect2.getLeft(), f), MathHelpersKt.lerp(roundRect.getTop(), roundRect2.getTop(), f), MathHelpersKt.lerp(roundRect.getRight(), roundRect2.getRight(), f), MathHelpersKt.lerp(roundRect.getBottom(), roundRect2.getBottom(), f), CornerRadiusKt.m3030lerp3Ry4LBc(roundRect.m3094getTopLeftCornerRadiuskKHJgLs(), roundRect2.m3094getTopLeftCornerRadiuskKHJgLs(), f), CornerRadiusKt.m3030lerp3Ry4LBc(roundRect.m3095getTopRightCornerRadiuskKHJgLs(), roundRect2.m3095getTopRightCornerRadiuskKHJgLs(), f), CornerRadiusKt.m3030lerp3Ry4LBc(roundRect.m3093getBottomRightCornerRadiuskKHJgLs(), roundRect2.m3093getBottomRightCornerRadiuskKHJgLs(), f), CornerRadiusKt.m3030lerp3Ry4LBc(roundRect.m3092getBottomLeftCornerRadiuskKHJgLs(), roundRect2.m3092getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }
}