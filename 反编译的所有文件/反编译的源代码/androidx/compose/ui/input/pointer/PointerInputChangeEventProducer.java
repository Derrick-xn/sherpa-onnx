...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long uptime;
        boolean down;
        long jMo4633screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(pointerInputEventData.m4564getIdJ3iCeTQ());
            if (pointerInputData == null) {
                uptime = pointerInputEventData.getUptime();
                jMo4633screenToLocalMKHz9U = pointerInputEventData.m4566getPositionF1C5BW0();
                down = false;
            } else {
                long uptime2 = pointerInputData.getUptime();
                uptime = uptime2;
                down = pointerInputData.getDown();
                jMo4633screenToLocalMKHz9U = positionCalculator.mo4633screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            longSparseArray.put(pointerInputEventData.m4564getIdJ3iCeTQ(), new PointerInputChange(pointerInputEventData.m4564getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m4566getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), uptime, jMo4633screenToLocalMKHz9U, down, false, pointerInputEventData.m4569getTypeT8wyACA(), pointerInputEventData.getHistorical(), pointerInputEventData.m4568getScrollDeltaF1C5BW0(), pointerInputEventData.m4565getOriginalEventPositionF1C5BW0(), null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(pointerInputEventData.m4564getIdJ3iCeTQ(), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m4567getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m4569getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(pointerInputEventData.m4564getIdJ3iCeTQ());
            }
        }
