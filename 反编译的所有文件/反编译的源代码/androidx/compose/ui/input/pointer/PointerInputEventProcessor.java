...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m4570processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m4571processBIzXfog(pointerInputEvent, positionCalculator, z);
    }

    /* renamed from: process-BIzXfog, reason: not valid java name */
    public final int m4571processBIzXfog(PointerInputEvent pointerEvent, PositionCalculator positionCalculator, boolean isInBounds) {
        boolean z;
        ...
        try {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (z || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChangeValueAt2)) {
                    this.root.m4839hitTestM_7yMNQ$ui_release(pointerInputChangeValueAt2.getPosition(), this.hitResult, (8 & 4) != 0 ? false : PointerType.m4622equalsimpl0(pointerInputChangeValueAt2.getType(), PointerType.INSTANCE.m4629getTouchT8wyACA()), (8 & 8) != 0);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m4477addHitPathQJqDSyo(pointerInputChangeValueAt2.getId(), this.hitResult, PointerEventKt.changedToDownIgnoreConsumed(pointerInputChangeValueAt2));
