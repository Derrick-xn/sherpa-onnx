...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public SuspendingPointerInputModifierNodeImpl(Object obj, Object obj2, Object[] objArr, Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        this.boundsSize = IntSize.INSTANCE.m6023getZeroYbymL2g();
    }
    ...
    public long mo388getExtendedTouchPaddingNHjbRc() {
        long jMo398toSizeXkaWNTQ = mo398toSizeXkaWNTQ(getViewConfiguration().mo4843getMinimumTouchTargetSizeMYxV2XQ());
        long boundsSize = getBoundsSize();
        return SizeKt.Size(Math.max(0.0f, Size.m3113getWidthimpl(jMo398toSizeXkaWNTQ) - IntSize.m6018getWidthimpl(boundsSize)) / 2.0f, Math.max(0.0f, Size.m3110getHeightimpl(jMo398toSizeXkaWNTQ) - IntSize.m6017getHeightimpl(boundsSize)) / 2.0f);
    }
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public int mo390roundToPxR2X_6o(long j) {
            return this.$$delegate_0.mo390roundToPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: roundToPx-0680j_4 */
        public int mo391roundToPx0680j_4(float f) {
            return this.$$delegate_0.mo391roundToPx0680j_4(f);
        }

        @Override // androidx.compose.ui.unit.FontScaling
        /* renamed from: toDp-GaN1DYA */
        public float mo392toDpGaN1DYA(long j) {
            return this.$$delegate_0.mo392toDpGaN1DYA(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDp-u2uoSUM */
        public float mo393toDpu2uoSUM(float f) {
            return this.$$delegate_0.mo393toDpu2uoSUM(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDp-u2uoSUM */
        public float mo394toDpu2uoSUM(int i) {
            return this.$$delegate_0.mo394toDpu2uoSUM(i);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDpSize-k-rfVVM */
        public long mo395toDpSizekrfVVM(long j) {
            return this.$$delegate_0.mo395toDpSizekrfVVM(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toPx--R2X_6o */
        public float mo396toPxR2X_6o(long j) {
            return this.$$delegate_0.mo396toPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toPx-0680j_4 */
        public float mo397toPx0680j_4(float f) {
            return this.$$delegate_0.mo397toPx0680j_4(f);
        }
        ...
        public long mo398toSizeXkaWNTQ(long j) {
            return this.$$delegate_0.mo398toSizeXkaWNTQ(j);
        }

        @Override // androidx.compose.ui.unit.FontScaling
        /* renamed from: toSp-0xMU5do */
        public long mo399toSp0xMU5do(float f) {
            return this.$$delegate_0.mo399toSp0xMU5do(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-kPz2Gy4 */
        public long mo400toSpkPz2Gy4(float f) {
            return this.$$delegate_0.mo400toSpkPz2Gy4(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-kPz2Gy4 */
        public long mo401toSpkPz2Gy4(int i) {
            return this.$$delegate_0.mo401toSpkPz2Gy4(i);
        }
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo4445getExtendedTouchPaddingNHjbRc() {
            return SuspendingPointerInputModifierNodeImpl.this.mo388getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m6309constructorimpl(event));
        }
        ...
        */
        public <T> java.lang.Object withTimeoutOrNull(long r5, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super T> r8) throws java.lang.Throwable {
            /*
                r4 = this;
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public <T> java.lang.Object withTimeout(long r11, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super T> r14) throws java.lang.Throwable {
            /*
                r10 = this;
            ...
            L38:
                ...
                java.lang.Object r2 = kotlin.Result.m6309constructorimpl(r2)
                r14.resumeWith(r2)
            L5b:
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) throws Throwable {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.INSTANCE;
            continuationCreateCoroutine.resumeWith(Result.m6309constructorimpl(Unit.INSTANCE));
            Unit unit = Unit.INSTANCE;
        }
