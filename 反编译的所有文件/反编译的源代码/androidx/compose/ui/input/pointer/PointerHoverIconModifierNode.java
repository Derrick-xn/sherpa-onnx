...
public final class PointerHoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public void mo233onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            if (PointerEventType.m4498equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4502getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m4498equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4503getExit7fucELk())) {
                onExit();
            }
        }
    }
