...
public final class HitPathTracker {
    ...
    public static /* synthetic */ void m4476addHitPathQJqDSyo$default(HitPathTracker hitPathTracker, long j, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        hitPathTracker.m4477addHitPathQJqDSyo(j, list, z);
    }
    ...
    */
    public final void m4477addHitPathQJqDSyo(long r18, java.util.List<? extends androidx.compose.ui.Modifier.Node> r20, boolean r21) {
        /*
            Method dump skipped, instructions count: 239
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.HitPathTracker.m4477addHitPathQJqDSyo(long, java.util.List, boolean):void");
    }
