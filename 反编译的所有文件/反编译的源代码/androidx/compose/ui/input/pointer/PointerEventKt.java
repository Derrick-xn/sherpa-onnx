...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        return !Offset.m3041equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.INSTANCE.m3060getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        return !Offset.m3041equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.INSTANCE.m3060getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long jM3048minusMKHz9U = Offset.m3048minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange.getPreviousPosition());
        return (z || !pointerInputChange.isConsumed()) ? jM3048minusMKHz9U : Offset.INSTANCE.m3060getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        if (Offset.m3041equalsimpl0(positionChange(pointerInputChange), Offset.INSTANCE.m3060getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m4493isOutOfBoundsO0kMr_c(PointerInputChange pointerInputChange, long j) {
        ...
        return fM3044getXimpl < 0.0f || fM3044getXimpl > ((float) IntSize.m6018getWidthimpl(j)) || fM3045getYimpl < 0.0f || fM3045getYimpl > ((float) IntSize.m6017getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m4494isOutOfBoundsjwHxaWs(PointerInputChange pointerInputChange, long j, long j2) {
        if (!PointerType.m4622equalsimpl0(pointerInputChange.getType(), PointerType.INSTANCE.m4629getTouchT8wyACA())) {
            return m4493isOutOfBoundsO0kMr_c(pointerInputChange, j);
        }
        long position = pointerInputChange.getPosition();
        float fM3044getXimpl = Offset.m3044getXimpl(position);
        float fM3045getYimpl = Offset.m3045getYimpl(position);
        return fM3044getXimpl < (-Size.m3113getWidthimpl(j2)) || fM3044getXimpl > ((float) IntSize.m6018getWidthimpl(j)) + Size.m3113getWidthimpl(j2) || fM3045getYimpl < (-Size.m3110getHeightimpl(j2)) || fM3045getYimpl > ((float) IntSize.m6017getHeightimpl(j)) + Size.m3110getHeightimpl(j2);
    }
}