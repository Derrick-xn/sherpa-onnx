...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        ...
        this.currentPointerPositionAccumulator = Offset.INSTANCE.m3060getZeroF1C5BW0();
    }
    ...
    public final void m4652setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m4648addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m3044getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m3045getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m4649calculateVelocity9UxMQ8M() {
        return m4650calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m4650calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m6085getXimpl(maximumVelocity) > 0.0f && Velocity.m6086getYimpl(maximumVelocity) > 0.0f)) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m6092toStringimpl(maximumVelocity)));
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m6085getXimpl(maximumVelocity)), this.yVelocityTracker.calculateVelocity(Velocity.m6086getYimpl(maximumVelocity)));
    }
