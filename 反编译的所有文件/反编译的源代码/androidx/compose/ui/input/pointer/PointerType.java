...
public final class PointerType {
    ...
    private static final int Unknown = m4620constructorimpl(0);
    private static final int Touch = m4620constructorimpl(1);
    private static final int Mouse = m4620constructorimpl(2);
    private static final int Stylus = m4620constructorimpl(3);
    private static final int Eraser = m4620constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerType m4619boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4620constructorimpl(int i) {
        return i;
    }
