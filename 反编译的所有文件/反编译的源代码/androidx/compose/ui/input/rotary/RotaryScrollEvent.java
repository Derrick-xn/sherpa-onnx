...
public final class RotaryScrollEvent {
    ...
    public int hashCode() {
        return (((((Float.floatToIntBits(this.verticalScrollPixels) * 31) + Float.floatToIntBits(this.horizontalScrollPixels)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.uptimeMillis)) * 31) + this.inputDeviceId;
    }
