...
final class InterceptedKeyInputNode extends Modifier.Node implements SoftKeyboardInterceptionModifierNode {
    ...
    public boolean mo4089onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
    ...
    public boolean mo4090onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
