...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m3045getYimpl(targetCoordinates.mo4683localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(IntSize.m6018getWidthimpl(sourceCoordinates.mo4682getSizeYbymL2g()) / 2.0f, coordinate)));
    }
}