...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public /* synthetic */ long mo132localLookaheadPositionOfauaQtc(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        return LookaheadScopeKt.m4715localLookaheadPositionOfFgt4K4Q(this, layoutCoordinates, layoutCoordinates2, j, z);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo390roundToPxR2X_6o(long j) {
        return this.coordinator.mo390roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo391roundToPx0680j_4(float f) {
        return this.coordinator.mo391roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo392toDpGaN1DYA(long j) {
        return this.coordinator.mo392toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo393toDpu2uoSUM(float f) {
        return this.coordinator.mo393toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo394toDpu2uoSUM(int i) {
        return this.coordinator.mo394toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo395toDpSizekrfVVM(long j) {
        return this.coordinator.mo395toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo396toPxR2X_6o(long j) {
        return this.coordinator.mo396toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo397toPx0680j_4(float f) {
        return this.coordinator.mo397toPx0680j_4(f);
    }
    ...
    public long mo398toSizeXkaWNTQ(long j) {
        return this.coordinator.mo398toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo399toSp0xMU5do(float f) {
        return this.coordinator.mo399toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo400toSpkPz2Gy4(float f) {
        return this.coordinator.mo400toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo401toSpkPz2Gy4(int i) {
        return this.coordinator.mo401toSpkPz2Gy4(i);
    }
    ...
    public long mo4653getLookaheadConstraintsmsEJaDk() {
    ...
    public long mo4654getLookaheadSizeYbymL2g() {
