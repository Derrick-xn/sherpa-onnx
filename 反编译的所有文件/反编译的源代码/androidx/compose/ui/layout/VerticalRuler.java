...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m3044getXimpl(targetCoordinates.mo4683localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(coordinate, IntSize.m6017getHeightimpl(sourceCoordinates.mo4682getSizeYbymL2g()) / 2.0f)));
    }
}