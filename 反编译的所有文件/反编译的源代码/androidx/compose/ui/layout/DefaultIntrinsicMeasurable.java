...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo4680measureBRTryo0(long constraints) {
        ...
        if (intrinsicWidthHeight == intrinsicWidthHeight2) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, iM5787getMaxWidthimpl);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(iM5787getMaxWidthimpl, iMinIntrinsicHeight);
    }
