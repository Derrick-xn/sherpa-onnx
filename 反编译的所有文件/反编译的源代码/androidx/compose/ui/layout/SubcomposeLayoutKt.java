...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            int i5 = i3 << 3;
            SubcomposeLayout(subcomposeLayoutState, modifier, function2, composerStartRestartGroup, (i5 & 112) | (i5 & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m2784setimpl(composerM2777constructorimpl, subcomposeLayoutState, subcomposeLayoutState.getSetRoot$ui_release());
            Updater.m2784setimpl(composerM2777constructorimpl, compositionContextRememberCompositionContext, subcomposeLayoutState.getSetCompositionContext$ui_release());
            Updater.m2784setimpl(composerM2777constructorimpl, function2, subcomposeLayoutState.getSetMeasurePolicy$ui_release());
