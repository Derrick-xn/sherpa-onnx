...
public abstract class Placeable implements Measured {
    ...
    private long apparentToRealOffset = IntOffset.INSTANCE.m5986getZeronOccac();
    ...
    public abstract void mo4681placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock);
    ...
    public int getMeasuredWidth() {
        return IntSize.m6018getWidthimpl(this.measuredSize);
    }

    @Override // androidx.compose.ui.layout.Measured
    public int getMeasuredHeight() {
        return IntSize.m6017getHeightimpl(this.measuredSize);
    }
    ...
    protected final void m4747setMeasuredSizeozmzZPI(long j) {
        if (IntSize.m6016equalsimpl0(this.measuredSize, j)) {
            return;
        }
        this.measuredSize = j;
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m6018getWidthimpl(this.measuredSize), Constraints.m5789getMinWidthimpl(this.measurementConstraints), Constraints.m5787getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m6017getHeightimpl(this.measuredSize), Constraints.m5788getMinHeightimpl(this.measurementConstraints), Constraints.m5786getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m6018getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m6017getHeightimpl(this.measuredSize)) / 2);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: placeAt-f8xVGno, reason: not valid java name */
    public void mo4746placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        mo4681placeAtf8xVGno(position, zIndex, (Function1<? super GraphicsLayerScope, Unit>) null);
    }
    ...
    public final void m4748setMeasurementConstraintsBRTryo0(long j) {
        if (Constraints.m5780equalsimpl0(this.measurementConstraints, j)) {
            return;
        }
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m4750placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4760placeRelative70tqf50(placeable, j, f);
        }
        ...
        public final void placeRelative(Placeable placeable, int i, int i2, float f) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
            } else {
                long jIntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m5976getXimpl(jIntOffset), IntOffset.m5977getYimpl(jIntOffset));
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset2, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
            }
        }
        ...
        public static /* synthetic */ void m4749place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4755place70tqf50(placeable, j, f);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m4751placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4761placeRelativeWithLayeraW9wM(placeable, j, f2, (Function1<? super GraphicsLayerScope, Unit>) function1);
        }
        ...
        public final void placeRelativeWithLayer(Placeable placeable, int i, int i2, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset, placeable.apparentToRealOffset), f, function1);
            } else {
                long jIntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m5976getXimpl(jIntOffset), IntOffset.m5977getYimpl(jIntOffset));
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset2, placeable.apparentToRealOffset), f, function1);
            }
        }
        ...
        public static /* synthetic */ void m4753placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4763placeWithLayeraW9wM(placeable, j, f2, (Function1<? super GraphicsLayerScope, Unit>) function1);
        }
        ...
        public static /* synthetic */ void placeWithLayer$default(PlacementScope placementScope, Placeable placeable, int i, int i2, GraphicsLayer graphicsLayer, float f, int i3, Object obj) {
            ...
            placementScope.placeWithLayer(placeable, i, i2, graphicsLayer, (i3 & 8) != 0 ? 0.0f : f);
        }

        public final void placeWithLayer(Placeable placeable, int i, int i2, GraphicsLayer graphicsLayer, float f) {
            long jIntOffset = IntOffsetKt.IntOffset(i, i2);
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo4746placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset, placeable.apparentToRealOffset), f, graphicsLayer);
        }

        /* renamed from: placeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m4754placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, GraphicsLayer graphicsLayer, float f, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: placeWithLayer-aW-9-wM");
            }
            placementScope.m4764placeWithLayeraW9wM(placeable, j, graphicsLayer, (i & 4) != 0 ? 0.0f : f);
        }
        ...
        public static /* synthetic */ void placeRelativeWithLayer$default(PlacementScope placementScope, Placeable placeable, int i, int i2, GraphicsLayer graphicsLayer, float f, int i3, Object obj) {
            ...
            placementScope.placeRelativeWithLayer(placeable, i, i2, graphicsLayer, (i3 & 8) != 0 ? 0.0f : f);
        }
        ...
        public final void placeRelativeWithLayer(Placeable placeable, int i, int i2, GraphicsLayer graphicsLayer, float f) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                long jIntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m5976getXimpl(jIntOffset), IntOffset.m5977getYimpl(jIntOffset));
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4746placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset2, placeable.apparentToRealOffset), f, graphicsLayer);
            }
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m4752placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, GraphicsLayer graphicsLayer, float f, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: placeRelativeWithLayer-aW-9-wM");
            }
            placementScope.m4762placeRelativeWithLayeraW9wM(placeable, j, graphicsLayer, (i & 4) != 0 ? 0.0f : f);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4759placeAutoMirroredaW9wM$ui_release(Placeable placeable, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, function1);
            } else {
                long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m5976getXimpl(j), IntOffset.m5977getYimpl(j));
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset, placeable.apparentToRealOffset), f, function1);
            }
        }
        ...
        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4758placeAutoMirroredaW9wM$ui_release(Placeable placeable, long j, float f, GraphicsLayer graphicsLayer) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4746placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, graphicsLayer);
            } else {
                long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m5976getXimpl(j), IntOffset.m5977getYimpl(j));
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4746placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset, placeable.apparentToRealOffset), f, graphicsLayer);
        ...
        public final void m4757placeApparentToRealOffsetaW9wM$ui_release(Placeable placeable, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, function1);
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4756placeApparentToRealOffsetaW9wM$ui_release(Placeable placeable, long j, float f, GraphicsLayer graphicsLayer) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo4746placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, graphicsLayer);
        }
        ...
        public final void m4760placeRelative70tqf50(Placeable placeable, long j, float f) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
            } else {
                long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m5976getXimpl(j), IntOffset.m5977getYimpl(j));
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(jIntOffset, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
        ...
        public final void m4755place70tqf50(Placeable placeable, long j, float f) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4761placeRelativeWithLayeraW9wM(Placeable placeable, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, function1);
            } else {
        ...
        public final void m4763placeWithLayeraW9wM(Placeable placeable, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo4681placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, function1);
        }

        /* renamed from: placeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4764placeWithLayeraW9wM(Placeable placeable, long j, GraphicsLayer graphicsLayer, float f) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo4746placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, graphicsLayer);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4762placeRelativeWithLayeraW9wM(Placeable placeable, long j, GraphicsLayer graphicsLayer, float f) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo4746placeAtf8xVGno(IntOffset.m5980plusqkQi6aY(j, placeable.apparentToRealOffset), f, graphicsLayer);
            } else {
