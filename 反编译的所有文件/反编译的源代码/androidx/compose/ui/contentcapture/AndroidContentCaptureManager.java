    ...
    */
    private final void sendSemanticsStructureChangeEvents(androidx.compose.ui.semantics.SemanticsNode r18, androidx.compose.ui.platform.SemanticsNodeCopy r19) {
        ...
        L13:
            ...
            androidx.collection.IntObjectMap r7 = r17.getCurrentSemanticsNodes$ui_release()
            int r8 = r6.getId()
        ...
        La4:
            ...
            androidx.collection.IntObjectMap r5 = r17.getCurrentSemanticsNodes$ui_release()
            int r6 = r3.getId()
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final void sendContentCaptureStructureChangeEvents(androidx.compose.ui.semantics.SemanticsNode r17, androidx.compose.ui.platform.SemanticsNodeCopy r18) {
        /*
            r16 = this;
            r0 = r16
        ...
        Lc:
            ...
            androidx.collection.IntObjectMap r6 = r16.getCurrentSemanticsNodes$ui_release()
            int r7 = r5.getId()
            boolean r6 = r6.contains(r7)
            if (r6 == 0) goto L33
            androidx.collection.MutableIntSet r6 = r18.getChildren()
            int r7 = r5.getId()
            boolean r6 = r6.contains(r7)
            if (r6 != 0) goto L33
            r0.updateBuffersOnAppeared(r5)
        L33:
            int r4 = r4 + 1
            goto Lc
        L36:
        ...
        L5e:
            ...
            int r11 = r11 + r10
            r11 = r2[r11]
            androidx.collection.IntObjectMap r12 = r16.getCurrentSemanticsNodes$ui_release()
            boolean r12 = r12.contains(r11)
            if (r12 != 0) goto L7b
            r0.bufferContentCaptureViewDisappeared(r11)
        L7b:
            long r6 = r6 >> r9
            int r10 = r10 + 1
            goto L5e
        ...
        L8e:
            ...
            if (r5 == 0) goto Lc2
            androidx.compose.ui.platform.SemanticsNodeCopy r5 = (androidx.compose.ui.platform.SemanticsNodeCopy) r5
            r0.sendContentCaptureStructureChangeEvents(r4, r5)
            goto Lcd
        Lc2:
            java.lang.String r1 = "node not present in pruned tree before this change"
            androidx.compose.ui.internal.InlineClassHelperKt.throwIllegalStateExceptionForNullCheck(r1)
    ...
    */
    private final void updateSemanticsCopy() {
        /*
            ...
            androidx.collection.MutableIntObjectMap<androidx.compose.ui.platform.SemanticsNodeCopy> r1 = r0.previousSemanticsNodes
            r1.clear()
            androidx.collection.IntObjectMap r1 = r17.getCurrentSemanticsNodes$ui_release()
            int[] r2 = r1.keys
        ...
        L62:
            ...
            androidx.collection.IntObjectMap r3 = r17.getCurrentSemanticsNodes$ui_release()
            r1.<init>(r2, r3)
    ...
    private final ViewStructureCompat toViewStructure(SemanticsNode semanticsNode) {
        ...
        String strM5079toLegacyClassNameV4PA4sw;
        ...
        if (role != null && (strM5079toLegacyClassNameV4PA4sw = SemanticsUtils_androidKt.m5079toLegacyClassNameV4PA4sw(role.getValue())) != null) {
            viewStructureCompatNewVirtualViewStructure.setClassName(strM5079toLegacyClassNameV4PA4sw);
        }
        TextLayoutResult textLayoutResult = SemanticsUtils_androidKt.getTextLayoutResult(unmergedConfig);
        if (textLayoutResult != null) {
            TextLayoutInput layoutInput = textLayoutResult.getLayoutInput();
            viewStructureCompatNewVirtualViewStructure.setTextStyle(TextUnit.m6041getValueimpl(layoutInput.getStyle().m5329getFontSizeXSAIIZE()) * layoutInput.getDensity().getDensity() * layoutInput.getDensity().getFontScale(), 0, 0, 0);
        }
    ...
    static final class ViewTranslationHelperMethods {
        ...
        public final void onVirtualViewTranslationResponses(final AndroidContentCaptureManager contentCaptureManager, final LongSparseArray<ViewTranslationResponse> response) {
            ...
            if (Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
                ...
                contentCaptureManager.getView().post(new Runnable() { // from class: androidx.compose.ui.contentcapture.AndroidContentCaptureManager$ViewTranslationHelperMethods$$ExternalSyntheticLambda10
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        */
        public final void onCreateVirtualViewTranslationRequests(androidx.compose.ui.contentcapture.AndroidContentCaptureManager r21, long[] r22, int[] r23, java.util.function.Consumer<android.view.translation.ViewTranslationRequest> r24) {
            ...
            L4:
                ...
                if (r3 == 0) goto L78
                androidx.compose.ui.graphics.Api26Bitmap$$ExternalSyntheticApiModelOutline0.m3207m()
                androidx.compose.ui.platform.AndroidComposeView r4 = r21.getView()
                android.view.autofill.AutofillId r4 = androidx.compose.ui.graphics.Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(r4)
                int r5 = r3.getId()
                long r5 = (long) r5
                android.view.translation.ViewTranslationRequest$Builder r4 = androidx.compose.ui.graphics.Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(r4, r5)
                ...
                android.view.translation.TranslationRequestValue r3 = androidx.compose.ui.graphics.Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(r3)
                java.lang.String r5 = "android:text"
                androidx.compose.ui.graphics.Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(r4, r5, r3)
                android.view.translation.ViewTranslationRequest r3 = androidx.compose.ui.graphics.Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(r4)
                r4 = r24
                androidx.compose.ui.graphics.Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(r4, r3)
                goto L7a
            L78:
                r4 = r24
            L7a:
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        ...
                        SemanticsNodeWithAdjustedBounds semanticsNodeWithAdjustedBounds = newSemanticsNodes.get(i4);
