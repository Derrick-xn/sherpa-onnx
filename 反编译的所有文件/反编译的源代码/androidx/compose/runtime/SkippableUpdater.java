...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m2768boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m2769constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2770equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2771equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2772hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2773toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2770equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2772hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2773toStringimpl(this.composer);
    }
    ...
    public static final void m2774updateimpl(Composer composer, Function1<? super Updater<T>, Unit> function1) {
        composer.startReplaceableGroup(509942095);
        function1.invoke(Updater.m2776boximpl(Updater.m2777constructorimpl(composer)));
