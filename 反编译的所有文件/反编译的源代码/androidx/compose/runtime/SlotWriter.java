...
public final class SlotWriter {
    ...
    public static final class Companion {
        ...
        public final List<Anchor> moveGroup(SlotWriter fromWriter, int fromIndex, SlotWriter toWriter, boolean updateFromCursor, boolean updateToCursor, boolean removeSourceGroup) {
            ...
            int i4 = fromIndex + iGroupSize;
            int iDataIndex = fromWriter.dataIndex(fromIndex);
            int iDataIndex2 = fromWriter.dataIndex(i4);
            int i5 = iDataIndex2 - iDataIndex;
            ...
            if (fromWriter.slotsGapStart < iDataIndex2) {
                fromWriter.moveSlotGapTo(iDataIndex2, i4);
            }
            int[] iArr = toWriter.groups;
            int currentGroup = toWriter.getCurrentGroup();
            ArraysKt.copyInto(fromWriter.groups, iArr, currentGroup * 5, fromIndex * 5, i4 * 5);
            Object[] objArr = toWriter.slots;
            int i6 = toWriter.currentSlot;
            ArraysKt.copyInto(fromWriter.slots, objArr, i6, iDataIndex, iDataIndex2);
            int parent = toWriter.getParent();
            SlotTableKt.updateParentAnchor(iArr, currentGroup, parent);
            int i7 = currentGroup - fromIndex;
            int i8 = currentGroup + iGroupSize;
            int iDataIndex3 = i6 - toWriter.dataIndex(iArr, currentGroup);
            ...
            while (true) {
                ...
                if (i12 != currentGroup) {
                    i = i8;
                    SlotTableKt.updateParentAnchor(iArr, i12, SlotTableKt.parentAnchor(iArr, i12) + i7);
                } else {
                    i = i8;
                }
                int iDataIndex4 = toWriter.dataIndex(iArr, i12) + iDataIndex3;
                if (i11 < i12) {
                    i2 = iDataIndex3;
                    i3 = 0;
                } else {
                ...
                SlotTableKt.updateDataAnchor(iArr, i12, toWriter.dataIndexToDataAnchor(iDataIndex4, i3, i10, length));
                if (i12 == i11) {
                    i11++;
                }
                i12++;
            ...
            int iLocationOf2 = SlotTableKt.locationOf(fromWriter.anchors, i4, fromWriter.getSize$runtime_release());
            ...
            if (!arrayListEmptyList.isEmpty()) {
                ...
                if (map != null && map2 != null) {
                    ...
                    for (int i15 = 0; i15 < size; i15++) {
                        Anchor anchor2 = arrayListEmptyList.get(i15);
            ...
            if (removeSourceGroup) {
                if (!updateFromCursor) {
                    ...
                    fromWriter.removeSlots(iDataIndex, i5, fromIndex - 1);
                } else {
                    zRemoveGroups = iParent >= 0;
                    if (zRemoveGroups) {
    ...
    public final boolean removeGroups(int start, int len) {
        if (len > 0) {
            ...
            zRemoveAnchors = arrayList.isEmpty() ^ true ? removeAnchors(start, len, this.sourceInformationMap) : false;
