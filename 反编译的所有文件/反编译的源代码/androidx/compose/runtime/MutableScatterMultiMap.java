...
final class MutableScatterMultiMap<K, V> {
    ...
    public static final /* synthetic */ MutableScatterMultiMap m2757boximpl(MutableScatterMap mutableScatterMap) {
        return new MutableScatterMultiMap(mutableScatterMap);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <K, V> MutableScatterMap<K, Object> m2758constructorimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return mutableScatterMap;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2759equalsimpl(MutableScatterMap<K, Object> mutableScatterMap, Object obj) {
    ...
    public static final boolean m2760equalsimpl0(MutableScatterMap<K, Object> mutableScatterMap, MutableScatterMap<K, Object> mutableScatterMap2) {
        return Intrinsics.areEqual(mutableScatterMap, mutableScatterMap2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2761hashCodeimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return mutableScatterMap.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2764toStringimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return "MutableScatterMultiMap(map=" + mutableScatterMap + ')';
    }

    public boolean equals(Object obj) {
        return m2759equalsimpl(this.map, obj);
    }

    public int hashCode() {
        return m2761hashCodeimpl(this.map);
    }

    public String toString() {
        return m2764toStringimpl(this.map);
    }
    ...
    public static final V m2762popimpl(MutableScatterMap<K, Object> mutableScatterMap, K k) {
    ...
    public static final void m2763putimpl(MutableScatterMap<K, Object> mutableScatterMap, K k, V v) {
