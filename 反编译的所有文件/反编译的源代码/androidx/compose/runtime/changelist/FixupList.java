...
public final class FixupList extends OperationsDebugStringFormattable {
    ...
    public final void createAndInsertNode(Function0<? extends Object> factory, int insertIndex, Anchor groupAnchor) {
        ...
        Operations operationsM2860constructorimpl = Operations.WriteScope.m2860constructorimpl(operations3);
        Operation.InsertNodeFixup insertNodeFixup2 = Operation.InsertNodeFixup.INSTANCE;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), factory);
        Operation.InsertNodeFixup insertNodeFixup3 = Operation.InsertNodeFixup.INSTANCE;
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(0), insertIndex);
        Operation.InsertNodeFixup insertNodeFixup4 = Operation.InsertNodeFixup.INSTANCE;
        int i = 1;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(1), groupAnchor);
        if (!(operations3.pushedIntMask == operations3.createExpectedArgMask(insertNodeFixup.getInts()) && operations3.pushedObjectMask == operations3.createExpectedArgMask(insertNodeFixup.getObjects()))) {
            ...
            while (i3 < ints) {
                if (((i << i3) & operations3.pushedIntMask) != 0) {
                    ...
                    sb.append(insertNodeFixup.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i3)));
                    i2++;
                }
                i3++;
                i = 1;
            ...
            while (i5 < objects) {
                if (((1 << i5) & operations3.pushedObjectMask) != 0) {
                    ...
                    sb2.append(insertNodeFixup.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i5)));
                    i4++;
                } else {
                    operations2 = operations3;
                }
        ...
        Operations operationsM2860constructorimpl2 = Operations.WriteScope.m2860constructorimpl(operations4);
        Operation.PostInsertNodeFixup postInsertNodeFixup2 = Operation.PostInsertNodeFixup.INSTANCE;
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl2, Operation.IntParameter.m2817constructorimpl(0), insertIndex);
        Operation.PostInsertNodeFixup postInsertNodeFixup3 = Operation.PostInsertNodeFixup.INSTANCE;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl2, Operation.ObjectParameter.m2828constructorimpl(0), groupAnchor);
        ...
        for (int i7 = 0; i7 < ints2; i7++) {
            if (((1 << i7) & operations4.pushedIntMask) != 0) {
                ...
                sb3.append(postInsertNodeFixup.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i7)));
                i6++;
            }
        }
        ...
        while (i9 < objects2) {
            if (((1 << i9) & operations4.pushedObjectMask) != 0) {
                ...
                sb4.append(postInsertNodeFixup.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i9)));
                i8++;
            } else {
                operations = operations4;
            }
