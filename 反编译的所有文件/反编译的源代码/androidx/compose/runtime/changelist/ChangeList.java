...
public final class ChangeList extends OperationsDebugStringFormattable {
    ...
    public final void pushRemember(RememberObserver value) {
        ...
        Operations operationsM2860constructorimpl = Operations.WriteScope.m2860constructorimpl(operations);
        Operation.Remember remember2 = Operation.Remember.INSTANCE;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), value);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(remember.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(remember.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
    ...
    public final void pushUpdateValue(Object value, int groupSlotIndex) {
        ...
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(0), groupSlotIndex);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(updateValue.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(updateValue.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushUpdateAnchoredValue(Object value, Anchor anchor, int groupSlotIndex) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(1), anchor);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(updateAnchoredValue.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(updateAnchoredValue.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushAppendValue(Anchor anchor, Object value) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), anchor);
        Operation.AppendValue appendValue3 = Operation.AppendValue.INSTANCE;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(1), value);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(appendValue.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(appendValue.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushTrimValues(int count) {
        ...
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(0), count);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(trimParentValues.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(trimParentValues.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushUpdateAuxData(Object data) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), data);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(updateAuxData.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(updateAuxData.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushEnsureGroupStarted(Anchor anchor) {
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(ensureGroupStarted.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(ensureGroupStarted.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(1), from);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(insertSlots.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(insertSlots.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from, FixupList fixups) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(2), fixups);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(insertSlotsWithFixups.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(insertSlotsWithFixups.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushMoveCurrentGroup(int offset) {
        ...
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(0), offset);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(moveCurrentGroup.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(moveCurrentGroup.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushEndCompositionScope(Function1<? super Composition, Unit> action, Composition composition) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), action);
        Operation.EndCompositionScope endCompositionScope3 = Operation.EndCompositionScope.INSTANCE;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(1), composition);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(endCompositionScope.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(endCompositionScope.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final <T, V> void pushUpdateNode(V value, Function2<? super T, ? super V, Unit> block) {
        ...
        int iM2828constructorimpl = Operation.ObjectParameter.m2828constructorimpl(1);
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, iM2828constructorimpl, (Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(block, 2));
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(updateNode.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(updateNode.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushRemoveNode(int removeFrom, int moveCount) {
        ...
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(0), removeFrom);
        Operation.RemoveNode removeNode3 = Operation.RemoveNode.INSTANCE;
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(1), moveCount);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(removeNode.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(removeNode.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushMoveNode(int to, int from, int count) {
        ...
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(1), to);
        Operation.MoveNode moveNode3 = Operation.MoveNode.INSTANCE;
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(0), from);
        Operation.MoveNode moveNode4 = Operation.MoveNode.INSTANCE;
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(2), count);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(moveNode.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(moveNode.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushAdvanceSlotsBy(int distance) {
        ...
        Operations.WriteScope.m2865setIntA6tL2VI(operationsM2860constructorimpl, Operation.IntParameter.m2817constructorimpl(0), distance);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(advanceSlotsBy.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(advanceSlotsBy.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushUps(int count) {
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(ups.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(ups.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushDowns(Object[] nodes) {
        if (!(nodes.length == 0)) {
            ...
            Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), nodes);
            ...
            for (int i2 = 0; i2 < ints; i2++) {
                if (((1 << i2) & operations.pushedIntMask) != 0) {
                    ...
                    sb.append(downs.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                    i++;
                }
            }
            String string = sb.toString();
            ...
            for (int i4 = 0; i4 < objects; i4++) {
                if (((1 << i4) & operations.pushedObjectMask) != 0) {
                    ...
                    sb2.append(downs.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                    i3++;
                }
            }
            String string2 = sb2.toString();
    ...
    public final void pushSideEffect(Function0<Unit> effect) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), effect);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(sideEffect.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(sideEffect.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushDetermineMovableContentNodeIndex(IntRef effectiveNodeIndexOut, Anchor anchor) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), effectiveNodeIndexOut);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(determineMovableContentNodeIndex.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(determineMovableContentNodeIndex.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushCopyNodesToNewAnchorLocation(List<? extends Object> nodes, IntRef effectiveNodeIndex) {
        if (!nodes.isEmpty()) {
            ...
            Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(1), nodes);
            Operation.CopyNodesToNewAnchorLocation copyNodesToNewAnchorLocation3 = Operation.CopyNodesToNewAnchorLocation.INSTANCE;
            Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), effectiveNodeIndex);
            ...
            for (int i2 = 0; i2 < ints; i2++) {
                if (((1 << i2) & operations.pushedIntMask) != 0) {
                    ...
                    sb.append(copyNodesToNewAnchorLocation.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                    i++;
                }
            }
            String string = sb.toString();
            ...
            for (int i4 = 0; i4 < objects; i4++) {
                if (((1 << i4) & operations.pushedObjectMask) != 0) {
                    ...
                    sb2.append(copyNodesToNewAnchorLocation.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                    i3++;
                }
            }
            String string2 = sb2.toString();
    ...
    public final void pushCopySlotTableToAnchorLocation(MovableContentState resolvedState, CompositionContext parentContext, MovableContentStateReference from, MovableContentStateReference to) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), resolvedState);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation3 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(1), parentContext);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation4 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(3), to);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation5 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(2), from);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(copySlotTableToAnchorLocation.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(copySlotTableToAnchorLocation.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushReleaseMovableGroupAtCurrent(ControlledComposition composition, CompositionContext parentContext, MovableContentStateReference reference) {
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), composition);
        ...
        Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(2), reference);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(releaseMovableGroupAtCurrent.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(releaseMovableGroupAtCurrent.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushExecuteOperationsIn(ChangeList changeList, IntRef effectiveNodeIndex) {
        if (changeList.isNotEmpty()) {
            ...
            Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(0), changeList);
            Operation.ApplyChangeList applyChangeList3 = Operation.ApplyChangeList.INSTANCE;
            Operations.WriteScope.m2866setObjectDKhxnng(operationsM2860constructorimpl, Operation.ObjectParameter.m2828constructorimpl(1), effectiveNodeIndex);
            ...
            for (int i2 = 0; i2 < ints; i2++) {
                if (((1 << i2) & operations.pushedIntMask) != 0) {
                    ...
                    sb.append(applyChangeList.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                    i++;
                }
            }
            String string = sb.toString();
            ...
            for (int i4 = 0; i4 < objects; i4++) {
                if (((1 << i4) & operations.pushedObjectMask) != 0) {
                    ...
                    sb2.append(applyChangeList.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                    i3++;
                }
            }
            String string2 = sb2.toString();
