...
public abstract class Operation {
    ...
    public String mo2789intParamNamew8GmfQM(int parameter) {
        return "IntParameter(" + parameter + ')';
    }

    /* renamed from: objectParamName-31yXWZQ, reason: not valid java name */
    public String mo2790objectParamName31yXWZQ(int parameter) {
    ...
    public static final class IntParameter {
        ...
        public static final /* synthetic */ IntParameter m2816boximpl(int i) {
            return new IntParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m2817constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m2818equalsimpl(int i, Object obj) {
            return (obj instanceof IntParameter) && i == ((IntParameter) obj).m2822unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m2818equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m2820hashCodeimpl(this.offset);
        }

        public String toString() {
            return m2821toStringimpl(this.offset);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ int m2822unboximpl() {
            return this.offset;
        }
    ...
    public static final class ObjectParameter<T> {
        ...
        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ ObjectParameter m2827boximpl(int i) {
            return new ObjectParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static <T> int m2828constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m2829equalsimpl(int i, Object obj) {
            return (obj instanceof ObjectParameter) && i == ((ObjectParameter) obj).m2833unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m2830equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m2831hashCodeimpl(int i) {
            return i;
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m2832toStringimpl(int i) {
            return "ObjectParameter(offset=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m2829equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m2831hashCodeimpl(this.offset);
        }

        public String toString() {
            return m2832toStringimpl(this.offset);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ int m2833unboximpl() {
            return this.offset;
        }
    ...
    public static final class Ups extends Operation {
        ...
        public final int m2852getCountjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo2789intParamNamew8GmfQM(int parameter) {
            return IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(0)) ? "count" : super.mo2789intParamNamew8GmfQM(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int iMo2853getIntw8GmfQM = operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(0));
            for (int i = 0; i < iMo2853getIntw8GmfQM; i++) {
                applier.up();
            }
        }
    }
    ...
    public static final class Downs extends Operation {
        ...
        public final int m2804getNodesHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            for (Object obj : (Object[]) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0))) {
                applier.down(obj);
            }
        }
        ...
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "nodes" : super.mo2790objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class AdvanceSlotsBy extends Operation {
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo2789intParamNamew8GmfQM(int parameter) {
            return IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(0)) ? "distance" : super.mo2789intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.advanceBy(operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(0)));
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        public final int m2842getEffectHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "effect" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.sideEffect((Function0) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0)));
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        public final int m2839getValueHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "value" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.remembering((RememberObserver) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0)));
        }
    }
    ...
    public static final class AppendValue extends Operation {
        ...
        public final int m2792getAnchorHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m2793getValueHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "anchor" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "value" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Anchor anchor = (Anchor) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0));
            Object objMo2854getObject31yXWZQ = operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            if (objMo2854getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo2854getObject31yXWZQ).getWrapped());
            }
            slotWriter.appendSlot(anchor, objMo2854getObject31yXWZQ);
        }
    }
    ...
    public static final class TrimParentValues extends Operation {
        ...
        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m2843getCountjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            for (int iMax = Math.max(iSlotsStartIndex$runtime_release, iSlotsEndIndex$runtime_release - iMo2853getIntw8GmfQM); iMax < iSlotsEndIndex$runtime_release; iMax++) {
            ...
            slotWriter.trimTailSlots(iMo2853getIntw8GmfQM);
        }
    }
    ...
    public static final class UpdateValue extends Operation {
        ...
        public final int m2850getGroupSlotIndexjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo2789intParamNamew8GmfQM(int parameter) {
            return IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(0)) ? "groupSlotIndex" : super.mo2789intParamNamew8GmfQM(parameter);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object objMo2854getObject31yXWZQ = operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0));
            int iMo2853getIntw8GmfQM = operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(0));
            if (objMo2854getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo2854getObject31yXWZQ).getWrapped());
            }
            Object obj = slotWriter.set(iMo2853getIntw8GmfQM, objMo2854getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting(((RememberObserverHolder) obj).getWrapped(), slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(slotWriter.getCurrentGroup(), iMo2853getIntw8GmfQM), -1, -1);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
            }
        }
    ...
    public static final class UpdateAnchoredValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m2846getValueHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m2844getAnchorHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m2845getGroupSlotIndexjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "value" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "anchor" : super.mo2790objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            int slotsSize;
            Object objMo2854getObject31yXWZQ = operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            int iMo2853getIntw8GmfQM = operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(0));
            if (objMo2854getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo2854getObject31yXWZQ).getWrapped());
            }
            int iAnchorIndex2 = slotWriter.anchorIndex(anchor);
            Object obj = slotWriter.set(iAnchorIndex2, iMo2853getIntw8GmfQM, objMo2854getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                int slotsSize2 = slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(iAnchorIndex2, iMo2853getIntw8GmfQM);
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        public final int m2847getDataHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "data" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.updateAux(operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0)));
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m2807getAnchorHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "anchor" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0)));
        }
    }
    ...
    public static final class MoveCurrentGroup extends Operation {
        ...
        public final int m2823getOffsetjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo2789intParamNamew8GmfQM(int parameter) {
            return IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(0)) ? "offset" : super.mo2789intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.moveGroup(operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(0)));
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        public final int m2805getActionHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m2806getCompositionHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "anchor" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "composition" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function1) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0))).invoke((Composition) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1)));
        }
    }
    ...
    public static final class UpdateNode extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m2849getValueHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getBlock-HpuvwBQ, reason: not valid java name */
        public final int m2848getBlockHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "value" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "block" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function2) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1))).invoke(applier.getCurrent(), operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0)));
        }
    }
    ...
    public static final class RemoveNode extends Operation {
        ...
        public final int m2841getRemoveIndexjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m2840getCountjn0FJLE() {
            return IntParameter.m2817constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo2789intParamNamew8GmfQM(int parameter) {
            return IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(0)) ? "removeIndex" : IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(1)) ? "count" : super.mo2789intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.remove(operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(0)), operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(1)));
        }
    }
    ...
    public static final class MoveNode extends Operation {
        ...
        public final int m2825getFromjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }

        /* renamed from: getTo-jn0FJLE, reason: not valid java name */
        public final int m2826getTojn0FJLE() {
            return IntParameter.m2817constructorimpl(1);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m2824getCountjn0FJLE() {
            return IntParameter.m2817constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo2789intParamNamew8GmfQM(int parameter) {
            return IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(0)) ? "from" : IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(1)) ? "to" : IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(2)) ? "count" : super.mo2789intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.move(operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(0)), operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(1)), operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(2)));
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        public final int m2812getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "anchor" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "from" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0));
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m2813getAnchorHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m2815getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }

        /* renamed from: getFixups-HpuvwBQ, reason: not valid java name */
        public final int m2814getFixupsHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "anchor" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "from" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(2)) ? "fixups" : super.mo2790objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(2));
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        public final int m2808getFactoryHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m2810getInsertIndexjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m2809getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo2789intParamNamew8GmfQM(int parameter) {
            return IntParameter.m2819equalsimpl0(parameter, IntParameter.m2817constructorimpl(0)) ? "insertIndex" : super.mo2789intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "factory" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "groupAnchor" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object objInvoke = ((Function0) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0))).invoke();
            Anchor anchor = (Anchor) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            int iMo2853getIntw8GmfQM = operationArgContainer.mo2853getIntw8GmfQM(IntParameter.m2817constructorimpl(0));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            slotWriter.updateNode(anchor, objInvoke);
            applier.insertTopDown(iMo2853getIntw8GmfQM, objInvoke);
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m2835getInsertIndexjn0FJLE() {
            return IntParameter.m2817constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m2834getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "groupAnchor" : super.mo2790objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            applier.up();
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            applier.insertBottomUp(iMo2853getIntw8GmfQM, slotWriter.node(anchor));
        }
    }
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        public final int m2803getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m2802getAnchorHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "effectiveNodeIndexOut" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "anchor" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        public final int m2796getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getNodes-HpuvwBQ, reason: not valid java name */
        public final int m2797getNodesHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "effectiveNodeIndex" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "nodes" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int element = ((IntRef) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            int size = list.size();
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        public final int m2800getResolvedStateHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m2799getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }

        /* renamed from: getFrom-HpuvwBQ, reason: not valid java name */
        public final int m2798getFromHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(2);
        }

        /* renamed from: getTo-HpuvwBQ, reason: not valid java name */
        public final int m2801getToHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(3);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "resolvedState" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "resolvedCompositionContext" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(2)) ? "from" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(3)) ? "to" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(2));
            MovableContentStateReference movableContentStateReference2 = (MovableContentStateReference) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(3));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            MovableContentState movableContentStateMovableContentStateResolve$runtime_release = (MovableContentState) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0));
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m2836getCompositionHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m2837getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(1);
        }

        /* renamed from: getReference-HpuvwBQ, reason: not valid java name */
        public final int m2838getReferenceHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(2);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "composition" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "parentCompositionContext" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(2)) ? "reference" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            OperationKt.releaseMovableGroupAtCurrent((ControlledComposition) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0)), (CompositionContext) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1)), (MovableContentStateReference) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(2)), slotWriter);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        public final int m2794getChangesHpuvwBQ() {
            return ObjectParameter.m2828constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo2790objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(0)) ? "changes" : ObjectParameter.m2830equalsimpl0(parameter, ObjectParameter.m2828constructorimpl(1)) ? "effectiveNodeIndex" : super.mo2790objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.mo2854getObject31yXWZQ(ObjectParameter.m2828constructorimpl(0));
            if (element > 0) {
    ...
    public static final class TestOperation extends Operation {
        ...
        public TestOperation(int i, int i2, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i3 = 0; i3 < i; i3++) {
                arrayList.add(IntParameter.m2816boximpl(IntParameter.m2817constructorimpl(i3)));
            }
            this.intParams = arrayList;
            ArrayList arrayList2 = new ArrayList(i2);
            for (int i4 = 0; i4 < i2; i4++) {
                arrayList2.add(ObjectParameter.m2827boximpl(ObjectParameter.m2828constructorimpl(i4)));
            }
