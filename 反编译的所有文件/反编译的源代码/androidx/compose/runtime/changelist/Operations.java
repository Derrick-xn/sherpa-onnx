...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> args) {
        pushOp(operation);
        args.invoke(WriteScope.m2859boximpl(WriteScope.m2860constructorimpl(this)));
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & this.pushedIntMask) != 0) {
                ...
                sb.append(operation.mo2789intParamNamew8GmfQM(Operation.IntParameter.m2817constructorimpl(i2)));
                i++;
            }
        }
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & this.pushedObjectMask) != 0) {
                ...
                sb2.append(operation.mo2790objectParamName31yXWZQ(Operation.ObjectParameter.m2828constructorimpl(i4)));
                i3++;
            }
        }
    ...
    public static final class WriteScope {
        ...
        public static final /* synthetic */ WriteScope m2859boximpl(Operations operations) {
            return new WriteScope(operations);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Operations m2860constructorimpl(Operations operations) {
            return operations;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m2861equalsimpl(Operations operations, Object obj) {
            return (obj instanceof WriteScope) && Intrinsics.areEqual(operations, ((WriteScope) obj).getStack());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m2862equalsimpl0(Operations operations, Operations operations2) {
            return Intrinsics.areEqual(operations, operations2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m2864hashCodeimpl(Operations operations) {
            return operations.hashCode();
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m2867toStringimpl(Operations operations) {
            return "WriteScope(stack=" + operations + ')';
        }

        public boolean equals(Object obj) {
            return m2861equalsimpl(this.stack, obj);
        }

        public int hashCode() {
            return m2864hashCodeimpl(this.stack);
        }

        public String toString() {
            return m2867toStringimpl(this.stack);
        }
        ...
        public static final Operation m2863getOperationimpl(Operations operations) {
            return operations.peekOperation();
        }

        /* renamed from: setInt-A6tL2VI, reason: not valid java name */
        public static final void m2865setIntA6tL2VI(Operations operations, int i, int i2) {
            int i3 = 1 << i;
            if (!((operations.pushedIntMask & i3) == 0)) {
                PreconditionsKt.throwIllegalStateException("Already pushed argument " + m2863getOperationimpl(operations).mo2789intParamNamew8GmfQM(i));
            }
            operations.pushedIntMask |= i3;
            operations.intArgs[operations.m2857topIntIndexOfw8GmfQM(i)] = i2;
        }

        /* renamed from: setObject-DKhxnng, reason: not valid java name */
        public static final <T> void m2866setObjectDKhxnng(Operations operations, int i, T t) {
            int i2 = 1 << i;
            if (!((operations.pushedObjectMask & i2) == 0)) {
                PreconditionsKt.throwIllegalStateException("Already pushed argument " + m2863getOperationimpl(operations).mo2790objectParamName31yXWZQ(i));
            }
            operations.pushedObjectMask |= i2;
            operations.objectArgs[operations.m2858topObjectIndexOf31yXWZQ(i)] = t;
        }
    }
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public int mo2853getIntw8GmfQM(int parameter) {
            return Operations.this.intArgs[this.intIdx + parameter];
        }

        @Override // androidx.compose.runtime.changelist.OperationArgContainer
        /* renamed from: getObject-31yXWZQ */
        public <T> T mo2854getObject31yXWZQ(int parameter) {
    ...
    private final String currentOpToDebugString(OpIterator opIterator, String str) {
        ...
        for (int i = 0; i < ints; i++) {
            int iM2817constructorimpl = Operation.IntParameter.m2817constructorimpl(i);
            String strMo2789intParamNamew8GmfQM = operation.mo2789intParamNamew8GmfQM(iM2817constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            Intrinsics.checkNotNullExpressionValue(sb, "append('\\n')");
            sb.append(strIndent);
            sb.append(strMo2789intParamNamew8GmfQM);
            sb.append(" = ");
            sb.append(opIterator.mo2853getIntw8GmfQM(iM2817constructorimpl));
        }
        int objects = operation.getObjects();
        for (int i2 = 0; i2 < objects; i2++) {
            int iM2828constructorimpl = Operation.ObjectParameter.m2828constructorimpl(i2);
            String strMo2790objectParamName31yXWZQ = operation.mo2790objectParamName31yXWZQ(iM2828constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            Intrinsics.checkNotNullExpressionValue(sb, "append('\\n')");
            sb.append(strIndent);
            sb.append(strMo2790objectParamName31yXWZQ);
            sb.append(" = ");
            sb.append(formatOpArgumentToString(opIterator.mo2854getObject31yXWZQ(iM2828constructorimpl), strIndent));
        }
        sb.append('\n');
        Intrinsics.checkNotNullExpressionValue(sb, "append('\\n')");
        sb.append(str);
