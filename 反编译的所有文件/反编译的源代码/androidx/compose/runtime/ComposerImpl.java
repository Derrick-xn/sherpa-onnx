...
public final class ComposerImpl implements Composer {
    ...
    public void startReplaceableGroup(int key) {
        m2736startBaiHCIY(key, null, GroupKind.INSTANCE.m2748getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m2736startBaiHCIY(-127, null, GroupKind.INSTANCE.m2748getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m2736startBaiHCIY(key, dataKey, GroupKind.INSTANCE.m2748getGroupULZAiWs(), null);
    }
    ...
    public void startNode() {
        m2736startBaiHCIY(125, null, GroupKind.INSTANCE.m2749getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m2736startBaiHCIY(125, null, GroupKind.INSTANCE.m2750getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m2736startBaiHCIY(key, null, GroupKind.INSTANCE.m2748getGroupULZAiWs(), dataKey);
    }
    ...
    public void startProvider(ProvidedValue<?> value) {
        ...
        boolean z = true;
        boolean z2 = !Intrinsics.areEqual(valueHolderUpdatedStateOf$runtime_release, valueHolder);
        if (z2) {
        ...
        if (getInserting()) {
            ...
            persistentCompositionLocalMapCurrentCompositionLocalScope = ((!getSkipping() || z2) && (value.getCanOverride() || !CompositionLocalMapKt.contains(persistentCompositionLocalMapCurrentCompositionLocalScope, compositionLocal))) ? persistentCompositionLocalMapCurrentCompositionLocalScope.putValue(compositionLocal, valueHolderUpdatedStateOf$runtime_release) : persistentCompositionLocalMap;
        ...
        m2736startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m2748getGroupULZAiWs(), persistentCompositionLocalMapCurrentCompositionLocalScope);
    }
    ...
    public void startProviders(ProvidedValue<?>[] values) {
        ...
        m2736startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m2748getGroupULZAiWs(), persistentCompositionLocalMapUpdateProviderMapGroup);
    }
    ...
    */
    private final void m2736startBaiHCIY(int r14, java.lang.Object r15, int r16, java.lang.Object r17) {
        /*
            Method dump skipped, instructions count: 483
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.ComposerImpl.m2736startBaiHCIY(int, java.lang.Object, int, java.lang.Object):void");
    }
        ...
        if (getInserting()) {
            ...
            if (objGroupObjectKey == null) {
                if (objGroupAux != null && iGroupKey == 207 && !Intrinsics.areEqual(objGroupAux, Composer.INSTANCE.getEmpty())) {
                    ...
                    iRotateRight2 = Integer.rotateRight(iPeek2 ^ getCompoundKeyHash(), 3) ^ iGroupKey;
                }
            } else {
                if (objGroupObjectKey instanceof Enum) {
                    iHashCode2 = ((Enum) objGroupObjectKey).ordinal();
                } else {
                    iHashCode2 = objGroupObjectKey.hashCode();
                }
                iRotateRight2 = iHashCode2 ^ Integer.rotateRight(getCompoundKeyHash(), 3);
            }
            this.compoundKeyHash = Integer.rotateRight(iRotateRight2, 3);
        } else {
            ...
            if (objGroupObjectKey2 == null) {
                if (objGroupAux2 != null && iGroupKey2 == 207 && !Intrinsics.areEqual(objGroupAux2, Composer.INSTANCE.getEmpty())) {
                    ...
                    iRotateRight = Integer.rotateRight(iPeek2 ^ getCompoundKeyHash(), 3) ^ iGroupKey2;
                }
            } else {
                if (objGroupObjectKey2 instanceof Enum) {
                    iHashCode = ((Enum) objGroupObjectKey2).ordinal();
                } else {
                    iHashCode = objGroupObjectKey2.hashCode();
                }
                iRotateRight = iHashCode ^ Integer.rotateRight(getCompoundKeyHash(), 3);
            }
            this.compoundKeyHash = Integer.rotateRight(iRotateRight, 3);
        }
    ...
    */
    ...
    public final void invokeMovableContentLambda(final MovableContent<Object> content, PersistentCompositionLocalMap locals, final Object parameter, boolean force) {
        ...
        try {
            ...
            m2736startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m2748getGroupULZAiWs(), locals);
            this.providerCache = null;
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final void doCompose(androidx.compose.runtime.collection.ScopeMap<androidx.compose.runtime.RecomposeScopeImpl, java.lang.Object> r23, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r24) {
        /*
            Method dump skipped, instructions count: 355
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.ComposerImpl.doCompose(androidx.compose.runtime.collection.ScopeMap, kotlin.jvm.functions.Function2):void");
    }
