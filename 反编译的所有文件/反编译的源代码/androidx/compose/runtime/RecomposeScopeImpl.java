...
public final class RecomposeScopeImpl implements ScopeUpdateScope, RecomposeScope {
    ...
    */
    public final boolean isInvalidFor(java.lang.Object r19) {
        /*
            r18 = this;
            r0 = r18
            r1 = r19
                                    ...
                                    while (true) {
                                        ...
                                        if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                                            ...
                                            for (int i8 = 0; i8 < i7; i8++) {
                                                if ((255 & j2) < 128) {
                                                    int i9 = (i6 << 3) + i8;
                                                    Object obj2 = mutableObjectIntMap3.keys[i9];
                                                    boolean z = mutableObjectIntMap3.values[i9] != i5;
                                                    if (z) {
                                                    ...
                                                    if (z) {
                                                        mutableObjectIntMap3.removeValueAt(i9);
                                                    }
                                                }
                                                j2 >>= 8;
                                            }
