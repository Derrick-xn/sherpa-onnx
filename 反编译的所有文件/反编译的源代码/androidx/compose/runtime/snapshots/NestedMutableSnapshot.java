...
public final class NestedMutableSnapshot extends MutableSnapshot {
    ...
    public NestedMutableSnapshot(int i, SnapshotIdSet snapshotIdSet, Function1<Object, Unit> function1, Function1<Object, Unit> function12, MutableSnapshot mutableSnapshot) {
        ...
        mutableSnapshot.mo2872nestedActivated$runtime_release(this);
    }
    ...
    */
    public androidx.compose.runtime.snapshots.SnapshotApplyResult apply() {
        ...
        L2c:
            ...
            if (r0 == 0) goto L73
            int r5 = r0.get_size()     // Catch: java.lang.Throwable -> Lc7
            if (r5 != 0) goto L40
            goto L73
        L40:
        ...
        L5a:
            ...
            androidx.collection.MutableScatterSet r3 = r3.getModified$runtime_release()     // Catch: java.lang.Throwable -> Lc7
            if (r3 == 0) goto L6a
            r5 = r0
            androidx.collection.ScatterSet r5 = (androidx.collection.ScatterSet) r5     // Catch: java.lang.Throwable -> Lc7
    ...
    private final void deactivate() {
        ...
        this.parent.mo2873nestedDeactivated$runtime_release(this);
    }
}