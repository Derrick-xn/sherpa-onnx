...
public class MutableSnapshot extends Snapshot {
    ...
    */
    ...
    public void dispose() {
        ...
        super.dispose();
        mo2873nestedDeactivated$runtime_release(this);
    }
    ...
    public void mo2872nestedActivated$runtime_release(Snapshot snapshot) {
        this.snapshots++;
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    /* renamed from: nestedDeactivated$runtime_release */
    public void mo2873nestedDeactivated$runtime_release(Snapshot snapshot) {
        if (!(this.snapshots > 0)) {
    ...
    */
    private final void abandon() {
        /*
            r17 = this;
            r0 = r17
            androidx.collection.MutableScatterSet r1 = r17.getModified$runtime_release()
            if (r1 == 0) goto L7d
        ...
        L3a:
            ...
            int r12 = r12 + r11
            r12 = r3[r12]
            androidx.compose.runtime.snapshots.StateObject r12 = (androidx.compose.runtime.snapshots.StateObject) r12
            androidx.compose.runtime.snapshots.StateRecord r12 = r12.getFirstStateRecord()
        L50:
            if (r12 == 0) goto L72
            int r13 = r12.getSnapshotId()
            if (r13 == r2) goto L6a
            androidx.compose.runtime.snapshots.SnapshotIdSet r13 = r0.previousIds
            java.lang.Iterable r13 = (java.lang.Iterable) r13
            int r14 = r12.getSnapshotId()
            java.lang.Integer r14 = java.lang.Integer.valueOf(r14)
            boolean r13 = kotlin.collections.CollectionsKt.contains(r13, r14)
            if (r13 == 0) goto L6d
        L6a:
            r12.setSnapshotId$runtime_release(r5)
        L6d:
            androidx.compose.runtime.snapshots.StateRecord r12 = r12.getNext()
            goto L50
        L72:
            long r7 = r7 >> r10
            int r11 = r11 + 1
        ...
        L78:
            ...
            goto L20
        L7d:
            r17.closeAndReleasePinning$runtime_release()
            return
        */
    ...
    public final SnapshotApplyResult innerApplyLocked$runtime_release(int snapshotId, Map<StateRecord, ? extends StateRecord> optimisticMerges, SnapshotIdSet invalidSnapshots) {
        ...
        if (length >= 0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i3 < i2) {
                        if ((j & 255) < 128) {
                            StateObject stateObject = (StateObject) objArr3[(i << 3) + i3];
        ...
        if (arrayListPlus != null) {
            ...
            for (int i5 = 0; i5 < size2; i5++) {
                mutableScatterSet.remove(arrayListPlus.get(i5));
            }
    ...
    public void mo2874recordModified$runtime_release(StateObject state) {
        MutableScatterSet<StateObject> modified$runtime_release = getModified$runtime_release();
