...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m2889recordReadInh_f27i8$runtime_release(int reader) {
        int iM2876constructorimpl;
        do {
            iM2876constructorimpl = ReaderKind.m2876constructorimpl(this.readerKind.get());
            if ((iM2876constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(iM2876constructorimpl, ReaderKind.m2876constructorimpl(iM2876constructorimpl | reader)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime_release, reason: not valid java name */
    public final boolean m2888isReadInh_f27i8$runtime_release(int reader) {
        return (reader & ReaderKind.m2876constructorimpl(this.readerKind.get())) != 0;
    }
}