...
public class NavController {
    ...
    public static /* synthetic */ boolean popBackStack$default(NavController navController, boolean z, boolean z2, int i, Object obj) {
        ...
        if (navController.findDestinationComprehensive(navController.getGraph(), iGenerateHashCode, true) == null) {
    ...
    public final /* synthetic */ <T> boolean popBackStack(boolean inclusive, boolean saveState) {
        ...
        MagicApiIntrinsics.voidMagicApiCall("kotlinx.serialization.serializer.simple");
        int iGenerateHashCode = RouteSerializerKt.generateHashCode(SerializersKt.serializer((KType) null));
        if (findDestinationComprehensive(getGraph(), iGenerateHashCode, true) == null) {
            StringBuilder sb = new StringBuilder("Destination with route ");
            Intrinsics.reifiedOperationMarker(4, "T");
            sb.append(Reflection.getOrCreateKotlinClass(Object.class).getSimpleName());
            sb.append(" cannot be found in navigation graph ");
    ...
    public final void addEntryToBackStack(NavDestination node, Bundle finalArgs, NavBackStackEntry backStackEntry, List<NavBackStackEntry> restoredEntries) {
        ...
        while (destination2 != null && findDestination(destination2.getId()) != destination2) {
            ...
            if (parent2 != null) {
                ...
                if (navBackStackEntryCreate$default2 == null) {
                    navBackStackEntryCreate$default2 = NavBackStackEntry.Companion.create$default(NavBackStackEntry.INSTANCE, this.context, parent2, parent2.addInDefaultArgs(bundle4), getHostLifecycleState$navigation_runtime_release(), this.viewModel, null, null, 96, null);
                }
        ...
        for (NavBackStackEntry navBackStackEntry5 : CollectionsKt.plus((Collection<? extends NavBackStackEntry>) arrayDeque3, navBackStackEntry)) {
