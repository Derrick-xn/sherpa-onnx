        ...
        if (a.getValue(androidx.navigation.common.R.styleable.NavArgument_android_defaultValue, typedValue)) {
            if (navTypeFromArgType == NavType.ReferenceType) {
                ...
                if (i2 == 3) {
                    ...
                    navTypeFromArgType = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navTypeFromArgType, NavType.FloatType, string, "float");
                    ...
                    navTypeFromArgType = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navTypeFromArgType, NavType.BoolType, string, "boolean");
                    ...
                    if (navTypeFromArgType == NavType.FloatType) {
                        ...
                        navTypeFromArgType = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navTypeFromArgType, NavType.IntType, string, "integer");
