            ...
            if (j == 128) {
                ...
                if (j == 254) {
                    ...
                    if (((iFindFirstAvailableSlot - i7) & i2) / 8 == ((i3 - i7) & i2) / 8) {
                        jArr[i4] = ((r9 & WorkQueueKt.MASK) << i5) | ((~(255 << i5)) & jArr[i4]);
                        ...
                        if (((j2 >> i9) & 255) == 128) {
                            int i10 = i3;
                            jArr[i8] = ((r9 & WorkQueueKt.MASK) << i9) | (j2 & (~(255 << i9)));
                            jArr[i4] = (jArr[i4] & (~(255 << i5))) | (128 << i5);
                            objArr[iFindFirstAvailableSlot] = objArr[i10];
                            objArr[i10] = null;
                            i = i10;
                            iFindEmptySlot = i;
                        } else {
                            ...
                            objArr[i11] = objArr[iFindEmptySlot];
                            i = i11 - 1;
                        }
