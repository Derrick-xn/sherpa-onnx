    ...
    private final void dropDeletes() {
        ...
        while (i4 != i3) {
            ...
            if (j == 128) {
                ...
                if (j == 254) {
                    int iM = UByte$$ExternalSyntheticBackport0.m(jArr3[i4]) * ScatterMapKt.MurmurHashC1;
                    int i7 = iM ^ (iM << 16);
                    int i8 = i7 >>> 7;
                    int iFindFirstAvailableSlot = findFirstAvailableSlot(i8);
                    int i9 = i8 & i3;
                    if (((iFindFirstAvailableSlot - i9) & i3) / 8 == ((i4 - i9) & i3) / 8) {
                        jArr2[i5] = ((i7 & WorkQueueKt.MASK) << i6) | ((~(255 << i6)) & jArr2[i5]);
                        ...
                        if (((j2 >> i11) & 255) == 128) {
                            int i12 = i4;
                            jArr = jArr3;
                            jArr2[i10] = (j2 & (~(255 << i11))) | ((i7 & WorkQueueKt.MASK) << i11);
                            jArr2[i5] = (jArr2[i5] & (~(255 << i6))) | (128 << i6);
                            jArr[iFindFirstAvailableSlot] = jArr[i12];
                            jArr[i12] = 0;
                            jArr4[iFindFirstAvailableSlot] = jArr4[i12];
                            jArr4[i12] = 0;
                            i2 = i12;
                            iFindEmptySlot = i2;
                            i = i3;
                            ...
                            jArr = jArr3;
                            int i14 = i4;
                            jArr2[i10] = ((i7 & WorkQueueKt.MASK) << i11) | (j2 & (~(255 << i11)));
                            if (iFindEmptySlot == -1) {
                                i = i13;
                            ...
                            jArr4[iFindFirstAvailableSlot] = jArr4[i14];
                            jArr4[i14] = jArr4[iFindEmptySlot];
                            i2 = i14 - 1;
                        }
                        c = 0;
