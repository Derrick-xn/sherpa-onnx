                ...
                if (j == 254) {
                    ...
                    if (((iFindFirstAvailableSlot - i9) & i3) / 8 == ((i4 - i9) & i3) / 8) {
                        ...
                        if (((j2 >> i11) & 255) == 128) {
                            ...
                            fArr[i12] = 0.0f;
                            fArr3[iFindFirstAvailableSlot] = fArr3[i12];
                            fArr3[i12] = 0.0f;
                            i2 = i12;
                            iFindEmptySlot = i2;
                            i = i3;
                            ...
                            fArr3[iFindEmptySlot] = fArr3[iFindFirstAvailableSlot];
                            fArr3[iFindFirstAvailableSlot] = fArr3[i14];
                            fArr3[i14] = fArr3[iFindEmptySlot];
                            i2 = i14 - 1;
                        }
                        c = 0;
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i3 < i) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatFloatMap.findFirstAvailableSlot(i4 >>> 7);
                ...
                fArr4[iFindFirstAvailableSlot] = fArr2[i3];
            } else {
                jArr = jArr2;
            }
            i3++;
