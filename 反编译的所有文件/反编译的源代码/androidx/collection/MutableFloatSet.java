    ...
    private final void dropDeletes() {
        ...
        while (i3 != i2) {
            ...
            if (j == 128) {
                ...
                if (j == 254) {
                    int iFloatToIntBits = Float.floatToIntBits(fArr[i3]) * ScatterMapKt.MurmurHashC1;
                    ...
                    if (((iFindFirstAvailableSlot - i8) & i2) / 8 == ((i3 - i8) & i2) / 8) {
                        jArr[i4] = ((i6 & WorkQueueKt.MASK) << i5) | ((~(255 << i5)) & jArr[i4]);
                        ...
                        if (((j2 >> i10) & 255) == 128) {
                            int i11 = i3;
                            jArr[i9] = ((i6 & WorkQueueKt.MASK) << i10) | (j2 & (~(255 << i10)));
