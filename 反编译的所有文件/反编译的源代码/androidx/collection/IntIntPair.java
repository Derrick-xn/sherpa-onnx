...
public final class IntIntPair {
    ...
    public static final /* synthetic */ IntIntPair m44boximpl(long j) {
        return new IntIntPair(j);
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final int m45component1impl(long j) {
        return (int) (j >> 32);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final int m46component2impl(long j) {
    ...
    public static final int m51getFirstimpl(long j) {
        return (int) (j >> 32);
    }
    ...
    public static final int m52getSecondimpl(long j) {
        return (int) (j & 4294967295L);
    }
    ...
    public boolean equals(Object obj) {
        return m49equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m53hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m47constructorimpl(int i, int i2) {
        return m48constructorimpl((i2 & 4294967295L) | (i << 32));
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m54toStringimpl(long j) {
        return "(" + m51getFirstimpl(j) + ", " + m52getSecondimpl(j) + ')';
    }

    public String toString() {
        return m54toStringimpl(this.packedValue);
    }
}