            ...
            if (j == 128) {
                ...
                if (j == 254) {
                    ...
                    if (((iFindFirstAvailableSlot - i8) & i3) / 8 == ((i4 - i8) & i3) / 8) {
                        ...
                        jArr[ArraysKt.getLastIndex(jArr)] = jArr[c];
                    } else {
                        ...
                        if (((j2 >> i10) & 255) == 128) {
                            ...
                            objArr[i11] = null;
                            objArr3[iFindFirstAvailableSlot] = objArr3[i11];
                            objArr3[i11] = null;
                            i2 = i11;
                            iFindEmptySlot = i2;
                            i = i3;
                            ...
                            objArr3[iFindFirstAvailableSlot] = objArr3[i13];
                            objArr3[i13] = objArr3[iFindEmptySlot];
                            i2 = i13 - 1;
                        }
                        c = 0;
