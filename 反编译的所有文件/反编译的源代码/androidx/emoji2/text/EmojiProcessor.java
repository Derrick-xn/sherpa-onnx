...
final class EmojiProcessor {
    ...
    CharSequence process(CharSequence charSequence, int i, int i2, int i3, boolean z) {
        ...
        if (i4 != i5 && i4 < charSequence.length()) {
            ...
            UnprecomputeTextOnModificationSpannable unprecomputeTextOnModificationSpannable2 = (UnprecomputeTextOnModificationSpannable) process(charSequence, i4, i5, i3, z, new EmojiProcessAddSpanCallback(unprecomputeTextOnModificationSpannable, this.mSpanFactory));
