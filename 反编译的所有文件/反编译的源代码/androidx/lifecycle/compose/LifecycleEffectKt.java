...
public final class LifecycleEffectKt {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:56:0x00e0 A[LOOP:1: B:55:0x00de->B:56:0x00e0, LOOP_END] */
    ...
    */
    ...
    public static final void LifecycleStartEffectImpl(final LifecycleOwner lifecycleOwner, final LifecycleStartStopEffectScope lifecycleStartStopEffectScope, final Function1<? super LifecycleStartStopEffectScope, ? extends LifecycleStopOrDisposeEffectResult> function1, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(LifecycleStartEffectImpl)P(1,2)358@16483L619,358@16443L659:LifecycleEffect.kt#2vxrgp");
        if ((i & 6) == 0) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            composerStartRestartGroup.startReplaceableGroup(-1076218375);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(remember):LifecycleEffect.kt#9igjgp");
            ...
            EffectsKt.DisposableEffect(lifecycleOwner, lifecycleStartStopEffectScope, (Function1) lifecycleEffectKt$LifecycleStartEffectImpl$1$1RememberedValue, composerStartRestartGroup, (i2 & 14) | (i2 & 112));
            if (ComposerKt.isTraceInProgress()) {
    ...
    */
    ...
    public static final void LifecycleResumeEffect(final LifecycleOwner lifecycleOwner, final Function1<? super LifecycleResumePauseEffectScope, ? extends LifecyclePauseOrDisposeEffectResult> function1, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(LifecycleResumeEffect)P(1)681@31516L7:LifecycleEffect.kt#2vxrgp");
        int i3 = i & 1;
        if (i3 == 0 && composerStartRestartGroup.getSkipping()) {
            composerStartRestartGroup.skipToGroupEnd();
            ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        ...
        composerStartRestartGroup.endDefaults();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-747476210, i, -1, "androidx.lifecycle.compose.LifecycleResumeEffect (LifecycleEffect.kt:683)");
        }
    ...
    public static final void LifecycleResumeEffectImpl(final LifecycleOwner lifecycleOwner, final LifecycleResumePauseEffectScope lifecycleResumePauseEffectScope, final Function1<? super LifecycleResumePauseEffectScope, ? extends LifecyclePauseOrDisposeEffectResult> function1, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(LifecycleResumeEffectImpl)P(1,2)691@31930L628,691@31890L668:LifecycleEffect.kt#2vxrgp");
        if ((i & 6) == 0) {
            i2 = (composerStartRestartGroup.changedInstance(lifecycleOwner) ? 4 : 2) | i;
        } else {
            i2 = i;
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(912823238, i2, -1, "androidx.lifecycle.compose.LifecycleResumeEffectImpl (LifecycleEffect.kt:690)");
            }
            composerStartRestartGroup.startReplaceableGroup(657406551);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(remember):LifecycleEffect.kt#9igjgp");
            ...
            composerStartRestartGroup.endReplaceableGroup();
            EffectsKt.DisposableEffect(lifecycleOwner, lifecycleResumePauseEffectScope, (Function1) lifecycleEffectKt$LifecycleResumeEffectImpl$1$1RememberedValue, composerStartRestartGroup, (i2 & 14) | (i2 & 112));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
