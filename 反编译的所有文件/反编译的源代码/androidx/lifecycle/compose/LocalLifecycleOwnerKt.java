...
public final class LocalLifecycleOwnerKt {
    ...
    static {
        ...
        try {
            ...
            objM6309constructorimpl = Result.m6309constructorimpl(providableCompositionLocal);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6309constructorimpl = Result.m6309constructorimpl(ResultKt.createFailure(th));
        }
        ProvidableCompositionLocal<LifecycleOwner> providableCompositionLocalStaticCompositionLocalOf = (ProvidableCompositionLocal) (Result.m6315isFailureimpl(objM6309constructorimpl) ? null : objM6309constructorimpl);
