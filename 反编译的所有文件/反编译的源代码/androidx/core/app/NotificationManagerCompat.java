...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelM6115m = ColorKt$$ExternalSyntheticApiModelOutline0.m6115m((Object) it.next());
                if (!collection.contains(Api26Impl.getId(notificationChannelM6115m)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelM6115m)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(notificationChannelM6115m));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM6116m = ColorKt$$ExternalSyntheticApiModelOutline0.m6116m((Object) it.next());
                if (Api26Impl.getId(notificationChannelGroupM6116m).equals(str)) {
                    return notificationChannelGroupM6116m;
                }
            }
        }
        return null;
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(ColorKt$$ExternalSyntheticApiModelOutline0.m6115m((Object) it.next())));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup notificationChannelGroupM6116m = ColorKt$$ExternalSyntheticApiModelOutline0.m6116m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM6116m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM6116m, notificationChannels));
                    }
                }
                return arrayList;
            }
