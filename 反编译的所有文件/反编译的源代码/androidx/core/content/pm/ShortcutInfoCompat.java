...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ColorKt$$ExternalSyntheticApiModelOutline0.m6151m$2();
        ShortcutInfo.Builder intents = ColorKt$$ExternalSyntheticApiModelOutline0.m6120m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, ColorKt$$ExternalSyntheticApiModelOutline0.m6121m((Object) it.next())).build());
        }
        return arrayList;
    }
