...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m6213m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM6213m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM6213m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m6214m(windowInsets);
            } else {
                builderM6213m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m6213m();
            }
            this.mPlatBuilder = builderM6213m;
        }
