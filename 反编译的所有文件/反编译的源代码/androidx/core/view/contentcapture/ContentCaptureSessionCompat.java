...
public class ContentCaptureSessionCompat {
    ...
    public AutofillId newAutofillId(long j) {
        if (Build.VERSION.SDK_INT >= 29) {
            return Api29Impl.newAutofillId(Paint29$$ExternalSyntheticApiModelOutline0.m5351m(this.mWrappedObj), ((AutofillIdCompat) Objects.requireNonNull(ViewCompat.getAutofillId(this.mView))).toAutofillId(), j);
        }
        return null;
    }
    ...
    public void notifyViewsDisappeared(long[] jArr) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api29Impl.notifyViewsDisappeared(Paint29$$ExternalSyntheticApiModelOutline0.m5351m(this.mWrappedObj), ((AutofillIdCompat) Objects.requireNonNull(ViewCompat.getAutofillId(this.mView))).toAutofillId(), jArr);
            return;
        }
        if (Build.VERSION.SDK_INT >= 29) {
            ViewStructure viewStructureNewViewStructure = Api29Impl.newViewStructure(Paint29$$ExternalSyntheticApiModelOutline0.m5351m(this.mWrappedObj), this.mView);
