...
public final class UStringsKt {
    ...
    public static final String m7640toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m7642toStringolVBNx4(short s, int i) {
    ...
    public static final String m7641toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m7639toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m6405constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m6321boximpl(UByte.m6327constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m6405constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m6585boximpl(UShort.m6591constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM6405constructorimpl = UInt.m6405constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM6405constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM6405constructorimpl2 = UInt.m6405constructorimpl(i3 * iM6405constructorimpl);
            int iM6405constructorimpl3 = UInt.m6405constructorimpl(UInt.m6405constructorimpl(iDigitOf) + iM6405constructorimpl2);
            if (Integer.compare(iM6405constructorimpl3 ^ Integer.MIN_VALUE, iM6405constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM6405constructorimpl3;
        }
        return UInt.m6399boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM6484constructorimpl = ULong.m6484constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM6484constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM6484constructorimpl2 = ULong.m6484constructorimpl(j * jM6484constructorimpl);
            long jM6484constructorimpl3 = ULong.m6484constructorimpl(ULong.m6484constructorimpl(UInt.m6405constructorimpl(r13) & 4294967295L) + jM6484constructorimpl2);
            if (Long.compare(jM6484constructorimpl3 ^ Long.MIN_VALUE, jM6484constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM6484constructorimpl3;
        }
        return ULong.m6478boximpl(j);
    }
}