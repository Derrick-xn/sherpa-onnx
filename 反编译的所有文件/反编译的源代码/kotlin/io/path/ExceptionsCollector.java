    ...
    public final void collect(Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                ...
                Throwable thInitCause = Trace$$ExternalSyntheticApiModelOutline0.m(String.valueOf(this.path)).initCause(exception);
                Intrinsics.checkNotNull(thInitCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exception = Trace$$ExternalSyntheticApiModelOutline0.m6263m((Object) thInitCause);
            }
