...
public final class PathTreeWalkKt {
    ...
    public static final Object keyOf(Path path, LinkOption[] linkOptionArr) {
        try {
            ...
            BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) Trace$$ExternalSyntheticApiModelOutline0.m6257m(), (LinkOption[]) Arrays.copyOf(linkOptionArr2, linkOptionArr2.length));
