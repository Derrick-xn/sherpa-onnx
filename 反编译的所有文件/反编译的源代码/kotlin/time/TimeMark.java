...
public interface TimeMark {
    ...
    TimeMark mo7644minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo7646plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7791plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7790minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo7646plusLRDsOJo(Duration.m7706unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m7686isNegativeimpl(timeMark.mo7643elapsedNowUwyO8pc());
        }
