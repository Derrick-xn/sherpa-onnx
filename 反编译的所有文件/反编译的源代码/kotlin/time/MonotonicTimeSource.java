...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m7793boximpl(m7787markNowz9LOYto());
    }
    ...
    public long m7787markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m7796constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m7786elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m7785differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m7784adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m7796constructorimpl(LongSaturatedMathKt.m7782saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}