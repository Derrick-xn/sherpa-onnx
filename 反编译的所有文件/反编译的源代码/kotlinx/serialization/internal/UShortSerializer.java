...
public final class UShortSerializer implements KSerializer<UShort> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UShort.m6585boximpl(m7933deserializeBwKQO78(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m7934serializei8woANY(encoder, ((UShort) obj).getData());
    }
    ...
    public void m7934serializei8woANY(Encoder encoder, short value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeShort(value);
    }

    /* renamed from: deserialize-BwKQO78, reason: not valid java name */
    public short m7933deserializeBwKQO78(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UShort.m6591constructorimpl(decoder.decodeInline(getDescriptor()).decodeShort());
    }
}