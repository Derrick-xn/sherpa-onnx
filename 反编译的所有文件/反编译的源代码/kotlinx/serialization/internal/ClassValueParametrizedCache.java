...
final class ClassValueParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo7898getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj2 == null) {
            try {
                ...
                objM6309constructorimpl = Result.m6309constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            obj2 = objPutIfAbsent == null ? resultM6308boximpl : objPutIfAbsent;
        }
