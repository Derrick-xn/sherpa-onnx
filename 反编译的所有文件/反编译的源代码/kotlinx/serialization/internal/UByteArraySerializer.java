...
public final class UByteArraySerializer extends PrimitiveArraySerializer<UByte, UByteArray, UByteArrayBuilder> implements KSerializer<UByteArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m7905collectionSizeGBYM_sE(((UByteArray) obj).getStorage());
    }

    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public /* bridge */ /* synthetic */ UByteArray empty() {
        return UByteArray.m6379boximpl(m7906emptyTcUX1vc());
    }

    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m7907toBuilderGBYM_sE(((UByteArray) obj).getStorage());
    }

    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, UByteArray uByteArray, int i) {
        m7908writeContentCoi6ktg(compositeEncoder, uByteArray.getStorage(), i);
    }
    ...
    protected int m7905collectionSizeGBYM_sE(byte[] collectionSize) {
        Intrinsics.checkNotNullParameter(collectionSize, "$this$collectionSize");
        return UByteArray.m6387getSizeimpl(collectionSize);
    }

    /* renamed from: toBuilder-GBYM_sE, reason: not valid java name */
    protected UByteArrayBuilder m7907toBuilderGBYM_sE(byte[] toBuilder) {
        Intrinsics.checkNotNullParameter(toBuilder, "$this$toBuilder");
        return new UByteArrayBuilder(toBuilder, null);
    }

    /* renamed from: empty-TcUX1vc, reason: not valid java name */
    protected byte[] m7906emptyTcUX1vc() {
        return UByteArray.m6380constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder decoder, int index, UByteArrayBuilder builder, boolean checkIndex) {
        ...
        builder.m7903append7apg3OU$kotlinx_serialization_core(UByte.m6327constructorimpl(decoder.decodeInlineElement(getDescriptor(), index).decodeByte()));
    }

    /* renamed from: writeContent-Coi6ktg, reason: not valid java name */
    protected void m7908writeContentCoi6ktg(CompositeEncoder encoder, byte[] content, int size) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(content, "content");
        for (int i = 0; i < size; i++) {
            encoder.encodeInlineElement(getDescriptor(), i).encodeByte(UByteArray.m6386getw2LRezQ(content, i));
        }
    }
}