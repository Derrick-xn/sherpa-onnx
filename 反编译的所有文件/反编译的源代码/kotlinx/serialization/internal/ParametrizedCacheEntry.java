...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m7901computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                objM6309constructorimpl = Result.m6309constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6309constructorimpl = Result.m6309constructorimpl(ResultKt.createFailure(th));
            }
            Result resultM6308boximpl = Result.m6308boximpl(objM6309constructorimpl);
            Object objPutIfAbsent = concurrentHashMap.putIfAbsent(arrayList2, resultM6308boximpl);
            obj = objPutIfAbsent == null ? resultM6308boximpl : objPutIfAbsent;
        }
