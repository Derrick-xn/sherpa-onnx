...
public final class DurationSerializer implements KSerializer<Duration> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return Duration.m7651boximpl(m7899deserialize5sfh64U(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m7900serializeHG0u8IE(encoder, ((Duration) obj).getRawValue());
    }
    ...
    public void m7900serializeHG0u8IE(Encoder encoder, long value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeString(Duration.m7698toIsoStringimpl(value));
    }

    /* renamed from: deserialize-5sfh64U, reason: not valid java name */
    public long m7899deserialize5sfh64U(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return Duration.INSTANCE.m7773parseIsoStringUwyO8pc(decoder.decodeString());
    }
}