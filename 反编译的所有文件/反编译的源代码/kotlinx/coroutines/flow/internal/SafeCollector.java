...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM6312exceptionOrNullimpl = Result.m6312exceptionOrNullimpl(result);
        if (thM6312exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM6312exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
