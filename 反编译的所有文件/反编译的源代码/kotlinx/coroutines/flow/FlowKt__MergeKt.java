...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C06741<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C06741(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C06741> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C06741 c06741 = new C06741(this.$transform, continuation);
            c06741.L$0 = flowCollector;
            c06741.L$1 = t;
            return c06741.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C06741(function2, null));
    }
