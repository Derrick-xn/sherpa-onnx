...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM6309constructorimpl = Result.m6309constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), b2 == true ? 1 : 0, 2, b == true ? 1 : 0));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6309constructorimpl = Result.m6309constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m6315isFailureimpl(objM6309constructorimpl) ? null : objM6309constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) throws Throwable {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo7885dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
