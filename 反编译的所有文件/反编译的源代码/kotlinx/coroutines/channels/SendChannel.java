...
public interface SendChannel<E> {
    ...
    Object mo7829trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m7849isSuccessimpl(objMo7829trySendJP2dKIU)) {
                return true;
            }
            Throwable thM7843exceptionOrNullimpl = ChannelResult.m7843exceptionOrNullimpl(objMo7829trySendJP2dKIU);
