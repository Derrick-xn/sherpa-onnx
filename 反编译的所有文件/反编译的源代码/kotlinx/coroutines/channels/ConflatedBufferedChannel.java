...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM7857trySendImplMj0NB7M = conflatedBufferedChannel.m7857trySendImplMj0NB7M(e, true);
        if (objM7857trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m7843exceptionOrNullimpl(objM7857trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM7857trySendImplMj0NB7M = conflatedBufferedChannel.m7857trySendImplMj0NB7M(e, true);
        if (!(objM7857trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo7829trySendJP2dKIU(E element) {
        return m7857trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m7857trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m7855trySendDropLatestMj0NB7M(element, isSendOp) : m7856trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m7855trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo7829trySendJP2dKIU = super.mo7829trySendJP2dKIU(element);
        if (ChannelResult.m7849isSuccessimpl(objMo7829trySendJP2dKIU) || ChannelResult.m7847isClosedimpl(objMo7829trySendJP2dKIU)) {
            return objMo7829trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m7854successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m7856trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ChannelSegment channelSegmentFindSegmentSend = conflatedBufferedChannel.findSegmentSend(j2, channelSegment2);
                if (channelSegmentFindSegmentSend != null) {
                    channelSegment = channelSegmentFindSegmentSend;
                } else if (zIsClosedForSend0) {
                    return ChannelResult.INSTANCE.m7852closedJP2dKIU(getSendException());
                }
            } else {
                channelSegment = channelSegment2;
            }
            int iUpdateCellSend = conflatedBufferedChannel.updateCellSend(channelSegment, i, element, j, obj, zIsClosedForSend0);
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo7829trySendJP2dKIU = mo7829trySendJP2dKIU(element);
        if (!(objMo7829trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo7829trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m7843exceptionOrNullimpl(objMo7829trySendJP2dKIU);
