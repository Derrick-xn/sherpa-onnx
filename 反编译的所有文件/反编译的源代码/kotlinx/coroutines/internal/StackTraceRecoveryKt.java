...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM6309constructorimpl2;
        ...
        try {
            ...
            objM6309constructorimpl = Result.m6309constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m6312exceptionOrNullimpl(objM6309constructorimpl) == null) {
            obj2 = objM6309constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM6309constructorimpl2 = Result.m6309constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM6309constructorimpl2 = Result.m6309constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m6312exceptionOrNullimpl(objM6309constructorimpl2) == null) {
            obj = objM6309constructorimpl2;
        }
