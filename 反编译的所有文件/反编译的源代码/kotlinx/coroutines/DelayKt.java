...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) throws Throwable {
        if (j <= 0) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo7886scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m7817delayVtjQ1oo(long j, Continuation<? super Unit> continuation) throws Throwable {
        Object objDelay = delay(m7818toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m7818toDelayMillisLRDsOJo(long j) {
        if (Duration.m7652compareToLRDsOJo(j, Duration.INSTANCE.m7756getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m7671getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}