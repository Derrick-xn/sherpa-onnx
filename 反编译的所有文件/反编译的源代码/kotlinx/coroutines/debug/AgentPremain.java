...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM6309constructorimpl = Result.m6309constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6309constructorimpl = Result.m6309constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m6315isFailureimpl(objM6309constructorimpl) ? null : objM6309constructorimpl);
