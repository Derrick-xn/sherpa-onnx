...
final class ContinuationHandler<T> implements BiFunction<T, Throwable, Unit> {
    ...
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m6309constructorimpl(result));
            return;
        }
        CompletionException completionExceptionM7607m = StreamsKt$$ExternalSyntheticApiModelOutline0.m7612m((Object) exception) ? StreamsKt$$ExternalSyntheticApiModelOutline0.m7607m((Object) exception) : null;
        if (completionExceptionM7607m != null && (cause = completionExceptionM7607m.getCause()) != null) {
            exception = cause;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m6309constructorimpl(ResultKt.createFailure(exception)));
    }
}